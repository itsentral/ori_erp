...
class Rutin_model extends CI_Model {
  ...
  //===============================================================================================================================
	...
	public function get_json_warehouse_rutin(){
		...
		$GET_WAREHOUSE_STOCK = get_warehouseStock();
		foreach($query->result_array() as $row){
			$total_data     = $totalData;
			$start_dari     = $requestData['start'];
			$asc_desc       = $requestData['order'][0]['dir'];
	...
	public function get_query_json_warehouse_rutin($inventory, $like_value = NULL, $column_order = NULL, $column_dir = NULL, $limit_start = NULL, $limit_length = NULL){
