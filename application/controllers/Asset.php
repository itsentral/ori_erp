...
//					$SISA_NILAI = $SISA_NILAI + 29887;
	...
	public function hapus_asset_coa(){
	 ...
	 public function new_asset(){ 
        ...
        history("View New asset");
        $this->load->view('Asset/new_asset', $data);
    }
	
	public function data_side_new_asset(){
		$this->asset_model->getDataJSON_new_asset();
	}
	...
	public function add_new(){
		if($this->input->post()){
			...
			$id = $this->uri->segment(3);
			$header = $this->asset_model->getWhere('asset_new', 'id', $id);
			$data = array(
				'title'			=> 'Add Asset New',
				'action'		=> 'add',
				'data' 			=> $header,
			...
			$this->load->view('Asset/add_new', $data);
		}
	}
