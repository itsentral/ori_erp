...
class Penerimaan extends CI_Controller {
	...
	public function index()
    {
		...
		$this->load->view('Penerimaan/list_payment',$data);
	...
	public function save_penerimaan(){
		...
		// } 
			...
			$this->db->insert('tr_saldo_bank',$datasaldo);
			 }
