...
class Edit_custom extends CI_Controller {
	...
	public function elbow_mould_edit(){
		if($this->input->post()){
			...
			$kode_product	= $kdx.$KdResinSystem."PN".$KdPressure."DN".$KdDiameter."-".$KdLiner."-".$KdSudut."-".$radiusX.$Tambahan.$ket_plus;
			...
			if($this->db->trans_status() === FALSE){
				...
				history('Edit Est Elbow Mould code : '.$kode_product);
			}
			...
			$data = array(
				'title'			=> 'Revision Estimation Elbow Mould',
			...
			$this->load->view('Component_custom/edit/elbow_mould_edit', $data);
		}
	}
	//sudah
	public function flange_mould_edit(){
		if($this->input->post()){
			...
			$this->load->view('Component_custom/edit/flange_mould_edit_new', $data);
		}
	}
	//sudah
	public function colar_edit(){
		if($this->input->post()){
			...
			$this->load->view('Component_custom/edit/colar_edit', $data);
		}
	}
	//sudah
	public function colar_slongsong_edit(){
		if($this->input->post()){
			...
			$this->load->view('Component_custom/edit/colar_slongsong_edit', $data);
		}
	}
	//sudah
	public function flange_slongsong_edit(){
		if($this->input->post()){
			...
			$this->load->view('Component_custom/edit/flange_slongsong_edit_new', $data);
		}
	}
	...
	public function concentric_reducer_edit(){
		if($this->input->post()){
			...
			$this->load->view('Component_custom/edit/concentric_reducer_edit', $data);
		}
	}
	...
	public function eccentric_reducer_edit(){
		if($this->input->post()){
			...
			$this->load->view('Component_custom/edit/eccentric_reducer_edit', $data);
		}
	}
	...
	public function elbow_mitter_edit(){
		if($this->input->post()){
			...
			$ArrHeader	= array(
				...
				'nm_product'			=> 'Elbow Mitter '.$diameter.'mm, '.$data['angle'],
				'resin_sistem'			=> $resin_sistem,
				'pressure'				=> $pressure,
				'standart_code'			=> $data['standart_code'],
				'cust'					=> $custX,
			...
			if($this->db->trans_status() === FALSE){
				...
				update_berat_est($kode_product);
				history('Edit Est Elbow Mitter code : '.$kode_product);
			}
			...
			$dataStandart		= $this->db->query("SELECT * FROM identitas")->result_array(); 
			$data = array(
				'title'			=> 'Revision Estimation Elbow Mitter',
			...
			$this->load->view('Component_custom/edit/elbow_mitter_edit', $data);
		}
	}
	...
	public function equal_tee_mould_edit(){
		if($this->input->post()){
			...
			$this->load->view('Component_custom/edit/equal_tee_mould_edit', $data);
		}
	}
	...
	public function equal_tee_slongsong_edit(){
		if($this->input->post()){
			...
			$this->load->view('Component_custom/edit/equal_tee_slongsong_edit', $data);
		}
	}
	...
	public function reducer_tee_mould_edit(){
		if($this->input->post()){
			...
			$this->load->view('Component_custom/edit/reducer_tee_mould_edit', $data);
		}
	}
	...
	public function reducer_tee_slongsong_edit(){
		if($this->input->post()){
			...
			$this->load->view('Component_custom/edit/reducer_tee_slongsong_edit', $data);
		}
	}
