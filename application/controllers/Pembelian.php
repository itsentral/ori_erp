...
class Pembelian extends CI_Controller {
	...
	public function pr(){
		$this->pembelian_model->index_pr();
	}
	
	public function server_side_progress_pr(){
		// $this->pembelian_model->get_data_json_progress_pr();
		$this->pembelian_model->get_data_json_progress_pr_new();
	}

	public function modal_detail_pr(){
		$no_pr_group    = $this->uri->segment(3);
		...
		$this->load->view('Pembelian/modal_detail_pr', $data);
	}
	...
	public function rfq(){
		$this->pembelian_model->index_rfq();
	}
	
	public function server_side_rfq(){
		$this->pembelian_model->get_data_json_rfq();
	}
	
	public function add_rfq(){
		$this->pembelian_model->add_rfq();
	}
	
	public function server_side_list_pr(){
		$this->pembelian_model->get_data_json_list_pr();
	}
	
	public function save_rfq(){
		$this->pembelian_model->save_rfq();
	}
	
	public function modal_detail_rfq(){
		$this->pembelian_model->modal_detail_rfq();
	}
	
	public function modal_edit_rfq(){
		$this->pembelian_model->modal_edit_rfq();
	}
	
	public function modal_edit_rfq_print(){
		$this->pembelian_model->modal_edit_rfq_print();
	}
	
	public function update_rfq(){
		$this->pembelian_model->update_rfq();
	}
	
	public function cancel_sebagian_rfq(){
		$this->pembelian_model->cancel_sebagian_rfq();
	}
	
	public function print_rfq(){
		$this->pembelian_model->print_rfq();
	}

	public function hapus_rfq(){
		$this->pembelian_model->hapus_rfq();
	}
	...
	public function perbandingan(){
		$this->pembelian_model->index_perbandingan();
	}
	
	public function server_side_perbandingan(){
		$this->pembelian_model->get_data_json_perbandingan();
	}
	...
	public function add_perbandingan(){
		if($this->input->post()){
			...
			$this->load->view('Pembelian/add_perbandingan', $data);
		}
	}
	
	public function modal_detail_perbandingan(){
//		$this->pembelian_model->modal_detail_perbandingan();
		$this->pembelian_model->modal_detail_perbandingan_new();
	}	
	public function pengajuan_rfq(){
		$this->pembelian_model->pengajuan_rfq();
	}
	...
	public function pengajuan(){
		$this->pembelian_model->index_pengajuan();
	}
	
	public function server_side_pengajuan(){
		$this->pembelian_model->get_data_json_pengajuan();
	}
	
	public function modal_detail_pengajuan(){
		$this->pembelian_model->modal_detail_pengajuan();
	}
	...
	public function modal_pemilihan(){
		if($this->input->post()){
			...
			$this->load->view('Pembelian/modal_pemilihan', $data);
		}
	}
	...
	public function modal_pemilihan_reject(){
		...
		$this->db->trans_start();
			...
			$this->db->where(array('no_rfq'=>$no_rfq));
			$this->db->update('tran_rfq_detail', $ArrDetail);
		$this->db->trans_complete();
	...
	public function modal_hasil_pengajuan(){
		...
		$this->load->view('Pembelian/modal_hasil_pengajuan', $data);
	}
	
	public function print_hasil_pemilihan(){
		$this->pembelian_model->print_hasil_pemilihan();
	}
	...
	public function approval(){
		...
		$this->load->view('Pembelian/approval',$data);
	}
	
	public function server_side_approval(){
		$this->pembelian_model->get_data_json_approval();
	}
	
	public function modal_detail_approve(){
		$this->pembelian_model->modal_detail_approve();
	}
	...
	public function modal_approve(){
		if($this->input->post()){
			...
			$this->load->view('Pembelian/modal_approve', $data);
		}
	}
	...
	public function purchase_order(){
		$this->pembelian_model->index_purchase_order();
	}
	
	public function server_side_purchase_order(){
		$this->pembelian_model->get_data_json_purchase_order();
	}
	...
	public function modal_detail_purchase_order(){
		...
		$this->load->view('Pembelian/modal_detail_purchase_order', $data);
	}
	...
	public function modal_edit_purchase_order(){
		if($this->input->post()){
			...
			$this->load->view('Pembelian/modal_edit_purchase_order', $data);
		}
	}
	
	public function print_po(){
		$this->pembelian_model->print_po();
	}

	public function print_po2xxx(){
		$this->pembelian_model->print_po2();
	}
	...
	public function print_po3(){
		...
		history('Print Purchase Order Revisi '.$no_po);
		$this->load->view('Print/print_po_dotmatrik_non_material_revisi1', $data); 
	}
	...
	public function get_add(){
		$this->pembelian_model->get_add();
	}
	
	public function get_kurs(){
		$this->pembelian_model->get_kurs();
	}
	
	public function modal_po(){
		$this->pembelian_model->modal_po();
	}

	public function server_side_list_rfq(){
		$this->pembelian_model->get_data_json_list_rfq();
	}
	...
	public function edit_po_qty(){
		if($this->input->post()){
			...
			$this->load->view('Pembelian/edit_po_qty', $data);
		}
	}
	
	public function delete_sebagian_po(){
		$this->pembelian_model->delete_sebagian_po();
	}
	
	public function delete_sebagian_po_new(){
		$this->pembelian_model->delete_sebagian_po_new();
	}
	...
	public function delete_semua_po(){
		$this->pembelian_model->delete_semua_po();
	}
	public function po_top($id_po) {
		$this->pembelian_model->po_top();
	}
	...
	public function invoice_receive($id) { 
		...
		if($info_payterm->invoice_no!=""){
			$dt_incoming=$this->db->query("select a.*, 
				CASE WHEN a.category = 'incoming rutin' THEN sum(b.harga) 
				ELSE sum(b.harga * b.qty_oke) END as total 
			...
			$dt_incoming=$this->db->query("select a.*, 
				...
				from warehouse_adjustment a 
				inner join warehouse_adjustment_detail b on a.kode_trans = b.kode_trans 
				where a.no_ipp='".$info_payterm->no_po."' and (a.id_invoice is null or a.id_invoice = '') GROUP BY a.kode_trans")->result();
		}
		...
		$this->load->view('Pembelian/form_receive_invoice',$data);		
	}
	...
	public function invoice_receive_top($no_po) {
		...
		$this->load->view('Pembelian/form_receive_invoice_top',$data);		
	}
...
//			$total=($data->nilai_terima_barang_kurs);			
			if($total!=0) {
			  foreach ($datajurnal1 as $rec) {
				if($rec->parameter_no=="1"){
					$det_Jurnaltes1[] = array(
						'nomor' => $nomor_jurnal, 'tanggal' => $payment_date, 'tipe' => 'JV', 'no_perkiraan' => $rec->no_perkiraan, 'keterangan' => 'PO '.$datapo->no_po, 'no_reff' => $data['invoice_no'], 'debet' => $data['invoice_total']+$data['potong_um']-$data['nilai_ppn'], 'kredit' => 0, 'no_request' => $datapo->no_po, 'jenis_jurnal'=>$jenis_jurnal, 'nocust'=>$datapo->id_supplier, 'stspos' => '1'
					);
				...
				if($rec->parameter_no=="2"){
					$det_Jurnaltes1[] = array(
						'nomor' => $nomor_jurnal, 'tanggal' => $payment_date, 'tipe' => 'JV', 'no_perkiraan' => $rec->no_perkiraan, 'keterangan' => 'PO '.$datapo->no_po, 'no_reff' => $data['invoice_no'], 'debet' => 0, 'kredit' => $data['invoice_total'], 'no_request' => $datapo->no_po, 'jenis_jurnal'=>$jenis_jurnal, 'nocust'=>$datapo->id_supplier, 'stspos' => '1'
					);
					$totalap=$data['invoice_total'];
				...
				if($rec->parameter_no=="4"){
					$det_Jurnaltes1[] = array(
						'nomor' => $nomor_jurnal, 'tanggal' => $payment_date, 'tipe' => 'JV', 'no_perkiraan' => $rec->no_perkiraan, 'keterangan' => 'Potongan DP '.$datapo->no_po, 'no_request' => $datapo->no_po, 'debet' => 0, 'kredit' => $data['potong_um'], 'no_reff' => $data['invoice_no'], 'jenis_jurnal'=>$jenis_jurnal, 'nocust'=>$datapo->id_supplier, 'stspos' => '1'
					);
				}
			  }
			}
...
//===Payment===
	public function request_payment($id_top){
		...
		$this->load->view('Pembelian/form_request', $data);
	}
	...
	function print_request($id_request){
		...
		$this->load->view('Pembelian/print_request', $data);
	}
	function close_po($no_po){
		...
		$this->load->view('Pembelian/close_po', $data);
	}
...
*/		
	...
	public function approval_non_po(){
		$this->pembelian_model->approval_non_po();
	}
	
	public function server_side_app_non_po(){
		$this->pembelian_model->get_data_json_app_non_po();
	}
	
	public function app_non_po(){
		$this->pembelian_model->app_non_po();
	}
	
	public function get_add_non_po(){
		$this->pembelian_model->get_add_non_po();
	}
	...
	public function expense_non_po(){
		if($this->input->post()){
			...
			$this->load->view('Pembelian/expense_non_po',$data);
		}
	}
	...
	public function approval_po($id=null){
		...
		$data_Group			= $this->master_model->getArray('groups',array(),'id','name');
		$data = array(
			'title'			=> 'Pembelian Non-Material & Jasa >> PO >> Approval PO',
			'action'		=> 'index',
			'row_group'		=> $data_Group,
			'akses_menu'	=> $Arr_Akses,
			'id'			=> $id
		...
		$this->load->view('Pembelian/approval_po',$data);
	}

	public function server_side_purchase_order_approve(){
		$this->pembelian_model->get_data_json_purchase_order_approve();
	}
	...
	public function modal_approval_po(){
		if($this->input->post()){
			...
			$this->load->view('Pembelian/modal_approval_po', $data);
		}
	}
	...
	public function repeat_po(){
		...
		$data_Group			= $this->master_model->getArray('groups',array(),'id','name');
		$data = array(
			'title'			=> 'Pembelian Non-Material & Jasa >> PO >> Repeat PO',
			'action'		=> 'index',
			'row_group'		=> $data_Group,
			'akses_menu'	=> $Arr_Akses
		);
		history('View data repeat po non-material');
		$this->load->view('Pembelian/repeat_po',$data);
	}
