...
class Budget extends CI_Controller {
	...
	public function kompilasi_budget(){
		...
		$data = array(
			'title'			=> 'Indeks Of Compile Budget',
			'action'		=> 'index',
		...
		$this->load->view('Budget_rutin/kompilasi_budget',$data);
	}
	...
	public function add_asset(){
		if($this->input->post()){
			...
			$datacoa = $this->db2->like('no_perkiraan','13','after')->get_where('coa_master',array('level'=>'5','no_perkiraan not like '=>'1309%' ))->result_array();
			$penyusutan = $this->db2->query("SELECT * FROM coa_master WHERE `level`='5' AND (nama LIKE 'DEPRECIATION%') ORDER BY no_perkiraan ASC")->result_array();
			...
			$this->load->view('Budget_asset/add',$data);
		}
	}
