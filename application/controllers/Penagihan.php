...
//		$Nomor_JV				= $this->Jurnal_model->get_Nomor_Jurnal_Sales('101',$tgl);
		...
		if($this->db->trans_status() === FALSE or $db2->trans_status()=== FALSE){
		 ...
		 $Arr_Return		= array(
			...
			$this->db->query("INSERT INTO data_erp_in_customerx (tanggal,keterangan,no_so,product,no_spk,kode_trans,id_pro_det,qty,nilai_unit,created_by,created_date,id_trans,id_pro,qty_ke,kode_delivery,jenis,id_material,nm_material,qty_mat,cost_book,gudang,kode_spool)			
			...
			$this->db->query("INSERT INTO data_erp_cogsx (tanggal,keterangan,no_so,product,no_spk,kode_trans,id_pro_det,qty,nilai_unit,created_by,created_date,id_trans,id_pro,qty_ke,kode_delivery,jenis,id_material,nm_material,qty_mat,cost_book,gudang,kode_spool)			
