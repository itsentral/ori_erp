<?php
	...
	$qDetailAdd1	= "SELECT a.*, b.price_ref_estimation FROM component_detail_add a LEFT JOIN raw_materials b ON a.id_material = b.id_material WHERE a.id_product='".$id_product."' AND a.detail_name='LINER THIKNESS / CB' AND a.id_material <> 'MTL-1903000'";
	$qDetailAdd2	= "SELECT a.*, b.price_ref_estimation FROM component_detail_add a LEFT JOIN raw_materials b ON a.id_material = b.id_material WHERE a.id_product='".$id_product."' AND a.detail_name='STRUKTUR THICKNESS' AND a.id_material <> 'MTL-1903000'";
	$qDetailAdd3	= "SELECT a.*, b.price_ref_estimation FROM component_detail_add a LEFT JOIN raw_materials b ON a.id_material = b.id_material WHERE a.id_product='".$id_product."' AND a.detail_name='EXTERNAL LAYER THICKNESS' AND a.id_material <> 'MTL-1903000'";
	$qDetailAdd4	= "SELECT a.*, b.price_ref_estimation FROM component_detail_add a LEFT JOIN raw_materials b ON a.id_material = b.id_material WHERE a.id_product='".$id_product."' AND a.detail_name='TOPCOAT' AND a.id_material <> 'MTL-1903000'";
			...
			<table id="my-grid" class="table table-striped table-bordered table-hover table-condensed" width="100%">
				<tbody>
					...
					<tr style='background-color: #4edcc1;'>
						...
						<td class="text-right" style='background-color: #ffc4da;'><b><?= number_format($TotExternal, 2);?></b></td>
					</tr>
				</tbody>
			</table>
		</div>
		...
		<div class="box-body" style="">
			<table id="my-grid" class="table table-striped table-bordered table-hover table-condensed" width="100%">
				...
				<tbody>
					...
					<tr>
						<td class="text-left" colspan='5' height='20px'></td>
					</tr>
				</tbody>
				<?php
					}
				...
				<tfoot>
					<tr style='background-color: #4edcc1; font-size: 18px; color:black;'>
						...
						<td class="text-right" width='10%' style='background-color: #ffc4da;'><b><?= number_format($TotLiner + $TotStructure + $TotStructureN1 + $TotStructureN2 + $TotExternal + $TotCoat, 2);?><input type='hidden' id='product_price' name='product_price' value='<?= number_format($TotLiner + $TotStructure + $TotExternal + $TotCoat, 2);?>' ></b></td>
					</tr>
				</tfoot>
			</table>
		</div>
