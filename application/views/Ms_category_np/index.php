	...
	<div class="box box-primary">
		<div class="box-header">
			...
			<?php if($akses_menu['create']=='1'){ ?>
			  <button type='button' class="btn btn-md btn-info" id='add'><i class="fa fa-plus"></i> Add Category</button>
			  <?php } ?>
			</div>
		</div>
		<div class="box-body">
...
<script>
	...
	$(document).on('click', '#add', function(e){
		e.preventDefault();
		loading_spinner();
		$("#head_title").html("<b>ADD CATEGORY</b>");
	...
	$(document).on('click', '.edit', function(e){
		...
		$("#head_title").html("<b>EDIT CATEGORY</b>");
	...
	$(document).on('click', '#save', function(){
		var nama	= $("#nama").val();
		if(nama==''){
			swal({title:"Error Message!", text:'Category Name', type:"warning"});
