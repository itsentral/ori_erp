		...
		<table class="table table-bordered table-striped" id="my-grid" width='100%'>
			<thead>
				<tr class='bg-blue'>
                    ...
                    <th class="text-center" width='9%'>No SO</th>
                    ...
                    <th class="text-center no-sort" width='10%'>Total SO</th>
...
<script>
	...
	$(document).on('click', '.detail', function(e){
		...
		$.ajax({
			type:'POST',
			url: base_url+active_controller+'/detail_so/'+$(this).data('id_bq'),
	...
	function DataTables(cust=null){
		var dataTable = $('#my-grid').DataTable({
			...
			"ajax":{
				url : base_url + active_controller+'/server_side_sales_order',
				type: "post",
				data: function(d){
					d.cust = cust
				},
