	...
	<div class="box box-primary">
		...
		<div class="box-body">
			<div class='form-group row'>
				...
				<div class='col-sm-4'>
					<?php
						echo form_input(array('id'=>'nm_plant','name'=>'nm_plant','class'=>'form-control input-md','autocomplete'=>'off','placeholder'=>'Plane Name','style'=>'text-transform:uppercase'));
					?>				</div>
				<label class='label-control col-sm-2'><b>Initial Plants</b></label>
				<div class='col-sm-4'>
					<?php
						echo form_input(array('id'=>'inisial_plant','name'=>'inisial_plant','class'=>'form-control input-md','autocomplete'=>'off','placeholder'=>'Initial Name','maxlength'=>'10', 'style'=>'text-transform:uppercase'));
					?>
				</div>
			</div>
			<div class='form-group row'>
				...
				<div class='col-sm-4'>
					...
					echo form_dropdown('kdcab',$branch, '0', array('id'=>'kdcab','class'=>'form-control input-md'));
					?>
				</div>
				...
				<div class='col-sm-4'>
					 ...
					 $rows_province[0]='Select An Province';
						echo form_dropdown('province',$rows_province, 0, array('id'=>'province','class'=>'form-control input-md'));
					 ?>
				</div>
			</div>
			<div class='form-group row'>
				...
				<div class='col-sm-4'>
					<?php
						echo form_input(array('id'=>'phone','name'=>'phone','class'=>'form-control input-md','placeholder'=>'User Phone'));
					?>
				</div>
				<label class='label-control col-sm-2'><b>Fax <span class='text-red'>*</span></b></label>
				<div class='col-sm-4'>
					<?php
						echo form_input(array('id'=>'fax','name'=>'fax','class'=>'form-control input-md','placeholder'=>'Fax Number'));
					?>
				</div>
			</div>
			<div class='form-group row'>
				...
				<div class='col-sm-4'>
					<?php
					 echo form_input(array('id'=>'email','name'=>'email','class'=>'form-control input-md','placeholder'=>'Email company plant'));
					?>
				</div>
				...
				<div class='col-sm-4'>
					 <?php
						...
						echo form_textarea(array('id'=>'address','name'=>'address','class'=>'form-control input-md','rows'=>'3','cols'=>'75','placeholder'=>'Address company plants'));
					?>
				</div>
			</div>
		</div>
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl=base_url + active_controller +'/add_company_plant';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
