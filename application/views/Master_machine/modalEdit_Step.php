	...
	<div class="box box-primary">
		...
		<div class="box-body">
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-4'>             
						<?php
							echo form_input(array('id'=>'no_mesin','name'=>'no_mesin','class'=>'form-control input-md','autocomplete'=>'off','placeholder'=>'Nomor Mesin','readonly'=>'readonly'), $getData->no_mesin);											
							echo form_input(array('type'=>'hidden','id'=>'id_mesin','name'=>'id_mesin','class'=>'form-control input-md','autocomplete'=>'off','placeholder'=>'Id Mesin'), $getData->id_mesin);											
				...
				<div class='col-sm-4'>            
						<?php
							echo form_input(array('id'=>'nm_mesin','name'=>'nm_mesin','class'=>'form-control input-md','autocomplete'=>'off','placeholder'=>'Nama Mesin'), $getData->nm_mesin);											
						?>		
				</div>
			</div>
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-4'>             
						<?php
							echo form_input(array('id'=>'capacity','name'=>'capacity','class'=>'form-control input-md','autocomplete'=>'off','placeholder'=>'Kapasitas'), $getData->capacity);											
						?>		
				</div>
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-4'>             
						<?php
							echo form_input(array('id'=>'machine_price','name'=>'machine_price','class'=>'form-control input-md numberOnly','autocomplete'=>'off','placeholder'=>'Harga Mesin (USD)'), floatval($getData->machine_price));											
						?>		
				</div>
				<label class='label-control col-sm-2'><b>Est. Pemanfaatan (Tahun) <span class='text-red'>*</span></b></label>
				<div class='col-sm-4'>            
						<?php
							echo form_input(array('id'=>'utilization_estimate','name'=>'utilization_estimate','class'=>'form-control input-md numberOnly','autocomplete'=>'off','placeholder'=>'Est. Pemanfaatan (Tahun)'), $getData->utilization_estimate);											
						?>		
				</div>
			</div>
			<div class='form-group row'>		 	 
			...
			<div class='box-footer'>
				<?php
				echo form_button(array('type'=>'button','class'=>'btn btn-md btn-primary','value'=>'save','content'=>'Save','id'=>'update-bro')).' ';
				?>
			</div>			
		</div>
		<!-- /.box-body -->
	...
	$(document).ready(function(){
		...
		$('#update-bro').click(function(e){
			...
			if(no_mesin=='' || no_mesin==null){
				...
				$('#update-bro').prop('disabled',false);
				return false;
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl		= base_url + active_controller +'/update';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
