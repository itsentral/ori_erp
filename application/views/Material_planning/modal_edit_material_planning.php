...
<div class="box-body">
		...
		<tbody>
			...
			if(!empty($data_result)){
				...
				echo "<td align='right'><input type='text' name='addMatPlanning[$No][use_stock]' id='use_stock_$No' data-no='$No' class='form-control input-sm text-right maskM use_stock' value='".number_format($valx['use_stock'],2)."'></td>";
							echo "<td align='right'><input type='text' name='addMatPlanning[$No][sisa_avl]' id='sisa_avl_$No' data-no='$No' class='form-control input-sm text-right maskM' value='".number_format($valx['sisa_avl'],2)."' readonly></td>";
	...
	<table class="table table-striped table-bordered table-hover table-condensed" width="100%">
		<thead id='head_table'>
			<tr>
				<td class='bg-blue' colspan='6'><b>BQ NON FRP</b></td>
			</tr>
		</thead>
		<thead id='head_table'>
			<tr class='bg-blue'>
