	...
	<table id="my-grid" class="table table-striped table-bordered table-hover table-condensed" width="100%">
		<thead id='head_table'>
			<tr class='bg-blue'>
				...
				<th class="text-center" style='vertical-align:middle;' width='13%'>Qty Outstanding</th>
			...
			if(!empty($result)){
				if($tanda == 'RTR'){
					...
					foreach($result AS $val => $valx){
						$No++;
						$Total1 += $valx['qty_oke'] - $valx['check_qty_oke'];
						$Total2 += $valx['qty_oke'];
						...
						echo "<tr>";
							echo "<td align='center'>".$No."
								<input type='hidden' name='addInMat[$No][code_group]' value='".$valx['id_material']."'>
								<input type='hidden' name='addInMat[$No][no_po]' value='".$valx['kode_trans']."'>
								<input type='hidden' name='addInMat[$No][id]' value='".$valx['id']."'>
								<input type='hidden' name='addInMat[$No][qty_order]' value='".$valx['qty_oke']."'>
							...
							echo "<td align='center'>".number_format($valx['qty_oke'],2)."</td>";
							echo "<td align='center' class='belumDiterima'>".number_format($totIn,2)."</td>";
					...
					<tr>
						...
						<td align='center'><b><?= number_format($Total2,2);?></b></td> 
						<td align='center'><b><?= number_format($Total1,2);?></b></td> 
						<td colspan='2'><b></b></td>
					</tr>
					<?php 
				}
