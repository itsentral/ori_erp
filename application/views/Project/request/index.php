...
<script>
	...
	$(document).on('click', '.pemakaian', function(e){
		e.preventDefault();
		loading_spinner();
		$("#head_title").html("<b>PEMAKAIAN ITEM PROJECT</b>");
		$.ajax({
			type:'POST',
			url: base_url+active_controller+'/pemakaian/'+$(this).data('id_bq'),
			success:function(data){
				$("#ModalView").modal();
				$("#view").html(data);
			},
	...
	$(document).on('click', '.laporan', function(e){
		e.preventDefault();
		loading_spinner();
		$("#head_title").html("<b>LAPORAN ITEM PROJECT</b>");
		$.ajax({
			type:'POST',
			url: base_url+active_controller+'/laporan/'+$(this).data('id_bq'),
			success:function(data){
				$("#ModalView").modal();
				$("#view").html(data);
			},
	...
	$(document).on('click', '.stock', function(e){
		e.preventDefault();
		loading_spinner();
		$("#head_title").html("<b>STOCK ITEM PROJECT</b>");
		$.ajax({
			type:'POST',
			url: base_url+active_controller+'/stock/'+$(this).data('id_bq'),
			success:function(data){
				$("#ModalView").modal();
				$("#view").html(data);
			},
	...
	$(document).on('click', '.retur', function(e){
		e.preventDefault();
		loading_spinner();
		$("#head_title").html("<b>RETUR ITEM PROJECT</b>");
		$.ajax({
			type:'POST',
			url: base_url+active_controller+'/retur/'+$(this).data('id_bq'),
			success:function(data){
				$("#ModalView").modal();
				$("#view").html(data);
			},
	...
	$(document).on('click', '#btnPengeluaran', function(e){
		...
		function(isConfirm) {
			if (isConfirm) {
				...
				var formData  	= new FormData($('#form_proses')[0]);
				$.ajax({
					url			: base_url + active_controller+'/pemakaian',
					type		: "POST",
					data		: formData,
					cache		: false,
					dataType	: 'json',
	...
	$(document).on('click', '#btnRetur', function(e){
		e.preventDefault();
		...
		function(isConfirm) {
			if (isConfirm) {
				...
				var formData  	= new FormData($('#form_proses')[0]);
				$.ajax({
					url			: base_url + active_controller+'/proses_retur',
					type		: "POST",
					data		: formData,
					cache		: false,
					dataType	: 'json',
	...
	$(document).on('click', '.closed', function(e){
		e.preventDefault();
		var id_customer = $(this).data('id_bq')
		swal({
			title: "Are you sure?",
			text: "You will not be able to process again this data!",
			type: "warning",
		...
		function(isConfirm) {
			if (isConfirm) {
				...
				// var formData  	= new FormData($('#form_proses')[0]);
				$.ajax({
					url			: base_url + active_controller+'/proses_close',
					type		: "POST",
					data		: {
