...
$rest_d		= $this->db
                    ->select('a.*')
                    ->get_where('warehouse_adjustment_detail a', array('a.kode_trans'=>$kode_trans))->result_array();
...
<table class="gridtable2" width="100%" border='0' style='border-bottom:none;'>
	...
	<tr>
		<td style='border-bottom:none; border-top: none; border-right: none;'>No. Trans</td>
		<td style='border:none;'>:</td>
...
<table class="gridtable2" width="100%" border='0'>
	<tr>
		...
		<td width='33%' rowspan='5' style='border-bottom:none; border-left: none; vertical-align: top; padding-top:10px;'>
			...
			Kepada Yth, <br>
			Gudang Pusat Indirect Project <br>
		</td>
	</tr>
	<tr>
...
$mpdf->WriteHTML($html);
ob_clean();
$mpdf->Output('surat-jalan-retur-accessories-'.$kode_trans.'.pdf' ,'I');