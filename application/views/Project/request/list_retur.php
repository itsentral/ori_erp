...
<div class="box box-primary">
	<div class="box-header">
		...
		<div class="box-tool pull-right">
			<a href="<?php echo site_url($this->uri->segment(1)) ?>" class="btn btn-sm btn-danger"><i class="fa fa-reply"></i> Back</a>
		</div>
	</div>
	<!-- /.box-header -->
	<div class="box-body">
...
<script>
	...
	function DataTables(){
		var dataTable = $('#my-grid').DataTable({
			...
			"ajax":{
				url : base_url + active_controller+'/server_side_request_retur',
				type: "post",
				data: function(d){
