	...
	<table class="table table-striped table-bordered table-hover table-condensed" width="100%">
		<thead id='head_table'>
			<tr class='bg-blue'>
				...
				<th class="text-center" style='vertical-align:middle;' width='6%'>Kode</th>
				...
				<th class="text-center" style='vertical-align:middle;' width='9%'>Sisa</th>
				<th class="text-center" style='vertical-align:middle;' width='6%'>Unit</th>
				<th class="text-center" style='vertical-align:middle;' width='9%'>Stock</th>
				<th class="text-center" style='vertical-align:middle;' width='9%'>Pengeluaran</th>
		...
		<tbody>
            ...
            foreach($result_aksesoris AS $val => $valx){
                ...
                echo "<tr>";
                    ...
                    echo "<td align='right' id='maxStock".$No."'>".number_format($stock,2)."</td>";
...
<div class="box-footer">
    <?php
		echo form_button(array('type'=>'button','class'=>'btn btn-md btn-primary','content'=>'Report','id'=>'btnPengeluaran'));
	?>
</div>
<style>
	.tgl{
