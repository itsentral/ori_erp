<table class="table table-bordered table-striped table-sm">
    <thead>
        <tr class='bg-blue'>
            ...
            <th class="text-center no-sort" width='10%'>GUDANG DARI</th>
            <th class="text-center no-sort" width='10%'>GUDANG KE</th>
            ...
            <th class="text-center no-sort" width='12%'>KETERANGAN</th>
