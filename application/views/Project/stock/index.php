...
<div class="box box-primary">
	<div class="box-header">
		...
		<div class='form-group row'>
			<div class='col-sm-7'>
		        <button type='button' class='btn btn-sm btn-primary' id='download_excel'><i class='fa fa-file-excel-o'></i> Download Excel</button>
            </div>
			<div class='col-sm-3' hidden>
                <select id='id_gudang' name='id_gudang' class='form-control input-sm'>
					<?php
			...
			<div class='col-sm-3'>
				<select id='id_category' name='id_category' class='form-control input-sm'>
					<option value='0'>All Category</option>
					<?php
						foreach($data_category AS $val => $valx){
...
<script>
	$('input[type="text"][data-role="datepicker2"]').datepicker({
		...
		closeText: 'Clear',
			...
			if ($(window.event.srcElement).hasClass('ui-datepicker-close'))
			{
				...
				DataTables(id_category, id_gudang, date_filter);
			}
		}
	});
	...
	$(document).on('click', '#download_excel', function(e){
        ...
        var id_gudang = $('#id_gudang').val();
		var date_filter = $('#date_filter').val();
		var Links		= base_url + active_controller+'/ExcelGudangStok/'+id_category+'/'+id_gudang+'/'+date_filter;
	...
	$(document).ready(function(){
        ...
        $(document).on('change','#id_category, #date_filter', function(e){
			e.preventDefault();
			var id_category = $('#id_category').val();
            var id_gudang = $('#id_gudang').val();
            var date_filter = $('#date_filter').val();
	...
	function DataTables(id_category=null, id_gudang=null, date_filter=null){
		let stock	= 0;
		let rusak	= 0;
		var dataTable = $('#my-grid').DataTable({
			...
			drawCallback: function( settings ) {
				...
				$( api.column( 9 ).footer() ).html("<div align='right'>"+ number_format(booking) +"</div>");
				$( api.column( 10 ).footer() ).html("<div align='right'>"+ number_format(rusak) +"</div>");
			}
		});
	}
