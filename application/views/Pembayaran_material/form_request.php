			...
			<div class="box-body">
				<div class="row">
				  <div class="col-md-6">
					...
					<p><?=$datapoh->mata_uang?><input type="hidden" name="curs_header" id="curs_header" value="<?=$datapoh->mata_uang?>" />
					<input type="hidden" name="kurs" id="kurs" value="<?=$data->kurs_receive_invoice?>" />
					</p>
