...
?>
<?=form_open('pembayaran_material/form_payment_new_nonmaterial',array('id'=>'frm_data','name'=>'frm_data'));?>
<div class="box">
	...
	<ul class="nav nav-tabs" role="tablist">
		<li role="presentation" class="active"><a href="#material" aria-controls="material" role="tab" data-toggle="tab">Non Material</a></li>
	</ul>
