            ...
            <table class="table table-bordered" width="100%" id="tabel-detail-mutasi">
				<thead>
					<tr class="bg-blue">
						...
						<th class="text-center">Sisa Retensi</th>
	...
	function startmutasi(id,surat,ipp,nm,avl,real,ret,kurs){
	   ...
	   if(Cek_OK==1){
			...
			html='<tr id="tr_'+Urut+'">'
				...
				+ '<td style="padding:3px;"><select class="form-control input-sm tipe_bayar" name="tipe_bayar[]" id="tipe_bayar'+Urut+'"><option value="">Pilih Tipe</option><option value="PROGRESS">PROGRESS</option><option value="RETENSI">RETENSI TANPA PPN</option><option value="RETENSI PPN">RETENSI DENGAN PPN</option></select></td>'
