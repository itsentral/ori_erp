...
<section class="content-header">
	<div class="box box-primary">
					<?php
						//$proses=0;					
						if($proses == 1){				
							echo "<div class='alert alert-success' role='alert'>Proses Periode End Sukses</div>";					
						}
					?>	
		<div class="myDiv">
			<form method="post" action="<?= base_url() ?>index.php/penerimaan/update_kartu_hutang" autocomplete="off">
				<div class="row">
					<div class="col-sm-10">
						<div class="col-sm-2">
