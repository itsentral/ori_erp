...
<div class="box box-primary">
	<div class="box-header">
		...
		<input type='hidden' id='gudang1' value='<?='fg';?>'>
...
<script>
	...
	$(document).ready(function(){
	    ...
	    $(document).on('click', '.look_history', function(e){
            ...
            $("#view2").load(base_url + active_controller + '/modal_history/'+$(this).data('no_so')+'/'+$(this).data('no_spk').replace(",", "_")+'/'+$(this).data('product').replace(/\s+/g, "_")+'/'+$(this).data('kode_trans').replace(" ", "_")+'/fg');
            $("#ModalView2").modal();
        });
