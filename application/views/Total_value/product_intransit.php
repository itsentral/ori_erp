	...
	$(document).ready(function(){
		...
		$(document).on('click','#search', function(e){
 		...
 		$(document).on('click', '.look_history', function(e){
            ...
            $("#view2").load(base_url + active_controller + '/modal_history/'+$(this).data('no_so')+'/'+$(this).data('no_spk').replace(",", "_")+'/'+$(this).data('product').replace(" ", "_")+'/'+$(this).data('kode_trans').replace(" ", "_")+'/intransit');
            $("#ModalView2").modal();
        });
