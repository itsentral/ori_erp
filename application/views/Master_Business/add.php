	...
	<div class="box box-primary">
		...
		<div class="box-body">
			<div class='form-group row'>			
				...
				<div class='col-sm-4'>           
					<?php
						echo form_input(array('id'=>'bidang_usaha','name'=>'bidang_usaha','class'=>'form-control input-md','autocomplete'=>'off','placeholder'=>'Business Fields','style'=>'text-transform:uppercase'));											
					?>		
				</div>
				<label class='label-control col-sm-2'><b>Description <span class='text-red'>*</span></b></label>
				<div class='col-sm-4'>            
					<?php
						echo form_textarea(array('id'=>'keterangan','name'=>'keterangan','class'=>'form-control input-md','cols'=>'75','rows'=>'3','autocomplete'=>'off','placeholder'=>'Description','style'=>'text-transform:uppercase'));
					?>		
				</div>
			</div>
