<?php
	...
	// echo $id_product;
	$qHeader		= "SELECT * FROM so_component_header WHERE id_product='".$id_product."'";
	...
	$qDetailAdd1	= "SELECT a.*, b.price_ref_estimation FROM so_component_detail_add a LEFT JOIN raw_materials b ON a.id_material = b.id_material WHERE a.id_product='".$id_product."' AND a.id_milik='".$id_milik."' AND a.detail_name='LINER THIKNESS / CB'";
	$qDetailAdd2	= "SELECT a.*, b.price_ref_estimation FROM so_component_detail_add a LEFT JOIN raw_materials b ON a.id_material = b.id_material WHERE a.id_product='".$id_product."' AND a.id_milik='".$id_milik."' AND a.detail_name='STRUKTUR THICKNESS'";
	$qDetailAdd3	= "SELECT a.*, b.price_ref_estimation FROM so_component_detail_add a LEFT JOIN raw_materials b ON a.id_material = b.id_material WHERE a.id_product='".$id_product."' AND a.id_milik='".$id_milik."' AND a.detail_name='EXTERNAL LAYER THICKNESS'";
	$qDetailAdd4	= "SELECT a.*, b.price_ref_estimation FROM so_component_detail_add a LEFT JOIN raw_materials b ON a.id_material = b.id_material WHERE a.id_product='".$id_product."' AND a.id_milik='".$id_milik."' AND a.detail_name='TOPCOAT'";
	// echo $qDetail2;
	...
	$qDetailAdd2N1	= "SELECT a.*, b.price_ref_estimation FROM so_component_detail_add a LEFT JOIN raw_materials b ON a.id_material = b.id_material WHERE a.id_product='".$id_product."' AND a.id_milik='".$id_milik."' AND a.detail_name='STRUKTUR NECK 1'";
	$qDetailAdd2N2	= "SELECT a.*, b.price_ref_estimation FROM so_component_detail_add a LEFT JOIN raw_materials b ON a.id_material = b.id_material WHERE a.id_product='".$id_product."' AND a.id_milik='".$id_milik."' AND a.detail_name='STRUKTUR NECK 2'";
	$detailResin2N1	= "SELECT a.*, b.price_ref_estimation FROM so_component_detail a LEFT JOIN raw_materials b ON a.id_material = b.id_material WHERE a.id_product='".$id_product."' AND a.id_milik='".$id_milik."' AND a.detail_name='STRUKTUR NECK 1' AND a.id_category ='TYP-0001' ORDER BY a.id_detail DESC LIMIT 1 ";
	$detailResin2N2	= "SELECT a.*, b.price_ref_estimation FROM so_component_detail a LEFT JOIN raw_materials b ON a.id_material = b.id_material WHERE a.id_product='".$id_product."' AND a.id_milik='".$id_milik."' AND a.detail_name='STRUKTUR NECK 2' AND a.id_category ='TYP-0001' ORDER BY a.id_detail DESC LIMIT 1 ";
	...
	{
		$qDetail1		= "SELECT a.*, b.price_ref_estimation FROM so_component_detail a LEFT JOIN raw_materials b ON a.id_material = b.id_material WHERE a.id_product='".$id_product."' AND a.id_milik='".$id_milik."' AND a.detail_name='GLASS'";
	...
	elseif($restHeader[0]['parent_product'] == 'concentric reducer' OR $restHeader[0]['parent_product'] == 'reducer tee mould' OR $restHeader[0]['parent_product'] == 'eccentric reducer' OR $restHeader[0]['parent_product'] == 'reducer tee slongsong'){
		$dim = floatval($restHeader[0]['diameter'])." x ".floatval($restHeader[0]['diameter2'])." x ".floatval($restHeader[0]['design']);
	}
	elseif($restHeader[0]['parent_product'] == 'colar' OR $restHeader[0]['parent_product'] == 'colar slongsong' OR $restHeader[0]['parent_product'] == 'end cap' OR $restHeader[0]['parent_product'] == 'flange slongsong' OR $restHeader[0]['parent_product'] == 'flange mould' OR $restHeader[0]['parent_product'] == 'equal tee mould' OR $restHeader[0]['parent_product'] == 'blind flange' OR $restHeader[0]['parent_product'] == 'equal tee slongsong'){
		$dim = floatval($restHeader[0]['diameter'])." x ".floatval($restHeader[0]['design']);
	}
	elseif($restHeader[0]['parent_product'] == 'field joint' OR $restHeader[0]['parent_product'] == 'shop joint' ){
		$dim = floatval($restHeader[0]['diameter'])." x ".floatval($restHeader[0]['panjang']);
	}
	elseif($restHeader[0]['parent_product'] == 'branch joint'){
		$dim = floatval($restHeader[0]['diameter'])." x ".floatval($restHeader[0]['diameter2'])." x ".floatval($restHeader[0]['panjang']);
	}
			...
			<table id="my-grid" class="table table-striped table-bordered table-hover table-condensed" width="100%">
				<tbody>
					...
					<tr>
						...
						<td class="text-left" colspan='5'><?= $dim;?></td>
					</tr>
					<tr>
