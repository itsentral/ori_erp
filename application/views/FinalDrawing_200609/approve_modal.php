...
$checkSO 	= "	SELECT * FROM production WHERE no_ipp = '".$ipp."' AND `status`='WAITING APPROVE FINAL DRAWING' ";
...
<div class="box-body">
	...
	<?php
		echo form_button(array('type'=>'button','class'=>'btn btn-md btn-success','style'=>'min-width:100px; float:right; margin: 0px 5px 5px 0px;','value'=>'Process','content'=>'Process','id'=>'approvedFD')).' ';

		// echo form_button(array('type'=>'button','class'=>'btn btn-md btn-danger','style'=>'min-width:100px; float:right; margin: 0px 10px 5px 0px;','value'=>'Please Dont Try','content'=>'Please Dont Try','id'=>'approvedFDNew')).' ';
	?>
