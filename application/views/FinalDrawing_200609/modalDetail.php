<?php
	...
	{
		$qDetail1		= "SELECT * FROM so_component_detail WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."' AND detail_name='GLASS' AND id_material <> 'MTL-1903000' AND id_category <> 'TYP-0001'";
		$qDetail2		= "SELECT * FROM so_component_detail WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."' AND detail_name='RESIN AND ADD' AND id_material <> 'MTL-1903000' AND id_category <> 'TYP-0001'";
