...
<div class="box box-primary">
	...
	<div class="box-body">
		<table class="table table-bordered table-striped" id="my-grid" width='100%'>
			<thead>
				<tr class='bg-blue'>
					<th align="text-center no-sort">No</th>
					<th align="text-center" width='80px'>BQ</th>
					<th align="text-center">Customer</th>
					<th align="text-center">Project</th>
					<th align="text-center">Series</th>
					<th align="text-center">Rev</th>
					<th align="text-center">SO</th>
					<th align="text-center">FD</th>
					<th align="text-center">Status</th>
					<th align="text-center" width='150px'>Option</th>
				</tr>
			</thead>
			<tbody></tbody>
		</table>
...
<script>
	...
	function DataTables(){
		var dataTable = $('#my-grid').DataTable({
			...
			"ajax":{
				url : base_url +'index.php/'+active_controller+'/getDataJSONAppFD',
				type: "post",
				data: function(d){
