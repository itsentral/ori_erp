	...
	<div class="box box-primary">
		...
		<div class="box-body" style="">
			<table id="my-grid" class="table table-striped table-bordered table-hover table-condensed" width="100%">
				...
				<tbody>
					...
					foreach($getDetail AS $val => $valx){
						...
						$est_harga		= ($TotalPrice + $direct_labour + $indirect_labour + $machine + $mould_mandrill + $consumable + $foh_consumable + $foh_depresiasi + $biaya_gaji_non_produksi + $biaya_non_produksi + $biaya_rutin_bulanan) / $qty;

						$getProfit = $this->db->query("SELECT profit FROM cost_profit WHERE diameter='".str_replace('.','',$diameter_1)."' AND diameter2='".str_replace('.','',$diameter_2)."' AND product_parent='".$id_category."' ")->result_array();
						$profit = (!empty($getProfit[0]['profit']))?floatval($getProfit[0]['profit']):0;
						$helpProfit = 0;
						if($profit <> 0){
							$helpProfit = $est_harga *($profit/100);
						}
						$HrgTot   = (($est_harga) + ($helpProfit)) * $qty;
						$SumTot2x += $HrgTot;
					}
					$SUM = 0;
					$no = 0;
					...
					foreach($getDetail AS $val => $valx){
						...
						echo "<tr>";
							...
							echo "<td align='right'>".$diameter_1."</td>";
							echo "<td align='right'>".$diameter_2."</td>";
							...
							echo "<td align='center'>".$qty; 
								echo "<input type='text' id='qty_$no' style='text-align: right;' name='MatCost[$no][qty]' class='form-control input-sm THide' value='".$qty."'>";
								echo "<input type='text' id='id_milik_$no' style='text-align: right;' name='MatCost[$no][id_milik]' class='form-control input-sm THide' value='".$id_milik."'>";
				...
				<tbody>
					<tr>
						<td class="text-left headX" colspan='13'><b>BILL OF QUANTITY NON FRP</b></td>
					</tr>
					<tr class='bg-bluexyz'>
						...
						<th class="text-center" colspan='2'>Unit Price (IDR)</th>
				...
				<tbody>
					...
					if(!empty($non_frp)){
						foreach($non_frp AS $val => $valx){
							...
							echo "<tr>";
								...
								echo "</td>";
								echo "<td align='right'  colspan='2'>".number_format($valx['unit_price']);
								...
								echo "</td>";
								echo "<td align='center'>";
									echo "<input type='text' id='nonfrp_persen_".$no1."' name='nonfrp[$no1][persen]' class='form-control input-sm text-center maskM ch_nonfrp' placeholder='0'>";
								echo "</td>";
								echo "<td align='right'><div id='nonfrp_price_html_".$no1."'>".number_format($valx['total_price'])."</div>";
									echo "<input type='text' id='nonfrp_price_".$no1."' name='nonfrp[$no1][price]' class='form-control input-sm THide' value='".$valx['total_price']."'>";
								echo "</td>";
								echo "<td align='center'>";
									echo "<input type='text' id='nonfrp_extra_".$no1."' name='nonfrp[$no1][extra]' class='form-control input-sm text-center maskM ch_nonfrp' placeholder='0'>";
								echo "</td>";
								echo "<td align='right'><div id='nonfrp_total_html_".$no1."'>".number_format($valx['total_price'])."</div>";
									echo "<input type='text' id='nonfrp_total_".$no1."' name='nonfrp[$no1][price_total]' class='form-control input-sm sum_nonfrp THide' value='".$valx['total_price']."'>";
					...
					?>
					<tr class='FootColor'>
						<th colspan='12'>TOTAL BILL OF QUANTITY NON FRP</th>
					...
					if(!empty($baut)){
						foreach($baut AS $val => $valx){
							...
							echo "<tr>";
								...
								echo "</td>";
								echo "<td align='center'>";
									echo "<input type='text' id='baut_persen_".$no1."' name='baut[$no1][persen]' class='form-control input-sm text-center maskM ch_baut' placeholder='0'>";
								echo "</td>";
								echo "<td align='right'><div id='baut_price_html_".$no1."'>".number_format($valx['total_price'],2)."</div>";
									echo "<input type='text' id='baut_price_".$no1."' name='baut[$no1][price]' class='form-control input-sm THide' value='".$valx['total_price']."'>";
								echo "</td>";
								echo "<td align='center'>";
									echo "<input type='text' id='baut_extra_".$no1."' name='baut[$no1][extra]' class='form-control input-sm text-center maskM ch_baut' placeholder='0'>";
								echo "</td>";
								echo "<td align='right'><div id='baut_total_html_".$no1."'>".number_format($valx['total_price'],2)."</div>";
									echo "<input type='text' id='baut_total_".$no1."' name='baut[$no1][price_total]' class='form-control input-sm sum_baut THide' value='".$valx['total_price']."'>";
					...
					if(!empty($plate)){
						foreach($plate AS $val => $valx){
							...
							echo "<tr>";
								...
								echo "</td>";
								echo "<td align='right'>".number_format($valx['berat'],2);
									echo "<input type='text' name='plate[$no1][qty]' class='form-control input-sm THide' value='".$valx['berat']."'>";
								echo "</td>";
								echo "<td align='center'>".strtoupper(get_name('raw_pieces', 'kode_satuan', 'id_satuan', $valx['satuan']));
								...
								echo "</td>";
								echo "<td align='center'>";
									echo "<input type='text' id='plate_persen_".$no1."' name='plate[$no1][persen]' class='form-control input-sm text-center maskM ch_plate' placeholder='0'>";
								echo "</td>";
								echo "<td align='right'><div id='plate_price_html_".$no1."'>".number_format($valx['total_price'],2)."</div>";
									echo "<input type='text' id='plate_price_".$no1."' name='plate[$no1][price]' class='form-control input-sm THide' value='".$valx['total_price']."'>";
								echo "</td>";
								echo "<td align='center'>";
									echo "<input type='text' id='plate_extra_".$no1."' name='plate[$no1][extra]' class='form-control input-sm text-center maskM ch_plate' placeholder='0'>";
								echo "</td>";
								echo "<td align='right'><div id='plate_total_html_".$no1."'>".number_format($valx['total_price'],2)."</div>";
									echo "<input type='text' id='plate_total_".$no1."' name='plate[$no1][price_total]' class='form-control input-sm sum_plate THide' value='".$valx['total_price']."'>";
					...
					if(!empty($gasket)){
						foreach($gasket AS $val => $valx){
							...
							echo "<tr>";
								...
								echo "</td>";
								echo "<td align='center'>";
									echo "<input type='text' id='gasket_persen_".$no1."' name='gasket[$no1][persen]' class='form-control input-sm text-center maskM ch_gasket' placeholder='0'>";
								echo "</td>";
								echo "<td align='right'><div id='gasket_price_html_".$no1."'>".number_format($valx['total_price'],2)."</div>";
									echo "<input type='text' id='gasket_price_".$no1."' name='gasket[$no1][price]' class='form-control input-sm THide' value='".$valx['total_price']."'>";
								echo "</td>";
								echo "<td align='center'>";
									echo "<input type='text' id='gasket_extra_".$no1."' name='gasket[$no1][extra]' class='form-control input-sm text-center maskM ch_gasket' placeholder='0'>";
								echo "</td>";
								echo "<td align='right'><div id='gasket_total_html_".$no1."'>".number_format($valx['total_price'],2)."</div>";
									echo "<input type='text' id='gasket_total_".$no1."' name='gasket[$no1][price_total]' class='form-control input-sm sum_gasket THide' value='".$valx['total_price']."'>";
				...
				<tbody>
					...
					if(!empty($lainnya)){
						foreach($lainnya AS $val => $valx){
							...
							echo "<tr>";
								echo "<td align='center'>".$no1."</td>";
								echo "<td colspan='4'>".strtoupper($get_detail[0]->nama.', '.$get_detail[0]->material.' - '.$get_detail[0]->dimensi.' - '.$get_detail[0]->spesifikasi);
								...
								echo "</td>";
								echo "<td align='center'>";
									echo "<input type='text' id='lainnya_persen_".$no1."' name='lainnya[$no1][persen]' class='form-control input-sm text-center maskM ch_lainnya' placeholder='0'>";
								echo "</td>";
								echo "<td align='right'><div id='lainnya_price_html_".$no1."'>".number_format($valx['total_price'],2)."</div>";
									echo "<input type='text' id='lainnya_price_".$no1."' name='lainnya[$no1][price]' class='form-control input-sm THide' value='".$valx['total_price']."'>";
								echo "</td>";
								echo "<td align='center'>";
									echo "<input type='text' id='lainnya_extra_".$no1."' name='lainnya[$no1][extra]' class='form-control input-sm text-center maskM ch_lainnya' placeholder='0'>";
								echo "</td>";
								echo "<td align='right'><div id='lainnya_total_html_".$no1."'>".number_format($valx['total_price'],2)."</div>";
									echo "<input type='text' id='lainnya_total_".$no1."' name='lainnya[$no1][price_total]' class='form-control input-sm sum_lainnya THide' value='".$valx['total_price']."'>";
					...
					if(!empty($material)){
						foreach($material AS $val => $valx){
							...
							echo "<tr>";
								...
								echo "</td>";
								echo "<td align='center'>";
									echo "<input type='text' id='material_persen_".$no1."' name='material[$no1][persen]' class='form-control input-sm text-center maskM ch_material_add' placeholder='0'>";
								echo "</td>";
								echo "<td align='right'><div id='material_price_html_".$no1."'>".number_format($valx['total_price'],2)."</div>";
									echo "<input type='text' id='material_price_".$no1."' name='material[$no1][price]' class='form-control input-sm THide' value='".$valx['total_price']."'>";
								echo "</td>";
								echo "<td align='center'>";
									echo "<input type='text' id='material_extra_".$no1."' name='material[$no1][extra]' class='form-control input-sm text-center maskM ch_material_add' placeholder='0'>";
								echo "</td>";
								echo "<td align='right'><div id='material_total_html_".$no1."'>".number_format($valx['total_price'],2)."</div>";
									echo "<input type='text' id='material_total_".$no1."' name='material[$no1][price_total]' class='form-control input-sm sum_material THide' value='".$valx['total_price']."'>";
				...
				<tbody>
					...
					foreach($getEngCost AS $val => $valx){
						...
						echo "<tr>";
							echo "<td align='center'>".$no1."</td>";
							echo "<td colspan='6'>".strtoupper($valx['item_cost'])."";
								echo "<input type='text' name='EngCost[$no1][category]' class='form-control input-sm THide' value='engine'>";
								echo "<input type='text' name='EngCost[$no1][caregory_sub]' class='form-control input-sm THide' value='".strtoupper($valx['item_cost'])."'>";
							echo "</td>";
							echo "<td align='center'>";
								echo form_button(array('type'=>'button','class'=>'btn btn-sm btn-success','id'=>'set_'.$no1.'','value'=>'SET','content'=>'SET','data-idbq'=>'BQ-'.$getHeader[0]->no_ipp.''));
							echo "</td>";
							echo "<td align='left'>";
								if($no1 != '5'){
							...
							echo "</td>";
							echo "<td align='right'>";
								echo "<input type='text' style='text-align:right;' id='EngCostPrice_$no1' data-nomor='$no1' name='EngCost[$no1][price]' class='form-control input-sm numberOnlyT EngCostPrice' value='".floatval($valx['value1']+$valx['value2']+$valx['value3'])."'>";
							echo "</td>";
							echo "<td align='right'>";
					...
					foreach($getTruck AS $val => $valx){
						...
						echo "<tr>";
							...
							echo "<td align='right'>";
								...
								echo "<input type='text' style='text-align:right;' id='ExportPricex_$no3' name='ExportCost[$no3][price]' data-nomor='$no3' class='form-control input-sm priceEx' value='".floatval($valx['price'])."'>";
							echo "</td>";
				...
				<tbody>
					...
					foreach($getVia AS $val => $valx){ 
						$no4++;
						$readOnly = '';
						if(strtolower($valx['name']) == 'via darat' OR strtolower($valx['name']) == 'via laut'){
							$readOnly = 'readonly';
						}
						echo "<tr>";
							echo "<td align='center'>".$no4."</td>";
							echo "<td align='left'>".strtoupper($valx['name']);
							...
							echo "<td align='left' colspan='2'>";
								if(strtolower($valx['name']) == 'via darat' OR strtolower($valx['name']) == 'via laut'){
									echo "<select name='LokalCost[$no4][area]' id='AreaTruck_$no4' class='form-control input-sm AreaTruck' data-nomor='$no4'>";
										...
										if(strtolower($valx['name']) == 'via laut'){
									...
									echo "<input type='text' id='AreaTruck_$no4' style='text-align:left;' name='LokalCost[$no4][area]' class='form-control input-sm' data-nomor='$no4'>";
								}
							echo "</td>";
							echo "<td align='left' colspan='3'>";
								if(strtolower($valx['name']) == 'via darat' OR strtolower($valx['name']) == 'via laut'){
									...
									echo "<input type='text' id='TujuanTruck_$no4' style='text-align:left;' name='LokalCost[$no4][tujuan]' class='form-control input-sm' data-nomor='$no4'>";
								}
							echo "</td>";
							echo "<td align='left' colspan='3'>";
								if(strtolower($valx['name']) == 'via darat' OR strtolower($valx['name']) == 'via laut'){
									...
									echo "<input type='text' id='TruckTruck_$no4' style='text-align:left;' name='LokalCost[$no4][kendaraan]' class='form-control input-sm' data-nomor='$no4'>";
								}
							echo "</td>";
							echo "<td align='right'><input type='text' style='text-align:right;' id='TrPrice_$no4' name='LokalCost[$no4][price]' class='form-control input-sm numberOnlyT PriceTruck'  value='0' data-nomor='$no4' ".$readOnly."></td>";
				...
				<tbody>
					...
					<tr class='FootColor'>
						...
						<th class="text-right"><input type='input' style='text-align:right;' class='form-control input-sm' name='total_other' id='total_other' readonly></th>
					</tr>
				</tbody>
				<tfoot>
			...
			<div class='box-footer' style='float:right;'>
				<?php
				echo form_button(array('type'=>'button','class'=>'btn btn-md btn-primary','id'=>'saved_data','value'=>'simpan','content'=>'Save'));
				?>
...
<script>
	$(document).ready(function(){ 
		...
		$(document).on('click', '#set_1', function(e){
			e.preventDefault();
			loading_spinner();
			$("#head_title").html("<b>SETTING COST AXIAL TENSILE STRENGTH TESTS</b>");
			$("#view").load(base_url + active_controller+'/set_a/'+$(this).data('idbq')+'/1');
			$("#ModalView").modal();
		});
		
		$(document).on('click', '#set_2', function(e){
			e.preventDefault();
			loading_spinner();
			$("#head_title2").html("<b>SETTING FLEXURAL PROPERTIES</b>");
			$("#view2").load(base_url + active_controller+'/set_b/'+$(this).data('idbq')+'/2');
			$("#ModalView2").modal();
		});
		
		$(document).on('click', '#set_3', function(e){
			e.preventDefault();
			loading_spinner();
			$("#head_title2").html("<b>SETTING WELD JOINT TEST, HOOP TENSILE STRENGTH TESTS, FITT</b>");
			$("#view2").load(base_url + active_controller+'/set_c/'+$(this).data('idbq')+'/3');
			$("#ModalView2").modal();
		});
		
		$(document).on('click', '#set_4', function(e){
			e.preventDefault();
			loading_spinner();
			$("#head_title2").html("<b>SETTING PROOF TEST</b>");
			$("#view2").load(base_url + active_controller+'/set_d/'+$(this).data('idbq')+'/4');
			$("#ModalView2").modal();
		});
		
		$(document).on('click', '#set_5', function(e){
			e.preventDefault();
			loading_spinner();
			$("#head_title2").html("<b>SETTING BEAM STRENGT TEST</b>");
			$("#view2").load(base_url + active_controller+'/set_e/'+$(this).data('idbq')+'/5');
			$("#ModalView2").modal();
		});
		
		$(document).on('click', '#set_6', function(e){
			e.preventDefault();
			loading_spinner();
			$("#head_title").html("<b>SETTING MANUFACTURING DATA REPORT</b>");
			$("#view").load(base_url + active_controller+'/set_f/'+$(this).data('idbq')+'/6');
			$("#ModalView").modal();
		});
		
		$(document).on('click', '#set_7', function(e){
			e.preventDefault();
			loading_spinner();
			$("#head_title").html("<b>SETTING STRESS ANALISYS</b>");
			$("#view").load(base_url + active_controller+'/set_g/'+$(this).data('idbq')+'/7');
			$("#ModalView").modal();
		});
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl=base_url + active_controller +'/save_penawaran2';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
	...
	function SumAll(){
		...
		$('#total_nonfrp_html').html(number_format(SUM_NONFRP,2));
		...
		$('#sum_tot_html').html(number_format(SUM_PRICE,2));
		...
		var data1 = getNum($('#total_material').val().split(",").join(""));
		var data2 = getNum($('#total_eng').val().split(",").join(""));
		var data3 = getNum($('#total_packing').val().split(",").join(""));
		var data4 = getNum($('#total_export').val().split(",").join(""));
		var data5 = getNum($('#total_lokal').val().split(",").join(""));
		var data6 = getNum($('#total_other').val().split(",").join(""));
		...
		// console.log(total_material);
		// console.log(sell_price_kg);
