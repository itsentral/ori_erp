			...
			<table id="my-grid" class="table table-striped table-bordered table-hover table-condensed" width="100%">
				...
				<tbody>
					...
					foreach($getDetail AS $val => $valx){
						...
						elseif($valx['id_category'] == 'branch joint' OR $valx['id_category'] == 'concentric reducer' OR $valx['id_category'] == 'reducer tee mould' OR $valx['id_category'] == 'eccentric reducer' OR $valx['id_category'] == 'reducer tee slongsong'){
						...
						echo "<tr>";
							...
							echo "<td align='center'>";
								echo "<input type='text' id='persen_$no' style='text-align: center;' name='MatCost[$no][persen]' maxlength='5' class='form-control input-sm numberOnlyT persenMat' value='".floatval($profit)."' autocomplete='off' data-nomor='$no'>";
							echo "</td>";
...
<script>
	$(document).ready(function(){ 
		...
		$(document).on('click', '#set_1', function(e){
			...
			$("#view").load(base_url +'index.php/'+ active_controller+'/set_a/'+$(this).data('idbq')+'/1');
			$("#ModalView").modal();
		});
		...
		$(document).on('click', '#set_2', function(e){
			...
			$("#view2").load(base_url +'index.php/'+ active_controller+'/set_b/'+$(this).data('idbq')+'/2');
			$("#ModalView2").modal();
		});
		...
		$(document).on('click', '#set_3', function(e){
			...
			$("#view2").load(base_url +'index.php/'+ active_controller+'/set_c/'+$(this).data('idbq')+'/3');
			$("#ModalView2").modal();
		});
		...
		$(document).on('click', '#set_4', function(e){
			...
			$("#view2").load(base_url +'index.php/'+ active_controller+'/set_d/'+$(this).data('idbq')+'/4');
			$("#ModalView2").modal();
		});
		...
		$(document).on('click', '#set_5', function(e){
			...
			$("#view2").load(base_url +'index.php/'+ active_controller+'/set_e/'+$(this).data('idbq')+'/5');
			$("#ModalView2").modal();
		});
		...
		$(document).on('click', '#set_6', function(e){
			...
			$("#view").load(base_url +'index.php/'+ active_controller+'/set_f/'+$(this).data('idbq')+'/6');
			$("#ModalView").modal();
		});
		...
		$(document).on('click', '#set_7', function(e){
			...
			$("#view").load(base_url +'index.php/'+ active_controller+'/set_g/'+$(this).data('idbq')+'/7');
			$("#ModalView").modal();
		});
