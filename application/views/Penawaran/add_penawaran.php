	...
	<div class="box box-primary">
		...
		<div class="box-body" style="">
			<table id="my-grid" class="table table-striped table-bordered table-hover table-condensed" width="100%">
				...
				<tbody>
					...
					foreach($getDetail AS $val => $valx){
						...
						echo "<tr>";
							...
							echo "</td>";
							echo "<td align='center'>";
								echo "<input type='text' id='extra_$no' style='text-align: center;' name='MatCost[$no][extra]' class='form-control input-sm maskM ch_material' value='".number_format($allow,3)."' data-nomor='$no'>";
							echo "</td>";
					...
					<tr class='FootColor'>
						...
						<th class="text-center"><div id='net_profit'><?= number_format(($SumTot2 - $HPP_Tot)/$SumTot2,2) * 100;?></div></th>
				...
				<tbody>
					<tr>
						<td class="text-left headX" colspan='12'><b>MATERIAL</b></td>
					</tr>
					<tr class='bg-bluexyz'>
						<th class="text-center">No</th>
						<th class="text-center" colspan='3'>Material Name</th>
				...
				<tbody>
					...
					if(!empty($material)){
						foreach($material AS $val => $valx){
							...
							echo "<tr>";
								echo "<td align='center'>".$no1."</td>";
								echo "<td colspan='3'>".strtoupper(get_name('raw_materials', 'nm_material', 'id_material', $valx['id_material']));
					...
					?>
					<tr class='FootColor'>
						<th colspan='11'>TOTAL MATERIAL</th>
				...
				<tbody>
					<tr>
						<td class="text-left headX" colspan='12'><b>ENGINEERING COST</b></td>
					</tr>
					<tr class='bg-bluexyz'>
						<th class="text-center">No</th>
				...
				<tbody>
					...
					foreach($getEngCost AS $val => $valx){
						...
						echo "<tr>";
							echo "<td align='center'>".$no1."</td>";
							echo "<td colspan='5'>".strtoupper($valx['item_cost'])."";
				...
				<tbody>
					<tr>
						<td class="text-left headX" colspan='12'><b>PACKING COST</b></td>
					</tr>
					<tr class='bg-bluexyz'>
						<th class="text-center">No</th>
				...
				<tbody>
					<tr>
						<td class="text-left headX" colspan='12'><b>TRUCKING EXPORT</b></td>
					</tr>
					<tr class='bg-bluexyz'>
						<th class="text-center">No</th>
				...
				<tbody>
					<tr>
						<td class="text-left headX" colspan='12'><b>TRUCKING LOKAL</b></td>
					</tr>
					<tr class='bg-bluexyz'>
				...
				<tbody>
					...
					foreach($getVia AS $val => $valx){ 
						...
						echo "<tr>";
							echo "<td align='center'>".strtoupper($valx['name']);
...
<script>
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl=base_url + active_controller +'/save_penawaran';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
	...
	function SumAll(){
		...
		var Total = data1 + data2 + data3 + data4 + data5 + SUM_MAT;
