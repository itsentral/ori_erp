...
<script>
	...
	$(document).on('click', '.detail_spk', function(e){
		...
		$.ajax({
			type:'POST',
			url: base_url + active_controller+'/modal_detail_progress_tanki/'+$(this).data('id_produksi'),
	...
	function DataTables(tgl_awal=null,tgl_akhir=null){
		var dataTable = $('#my-grid').DataTable({
			...
			"ajax":{
				url : base_url + active_controller+'/server_side_spk_produksi_progress_tanki',
				type: "post",
				data: function(d){
					d.tgl_awal = tgl_awal,
