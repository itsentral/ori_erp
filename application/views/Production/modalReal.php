...
?>
	...
	<div class="box">
		<div class="box-body" style="">
			<table id="my-grid" class="table table-striped table-bordered table-hover table-condensed" width="100%">
				<tbody>
					<tr>
						<td class="text-left"width='13%'><u>Customer Name</u></td>
						<td class="text-left" colspan='5'><b><?= $restProduksi[0]['nm_customer']; ?></b></td>
					</tr>
					<!--
					<tr>
				...
				echo "<tbody id='restDetail2'>";
					...
					foreach($restDetail2 AS $val => $valx){
						...
						<tr id='tr_<?= $no5;?>'>
							...
							<td class="text-right"><input type='text' name='DetailUtama2[<?=$no5;?>][layer]' id='layer_<?= $no5;?>' class='form-control input-sm numberOnly' autocomplete='off'></td>
	...
	<div class="box box-danger">
		...
		<div class='box-footer'>
			<button type='button' id='updateRealMat' class='btn btn-md btn-primary'>Update</button>
			<?php
