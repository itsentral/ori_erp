			...
			<thead>
				<tr class='bg-blue'>
					...
					for($a=0; $a<=3; $a++){
						...
						echo "<th class='text-center no-sort'>".$month."</th>";
					}
					?>
				</tr>
			</thead>
...
<script>
	...
	function DataTables(gudang=null){
		var dataTable = $('#my-grid').DataTable({
			...
			"iDisplayLength": 10,
			"aLengthMenu": [[10, 20, 50, 100, 150, 1000], [10, 20, 50, 100, 150, 1000]],
			"ajax":{
				url : base_url + active_controller+'/server_side_summary',
				type: "post",
				data: function(d){
					d.gudang = $('#gudang').val()
				},
