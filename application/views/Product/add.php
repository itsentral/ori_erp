	...
	<div class="box box-primary">
		...
		<div class="box-body">
			<div class='form-group row'>
				...
				<div class='col-sm-4'>
					<?php
						echo form_input(array('id'=>'nm_product','name'=>'nm_product','class'=>'form-control input-md','autocomplete'=>'off','placeholder'=>'Product Name'));
					?>				
				</div>
				...
				<div class='col-sm-4'>
					<select name='parent_product' id='parent_product' class='form-control input-md'>
						<option value=''>Select An Type Product</option>
						<?php
							foreach($type AS $val => $valx){
								echo "<option value='".$valx['product_parent']."'>".ucwords(strtolower($valx['product_parent']))."</option>";
							}
						?>
					</select>
				</div>
			...
			<div class='form-group row'>
				...
				<div class='col-sm-2'>
					<?php
					 echo form_input(array('id'=>'value_d','name'=>'value_d','class'=>'form-control input-md numberOnly','placeholder'=>'Diameter 1'));
					?>
				</div>
				<div class='col-sm-2'>
					<?php
					 echo form_input(array('id'=>'value_d2','name'=>'value_d2','class'=>'form-control input-md numberOnly','placeholder'=>'Diameter 2'));
					?>
				</div>
				...
				<div class='col-sm-4'>
					 <?php
						...
						echo form_textarea(array('id'=>'ket','name'=>'ket','class'=>'form-control input-md','rows'=>'3','cols'=>'75','placeholder'=>'Product Information'));
					?>
				</div>
			</div>
		</div>
