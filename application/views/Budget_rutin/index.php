...
<div class="box box-primary">
	<div class="box-header">
		...
		<div class="box-tool pull-right">
			...
			<!-- <a href="<?php echo site_url('budget/kompilasi') ?>" class="btn btn-sm btn-primary" id='look_budget'>
				Kompilasi Budget
			</a> -->
			<button type='button' class="btn btn-sm btn-primary" id='look_budget'>
				Kompilasi Budget
			</button>
		<?php
			if($akses_menu['create']=='1'){ 
			?>
				<a href="<?php echo site_url('budget/add_rutin') ?>" class="btn btn-sm btn-success" id='btn-add'>
...
<script>
	...
	$(document).on('click', '#look_budget', function(e){
		let id_category = $('#id_category').val()
		window.open(base_url + active_controller+'/kompilasi/'+id_category,'_self');
