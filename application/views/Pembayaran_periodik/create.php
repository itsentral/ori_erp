                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        if(!empty($data_detail)){
                            ...
                            <tr id='trd<?=$idd?>' class='delAll'>
                                ...
                                <td><input type="text" class="form-control divide subppn" name="ppn[]" id="ppn_<?=$idd;?>" value="<?=$record->ppn?>" onblur="cektotal(<?=$idd;?>)"></td>
                                <td><input type="text" class="form-control divide subpph" name="pph[]" id="pph_<?=$idd;?>" value="<?=$record->pph?>" onblur="cektotal(<?=$idd;?>)"></td>
                            </tr>
                            <?php
                                $idd++;
                            }
                ...
                <div class="box-footer">
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <a class="btn btn-danger btn-sm" href='<?=base_url('pembayaran_periodik');?>'>Back</a>
                        </div>
                    </div>
                </div>
            </div>
