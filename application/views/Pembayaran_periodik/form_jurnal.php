			...
			<div class="box-footer">
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
						...
						<a href="<?=base_url("pembayaran_periodik/periodik_jurnal_list")?>" class="btn btn-warning btn-sm"><i class="fa fa-reply">&nbsp;</i>Kembali</a>
					</div>
				</div>
			</div>
		</div>
					  ...
					  $.ajax({
						...
						success: function(msg){
							if(msg['save']=='1'){
								...
								window.location.href = base_url + active_controller +"/periodik_jurnal_list";
							} else {
								swal({
