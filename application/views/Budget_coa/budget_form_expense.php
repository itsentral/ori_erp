                ...
                <div class="row">
                    ...
                    foreach($data as $record) {
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="total<?=$i?>" name="total[]" value="<?=(isset($record->total)?$record->total:0); ?>" class="input-sm maskMoney" size="8" readonly tabindex="-1" style="background-color:#eee"  data-decimal="." data-thousand="" data-precision="0" data-allow-zero="">
                            </td>
                            <?php
                            for($bln=1;$bln<=12;$bln++){
                                echo '<td><input type="text" size=8 onkeyup="cektotalrow('.$bln.','.$i.')" class="maskMoney input-sm" id="bulan_'.$bln.'_'.$i.'" name="bulan_'.$bln.'[]" value="'.(isset($record->{"bulan_".$bln})?$record->{"bulan_".$bln}:0).'" required data-decimal="." data-thousand="" data-precision="0" data-allow-zero=""></td>';
                            }
                            ?>
                    <?php } ?>
                    </table>
...
<script type="text/javascript">
    ...
    $('#frm_data').on('submit', function(e){
        ...
        $.ajax({
            url: base_url+"budget_coa/save_data_expense",
            dataType : "json",
            type: 'POST',
            data: formdata,
