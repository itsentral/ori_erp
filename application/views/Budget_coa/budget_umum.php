  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		echo '<div class="col-md-8"><label> Penanggung Jawab</label><br />'.form_dropdown('fdivisi',$datadept, 0,array('id'=>'fdivisi','class'=>'form-control')).'</div>';
...
<script type="text/javascript">
	...
	function revisi_data(tahun,kategori,divisi,revisi){
        $.ajax({
            url: base_url+"budget_coa/revisi_data_umum",
            dataType : "json",
            type: 'POST',
	...
	function approve_data(tahun,kategori,divisi){
        $.ajax({
            url: base_url+"budget_coa/approve_data_umum",
            dataType : "json",
            type: 'POST',
	...
	function data_proses(){
		...
		function(isConfirm){
		  if (isConfirm) {
			$.ajax({
				dataType : "json",
				url: base_url+'budget_coa/proses_budget_umum',
				type: 'POST',
				success: function(msg){
					if(msg['save']=='1'){
						swal({
