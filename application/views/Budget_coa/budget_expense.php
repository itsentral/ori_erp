  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		<form id="frmbudget" name="frmbudget" method="post" target="_blank" action="<?=base_url('budget_coa/print_budget_expense')?>">
...
<script type="text/javascript">
	...
	function revisi_data(tahun,kategori,divisi,revisi){
        $.ajax({
            url: base_url+"budget_coa/revisi_data_expense",
            dataType : "json",
            type: 'POST',
	...
	function approve_data(tahun,kategori,divisi){
        $.ajax({
            url: base_url+"budget_coa/approve_data_expense",
            dataType : "json",
            type: 'POST',
	...
	function showmodal(){
  	...
  	function add_data(){
		var url = 'budget_coa/create_budget_expense';
		$(".box").hide();
		$('#mymodal').modal('hide');
		$("#form-data").show();
