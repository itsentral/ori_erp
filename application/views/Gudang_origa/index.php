			...
			<table class="table table-sm table-bordered table-striped" id="my-grid2" width='100%'>
				<thead>
					<tr class='bg-blue'>
						...
						<th class="text-center">DESC BARANG</th>
						<th class="text-center">QTY GD ORIGA</th>
						<th class="text-center">QTY RM F-TACKLE</th>
						<th class="text-center">COST BOOK</th>
						<th class="text-center no-sort">TOTAL GD ORIGA</th>
						<th class="text-center no-sort">TOTAL RM F-TACKLE</th>
					</tr>
				</thead>
				<tbody></tbody>
			</table>
...
<script>
	$(document).ready(function() {
        ...
        $(document).on('click', '#download_excel', function(e){
			...
			// }
			var Links		= base_url + active_controller+'/ExcelGudangOriga/'+date_filter_;
	...
	function DataTables2() {
		var dataTable = $('#my-grid2').DataTable({
			...
			"ajax": {
				url: base_url + active_controller + '/server_side_gudang_origa',
				type: "post",
				data: function(d){
					d.date_filter = ''
				},
