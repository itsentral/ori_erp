        ...
        <div class="box-body">
            ...
            <div class='box-footer'>
				<?php
					...
					if(!empty($data[0]['id'])){
						echo form_button(array('type'=>'button','class'=>'btn btn-md btn-success','value'=>'save','content'=>'Save Edit','id'=>'simpan-bro','style'=>'width:100px; float:right;')).' ';
					}
		...
		swal({
			...
			function(isConfirm) {
			  if (isConfirm) {
					...
					var baseurl		= base_url + active_controller +'/edited';
					$.ajax({
						url			: baseurl,
						type		: "POST",
						data		: formData,
