...
$tgl_depresiasi  = (!empty($data))?$data[0]['tanggal']:'';
$tgl_perolehan  = (!empty($data))?$data[0]['tanggal']:'';
$nama_user  	= (!empty($data))?$data[0]['created_by']:'';
    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
			...
			<div class='form-group row'>
				...
				<div class='col-sm-4'>  
					<select name='category_pajak' id='category_pajak' class='form-control input-md chosen-select'  >
            ...
            <div class='form-group row'>
                ...
                <div class='col-sm-4'>
                    <select name='category' id='category' class='form-control input-md chosen_select' >
			...
			<div class='form-group row'>
                ...
                <div class='col-sm-4'>
                    <select name='id_coa' id='id_coa' class='form-control input-md chosen_select' >
            ...
            <div class='form-group row'>
                ...
                <div class='col-sm-4'>
                    <select name='lokasi_asset' id='lokasi_asset' class='form-control input-md chosen_select' >
                ...
                <div class='col-sm-4'>
                    <select name='cost_center' id='cost_center' class='form-control input-md chosen_select' >
            ...
            <div class='form-group row hide_penyusutan'>
                ...
                <div class='col-sm-4'>
					<?php
					echo form_input(array('id'=>'depresiasi','name'=>'depresiasi','class'=>'form-control input-md','autocomplete'=>'off','placeholder'=>'Period of Time','readonly'=>'readonly'));											
				?>	
                </div>
				<label class='label-control col-sm-2'><b>Depreciation per month</b></label>
                <div class='col-sm-4'>
                        <?php
                            echo form_input(array('id'=>'value','name'=>'value','class'=>'form-control input-md','autocomplete'=>'off','placeholder'=>'Depreciation per month', 'readonly'=>'readonly','data-decimal'=>'.','data-thousand'=>'','data-precision'=>'0','data-allow-zero'=>false));
                        ?>
                </div>
            </div>
			<div class='form-group row'>
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-4'>             
					<select name='penyusutan' id='penyusutan' class='form-control input-md chosen-select' >
			...
			<div class='form-group row'>		 	 
                ...
                <div class='col-sm-4'>
					<?php
					echo form_input(array('id'=>'nama_user','name'=>'nama_user','class'=>'form-control input-md','autocomplete'=>'off','placeholder'=>'Nama User'),$nama_user);											
				?>	
                </div>
			</div>
