				...
				<table id="example1" class="table table-bordered table-striped" width='100%'>
					<thead>
						<tr class='bg-blue' >
							...
							<th class="text-center" width='15%'>Kode Trans</th>
					...
					<tfoot>
						<tr>
							<th colspan="4" style="text-align:center">SUM</th>
							<th></th>
							<th></th>
						</tr>
					</tfoot>
...
<script type="text/javascript">
	...
	function DataTables(kategori=null){
		...
		var dataTable = $('#example1').DataTable({
			...
			"ajax":{
				url : base_url + active_controller+'/data_side_new_asset',
				type: "post",
				data: function(d){
					d.kategori = kategori
				},
			...
			drawCallback: function( settings ) {
				var api = this.api();
				$( api.column( 4 ).footer() ).html("<div align='right'>"+ number_format(total_aset) +"</div>");
			}
