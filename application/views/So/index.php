...
<div class="box box-primary">
	<div class="box-header">
		...
		?>
		  <a href="<?php echo site_url('So/add') ?>" class="btn btn-sm btn-success" id='btn-add'>
...
<script>
	...
	$(document).on('click', '#detailSO', function(e){
		e.preventDefault();
		$("#head_title").html("<b>DETAIL SO ["+$(this).data('no_so')+"]</b>");
		$("#view").load(base_url +'index.php/'+ active_controller+'/modalDetail/'+$(this).data('id'));
		$("#ModalView").modal();
	});
