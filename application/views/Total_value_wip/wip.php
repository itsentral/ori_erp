		...
		<table class="table table-bordered table-striped" id="my-grid" width='100%'>
			<thead>
				<tr class='bg-blue'>
					...
					<th class="text-center">WIP Value</th>
					<th class="text-center">WIP Qty</th>
					<th class="text-center">FG Value</th>
					<th class="text-center">FG Qty</th>
					<th class="text-center">INTR Value</th>
					<th class="text-center">INTR Qty</th>
					<th class="text-center">CUST Value</th>
					<th class="text-center">CUST Qty</th>
				</tr>
			</thead>
			<tbody></tbody>
			<!-- <tfoot>
...
<script>
	...
	function DataTables(gudang=null, date_filter=null){
		...
		var dataTable = $('#my-grid').DataTable({
			...
			"ajax":{
				url : base_url + active_controller+'/get_data_json_wip',
				type: "post",
				data: function(d){
					d.gudang = gudang,
