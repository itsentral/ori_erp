		...
		<div class="box box-success">
			<div class="box-body">
				<div class='in_ipp'>
					...
					<label class='label-control col-sm-2 hidden'><b>Warehouse</b></label>
...
*/
		...
		$.ajax({
			url: base_url + active_controller+'/modal_retur_stok',
			type		: "POST",
			data: {
				"no_ipp" 		: no_ipp,
	...
	function DataTables(no_po=null){
		var dataTable = $('#my-grid').DataTable({
			...
			"ajax":{
				url : base_url + active_controller+'/server_side_retur_stok',
				type: "post",
				data: function(d){
					d.no_po = no_po
				},
