...
<div class="box box-primary">
	<div class="box-header">
		...
		?>
		  <!-- <a href="<?php echo site_url('history_pembelian/excel_material') ?>" class="btn btn-sm btn-success" style='float:right;' target='_blank'>
...
<script>
	$(document).ready(function(){
		...
		$(document).on('click', '.detail_material', function(){
			...
			$.ajax({
				type:'POST',
				url:base_url+active_controller+'/modal_detail_material/'+no_po,
		...
		$(document).on('click', '#btnDownload', function(){
			...
			var Links		= base_url + active_controller+'/excel_material/'+tgl_awal+'/'+tgl_akhir;
	...
	function DataTables(range=null){
		var dataTable = $('#my-grid').DataTable({
			...
			"ajax":{
				url : base_url + active_controller+'/getDataJSONMaterial',
				type: "post",
				data: function(d){
					d.range = range
				},
