...
$data_hist = str_replace('Z', ' ', $this->uri->segment(4));

$qBQ 	= "	SELECT * FROM hist_bq_header WHERE id_bq = '".$id_bq."' ";
$row	= $this->db->query($qBQ)->result_array();

$qBQdetailHeader 	= "SELECT * FROM hist_bq_detail_header WHERE id_bq = '".$id_bq."' AND hist_date = '".$data_hist."' ORDER BY id_delivery ASC, sub_delivery ASC";
...
<div class="box-body">
	...
	<table id="my-grid" class="table table-striped table-bordered table-hover table-condensed" width="100%">
		<thead id='head_table'>
			<tr  style='background-color:#00b795; color: white;'>
