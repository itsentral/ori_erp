...
<script>
	...
	function AppendBarisKom(intd, num, NilSpool, hasilUrut1, ProductC){
		...
		var Rows	 = 	"<tr id='tr_"+intd+"_"+num+"'>"; 
			...
			Rows	+=			"<div class='labDet'>PRODUCT SUPPLY</div><select name='ListDetailKomp["+hasilUrut1+"][product_supply]' id='product_supply"+intd+"_"+num+"' class='chosen_select form-control inline-block' required><option value='0'>Select An Product Supply</option><option value='Loose Supply'>LOOSE SUPPLY</option><option value='Spool'>SPOOL</option></select>";
			...
			Rows	+= 		"</td>";
			Rows	+= 		"<td style='width: 12%;' align='right'>";
			Rows	+=			"<div class='labDet'>LINER</div><select name='ListDetailKomp["+hasilUrut1+"][id_fluida]' id='id_fluida_"+intd+"_"+num+"' class='chosen_select form-control inline-block' required><option value='0'>Liner</option></select>";
			Rows	+=			"<div class='labDet'>LIFE TIME</div><select name='ListDetailKomp["+hasilUrut1+"][time_life]' id='time_life_"+intd+"_"+num+"' class='chosen_select form-control inline-block' required><option value='0'>Select An Life Time</option><option value='20'>20 Year</option><option value='25'>25 Year</option><option value='30'>30 Year</option></select>";
			...
			Rows	+= 			"&nbsp;&nbsp;&nbsp;&nbsp;<input class='form-check-input' name='ListDetailKomp["+hasilUrut1+"][std_din]' id='std_din_"+intd+"_"+num+"' type='checkbox' value='Y'>";
			Rows	+= 				"<label class='form-check-label'>&nbsp;DIN</label>";
			Rows	+= 			"&nbsp;&nbsp;&nbsp;&nbsp;<input class='form-check-input' name='ListDetailKomp["+hasilUrut1+"][std_fff]' id='std_fff_"+intd+"_"+num+"' type='checkbox' value='Y'>";
			Rows	+= 				"<label class='form-check-label'>&nbsp;FLAT FACE FLANGE</label><br>";
			Rows	+= 			"&nbsp;&nbsp;&nbsp;&nbsp;<input class='form-check-input' name='ListDetailKomp["+hasilUrut1+"][std_rf]' id='std_rf_"+intd+"_"+num+"' type='checkbox' value='Y'>";
			Rows	+= 				"<label class='form-check-label'>&nbsp;RAISED FLANGE</label>";
