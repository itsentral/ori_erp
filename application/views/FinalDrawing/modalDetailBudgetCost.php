<?php
	...
	// echo $id_bq;
	$qHeader		= "SELECT * FROM so_component_header WHERE id_product='".$id_product."' AND id_milik='".$id_milik."' AND id_bq='".$id_bq."'";
	$qDetail1		= "SELECT a.*, a.price_mat AS price_ref_estimation FROM so_component_detail a WHERE a.id_product='".$id_product."' AND a.id_milik='".$id_milik."' AND a.id_bq='".$id_bq."' AND a.detail_name='LINER THIKNESS / CB' AND a.id_material <> 'MTL-1903000' AND a.id_category <> 'TYP-0001'";
	$qDetail2		= "SELECT a.*, a.price_mat AS price_ref_estimation FROM so_component_detail a WHERE a.id_product='".$id_product."' AND a.id_milik='".$id_milik."' AND a.id_bq='".$id_bq."' AND a.detail_name='STRUKTUR THICKNESS' AND a.id_material <> 'MTL-1903000' AND a.id_category <> 'TYP-0001'";
	$qDetail3		= "SELECT a.*, a.price_mat AS price_ref_estimation FROM so_component_detail a WHERE a.id_product='".$id_product."' AND a.id_milik='".$id_milik."' AND a.id_bq='".$id_bq."' AND a.detail_name='EXTERNAL LAYER THICKNESS' AND a.id_material <> 'MTL-1903000' AND a.id_category <> 'TYP-0001'";
	$detailResin1	= "SELECT a.*, a.price_mat AS price_ref_estimation FROM so_component_detail a WHERE a.id_product='".$id_product."' AND a.id_milik='".$id_milik."' AND a.id_bq='".$id_bq."' AND a.detail_name='LINER THIKNESS / CB' AND a.id_category ='TYP-0001' ORDER BY a.id_detail DESC LIMIT 1 ";
	$detailResin2	= "SELECT a.*, a.price_mat AS price_ref_estimation FROM so_component_detail a WHERE a.id_product='".$id_product."' AND a.id_milik='".$id_milik."' AND a.id_bq='".$id_bq."' AND a.detail_name='STRUKTUR THICKNESS' AND a.id_category ='TYP-0001' ORDER BY a.id_detail DESC LIMIT 1 ";
	$detailResin3	= "SELECT a.*, a.price_mat AS price_ref_estimation FROM so_component_detail a WHERE a.id_product='".$id_product."' AND a.id_milik='".$id_milik."' AND a.id_bq='".$id_bq."' AND a.detail_name='EXTERNAL LAYER THICKNESS' AND a.id_category ='TYP-0001' ORDER BY a.id_detail DESC LIMIT 1 ";
	$qDetailPlus1	= "SELECT a.*, a.price_mat AS price_ref_estimation FROM so_component_detail_plus a WHERE a.id_product='".$id_product."' AND a.id_milik='".$id_milik."' AND a.id_bq='".$id_bq."' AND a.detail_name='LINER THIKNESS / CB' AND a.id_material <> 'MTL-1903000'";
	$qDetailPlus2	= "SELECT a.*, a.price_mat AS price_ref_estimation FROM so_component_detail_plus a WHERE a.id_product='".$id_product."' AND a.id_milik='".$id_milik."' AND a.id_bq='".$id_bq."' AND a.detail_name='STRUKTUR THICKNESS' AND a.id_material <> 'MTL-1903000'";
	$qDetailPlus3	= "SELECT a.*, a.price_mat AS price_ref_estimation FROM so_component_detail_plus a WHERE a.id_product='".$id_product."' AND a.id_milik='".$id_milik."' AND a.id_bq='".$id_bq."' AND a.detail_name='EXTERNAL LAYER THICKNESS' AND a.id_material <> 'MTL-1903000'";
	$qDetailPlus4	= "SELECT a.*, a.price_mat AS price_ref_estimation FROM so_component_detail_plus a WHERE a.id_product='".$id_product."' AND a.id_milik='".$id_milik."' AND a.id_bq='".$id_bq."' AND a.detail_name='TOPCOAT' AND a.id_material <> 'MTL-1903000'";
	$qDetailAdd1	= "SELECT a.*, a.price_mat AS price_ref_estimation FROM so_component_detail_add a WHERE a.id_product='".$id_product."' AND a.id_milik='".$id_milik."' AND a.id_bq='".$id_bq."' AND a.detail_name='LINER THIKNESS / CB' AND a.id_material <> 'MTL-1903000'";
	$qDetailAdd2	= "SELECT a.*, a.price_mat AS price_ref_estimation FROM so_component_detail_add a WHERE a.id_product='".$id_product."' AND a.id_milik='".$id_milik."' AND a.id_bq='".$id_bq."' AND a.detail_name='STRUKTUR THICKNESS' AND a.id_material <> 'MTL-1903000'";
	$qDetailAdd3	= "SELECT a.*, a.price_mat AS price_ref_estimation FROM so_component_detail_add a WHERE a.id_product='".$id_product."' AND a.id_milik='".$id_milik."' AND a.id_bq='".$id_bq."' AND a.detail_name='EXTERNAL LAYER THICKNESS' AND a.id_material <> 'MTL-1903000'";
	$qDetailAdd4	= "SELECT a.*, a.price_mat AS price_ref_estimation FROM so_component_detail_add a WHERE a.id_product='".$id_product."' AND a.id_milik='".$id_milik."' AND a.id_bq='".$id_bq."' AND a.detail_name='TOPCOAT' AND a.id_material <> 'MTL-1903000'";
	...
	$qDetail2N1		= "SELECT a.*, a.price_mat AS price_ref_estimation FROM so_component_detail a WHERE a.id_product='".$id_product."' AND a.id_milik='".$id_milik."' AND a.id_bq='".$id_bq."' AND a.detail_name='STRUKTUR NECK 1' AND a.id_material <> 'MTL-1903000' AND a.id_category <> 'TYP-0001'";
	$qDetail2N2		= "SELECT a.*, a.price_mat AS price_ref_estimation FROM so_component_detail a WHERE a.id_product='".$id_product."' AND a.id_milik='".$id_milik."' AND a.id_bq='".$id_bq."' AND a.detail_name='STRUKTUR NECK 2' AND a.id_material <> 'MTL-1903000' AND a.id_category <> 'TYP-0001'";
	
	$qDetailPlus2N1	= "SELECT a.*, a.price_mat AS price_ref_estimation FROM so_component_detail_plus a WHERE a.id_product='".$id_product."' AND a.id_milik='".$id_milik."' AND a.id_bq='".$id_bq."' AND a.detail_name='STRUKTUR NECK 1' AND a.id_material <> 'MTL-1903000'";
	$qDetailPlus2N2	= "SELECT a.*, a.price_mat AS price_ref_estimation FROM so_component_detail_plus a WHERE a.id_product='".$id_product."' AND a.id_milik='".$id_milik."' AND a.id_bq='".$id_bq."' AND a.detail_name='STRUKTUR NECK 2' AND a.id_material <> 'MTL-1903000'";
	
	$qDetailAdd2N1	= "SELECT a.*, a.price_mat AS price_ref_estimation FROM so_component_detail_add a WHERE a.id_product='".$id_product."' AND a.id_milik='".$id_milik."' AND a.id_bq='".$id_bq."' AND a.detail_name='STRUKTUR NECK 1'";
	$qDetailAdd2N2	= "SELECT a.*, a.price_mat AS price_ref_estimation FROM so_component_detail_add a WHERE a.id_product='".$id_product."' AND a.id_milik='".$id_milik."' AND a.id_bq='".$id_bq."' AND a.detail_name='STRUKTUR NECK 2'";
	
	$detailResin2N1	= "SELECT a.*, a.price_mat AS price_ref_estimation FROM so_component_detail a WHERE a.id_product='".$id_product."' AND a.id_milik='".$id_milik."' AND a.id_bq='".$id_bq."' AND a.detail_name='STRUKTUR NECK 1' AND a.id_category ='TYP-0001' ORDER BY a.id_detail DESC LIMIT 1 ";
	$detailResin2N2	= "SELECT a.*, a.price_mat AS price_ref_estimation FROM so_component_detail a WHERE a.id_product='".$id_product."' AND a.id_milik='".$id_milik."' AND a.id_bq='".$id_bq."' AND a.detail_name='STRUKTUR NECK 2' AND a.id_category ='TYP-0001' ORDER BY a.id_detail DESC LIMIT 1 ";
	...
	//JOINT
	$qDetail1Joint		= "SELECT a.*, a.price_mat AS price_ref_estimation FROM so_component_detail a WHERE a.id_product='".$id_product."' AND a.id_milik='".$id_milik."' AND a.id_bq='".$id_bq."' AND a.detail_name='GLASS' AND a.id_material <> 'MTL-1903000'";
	$qDetail2Joint		= "SELECT a.*, a.price_mat AS price_ref_estimation FROM so_component_detail a WHERE a.id_product='".$id_product."' AND a.id_milik='".$id_milik."' AND a.id_bq='".$id_bq."' AND a.detail_name='RESIN AND ADD' AND a.id_material <> 'MTL-1903000'";
	$qDetail2JointAdd	= "SELECT a.*, a.price_mat AS price_ref_estimation FROM so_component_detail_add a WHERE a.id_product='".$id_product."' AND a.id_milik='".$id_milik."' AND a.id_bq='".$id_bq."' AND a.detail_name='RESIN AND ADD' AND a.id_material <> 'MTL-1903000'";
			...
			<table id="my-grid" class="table table-striped table-bordered table-hover table-condensed" width="100%">
				<tbody>
					...
					<tr>
						...
						<td class="text-left" colspan='5'><?= spec_hasil($restHeader[0]['id'], 'so_component_header');?></td>
					</tr>
					<tr>
