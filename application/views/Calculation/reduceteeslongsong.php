	...
	<div class="box box-primary">
		...
		<div class="box-body">
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-6'>              
					...
					<select name='top_typeList' id='top_typeList' class='form-control input-sm'>
						<option value='0'>Select An Pipe Type</option>
					<?php
				...
				<label class='label-control col-sm-2'><b>Thickness Pipe (EST)<span class='text-red'>*</span></b></label>
				<div class='col-sm-2'>              
					<?php
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-2'>              
					<?php
						// echo form_input(array('id'=>'top_length','name'=>'top_length','class'=>'form-control input-sm','autocomplete'=>'off','placeholder'=>'Pipe Length','value'=>'0', 'data-decimal'=>'.', 'data-thousand'=>'', 'data-prefix'=>'', 'data-precision'=>'0', 'data-allow-zero'=>'true'));											
						echo form_input(array('id'=>'top_length','name'=>'top_length','class'=>'form-control input-sm numberOnly','autocomplete'=>'off','placeholder'=>'Pipe Length','value'=>''));											
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-2'>              
					<?php
						echo form_input(array('type'=>'text','id'=>'waste','name'=>'waste','class'=>'form-control input-sm numberOnly','placeholder'=>'Waste','value'=>'0.2'));
						echo form_input(array('type'=>'hidden','id'=>'area','name'=>'area'));
						// echo form_input(array('type'=>'hidden','id'=>'parent_product','name'=>'parent_product'));
					?>
				</div>
				<label class='label-control col-sm-2'><b>Thickness Pipe (design)<span class='text-red'>*</span></b></label>
				<div class='col-sm-2'>              
					<?php
			...
			<!--
			<div class='form-group row'>		 	 
				<label class='label-control col-sm-2'><b>REALESE AGENT</b></label>
				
				<div class='col-sm-3'>              
					<select name='ListDetail[0][id_material]' id='mid_mtl_realese' class='form-control input-sm'>
						<option value=''>Select An Realese Agent</option>
					<?php
						// foreach($ListRealise AS $val => $valx){
							// echo "<option value='".$valx['id_material']."'>".strtoupper($valx['nm_material'])."</option>";
						// }
					 ?>
					</select>
					<input type='text' name='ListDetail[0][last_full]' class='HideCost' id='hasil_realise' value='0'>
				</div>
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'total_realise','name'=>'ListDetail[0][last_cost]', 'style'=>'margin-left:-80px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
			...
			<div class='form-group row'>		 	 
				<label class='label-control col-sm-2' style='text-align:right;'><b>VEIL<span class='text-red'>*</span></b></label>
				<div class='col-sm-3'>              
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-3'>              
					<select name='ListDetail[3][id_material]' id='mid_mtl_resin1' class='form-control input-sm'>
			...
			<div class='form-group row'>		 	 
				<label class='label-control col-sm-2' style='text-align:right;'><b>ADDITIONAL VEIL<span class='text-red'>*</span></b></label>
				<div class='col-sm-3'>              
			...
			<div class='form-group row'>		 	 
				<label class='label-control col-sm-2'><b>RESIN</b></label>
				<div class='col-sm-3'>              
			...
			<div class='form-group row'>		 	 
				<label class='label-control col-sm-2' style='text-align:right;'><b>MAT / CSM<span class='text-red'>*</span></b></label>
				<div class='col-sm-3'>              
			...
			<div class='form-group row'>		 	 
				<label class='label-control col-sm-2' style='text-align:right;'><b>ADDITIONAL CSM<span class='text-red'>*</span></b></label>
				<div class='col-sm-3'>              
			...
			<div class='form-group row'>		 	 
				<label class='label-control col-sm-2'><b>TOTAL RESIN</b></label>
				<div class='col-sm-3'>              
					<select name='id_material' id='mid_mtl_resin_tot' class='form-control input-sm' disabled>
					<option value=''>Select An Resin</option>
					<?php
						foreach($ListResin AS $val => $valx){
							echo "<option value='".$valx['id_material']."'>".strtoupper($valx['nm_material'])."</option>";
					...
					<input type='text' name='ListDetail[10][containing]' class='HideCost' id='layer_resin_tot' value='0.5'>
			...
			<div class='form-group row'>
				...
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus[0][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_katalis' value='0.02'>	
				</div>
				<div class='col-sm-1'>              
					<?php
			...
			<div class='form-group row'>
				...
				<label class='col-sm-2' style='text-align:left; margin-left: -129px; margin-top: 6px;'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus[1][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_sm' value='0.025'>	
				</div>
				<div class='col-sm-1'>              
					<?php
			...
			<div class='form-group row'>
				...
				<label class='col-sm-2' style='text-align:left; margin-left: -129px; margin-top: 6px;'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus[2][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_coblat' value='0.002'>	
				</div>
				<div class='col-sm-1'>              
					<?php
			...
			<div class='form-group row'>
				...
				<label class='col-sm-2' style='text-align:left; margin-left: -129px; margin-top: 6px;'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus[3][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_dma' value='0.002'>	
				</div>
				<div class='col-sm-1'>              
					<?php
			...
			<div class='form-group row'>
				...
				<label class='col-sm-2' style='text-align:left; margin-left: -129px; margin-top: 6px;'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus[4][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_hydroquinone' value='0.0005'>	
				</div>
				<div class='col-sm-1'>              
					<?php
			...
			<div class='form-group row'>
				...
				<label class='col-sm-2' style='text-align:left; margin-left: -129px; margin-top: 6px;'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus[5][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_methanol' value='0.0005'>	
				</div>
				<div class='col-sm-1'>              
					<?php
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-4'>              
					<select name='ListDetailPlus[6][id_material]' id='mid_mtl_additive' class='form-control input-sm'>
					...
					<input type='text' name='ListDetailPlus[6][last_full]' class='HideCost' id='hasil_additive' value='0'>
					<!--
					<input type='text' name='ListDetailPlus[6][containing]' class='HideCost' id='layer_additive' value='1'>
					<input type='text' name='ListDetailPlus[6][perse]' class='HideCost' id='persen_additive' value='0.0005'>
					-->
				<!--
				</div>
				...
				<label class='col-sm-1' style='text-align:left; margin-left:0px; margin-top: 6px;'>Comparison</label>
				<div class='col-sm-2'>              
					<input type='text' name='ListDetailPlus[6][containing]' style='width:50px; margin-left:12px;' class='form-control input-sm numberOnly' readonly='readonly' id='layer_additive' value='1'>	
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -129px; margin-top: 6px;'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus[6][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_additive' value='0.0005'>	
				</div>
				<div class='col-sm-1'>				
					<?php
						// echo form_input(array('id'=>'last_additive','name'=>'ListDetailPlus[6][last_cost]', 'style'=>'margin-left:-81px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-101px; margin-top: 6px;'>Kg</label>
			</div>
			...
			<div class='form-group row'>		 	 
				<label class='label-control col-sm-2'><b>RESIN<span class='text-red'>*</span></b></label>
				<div class='col-sm-3'>              
					<select name='ListDetail2[1][id_material]' id='mid_mtl_resin21' class='form-control input-sm'>
					<option value=''>Select An Resin</option>
					<?php
						foreach($ListResin AS $val => $valx){
							echo "<option value='".$valx['id_material']."'>".strtoupper($valx['nm_material'])."</option>";
			...
			<div class='form-group row'>		 	 
				<label class='label-control col-sm-2'><b>RESIN</b></label>
				<div class='col-sm-3'>              
					<select name='id_material' id='mid_mtl_resin22' class='form-control input-sm' disabled>
					<option value=''>Select An Resin</option>
					<?php
						foreach($ListResin AS $val => $valx){
							echo "<option value='".$valx['id_material']."'>".strtoupper($valx['nm_material'])."</option>";
			...
			<div class='form-group row'>		 	 
				<label class='label-control col-sm-2' style='text-align:right;'><b>WR<span class='text-red'>*</span></b></label>
				<div class='col-sm-3'>              
			...
			<div class='form-group row'>		 	 
				<label class='label-control col-sm-2' style='text-align:right;'><b>ADDITIONAL WR<span class='text-red'>*</span></b></label>
				<div class='col-sm-3'>              
			...
			<div class='form-group row'>		 	 
				<label class='label-control col-sm-2' style='text-align:right;'><b>ROOVING<span class='text-red'>*</span></b></label>
				<div class='col-sm-3'>              
			...
			<div class='form-group row'>		 	 
				<label class='label-control col-sm-2' style='text-align:right;'><b>ADDITIONAL ROOVING<span class='text-red'>*</span></b></label>
				<div class='col-sm-3'>              
			...
			<div class='form-group row'>		 	 
				<label class='label-control col-sm-2'><b>TOTAL RESIN</b></label>
				<div class='col-sm-3'>              
					<select name='id_material' id='mid_mtl_resin_tot2' class='form-control input-sm' disabled>
					<option value=''>Select An Resin</option>
					<?php
						foreach($ListResin AS $val => $valx){
							echo "<option value='".$valx['id_material']."'>".strtoupper($valx['nm_material'])."</option>";
			...
			<div class='form-group row'>
				...
				<label class='col-sm-2' style='text-align:left; margin-left: -129px; margin-top: 6px;'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus2[0][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_katalis2' value='0.02'>	
				</div>
				<div class='col-sm-1'>              
					<?php
			...
			<div class='form-group row'>
				...
				<label class='col-sm-2' style='text-align:left; margin-left: -129px; margin-top: 6px;'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus2[1][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_sm2' value='0.025'>	
				</div>
				<div class='col-sm-1'>              
					<?php
			...
			<div class='form-group row'>
				...
				<label class='col-sm-2' style='text-align:left; margin-left: -129px; margin-top: 6px;'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus2[2][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_coblat2' value='0.002'>	
				</div>
				<div class='col-sm-1'>              
					<?php
			...
			<div class='form-group row'>
				...
				<label class='col-sm-2' style='text-align:left; margin-left: -129px; margin-top: 6px;'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus2[3][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_dma2' value='0.002'>	
				</div>
				<div class='col-sm-1'>              
					<?php
			...
			<div class='form-group row'>
				...
				<label class='col-sm-2' style='text-align:left; margin-left: -129px; margin-top: 6px;'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus2[4][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_hydroquinone2' value='0.002'>	
				</div>
				<div class='col-sm-1'>              
					<?php
			...
			<div class='form-group row'>
				...
				<label class='col-sm-2' style='text-align:left; margin-left: -129px; margin-top: 6px;'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus2[5][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_methanol2' value='0.002'>	
				</div>
				<div class='col-sm-1'>              
					<?php
			...
			<div class='form-group row'>		 	 
				<label class='label-control col-sm-2'><b>ADDITIVE</b></label>
				<div class='col-sm-4'>              
					<select name='ListDetailPlus2[6][id_material]' id='mid_mtl_additive2' class='form-control input-sm'>
						<option value=''>Select An Additive</option>
					<?php
						// foreach($ListMatAdditive AS $val => $valx){
							// echo "<option value='".$valx['id_material']."'>".strtoupper($valx['nm_material'])."</option>";
					...
					<input type='text' name='ListDetailPlus2[6][last_full]' class='HideCost' id='hasil_additive2' value='0'>
					<!--
					<input type='text' name='ListDetailPlus2[6][containing]' class='HideCost' id='layer_additive2' value='1'>
					<input type='text' name='ListDetailPlus2[6][perse]' class='HideCost' id='persen_additive2' value='0.0005'>
					-->
				<!--
				</div>
				...
				<label class='col-sm-1' style='text-align:left; margin-left: 0px; margin-top: 6px;'>Comparison</label>
				<div class='col-sm-2'>              
					<input type='text' name='ListDetailPlus2[6][containing]' style='width:50px; margin-left:12px;' class='form-control input-sm numberOnly' readonly='readonly' id='layer_additive2' value='0'>	
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -129px; margin-top: 6px;'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus2[6][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_additive2' value='0.0005'>	
				</div>
				<div class='col-sm-1'>              
					<?php
						//echo form_input(array('id'=>'last_additive2','name'=>'ListDetailPlus2[6][last_cost]', 'style'=>'margin-left:-81px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-101px; margin-top: 6px;'>Kg</label>
			</div>
			...
			<div class='form-group row'>		 	 
				<label class='label-control col-sm-2'><b>RESIN<span class='text-red'>*</span></b></label>
				<div class='col-sm-3'>              
					<select name='ListDetail3[1][id_material]' id='mid_mtl_resin31' class='form-control input-sm'>
						<option value=''>Select An Resin</option>
					<?php
						foreach($ListResin AS $val => $valx){
							echo "<option value='".$valx['id_material']."'>".strtoupper($valx['nm_material'])."</option>";
			...
			<div class='form-group row'>		 	 
				<label class='label-control col-sm-2'><b>TOTAL RESIN</b></label>
				<div class='col-sm-3'>              
					<select name='id_material' id='mid_mtl_resin_tot3' class='form-control input-sm' disabled>
					<option value=''>Select An Resin</option>
					<?php
						foreach($ListResin AS $val => $valx){
							echo "<option value='".$valx['id_material']."'>".strtoupper($valx['nm_material'])."</option>";
			...
			<div class='form-group row'>
				...
				<label class='col-sm-2' style='text-align:left; margin-left: -129px; margin-top: 6px;'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus3[0][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_katalis3' value='0.02'>	
				</div>
				<div class='col-sm-1'>              
					<?php
			...
			<div class='form-group row'>
				...
				<label class='col-sm-2' style='text-align:left; margin-left: -129px; margin-top: 6px;'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus3[1][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_sm3' value='0.02'>	
				</div>
				<div class='col-sm-1'>              
					<?php
			...
			<div class='form-group row'>
				...
				<label class='col-sm-2' style='text-align:left; margin-left: -129px; margin-top: 6px;'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus3[2][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_coblat3' value='0.002'>	
				</div>
				<div class='col-sm-1'>              
					<?php
			...
			<div class='form-group row'>
				...
				<label class='col-sm-2' style='text-align:left; margin-left: -129px; margin-top: 6px;'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus3[3][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_dma3' value='0.002'>	
				</div>
				<div class='col-sm-1'>              
					<?php
			...
			<div class='form-group row'>
				...
				<label class='col-sm-2' style='text-align:left; margin-left: -129px; margin-top: 6px;'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus3[4][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_hydroquinone3' value='0.0005'>	
				</div>
				<div class='col-sm-1'>              
					<?php
			...
			<div class='form-group row'>
				...
				<label class='col-sm-2' style='text-align:left; margin-left: -129px; margin-top: 6px;'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus3[5][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_methanol3' value='0.0005'>	
				</div>
				<div class='col-sm-1'>              
					<?php
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-3'>              
					...
					<input type='text' name='ListDetailPlus4[0][perse]' class='HideCost' id='resin41' value='0.25'>
				</div>
				<label class='col-sm-2' style='text-align:left; margin-top: 6px;'></label>
				<div class='col-sm-1'>              
			...
			<div class='form-group row'>
				...
				<label class='col-sm-2' style='text-align:left; margin-left: -129px; margin-top: 6px;'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus4[1][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_katalis4' value='0.02'>	
				</div>
				<div class='col-sm-1'>              
					<?php
			...
			<div class='form-group row'>
				...
				<label class='col-sm-2' style='text-align:left; margin-left: -129px; margin-top: 6px;'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus4[2][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_color4' value='0.05'>	
				</div>
				<div class='col-sm-1'>              
					<?php
			...
			<div class='form-group row'>
				...
				<label class='col-sm-2' style='text-align:left; margin-left: -129px; margin-top: 6px;'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus4[3][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_tin4' value='0.026'>	
				</div>
				<div class='col-sm-1'>              
					<?php
			...
			<div class='form-group row'>
				...
				<label class='col-sm-2' style='text-align:left; margin-left: -129px; margin-top: 6px;'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus4[4][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_chl4' value='0.026'>	
				</div>
				<div class='col-sm-1'>              
					<?php
			...
			<div class='form-group row'>
				...
				<label class='col-sm-2' style='text-align:left; margin-left: -129px; margin-top: 6px;'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus4[5][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_stery4' value='0.03'>	
				</div>
				<div class='col-sm-1'>              
					<?php
			...
			<div class='form-group row'>
				...
				<label class='col-sm-2' style='text-align:left; margin-left: -129px; margin-top: 6px;'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus4[6][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_wax4' value='0.03'>	
				</div>
				<div class='col-sm-1'>              
					<?php
			...
			<div class='form-group row'>
				...
				<label class='col-sm-2' style='text-align:left; margin-left: -129px; margin-top: 6px;'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus4[7][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_mch4' value='0.00'>	
				</div>
				<div class='col-sm-1'>              
					<?php
...
<script>
	...
	$(document).ready(function(){	
		...
		// $('#top_length').maskMoney();
		// $('#top_diameter').maskMoney();
		...
		// $(document).on('change', '#top_typeList', function(){
			// var id	= $(this).val();
			// $.ajax({
		...
		$(document).on('keyup', '#waste', function(){
			...
			var top_length		= parseFloat($('#top_length').val());
			...
			Hasil(tot_thickness1, layer_veil1, layer_veil2, layer_veil3, layer_veil4, top_diameter, top_length, top_thickness, waste);
			Hasil2(tot_thickness2, layer1, layer2, layer3, layer4, layer5, layer6, top_diameter, top_length, top_thickness, waste);
			Hasil3(tot_thickness3, layer31, layer32, layer33, layer34, top_diameter, top_length, top_thickness, waste);
		});
		...
		// $(document).on('keyup', '#acuhan_1', function(){
		...
		// $(document).on('keyup', '#acuhan_2', function(){
			// var liner		= $('#acuhan_1').val();
			// var struktur	= $('#acuhan_2').val();
			// var external	= $('#acuhan_3').val();
			// var MinToleransi	= $('#top_min_toleran').val();
		...
		$(document).on('keyup', '#persen_katalis', function(){
			...
			var Hasil			= parseFloat(nilai) * parseFloat(hasil_resin_tot) * parseFloat(layer_katalis);
		...
		$(document).on('keyup', '#persen_sm', function(){
			...
			var Hasil			= parseFloat(nilai) * parseFloat(hasil_resin_tot) * parseFloat(layer_sm);
		...
		$(document).on('keyup', '#persen_coblat', function(){
			...
			var Hasil			= parseFloat(nilai) * parseFloat(hasil_resin_tot) * parseFloat(layer_coblat);
		...
		$(document).on('keyup', '#persen_dma', function(){
			...
			var Hasil			= parseFloat(nilai) * parseFloat(hasil_resin_tot) * parseFloat(layer_dma);
		...
		$(document).on('keyup', '#persen_hydroquinone', function(){
			...
			var Hasil				= parseFloat(nilai) * parseFloat(hasil_resin_tot) * parseFloat(layer_hydroquinone);
		...
		$(document).on('keyup', '#persen_methanol', function(){
			...
			var Hasil				= parseFloat(nilai) * parseFloat(hasil_resin_tot) * parseFloat(layer_methanol);
			$('#last_methanol').val(Hasil.toFixed(3));
		});
		// $(document).on('keyup', '#persen_additive', function(){
			// var nilai				= $(this).val();
			// var hasil_resin_tot 	= $('#hasil_resin_tot').val();
			// var layer_additive		= $('#layer_additive').val();
			// var Hasil				= parseFloat(nilai) * parseFloat(hasil_resin_tot) * parseFloat(layer_additive);
			// $('#last_additive').val(Hasil.toFixed(3));
		// });
		...
		// $(document).on('keyup', '#persen_additive2', function(){
			// var nilai				= $(this).val();
			// var hasil_resin_tot 	= $('#hasil_resin_tot2').val();
			// var layer_additive		= $('#layer_additive2').val();
			// var Hasil				= parseFloat(nilai) * parseFloat(hasil_resin_tot) * parseFloat(layer_additive);
			// $('#last_additive2').val(Hasil.toFixed(3));
		// });
		...
		// $(document).on('keyup', '#persen_additive3', function(){
			// var nilai				= $(this).val();
			// var hasil_resin_tot 	= $('#hasil_resin_tot3').val();
			// var layer_additive		= $('#layer_additive3').val();
			// var Hasil				= parseFloat(nilai) * parseFloat(hasil_resin_tot) * parseFloat(layer_additive);
			// $('#last_additive3').val(Hasil.toFixed(3));
		// });
		...
		// $(document).on('keyup', '#persen_additive4', function(){
			// var nilai			= $(this).val();
			// var hasil_resin_tot = $('#hasil_additive4').val();
			// var layer_katalis	= $('#layer_additive4').val();
			// var Hasil			= parseFloat(nilai) * parseFloat(hasil_resin_tot) * parseFloat(layer_katalis);
			// $('#last_additive4').val(Hasil.toFixed(3));
		// });
		...
		$(document).on('change', '#mid_mtl_veil', function(){
			...
			$.ajax({
				...
				success: function(data){
					...
					$('#layer_veil').val('');
					// $("#mid_mtl_resin1").html(data.option).trigger("chosen:updated");
				}
			});
		});
		...
		$(document).on('keyup', '#layer_veil', function(){
			...
			Hasil(tot_thickness2, layer_veil, layer_veil2, layer_veil3, layer_veil4, top_diameter, top_length, top_thickness, waste);
		});
		
		$(document).on('change', '#mid_mtl_veil_add', function(){
			var id_material	= $(this).val();
			// alert($('#mid_mtl_resin1').val());
			$.ajax({
				url: base_url +'index.php/'+active_controller+'/getVeil2',
				cache: false,
				type: "POST",
				data: "id_material="+$(this).val()+"&resin2="+$('#layer_resin2').val()+"&resinutama="+$('#mid_mtl_resin1').val(),
				dataType: "json",
				success: function(data){ 
					$('#weight_veil_add').val(data.micron);
					$('#thickness_veil_add').val(RoundUp4(data.thickness));
					$('#layer_veil_add').val('');
					$("#mid_mtl_resin2").html(data.option).trigger("chosen:updated");
		...
		$(document).on('keyup', '#layer_veil_add', function(){
			...
			Hasil(tot_thickness2, layer_veil1, layer_veil, layer_veil3, layer_veil4, top_diameter, top_length, top_thickness, waste);
		});
		
		$(document).on('change', '#mid_mtl_resin1', function(){
			$("#mid_mtl_resin2").val($(this).val()).trigger("chosen:updated");
			$("#mid_mtl_resin3").val($(this).val()).trigger("chosen:updated");
			$("#mid_mtl_resin4").val($(this).val()).trigger("chosen:updated");
			$("#mid_mtl_resin_tot").val($(this).val()).trigger("chosen:updated");
			$("#layer_resin2hide").val($(this).val());
			$("#layer_resin3hide").val($(this).val());
			$("#layer_resin4hide").val($(this).val());
			$("#layer_resinTothide").val($(this).val());
		});
		...
		$(document).on('change', '#mid_mtl_matcsm', function(){
			...
			$.ajax({
				...
				cache: false,
				type: "POST",
				data: "id_material="+$(this).val()+"&resin3="+$('#layer_resin3').val()+"&resinutama="+$('#mid_mtl_resin1').val(),
				dataType: "json",
				success: function(data){
					$('#weight_matcsm').val(data.micron);
					$('#thickness_matcsm').val(RoundUp4(data.thickness));
					$('#layer_matcsm').val('');
					$("#mid_mtl_resin3").html(data.option).trigger("chosen:updated");
		...
		$(document).on('keyup', '#layer_matcsm', function(){
			...
			Hasil(tot_thickness2, layer_veil1, layer_veil2, layer_veil, layer_veil4, top_diameter, top_length, top_thickness, waste);
		});
		...
		$(document).on('change', '#mid_mtl_csm_add', function(){
			...
			$.ajax({
				...
				cache: false,
				type: "POST",
				data: "id_material="+$(this).val()+"&resin4="+$('#layer_resin4').val()+"&resinutama="+$('#mid_mtl_resin1').val(),
				dataType: "json",
				success: function(data){
					$('#weight_csm_add').val(data.micron);
					$('#thickness_csm_add').val(RoundUp4(data.thickness));
					$('#layer_csm_add').val('');
					$("#mid_mtl_resin4").html(data.option).trigger("chosen:updated");
		...
		$(document).on('keyup', '#layer_csm_add', function(){
			...
			Hasil(tot_thickness2, layer_veil1, layer_veil2, layer_veil3, layer_veil, top_diameter, top_length, top_thickness, waste);
		});
		
		//=============================================END=========================================================
		
		//========================================STRUKTURE THICKNESS=========================================================
		$(document).on('change', '#mid_mtl_resin21', function(){
			$("#mid_mtl_resin22").val($(this).val()).trigger("chosen:updated");
			$("#mid_mtl_resin23").val($(this).val()).trigger("chosen:updated");
			$("#mid_mtl_resin24").val($(this).val()).trigger("chosen:updated");
			$("#mid_mtl_resin25").val($(this).val()).trigger("chosen:updated");
			$("#mid_mtl_resin26").val($(this).val()).trigger("chosen:updated");
			$("#mid_mtl_resin_tot2").val($(this).val()).trigger("chosen:updated");
			...
			$("#layer_resin27hide").val($(this).val());
		});
		...
		$(document).on('keyup', '#layer_matcsm2', function(){
			...
			Hasil2(tot_thickness2, layer_veil, layer2, layer3, layer4, layer5, layer6, top_diameter, top_length, top_thickness, waste);
		});
		...
		$(document).on('change', '#mid_mtl_csm_add2', function(){
			...
			$.ajax({
				...
				cache: false,
				type: "POST",
				data: "id_material="+$(this).val()+"&resin4="+$('#layer_resin22').val()+"&resinutama="+$('#mid_mtl_resin21').val(),
				dataType: "json",
				success: function(data){
					$('#weight_csm_add2').val(data.micron);
					$('#thickness_csm_add2').val(RoundUp4(data.thickness));
					$('#layer_csm_add2').val('');
					$("#mid_mtl_resin22").html(data.option).trigger("chosen:updated");
		...
		$(document).on('keyup', '#layer_csm_add2', function(){
			...
			Hasil2(tot_thickness2, layer1, layer_veil, layer3, layer4, layer5, layer6, top_diameter, top_length, top_thickness, waste);
		});
		...
		$(document).on('keyup', '#layer_wr2', function(){
			...
			Hasil2(tot_thickness2, layer1, layer2, layer_veil, layer4, layer5, layer6, top_diameter, top_length, top_thickness, waste);
		});
		...
		$(document).on('change', '#mid_mtl_wr_add2', function(){
			...
			$.ajax({
				...
				success: function(data){
					...
					$('#layer_wr_add2').val('');
					$("#mid_mtl_resin24").html(data.option).trigger("chosen:updated");
		...
		$(document).on('keyup', '#layer_wr_add2', function(){
			...
			Hasil2(tot_thickness2, layer1, layer2, layer3, layer_veil, layer5, layer6, top_diameter, top_length, top_thickness, waste);
		});
		...
		$(document).on('change', '#mid_mtl_rooving21', function(){
			...
			$.ajax({
				...
				cache: false,
				type: "POST",
				data: "id_material="+$(this).val()+"&resin="+$('#layer_resin25').val()+"&resinutama="+$('#mid_mtl_resin21').val(),
				dataType: "json",
				success: function(data){
					...
					$('#layer_rooving21').val('');
					$("#mid_mtl_resin25").html(data.option).trigger("chosen:updated");
		...
		$(document).on('keyup', '#layer_rooving21', function(){
			...
			Hasil2(tot_thickness2, layer1, layer2, layer3, layer4, layer_veil, layer6, top_diameter, top_length, top_thickness, waste);
		});
		...
		$(document).on('change', '#mid_mtl_rooving22', function(){
			...
			$.ajax({
				...
				cache: false,
				type: "POST",
				data: "id_material="+$(this).val()+"&resin="+$('#layer_resin26').val()+"&resinutama="+$('#mid_mtl_resin21').val(),
				dataType: "json",
				success: function(data){
					...
					$('#layer_rooving22').val('');
					$("#mid_mtl_resin26").html(data.option).trigger("chosen:updated");
		...
		$(document).on('keyup', '#layer_rooving22', function(){
			...
			Hasil2(tot_thickness2, layer1, layer2, layer3, layer4, layer5, layer_veil, top_diameter, top_length, top_thickness, waste);
		});
		
		//=============================================END=========================================================
		
		//===================================EXTERNAL LAYER THICKNESS==============================================
		$(document).on('change', '#mid_mtl_resin31', function(){
			$("#mid_mtl_resin32").val($(this).val()).trigger("chosen:updated");
			$("#mid_mtl_resin33").val($(this).val()).trigger("chosen:updated");
			$("#mid_mtl_resin34").val($(this).val()).trigger("chosen:updated");
			$("#mid_mtl_resin_tot3").val($(this).val()).trigger("chosen:updated");
			$("#layer_resin32hide").val($(this).val());
			$("#layer_resin33hide").val($(this).val());
			$("#layer_resin34hide").val($(this).val());
			$("#layer_resin35hide").val($(this).val());
			$("#layer_resin36hide").val($(this).val());
		});
		...
		$(document).on('change', '#mid_mtl_veil3', function(){
			...
			$.ajax({
				...
				success: function(data){
					...
					$('#layer_veil3').val('');
					// $("#mid_mtl_resin31").html(data.option).trigger("chosen:updated");
				}
			});
		});
		...
		$(document).on('keyup', '#layer_veil3', function(){
			...
			Hasil3(tot_thickness2, layer_veil, layer2, layer3, layer4, top_diameter, top_length, top_thickness, waste);
		});
		...
		$(document).on('change', '#mid_mtl_veil_add3', function(){
			...
			$.ajax({
				...
				cache: false,
				type: "POST",
				data: "id_material="+$(this).val()+"&resin2="+$('#layer_resin32').val()+"&resinutama="+$('#mid_mtl_resin31').val(),
				dataType: "json",
				success: function(data){
					$('#weight_veil_add3').val(data.micron);
					$('#thickness_veil_add3').val(RoundUp4(data.thickness));
					$('#layer_veil_add3').val('');
					$("#mid_mtl_resin32").html(data.option).trigger("chosen:updated");
		...
		$(document).on('keyup', '#layer_veil_add3', function(){
			...
			Hasil3(tot_thickness2, layer1, layer_veil, layer3, layer4, top_diameter, top_length, top_thickness, waste);
		});
		...
		$(document).on('change', '#mid_mtl_matcsm3', function(){
			...
			$.ajax({
				...
				cache: false,
				type: "POST",
				data: "id_material="+$(this).val()+"&resin3="+$('#layer_resin33').val()+"&resinutama="+$('#mid_mtl_resin31').val(),
				dataType: "json",
				success: function(data){
					$('#weight_matcsm3').val(data.micron);
					$('#thickness_matcsm3').val(RoundUp4(data.thickness));
					$('#layer_matcsm3').val('');
					$("#mid_mtl_resin33").html(data.option).trigger("chosen:updated");
		...
		$(document).on('keyup', '#layer_matcsm3', function(){
			...
			Hasil3(tot_thickness2, layer1, layer2, layer_veil, layer4, top_diameter, top_length, top_thickness, waste);
		});
		...
		$(document).on('change', '#mid_mtl_csm_add3', function(){
			...
			$.ajax({
				...
				cache: false,
				type: "POST",
				data: "id_material="+$(this).val()+"&resin4="+$('#layer_resin34').val()+"&resinutama="+$('#mid_mtl_resin31').val(),
				dataType: "json",
				success: function(data){
					$('#weight_csm_add3').val(data.micron);
					$('#thickness_csm_add3').val(RoundUp4(data.thickness));
					$('#layer_csm_add3').val('');
					$("#mid_mtl_resin34").html(data.option).trigger("chosen:updated");
		...
		$(document).on('keyup', '#layer_csm_add3', function(){
			...
			Hasil3(tot_thickness2, layer1, layer2, layer3, layer_veil, top_diameter, top_length, top_thickness, waste);
		});  
		...
		$(document).on('click', '#simpan-bro', function(e){
			...
			var mid_mtl_resin1		= $('#mid_mtl_resin1').val();
			...
			var mid_mtl_resin21		= $('#mid_mtl_resin21').val();
			...
			var mid_mtl_resin31		= $('#mid_mtl_resin31').val();
			...
			//LINER THICKNESS
			// if(mid_mtl_realese == '' || mid_mtl_realese == null || mid_mtl_realese == 0){
				// swal({
				  // title	: "Error Message!",
				  // text	: 'Realise Agent Material [LINER THICKNESS] is Empty, please input first ...',
				  // type	: "warning"
				// });
				// $('#simpan-bro').prop('disabled',false);
				// return false;	
			...
			if(mid_mtl_resin1 == '' || mid_mtl_resin1 == null || mid_mtl_resin1 == 0){
				swal({
				  title	: "Error Message!",
			...
			if(mid_mtl_resin21 == '' || mid_mtl_resin21 == null || mid_mtl_resin21 == 0){
				swal({
				  title	: "Error Message!",
			...
			if(mid_mtl_resin31 == '' || mid_mtl_resin31 == null || mid_mtl_resin31 == 0){
				swal({
				  title	: "Error Message!",
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl		= base_url + active_controller +'/reduceteeslongsong';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
...
function Hasil(a, b, c, d, e, top_diameter, top_length, top_thickness, waste){
	var acuhan_1			= parseFloat($('#acuhan_1').val());
	...
	// var layer_additive		= parseFloat($('#layer_additive').val());
	// var persen_additive		= parseFloat($('#persen_additive').val());
	
	// if(top_diameter < 40){
		// var HasilRA	= ((3.14/1000)*(top_diameter+topEST)+0.04) * top_length * 1.2 * 0.000025 * 800 ;
	// }
	// else{
		// var HasilRA	= 0 ;
	// }
	...
	// var Luas_Area_Rumus		= 3.14*((top_diameter + top_thickness + 0.04)/1000)*(top_length/1000)*(1+waste);
	var Luas_Area_Rumus		= ((3.14/1000)*(top_diameter + top_thickness) + 0.04)*(top_length/1000)*(1+waste);
	...
	var HasilKatalis	= Katalis * persen_katalis * TotalResin;
	var HasilSm			= Sm * persen_sm * TotalResin;
	var HasilCoblat		= Coblat * persen_coblat * TotalResin;
	var HasilDma		= Dma * persen_dma * TotalResin;
	var HasilHydro		= Hyro * persen_hydroquinone * TotalResin;
	var HasilMethanol	= Methanol * persen_methanol * TotalResin;
	// var HasilAditive	= layer_additive * persen_additive * TotalResin;
	
	//TopCoat
	var ResinCoat		= $("#resin41").val();
	...
	var persen_wax4		= $("#persen_wax4").val();
	var persen_mch4		= $("#persen_mch4").val();
	// var persen_additive4 = $("#persen_additive4").val();
	...
	var HasilKatalis4	= Katalis4 * persen_katalis4 * HasilTopCoat;
	var HasilColor4		= Color4 * persen_color4 * HasilTopCoat;
	var HasilTinuvin4	= Tinuvin4 * persen_tin4 * HasilTopCoat;
	var HasilChlr4		= Chlr4 * persen_chl4 * HasilTopCoat;
	var HasilStery4		= Stery4 * persen_stery4 * HasilTopCoat;
	var HasilWax4		= Wax4 * persen_wax4 * HasilTopCoat;
	var HasilMetCh4		= MetCh4 * persen_mch4 * HasilTopCoat;
	// var HasilAddv42		= Addv4 * persen_additive4 * HasilTopCoat;
	...
	// $('#hasil_realise').val(HasilRA);
	// $('#total_realise').val(RoundUp(HasilRA));
	...
	// $('#hasil_additive').val(RoundUp4(HasilAditive));
	// $('#last_additive').val(RoundUp(HasilAditive));
	...
	// $('#layer_additive4').val(Addv4);
	// $('#hasil_additive4').val(RoundUp4(HasilAddv42));
	// $('#last_additive4').val(RoundUp(HasilAddv42));
	//Sampai Sini
}

function Hasil2(a, b, c, d, e, f, g, top_diameter, top_length, top_thickness, waste){
	...
	// var layer_additive2		= parseFloat($('#layer_additive2').val());
	// var persen_additive2	= parseFloat($('#persen_additive2').val());
	...
	var HasilKatalis2	= Katalis2 * persen_katalis2 * TotalResin2;
	var HasilSm2		= Sm2 * persen_sm2 * TotalResin2;
	var HasilCoblat2	= Coblat2 * persen_coblat2 * TotalResin2;
	var HasilDma2		= Dma2 * persen_dma2 * TotalResin2;
	var HasilHydro2		= Hyro2 * persen_hydroquinone2 * TotalResin2;
	var HasilMethanol2	= Methanol2 * persen_methanol2 * TotalResin2;
	// var HasilAditive2	= layer_additive2 * persen_additive2 * TotalResin2;
	...
	// $('#hasil_additive2').val(RoundUp4(HasilAditive2));
	// $('#last_additive2').val(RoundUp(HasilAditive2));
...
function Hasil3(a, b, c, d, e, top_diameter, top_length, top_thickness, waste){
	...
	var HasilKatalis3	= Katalis3 * persen_katalis3 * TotalResin3;
	var HasilSm3		= Sm3 * persen_sm3 * TotalResin3;
	var HasilCoblat3	= Coblat3 * persen_coblat3 * TotalResin3;
	var HasilDma3		= Dma3 * persen_dma3 * TotalResin3;
	var HasilHydro3		= Hyro3 * persen_hydroquinone3 * TotalResin3;
	var HasilMethanol3	= Methanol3 * persen_methanol3 * TotalResin3;
...
function AcuhanMaxMin(liner, struktur, external, MinToleransi, MaxToleransi, totThickness1, totThickness2, totThickness3){
	...
	// alert(min_str_thickness);
	// alert(max_str_thickness);
	
	// console.log(MinToleransi);
	// console.log(parseFloat(MinToleransi));
	// console.log(liner);
	// console.log(max_lin_thickness);
