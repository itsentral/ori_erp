	...
	<div class="box box-primary">
		...
		<div class="box-body">
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-6'>              
					...
					<select name='top_typeList' id='top_typeList' class='form-control input-sm'>
						<option value='0'>Select An End Cap Type</option>
					<?php
				...
				<label class='label-control col-sm-2'><b>Thickness End Cap (EST)<span class='text-red'>*</span></b></label>
				<div class='col-sm-2'>              
					<?php
			...
			<div class='form-group row'>		 	 
				...
				<label class='label-control col-sm-2'><b>Radius<span class='text-red'>*</span></b></label>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'radius','name'=>'radius','class'=>'form-control input-sm','autocomplete'=>'off','placeholder'=>'Radius', 'readonly'=>'readonly'));											
					?>	
				</div>
			</div>
			<div class='form-group row'>		 	 
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-2'>              
					<?php
						echo form_input(array('type'=>'text','id'=>'waste','name'=>'waste','class'=>'form-control input-sm numberOnly','placeholder'=>'Waste','value'=>'0.1'));
				...
				<label class='label-control col-sm-2'><b>Thickness End Cap (design)<span class='text-red'>*</span></b></label>
				<div class='col-sm-2'>              
					<?php
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl		= base_url + active_controller +'/endcap';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
...
function Hasil(a, b, c, d, e, top_diameter, top_length, top_thickness, waste){
	...
	// var Luas_Area_Rumus		= ((3.14/1000)*(top_diameter + topEST) + 0.04)*(top_length/1000)*(1+waste);
