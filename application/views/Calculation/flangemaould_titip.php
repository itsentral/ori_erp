	...
	<div class="box box-success">
		...
		<div class="box-body">
			<div class='form-group row'>		 	 
				...
				<label class='label-control col-sm-2'><b>Thickness (Est)</b></label>
				<div class='col-sm-2'>              
					<?php
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-6'>              
					...
					<select name='top_typeList' id='top_typeList' class='form-control input-sm'>
						<option value='0'>Select An Flange Mould</option>
					<?php
			...
			<div class='form-group row'>		 	 
				...
				<label class='label-control col-sm-2'><b>Diameter /mm</b></label>
				<div class='col-sm-2'>              
					<?php
					//data-decimal="." data-thousand="" data-prefix="" data-precision="0" data-allow-zero="true"
						...
						echo form_input(array('id'=>'top_diameter','name'=>'top_diameter','class'=>'form-control input-sm numberOnly','autocomplete'=>'off','placeholder'=>'Pipe Diameter', 'value'=>'','readonly'=>'readonly'));											
			...
			<div class='form-group row'>		 	 
				...
				<label class='label-control col-sm-2'><b>Angle<span class='text-red'>*</span></b></label>
				<div class='col-sm-2'>              
					<?php
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-2'>              
					<?php
						...
						echo form_input(array('type'=>'text','id'=>'area','name'=>'area', 'value'=>'0', 'class'=>'HideCost'));
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-2'>              
					<?php
						echo form_input(array('id'=>'panjang_neck_2','name'=>'panjang_neck_2','class'=>'form-control input-sm numberOnly','autocomplete'=>'off','placeholder'=>'Length 2','readonly'=>'readonly'));											
			...
			<div class='form-group row'>		 	 
				<div class='col-sm-12'>              
					...
					<input type='text' name='detail_name2_neck1' id='detail_name2_neck1' class='HideCost' value='STRUKTUR THICKNESS NECK 1'>
				</div>
			</div>
			<div class='form-group row'>		 	 
				<label class='label-control col-sm-2' style='text-align:left;'><b>MAT / CSM<span class='text-red'>*</span></b></label>
				...
				<div class='col-sm-3'>              
					...
					<input type='text' name='ListDetail2_neck1[0][last_full]' class='HideCost' id='hasil_matcsm2_neck1' value='0'>	
				</div>
				<label class='col-sm-2' style='text-align:left; margin-top: 6px;'>Weight</label>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'weight_matcsm2_neck1','name'=>'ListDetail2_neck1[0][value]', 'style'=>'margin-left:-110px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1' style='text-align:left; margin-left:-130px; margin-top: 6px;'>Layer</label>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'layer_matcsm2_neck1','name'=>'ListDetail2_neck1[0][layer]', 'style'=>'margin-left:-90px;width: 50px;','class'=>'form-control input-sm numberOnly','autocomplete'=>'off', 'value'=>''));											
					?>	
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -130px; margin-top: 6px;'>Thickness</label>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'totthick_matcsm2_neck1','name'=>'ListDetail2_neck1[0][total_thickness]', 'style'=>'margin-left:-90px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly','value'=>'0'));											
					?>	
				</div>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_matcsm2_neck1','name'=>'ListDetail2_neck1[0][last_cost]', 'style'=>'margin-left:-80px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly','value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-100px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-3'>              
					...
					<!--<input type='text' name='ListDetail2_neck1[1][containing]' class='HideCost' id='layer_resin21_neck1' value='2.333'>-->
				</div>
				<label class='col-sm-2' style='text-align:left; margin-top: 6px;'><u>Rs.Containing</u></label>
				<div class='col-sm-1'>              
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'layer_resin21_neck1','name'=>'ListDetail2_neck1[1][containing]', 'style'=>'margin-left:-90px;width: 50px;','class'=>'form-control input-sm numberOnly','autocomplete'=>'off', 'readonly'=>'readonly', 'value'=>'0'));	//2.333										
					?>
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -130px; margin-top: 6px;'></label>
				<div class='col-sm-1'>              
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_resin21_neck1','name'=>'ListDetail2_neck1[1][last_cost]', 'style'=>'margin-left:-80px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-100px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'weight_csm_add2_neck1','name'=>'ListDetail2_neck1[2][value]', 'style'=>'margin-left:-110px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1' style='text-align:left; margin-left:-130px; margin-top: 6px;'>Layer</label>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'layer_csm_add2_neck1','name'=>'ListDetail2_neck1[2][layer]', 'style'=>'margin-left:-90px;width: 50px;','class'=>'form-control input-sm numberOnly','autocomplete'=>'off', 'value'=>''));											
					?>	
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -130px; margin-top: 6px;'>Thickness</label>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'totthick_csm_add2_neck1','name'=>'ListDetail2_neck1[2][total_thickness]', 'style'=>'margin-left:-90px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly','value'=>'0'));											
					?>	
				</div>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_csm_add2_neck1','name'=>'ListDetail2_neck1[2][last_cost]', 'style'=>'margin-left:-80px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly','value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-100px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-3'>              
					...
					<!--<input type='text' name='ListDetail2_neck1[3][containing]' class='HideCost' id='layer_resin22' value='2.333'>-->
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'layer_resin22_neck1','name'=>'ListDetail2_neck1[3][containing]', 'style'=>'margin-left:-90px;width: 50px;','class'=>'form-control input-sm numberOnly','autocomplete'=>'off', 'readonly'=>'readonly', 'value'=>'0'));	//2,333										
					?>
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -130px; margin-top: 6px;'></label>
				<div class='col-sm-1'>              
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_resin22_neck1','name'=>'ListDetail2_neck1[3][last_cost]', 'style'=>'margin-left:-80px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-100px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'weight_wr2_neck1','name'=>'ListDetail2_neck1[4][value]', 'style'=>'margin-left:-110px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1' style='text-align:left; margin-left:-130px; margin-top: 6px;'>Layer</label>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'layer_wr2_neck1','name'=>'ListDetail2_neck1[4][layer]', 'style'=>'margin-left:-90px;width: 50px;','class'=>'form-control input-sm numberOnly','autocomplete'=>'off', 'value'=>''));											
					?>	
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -130px; margin-top: 6px;'>Thickness</label>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'totthick_wr2_neck1','name'=>'ListDetail2_neck1[4][total_thickness]', 'style'=>'margin-left:-90px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly','value'=>'0'));											
					?>	
				</div>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_wr2_neck1','name'=>'ListDetail2_neck1[4][last_cost]', 'style'=>'margin-left:-80px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly','value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-100px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-3'>              
					...
					<!--<input type='text' name='ListDetail2_neck1[5][containing]' class='HideCost' id='layer_resin23_neck1' value='1'>-->
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'layer_resin23_neck1','name'=>'ListDetail2_neck1[5][containing]', 'style'=>'margin-left:-90px;width: 50px;','class'=>'form-control input-sm numberOnly','autocomplete'=>'off', 'readonly'=>'readonly','value'=>'0'));		//1									
					?>
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -130px; margin-top: 6px;'></label>
				<div class='col-sm-1'>              
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_resin23_neck1','name'=>'ListDetail2_neck1[5][last_cost]', 'style'=>'margin-left:-80px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-100px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'weight_wr_add2_neck1','name'=>'ListDetail2_neck1[6][value]', 'style'=>'margin-left:-110px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1' style='text-align:left; margin-left:-130px; margin-top: 6px;'>Layer</label>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'layer_wr_add2_neck1','name'=>'ListDetail2_neck1[6][layer]', 'style'=>'margin-left:-90px;width: 50px;','class'=>'form-control input-sm numberOnly','autocomplete'=>'off', 'value'=>''));											
					?>	
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -130px; margin-top: 6px;'>Thickness</label>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'totthick_wr_add2_neck1','name'=>'ListDetail2_neck1[6][total_thickness]', 'style'=>'margin-left:-90px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_wr_add2_neck1','name'=>'ListDetail2_neck1[6][last_cost]', 'style'=>'margin-left:-80px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-100px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-3'>              
					...
					<!--<input type='text' name='ListDetail2_neck1[7][containing]' class='HideCost' id='layer_resin24_neck1' value='1'>-->
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'layer_resin24_neck1','name'=>'ListDetail2_neck1[7][containing]', 'style'=>'margin-left:-90px;width: 50px;','class'=>'form-control input-sm numberOnly','autocomplete'=>'off', 'readonly'=>'readonly', 'value'=>'0'));		//1									
					?>
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -130px; margin-top: 6px;'></label>
				<div class='col-sm-1'>              
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_resin24_neck1','name'=>'ListDetail2_neck1[7][last_cost]', 'style'=>'margin-left:-80px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-100px; margin-top: 6px;'>Kg</label>
			</div>
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'weight_rooving21_neck1','name'=>'ListDetail2_neck1[8][value]', 'style'=>'margin-left:-110px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1' style='text-align:left; margin-left:-130px; margin-top: 6px;'>Layer</label>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'layer_rooving21_neck1','name'=>'ListDetail2_neck1[8][layer]', 'style'=>'margin-left:-90px;width: 50px;','class'=>'form-control input-sm numberOnly','autocomplete'=>'off', 'value'=>''));											
					?>	
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -130px; margin-top: 6px;'>Thickness</label>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'totthick_rooving21_neck1','name'=>'ListDetail2_neck1[8][total_thickness]', 'style'=>'margin-left:-90px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_rooving21_neck1','name'=>'ListDetail2_neck1[8][last_cost]', 'style'=>'margin-left:-80px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-100px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-3'>              
					...
					<!--<input type='text' name='ListDetail2_neck1[9][containing]' class='HideCost' id='layer_resin25_neck1' value='0.429'>-->
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'layer_resin25_neck1','name'=>'ListDetail2_neck1[9][containing]', 'style'=>'margin-left:-90px;width: 50px;','class'=>'form-control input-sm numberOnly','autocomplete'=>'off', 'readonly'=>'readonly', 'value'=>'0'));											
					?>
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -130px; margin-top: 6px;'></label>
				<div class='col-sm-1'>              
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_resin25_neck1','name'=>'ListDetail2_neck1[9][last_cost]', 'style'=>'margin-left:-80px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-100px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'weight_rooving22_neck1','name'=>'ListDetail2_neck1[10][value]', 'style'=>'margin-left:-110px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1' style='text-align:left; margin-left:-130px; margin-top: 6px;'>Layer</label>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'layer_rooving22_neck1','name'=>'ListDetail2_neck1[10][layer]', 'style'=>'margin-left:-90px;width: 50px;','class'=>'form-control input-sm numberOnly','autocomplete'=>'off', 'value'=>''));											
					?>	
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -130px; margin-top: 6px;'>Thickness</label>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'totthick_rooving22_neck1','name'=>'ListDetail2_neck1[10][total_thickness]', 'style'=>'margin-left:-90px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_rooving22_neck1','name'=>'ListDetail2_neck1[10][last_cost]', 'style'=>'margin-left:-80px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-100px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-3'>              
					...
					<!--<input type='text' name='ListDetail2_neck1[11][containing]' class='HideCost' id='layer_resin26_neck1' value='0.429'>-->
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'layer_resin26_neck1','name'=>'ListDetail2_neck1[11][containing]', 'style'=>'margin-left:-90px;width: 50px;','class'=>'form-control input-sm numberOnly','autocomplete'=>'off', 'readonly'=>'readonly', 'value'=>'0'));											
					?>
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -130px; margin-top: 6px;'></label>
				<div class='col-sm-1'>              
				...
				<div class='col-sm-1'>               
					<?php
						echo form_input(array('id'=>'last_resin26_neck1','name'=>'ListDetail2_neck1[11][last_cost]', 'style'=>'margin-left:-80px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-100px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-3'>              
					...
					<!--<input type='text' name='ListDetail2_neck1[12][id_material]' class='HideCost' id='layer_resin27hide_neck1'>-->
				</div>
				<label class='col-sm-2' style='text-align:left; margin-top: 6px;'></label>
				<div class='col-sm-1'>              
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_resin_tot2_neck1','name'=>'ListDetail2_neck1[12][last_cost]', 'style'=>'margin-left:-80px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-100px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>
				...
				<div class='col-sm-3'>              
					...
					<!--
					<input type='text' name='ListDetailPlus2_neck1[0][containing]' class='HideCost' id='layer_katalis2_neck1' value='0'>
					<input type='text' name='ListDetailPlus2_neck1[0][perse]' class='HideCost' id='persen_katalis2_neck1' value='0.025'>
					--> 
				</div>
				
				<label class='col-sm-1' style='text-align:left; margin-left: 0px; margin-top: 6px;'>Comparison</label>
				<div class='col-sm-2'>              
					<input type='text' name='ListDetailPlus2_neck1[0][containing]' style='width:50px; margin-left:12px;' class='form-control input-sm numberOnly' readonly='readonly' id='layer_katalis2_neck1' value='0'>	
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -129px; margin-top: 6px;'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus2_neck1[0][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_katalis2_neck1' value='2'>	
				</div>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_katalis2_neck1','name'=>'ListDetailPlus2_neck1[0][last_cost]', 'style'=>'margin-left:-81px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-101px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>
				...
				<div class='col-sm-3'>              
					...
					<!--
					<input type='text' name='ListDetailPlus2_neck1[1][containing]' class='HideCost' id='layer_sm2_neck1' value='0'>
					<input type='text' name='ListDetailPlus2_neck1[1][perse]' class='HideCost' id='persen_sm2_neck1' value='0.025'>
					-->					
				</div>
				
				<label class='col-sm-1' style='text-align:left; margin-left: 0px; margin-top: 6px;'>Comparison</label>
				<div class='col-sm-2'>              
					<input type='text' name='ListDetailPlus2_neck1[1][containing]' style='width:50px; margin-left:12px;' class='form-control input-sm numberOnly' readonly='readonly' id='layer_sm2_neck1' value='0'>	
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -129px; margin-top: 6px;'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus2_neck1[1][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_sm2_neck1' value='2.5'>	
				</div>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_sm2_neck1','name'=>'ListDetailPlus2_neck1[1][last_cost]', 'style'=>'margin-left:-81px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-101px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>
				...
				<div class='col-sm-3'>              
					...
					<!--
					<input type='text' name='ListDetailPlus2_neck1[2][containing]' class='HideCost' id='layer_coblat2_neck1' value='0'>
					<input type='text' name='ListDetailPlus2_neck1[2][perse]' class='HideCost' id='persen_coblat2_neck1' value='0.002'>
					-->
				</div>
				
				<label class='col-sm-1' style='text-align:left; margin-left: 0px; margin-top: 6px;'>Comparison</label>
				<div class='col-sm-2'>              
					<input type='text' name='ListDetailPlus2_neck1[2][containing]' style='width:50px; margin-left:12px;' class='form-control input-sm numberOnly' readonly='readonly' id='layer_coblat2_neck1' value='0'>	
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -129px; margin-top: 6px;'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus2_neck1[2][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_coblat2_neck1' value='0.2'>	
				</div>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_cobalt2_neck1','name'=>'ListDetailPlus2_neck1[2][last_cost]', 'style'=>'margin-left:-81px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-101px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>
				...
				<div class='col-sm-3'>              
					...
					<!--
					<input type='text' name='ListDetailPlus2_neck1[3][containing]' class='HideCost' id='layer_dma2_neck1' value='0'>
					<input type='text' name='ListDetailPlus2_neck1[3][perse]' class='HideCost' id='persen_dma2_neck1' value='0.002'>
					-->					
				</div>
				
				<label class='col-sm-1' style='text-align:left; margin-left: 0px; margin-top: 6px;'>Comparison</label>
				<div class='col-sm-2'>              
					<input type='text' name='ListDetailPlus2_neck1[3][containing]' style='width:50px; margin-left:12px;' class='form-control input-sm numberOnly' readonly='readonly' id='layer_dma2_neck1' value='0'>	
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -129px; margin-top: 6px;'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus2_neck1[3][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_dma2_neck1' value='0.2'>	
				</div>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_dma2_neck1','name'=>'ListDetailPlus2_neck1[3][last_cost]', 'style'=>'margin-left:-81px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-101px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>
				...
				<div class='col-sm-3'>              
					...
					<!--
					<input type='text' name='ListDetailPlus2_neck1[4][containing]' class='HideCost' id='layer_hydroquinone2_neck1' value='0'>
					<input type='text' name='ListDetailPlus2_neck1[4][perse]' class='HideCost' id='persen_hydroquinone2_neck1' value='0.002'>
					-->
				</div>
				
				<label class='col-sm-1' style='text-align:left; margin-left: 0px; margin-top: 6px;'>Comparison</label>
				<div class='col-sm-2'>              
					<input type='text' name='ListDetailPlus2_neck1[4][containing]' style='width:50px; margin-left:12px;' class='form-control input-sm numberOnly' readonly='readonly' id='layer_hydroquinone2_neck1' value='0'>	
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -129px; margin-top: 6px;'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus2_neck1[4][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_hydroquinone2_neck1' value='0.2'>	
				</div>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_hidro2_neck1','name'=>'ListDetailPlus2_neck1[4][last_cost]', 'style'=>'margin-left:-81px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-101px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>
				...
				<div class='col-sm-3'>              
					...
					<!--
					<input type='text' name='ListDetailPlus2_neck1[5][containing]' class='HideCost' id='layer_methanol2_neck1' value='0'>
					<input type='text' name='ListDetailPlus2_neck1[5][perse]' class='HideCost' id='persen_methanol2_neck1' value='0.002'>
					-->
				</div>
				
				<label class='col-sm-1' style='text-align:left; margin-left: 0px; margin-top: 6px;'>Comparison</label>
				<div class='col-sm-2'>              
					<input type='text' name='ListDetailPlus2_neck1[5][containing]' style='width:50px; margin-left:12px;' class='form-control input-sm numberOnly' readonly='readonly' id='layer_methanol2_neck1' value='0'>	
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -129px; margin-top: 6px;'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus2_neck1[5][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_methanol2_neck1' value='0.2'>	
				</div>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_methanol2_neck1','name'=>'ListDetailPlus2_neck1[5][last_cost]', 'style'=>'margin-left:-81px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-101px; margin-top: 6px;'>Kg</label>
			</div>
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'tot_lin_thickness2_neck1','name'=>'tot_lin_thickness2_neck1', 'style'=>'margin-left:-50px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<div class='col-sm-1'>              
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'mix_lin_thickness2_neck1','name'=>'mix_lin_thickness2_neck1', 'style'=>'margin-left:-50px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<div class='col-sm-1'>              
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'max_lin_thickness2_neck1','name'=>'max_lin_thickness2_neck1', 'style'=>'margin-left:-50px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<div class='col-sm-1'>              
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-2'>              
					<?php
						echo form_input(array('id'=>'hasil_linier_thickness2_neck1','name'=>'hasil_linier_thickness2_neck1', 'style'=>'margin-left:-50px; height: 40px;','class'=>'form-control input-sm HasilKet','autocomplete'=>'off','readonly'=>'readonly'));											
					?>	
				</div>
			...
			<div class='form-group row'>		 	 
				<div class='col-sm-12'>
					...
					<input type='text' name='detail_name2_neck2' id='detail_name2_neck1' class='HideCost' value='STRUKTUR THICKNESS NECK 2'>
				</div>
			</div>
			<div class='form-group row'>		 	 
				<label class='label-control col-sm-2' style='text-align:left;'><b>MAT / CSM<span class='text-red'>*</span></b></label>
				...
				<div class='col-sm-3'>              
					<select name='ListDetail2_neck2[0][id_material]' id='mid_mtl_matcsm2_neck1' class='form-control input-sm'>
						<option value=''>Select An MAT/CSM</option>
					<?php
						foreach($ListMatCsm AS $val => $valx){
							echo "<option value='".$valx['id_material']."'>".strtoupper($valx['nm_material'])."</option>";
					...
					<input type='text' name='ListDetail2_neck2[0][thickness]' class='HideCost' id='thickness_matcsm2_neck1' value='0'>
					<input type='text' name='ListDetail2_neck2[0][last_full]' class='HideCost' id='hasil_matcsm2_neck1' value='0'>	
				</div>
				<label class='col-sm-2' style='text-align:left; margin-top: 6px;'>Weight</label>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'weight_matcsm2_neck1','name'=>'ListDetail2_neck2[0][value]', 'style'=>'margin-left:-110px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1' style='text-align:left; margin-left:-130px; margin-top: 6px;'>Layer</label>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'layer_matcsm2_neck1','name'=>'ListDetail2_neck2[0][layer]', 'style'=>'margin-left:-90px;width: 50px;','class'=>'form-control input-sm numberOnly','autocomplete'=>'off', 'value'=>''));											
					?>	
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -130px; margin-top: 6px;'>Thickness</label>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'totthick_matcsm2_neck1','name'=>'ListDetail2_neck2[0][total_thickness]', 'style'=>'margin-left:-90px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly','value'=>'0'));											
					?>	
				</div>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_matcsm2_neck1','name'=>'ListDetail2_neck2[0][last_cost]', 'style'=>'margin-left:-80px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly','value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-100px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-3'>              
					...
					<input type='text' name='ListDetail2_neck2[1][last_full]' class='HideCost' id='hasil_resin21_neck1' value='0'>
					<input type='text' name='ListDetail2_neck2[1][id_material]' class='HideCost' id='layer_resin21hide_neck1'>	
					<!--<input type='text' name='ListDetail2_neck2[1][containing]' class='HideCost' id='layer_resin21_neck1' value='2.333'>-->
				</div>
				<label class='col-sm-2' style='text-align:left; margin-top: 6px;'><u>Rs.Containing</u></label>
				<div class='col-sm-1'>              
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'layer_resin21_neck1','name'=>'ListDetail2_neck2[1][containing]', 'style'=>'margin-left:-90px;width: 50px;','class'=>'form-control input-sm numberOnly','autocomplete'=>'off', 'readonly'=>'readonly', 'value'=>'0'));	//2.333										
					?>
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -130px; margin-top: 6px;'></label>
				<div class='col-sm-1'>              
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_resin21_neck1','name'=>'ListDetail2_neck2[1][last_cost]', 'style'=>'margin-left:-80px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-100px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>		 	 
				<label class='label-control col-sm-2' style='text-align:left;'><b>ADDITIONAL CSM<span class='text-red'>*</span></b></label>
				<div class='col-sm-3'>              
					<select name='ListDetail2_neck2[2][id_material]' id='mid_mtl_csm_add2_neck1' class='form-control input-sm'>
					<option value=''>Select An MAT/CSM</option> 
					<?php
						foreach($ListMatCsm AS $val => $valx){
							echo "<option value='".$valx['id_material']."'>".strtoupper($valx['nm_material'])."</option>";
					...
					<input type='text' name='ListDetail2_neck2[2][thickness]' class='HideCost' id='thickness_csm_add2_neck1' value='0'>
					<input type='text' name='ListDetail2_neck2[2][last_full]' class='HideCost' id='hasil_csm_add2_neck1' value='0'>	
				</div>
				<label class='col-sm-2' style='text-align:left; margin-top: 6px;'>Weight</label>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'weight_csm_add2_neck1','name'=>'ListDetail2_neck2[2][value]', 'style'=>'margin-left:-110px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1' style='text-align:left; margin-left:-130px; margin-top: 6px;'>Layer</label>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'layer_csm_add2_neck1','name'=>'ListDetail2_neck2[2][layer]', 'style'=>'margin-left:-90px;width: 50px;','class'=>'form-control input-sm numberOnly','autocomplete'=>'off', 'value'=>''));											
					?>	
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -130px; margin-top: 6px;'>Thickness</label>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'totthick_csm_add2_neck1','name'=>'ListDetail2_neck2[2][total_thickness]', 'style'=>'margin-left:-90px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly','value'=>'0'));											
					?>	
				</div>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_csm_add2_neck1','name'=>'ListDetail2_neck2[2][last_cost]', 'style'=>'margin-left:-80px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly','value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-100px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-3'>              
					...
					<input type='text' name='ListDetail2_neck2[3][last_full]' class='HideCost' id='hasil_resin22_neck1' value='0'>
					<!--<input type='text' name='ListDetail2_neck2[3][containing]' class='HideCost' id='layer_resin22' value='2.333'>-->
					<input type='text' name='ListDetail2_neck2[3][id_material]' class='HideCost' id='layer_resin22hide_neck1'>					
				</div>
				<label class='col-sm-2' style='text-align:left; margin-top: 6px;'><u>Rs.Containing</u></label>
				<div class='col-sm-1'>              
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'layer_resin22_neck1','name'=>'ListDetail2_neck2[3][containing]', 'style'=>'margin-left:-90px;width: 50px;','class'=>'form-control input-sm numberOnly','autocomplete'=>'off', 'readonly'=>'readonly', 'value'=>'0'));	//2,333										
					?>
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -130px; margin-top: 6px;'></label>
				<div class='col-sm-1'>              
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_resin22_neck1','name'=>'ListDetail2_neck2[3][last_cost]', 'style'=>'margin-left:-80px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-100px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>		 	 
				<label class='label-control col-sm-2' style='text-align:left;'><b>WR<span class='text-red'>*</span></b></label>
				<div class='col-sm-3'>              
					<select name='ListDetail2_neck2[4][id_material]' id='mid_mtl_wr2_neck1' class='form-control input-sm'>
						<option value=''>Select An WR</option>
					<?php
						foreach($ListMatWR AS $val => $valx){
							echo "<option value='".$valx['id_material']."'>".strtoupper($valx['nm_material'])."</option>";
					...
					<input type='text' name='ListDetail2_neck2[4][thickness]' class='HideCost' id='thickness_wr2_neck1' value='0'>
					<input type='text' name='ListDetail2_neck2[4][last_full]' class='HideCost' id='hasil_wr2_neck1' value='0'>				
				</div>
				<label class='col-sm-2' style='text-align:left; margin-top: 6px;'>Weight</label>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'weight_wr2_neck1','name'=>'ListDetail2_neck2[4][value]', 'style'=>'margin-left:-110px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1' style='text-align:left; margin-left:-130px; margin-top: 6px;'>Layer</label>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'layer_wr2_neck1','name'=>'ListDetail2_neck2[4][layer]', 'style'=>'margin-left:-90px;width: 50px;','class'=>'form-control input-sm numberOnly','autocomplete'=>'off', 'value'=>''));											
					?>	
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -130px; margin-top: 6px;'>Thickness</label>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'totthick_wr2_neck1','name'=>'ListDetail2_neck2[4][total_thickness]', 'style'=>'margin-left:-90px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly','value'=>'0'));											
					?>	
				</div>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_wr2_neck1','name'=>'ListDetail2_neck2[4][last_cost]', 'style'=>'margin-left:-80px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly','value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-100px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-3'>              
					...
					<input type='text' name='ListDetail2_neck2[5][last_full]' class='HideCost' id='hasil_resin23_neck1' value='0'>
					<!--<input type='text' name='ListDetail2_neck2[5][containing]' class='HideCost' id='layer_resin23_neck1' value='1'>-->
					<input type='text' name='ListDetail2_neck2[5][id_material]' class='HideCost' id='layer_resin23hide_neck1'>
				</div>
				<label class='col-sm-2' style='text-align:left; margin-top: 6px;'><u>Rs.Containing</u></label>
				<div class='col-sm-1'>              
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'layer_resin23_neck1','name'=>'ListDetail2_neck2[5][containing]', 'style'=>'margin-left:-90px;width: 50px;','class'=>'form-control input-sm numberOnly','autocomplete'=>'off', 'readonly'=>'readonly','value'=>'0'));		//1									
					?>
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -130px; margin-top: 6px;'></label>
				<div class='col-sm-1'>              
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_resin23_neck1','name'=>'ListDetail2_neck2[5][last_cost]', 'style'=>'margin-left:-80px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-100px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>		 	 
				<label class='label-control col-sm-2' style='text-align:left;'><b>ADDITIONAL WR<span class='text-red'>*</span></b></label>
				<div class='col-sm-3'>              
					<select name='ListDetail2_neck2[6][id_material]' id='mid_mtl_wr_add2_neck1' class='form-control input-sm'>
						<option value=''>Select An WR Add</option>
					<?php
						foreach($ListMatWR AS $val => $valx){
							echo "<option value='".$valx['id_material']."'>".strtoupper($valx['nm_material'])."</option>";
					...
					<input type='text' name='ListDetail2_neck2[6][thickness]' class='HideCost' id='thickness_wr_add2_neck1' value='0'>
					<input type='text' name='ListDetail2_neck2[6][last_full]' class='HideCost' id='hasil_wr_add2_neck1' value='0'>	
				</div>
				<label class='col-sm-2' style='text-align:left; margin-top: 6px;'>Weight</label>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'weight_wr_add2_neck1','name'=>'ListDetail2_neck2[6][value]', 'style'=>'margin-left:-110px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1' style='text-align:left; margin-left:-130px; margin-top: 6px;'>Layer</label>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'layer_wr_add2_neck1','name'=>'ListDetail2_neck2[6][layer]', 'style'=>'margin-left:-90px;width: 50px;','class'=>'form-control input-sm numberOnly','autocomplete'=>'off', 'value'=>''));											
					?>	
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -130px; margin-top: 6px;'>Thickness</label>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'totthick_wr_add2_neck1','name'=>'ListDetail2_neck2[6][total_thickness]', 'style'=>'margin-left:-90px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_wr_add2_neck1','name'=>'ListDetail2_neck2[6][last_cost]', 'style'=>'margin-left:-80px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-100px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-3'>              
					...
					<input type='text' name='ListDetail2_neck2[7][last_full]' class='HideCost' id='hasil_resin24_neck1' value='0'>
					<!--<input type='text' name='ListDetail2_neck2[7][containing]' class='HideCost' id='layer_resin24_neck1' value='1'>-->
					<input type='text' name='ListDetail2_neck2[7][id_material]' class='HideCost' id='layer_resin24hide_neck1'>
				</div>
				<label class='col-sm-2' style='text-align:left; margin-top: 6px;'><u>Rs.Containing</u></label>
				<div class='col-sm-1'>              
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'layer_resin24_neck1','name'=>'ListDetail2_neck2[7][containing]', 'style'=>'margin-left:-90px;width: 50px;','class'=>'form-control input-sm numberOnly','autocomplete'=>'off', 'readonly'=>'readonly', 'value'=>'0'));		//1									
					?>
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -130px; margin-top: 6px;'></label>
				<div class='col-sm-1'>              
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_resin24_neck1','name'=>'ListDetail2_neck2[7][last_cost]', 'style'=>'margin-left:-80px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-100px; margin-top: 6px;'>Kg</label>
			</div>
			...
			<div class='form-group row'>		 	 
				<label class='label-control col-sm-2' style='text-align:left;'><b>ROOVING<span class='text-red'>*</span></b></label>
				<div class='col-sm-3'>              
					<select name='ListDetail2_neck2[8][id_material]' id='mid_mtl_rooving21_neck1' class='form-control input-sm'>
						<option value=''>Select An Rooving</option>
					<?php
						foreach($ListMatRooving AS $val => $valx){
							echo "<option value='".$valx['id_material']."'>".strtoupper($valx['nm_material'])."</option>";
					...
					<input type='text' name='ListDetail2_neck2[8][thickness]' class='HideCost' id='thickness_rooving21_neck1' value='0'>
					<input type='text' name='ListDetail2_neck2[8][last_full]' class='HideCost' id='hasil_rooving21_neck1' value='0'>
					<input type='text' name='ListDetail2_neck2[8][fak_pengali]' class='HideCost' id='penggali_rooving21_neck1' value='100'>
					<input type='text' name='ListDetail2_neck2[8][bw]' class='HideCost' id='bw_rooving21_neck1' value='0'>	
					<input type='text' name='ListDetail2_neck2[8][jumlah]' class='HideCost' id='jumlah_rooving21_neck1' value='0'>	
				</div>
				<label class='col-sm-2' style='text-align:left; margin-top: 6px;'>Weight</label>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'weight_rooving21_neck1','name'=>'ListDetail2_neck2[8][value]', 'style'=>'margin-left:-110px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1' style='text-align:left; margin-left:-130px; margin-top: 6px;'>Layer</label>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'layer_rooving21_neck1','name'=>'ListDetail2_neck2[8][layer]', 'style'=>'margin-left:-90px;width: 50px;','class'=>'form-control input-sm numberOnly','autocomplete'=>'off', 'value'=>''));											
					?>	
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -130px; margin-top: 6px;'>Thickness</label>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'totthick_rooving21_neck1','name'=>'ListDetail2_neck2[8][total_thickness]', 'style'=>'margin-left:-90px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_rooving21_neck1','name'=>'ListDetail2_neck2[8][last_cost]', 'style'=>'margin-left:-80px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-100px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-3'>              
					...
					<input type='text' name='ListDetail2_neck2[9][last_full]' class='HideCost' id='hasil_resin25_neck1' value='0'>
					<!--<input type='text' name='ListDetail2_neck2[9][containing]' class='HideCost' id='layer_resin25_neck1' value='0.429'>-->
					<input type='text' name='ListDetail2_neck2[9][id_material]' class='HideCost' id='layer_resin25hide_neck1'>
				</div>
				<label class='col-sm-2' style='text-align:left; margin-top: 6px;'><u>Rs.Containing</u></label>
				<div class='col-sm-1'>              
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'layer_resin25_neck1','name'=>'ListDetail2_neck2[9][containing]', 'style'=>'margin-left:-90px;width: 50px;','class'=>'form-control input-sm numberOnly','autocomplete'=>'off', 'readonly'=>'readonly', 'value'=>'0'));											
					?>
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -130px; margin-top: 6px;'></label>
				<div class='col-sm-1'>              
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_resin25_neck1','name'=>'ListDetail2_neck2[9][last_cost]', 'style'=>'margin-left:-80px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-100px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>		 	 
				<label class='label-control col-sm-2' style='text-align:left;'><b>ADDITIONAL ROOVING<span class='text-red'>*</span></b></label>
				<div class='col-sm-3'>              
					<select name='ListDetail2_neck2[10][id_material]' id='mid_mtl_rooving22_neck1' class='form-control input-sm'>
						<option value=''>Select An Rooving</option>
					<?php
						foreach($ListMatRooving AS $val => $valx){
							echo "<option value='".$valx['id_material']."'>".strtoupper($valx['nm_material'])."</option>";
					...
					<input type='text' name='ListDetail2_neck2[10][thickness]' class='HideCost' id='thickness_rooving22_neck1' value='0'>
					<input type='text' name='ListDetail2_neck2[10][last_full]' class='HideCost' id='hasil_rooving22_neck1' value='0'>
					<input type='text' name='ListDetail2_neck2[10][fak_pengali]' class='HideCost' id='penggali_rooving22_neck1' value='100'>
					<input type='text' name='ListDetail2_neck2[10][bw]' class='HideCost' id='bw_rooving22_neck1' value='0'>	
					<input type='text' name='ListDetail2_neck2[10][jumlah]' class='HideCost' id='jumlah_rooving22_neck1' value='0'>	
				</div>
				<label class='col-sm-2' style='text-align:left; margin-top: 6px;'>Weight</label>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'weight_rooving22_neck1','name'=>'ListDetail2_neck2[10][value]', 'style'=>'margin-left:-110px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1' style='text-align:left; margin-left:-130px; margin-top: 6px;'>Layer</label>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'layer_rooving22_neck1','name'=>'ListDetail2_neck2[10][layer]', 'style'=>'margin-left:-90px;width: 50px;','class'=>'form-control input-sm numberOnly','autocomplete'=>'off', 'value'=>''));											
					?>	
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -130px; margin-top: 6px;'>Thickness</label>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'totthick_rooving22_neck1','name'=>'ListDetail2_neck2[10][total_thickness]', 'style'=>'margin-left:-90px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_rooving22_neck1','name'=>'ListDetail2_neck2[10][last_cost]', 'style'=>'margin-left:-80px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-100px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-3'>              
					...
					<input type='text' name='ListDetail2_neck2[11][last_full]' class='HideCost' id='hasil_resin26_neck1' value='0'>
					<!--<input type='text' name='ListDetail2_neck2[11][containing]' class='HideCost' id='layer_resin26_neck1' value='0.429'>-->
					<input type='text' name='ListDetail2_neck2[11][id_material]' class='HideCost' id='layer_resin26hide_neck1'>
				</div>
				<label class='col-sm-2' style='text-align:left; margin-top: 6px;'><u>Rs.Containing</u></label>
				<div class='col-sm-1'>              
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'layer_resin26_neck1','name'=>'ListDetail2_neck2[11][containing]', 'style'=>'margin-left:-90px;width: 50px;','class'=>'form-control input-sm numberOnly','autocomplete'=>'off', 'readonly'=>'readonly', 'value'=>'0'));											
					?>
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -130px; margin-top: 6px;'></label>
				<div class='col-sm-1'>              
				...
				<div class='col-sm-1'>               
					<?php
						echo form_input(array('id'=>'last_resin26_neck1','name'=>'ListDetail2_neck2[11][last_cost]', 'style'=>'margin-left:-80px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-100px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>		 	 
				<label class='label-control col-sm-2'><b>TOTAL RESIN<span class='text-red'>*</span></b></label>
				<div class='col-sm-3'>              
					<select name='ListDetail2_neck2[12][id_material]' id='mid_mtl_resin_tot2_neck1' class='form-control input-sm'>
					<option value=''>Select An Resin</option>
					<?php
						foreach($ListResin AS $val => $valx){
							echo "<option value='".$valx['id_material']."'>".strtoupper($valx['nm_material'])."</option>";
					...
					<input type='text' name='ListDetail2_neck2[12][last_full]' class='HideCost' id='hasil_resin_tot2_neck1' value='0'>
					<!--<input type='text' name='ListDetail2_neck2[12][id_material]' class='HideCost' id='layer_resin27hide_neck1'>-->
				</div>
				<label class='col-sm-2' style='text-align:left; margin-top: 6px;'></label>
				<div class='col-sm-1'>              
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_resin_tot2_neck1','name'=>'ListDetail2_neck2[12][last_cost]', 'style'=>'margin-left:-80px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-100px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>
				...
				<label class='label-control col-sm-1'><b>Katalis<span class='text-red'>*</span></b></label>
				<div class='col-sm-3'>              
					<select name='ListDetailPlus2_neck2[0][id_material]' id='mid_mtl_katalis2_neck1' class='form-control input-sm'>
						<option value=''>Select An Katalis</option>
					<?php
						foreach($ListMatKatalis AS $val => $valx){
							echo "<option value='".$valx['id_material']."'>".strtoupper($valx['nm_material'])."</option>";
					...
					<input type='text' name='ListDetailPlus2_neck2[0][last_full]' class='HideCost' id='hasil_katalis2_neck1' value='0'>
					<!--
					<input type='text' name='ListDetailPlus2_neck2[0][containing]' class='HideCost' id='layer_katalis2_neck1' value='0'>
					<input type='text' name='ListDetailPlus2_neck2[0][perse]' class='HideCost' id='persen_katalis2_neck1' value='0.025'>
					--> 
				</div>
				
				<label class='col-sm-1' style='text-align:left; margin-left: 0px; margin-top: 6px;'>Comparison</label>
				<div class='col-sm-2'>              
					<input type='text' name='ListDetailPlus2_neck2[0][containing]' style='width:50px; margin-left:12px;' class='form-control input-sm numberOnly' readonly='readonly' id='layer_katalis2_neck1' value='0'>	
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -129px; margin-top: 6px;'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus2_neck2[0][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_katalis2_neck1' value='2'>	
				</div>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_katalis2_neck1','name'=>'ListDetailPlus2_neck2[0][last_cost]', 'style'=>'margin-left:-81px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-101px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>
				...
				<label class='label-control col-sm-1'><b>SM<span class='text-red'>*</span></b></label>
				<div class='col-sm-3'>              
					<select name='ListDetailPlus2_neck2[1][id_material]' id='mid_mtl_sm2_neck1' class='form-control input-sm'>
						<option value=''>Select An SM</option>
					<?php
						foreach($ListMatSm AS $val => $valx){
							echo "<option value='".$valx['id_material']."'>".strtoupper($valx['nm_material'])."</option>";
					...
					<input type='text' name='ListDetailPlus2_neck2[1][last_full]' class='HideCost' id='hasil_sm2_neck1' value='0'>
					<!--
					<input type='text' name='ListDetailPlus2_neck2[1][containing]' class='HideCost' id='layer_sm2_neck1' value='0'>
					<input type='text' name='ListDetailPlus2_neck2[1][perse]' class='HideCost' id='persen_sm2_neck1' value='0.025'>
					-->					
				</div>
				
				<label class='col-sm-1' style='text-align:left; margin-left: 0px; margin-top: 6px;'>Comparison</label>
				<div class='col-sm-2'>              
					<input type='text' name='ListDetailPlus2_neck2[1][containing]' style='width:50px; margin-left:12px;' class='form-control input-sm numberOnly' readonly='readonly' id='layer_sm2_neck1' value='0'>	
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -129px; margin-top: 6px;'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus2_neck2[1][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_sm2_neck1' value='2.5'>	
				</div>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_sm2_neck1','name'=>'ListDetailPlus2_neck2[1][last_cost]', 'style'=>'margin-left:-81px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-101px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>
				...
				<label class='label-control col-sm-1'><b>Cobalt<span class='text-red'>*</span></b></label>
				<div class='col-sm-3'>              
					<select name='ListDetailPlus2_neck2[2][id_material]' id='mid_mtl_cobalt2_neck1' class='form-control input-sm'>
						<option value=''>Select An Cobalt</option>
					<?php
						foreach($ListMatCobalt AS $val => $valx){
							echo "<option value='".$valx['id_material']."'>".strtoupper($valx['nm_material'])."</option>";
					...
					<input type='text' name='ListDetailPlus2_neck2[2][last_full]' class='HideCost' id='hasil_coblat2_neck1' value='0'>
					<!--
					<input type='text' name='ListDetailPlus2_neck2[2][containing]' class='HideCost' id='layer_coblat2_neck1' value='0'>
					<input type='text' name='ListDetailPlus2_neck2[2][perse]' class='HideCost' id='persen_coblat2_neck1' value='0.002'>
					-->
				</div>
				
				<label class='col-sm-1' style='text-align:left; margin-left: 0px; margin-top: 6px;'>Comparison</label>
				<div class='col-sm-2'>              
					<input type='text' name='ListDetailPlus2_neck2[2][containing]' style='width:50px; margin-left:12px;' class='form-control input-sm numberOnly' readonly='readonly' id='layer_coblat2_neck1' value='0'>	
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -129px; margin-top: 6px;'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus2_neck2[2][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_coblat2_neck1' value='0.2'>	
				</div>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_cobalt2_neck1','name'=>'ListDetailPlus2_neck2[2][last_cost]', 'style'=>'margin-left:-81px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-101px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>
				...
				<label class='label-control col-sm-1'><b>DMA<span class='text-red'>*</span></b></label>
				<div class='col-sm-3'>              
					<select name='ListDetailPlus2_neck2[3][id_material]' id='mid_mtl_dma2_neck1' class='form-control input-sm'>
						<option value=''>Select An DMA</option>
					<?php
						foreach($ListMatDma AS $val => $valx){
							echo "<option value='".$valx['id_material']."'>".strtoupper($valx['nm_material'])."</option>";
					...
					<input type='text' name='ListDetailPlus2_neck2[3][last_full]' class='HideCost' id='hasil_dma2_neck1' value='0'>
					<!--
					<input type='text' name='ListDetailPlus2_neck2[3][containing]' class='HideCost' id='layer_dma2_neck1' value='0'>
					<input type='text' name='ListDetailPlus2_neck2[3][perse]' class='HideCost' id='persen_dma2_neck1' value='0.002'>
					-->					
				</div>
				
				<label class='col-sm-1' style='text-align:left; margin-left: 0px; margin-top: 6px;'>Comparison</label>
				<div class='col-sm-2'>              
					<input type='text' name='ListDetailPlus2_neck2[3][containing]' style='width:50px; margin-left:12px;' class='form-control input-sm numberOnly' readonly='readonly' id='layer_dma2_neck1' value='0'>	
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -129px; margin-top: 6px;'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus2_neck2[3][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_dma2_neck1' value='0.2'>	
				</div>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_dma2_neck1','name'=>'ListDetailPlus2_neck2[3][last_cost]', 'style'=>'margin-left:-81px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-101px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>
				...
				<label class='label-control col-sm-1'><b>Hydroquinone<span class='text-red'>*</span></b></label>
				<div class='col-sm-3'>              
					<select name='ListDetailPlus2_neck2[4][id_material]' id='mid_mtl_hydro2_neck1' class='form-control input-sm'>
						<option value=''>Select An Hydroquinone</option>
					<?php
						foreach($ListMatHydo AS $val => $valx){
							echo "<option value='".$valx['id_material']."'>".strtoupper($valx['nm_material'])."</option>";
					...
					<input type='text' name='ListDetailPlus2_neck2[4][last_full]' class='HideCost' id='hasil_hydroquinone2_neck1' value='0'>
					<!--
					<input type='text' name='ListDetailPlus2_neck2[4][containing]' class='HideCost' id='layer_hydroquinone2_neck1' value='0'>
					<input type='text' name='ListDetailPlus2_neck2[4][perse]' class='HideCost' id='persen_hydroquinone2_neck1' value='0.002'>
					-->
				</div>
				
				<label class='col-sm-1' style='text-align:left; margin-left: 0px; margin-top: 6px;'>Comparison</label>
				<div class='col-sm-2'>              
					<input type='text' name='ListDetailPlus2_neck2[4][containing]' style='width:50px; margin-left:12px;' class='form-control input-sm numberOnly' readonly='readonly' id='layer_hydroquinone2_neck1' value='0'>	
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -129px; margin-top: 6px;'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus2_neck2[4][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_hydroquinone2_neck1' value='0.2'>	
				</div>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_hidro2_neck1','name'=>'ListDetailPlus2_neck2[4][last_cost]', 'style'=>'margin-left:-81px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-101px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>
				...
				<label class='label-control col-sm-1'><b>Methanol<span class='text-red'>*</span></b></label>
				<div class='col-sm-3'>              
					<select name='ListDetailPlus2_neck2[5][id_material]' id='mid_mtl_methanol2_neck1' class='form-control input-sm'>
						<option value=''>Select An Methanol</option>
					<?php
						foreach($ListMatMethanol AS $val => $valx){
							echo "<option value='".$valx['id_material']."'>".strtoupper($valx['nm_material'])."</option>";
					...
					<input type='text' name='ListDetailPlus2_neck2[5][last_full]' class='HideCost' id='hasil_methanol2_neck1' value='0'>
					<!--
					<input type='text' name='ListDetailPlus2_neck2[5][containing]' class='HideCost' id='layer_methanol2_neck1' value='0'>
					<input type='text' name='ListDetailPlus2_neck2[5][perse]' class='HideCost' id='persen_methanol2_neck1' value='0.002'>
					-->
				</div>
				
				<label class='col-sm-1' style='text-align:left; margin-left: 0px; margin-top: 6px;'>Comparison</label>
				<div class='col-sm-2'>              
					<input type='text' name='ListDetailPlus2_neck2[5][containing]' style='width:50px; margin-left:12px;' class='form-control input-sm numberOnly' readonly='readonly' id='layer_methanol2_neck1' value='0'>	
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -129px; margin-top: 6px;'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus2_neck2[5][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_methanol2_neck1' value='0.2'>	
				</div>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_methanol2_neck1','name'=>'ListDetailPlus2_neck2[5][last_cost]', 'style'=>'margin-left:-81px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-101px; margin-top: 6px;'>Kg</label>
			</div>
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'tot_lin_thickness2_neck2','name'=>'tot_lin_thickness2_neck2', 'style'=>'margin-left:-50px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<div class='col-sm-1'>              
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'mix_lin_thickness2_neck2','name'=>'mix_lin_thickness2_neck2', 'style'=>'margin-left:-50px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<div class='col-sm-1'>              
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'max_lin_thickness2_neck2','name'=>'max_lin_thickness2_neck2', 'style'=>'margin-left:-50px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<div class='col-sm-1'>              
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-2'>              
					<?php
						echo form_input(array('id'=>'hasil_linier_thickness2_neck2','name'=>'hasil_linier_thickness2_neck2', 'style'=>'margin-left:-50px; height: 40px;','class'=>'form-control input-sm HasilKet','autocomplete'=>'off','readonly'=>'readonly'));											
					?>	
				</div>
...
<script src="<?php echo base_url('application/views/Calculation/javascript/help_general.js'); ?>"></script>
<script src="<?php echo base_url('application/views/Calculation/javascript/flange_mould/add_table.js'); ?>"></script>
<script src="<?php echo base_url('application/views/Calculation/javascript/flange_mould/top.js'); ?>"></script>
<script src="<?php echo base_url('application/views/Calculation/javascript/flange_mould/liner.js'); ?>"></script>
<script src="<?php echo base_url('application/views/Calculation/javascript/flange_mould/structure.js'); ?>"></script>
<script src="<?php echo base_url('application/views/Calculation/javascript/flange_mould/external.js'); ?>"></script>
<script src="<?php echo base_url('application/views/Calculation/javascript/flange_mould/topcoat.js'); ?>"></script>
<script src="<?php echo base_url('application/views/Calculation/javascript/flange_mould/change_all.js'); ?>"></script>
<style type="text/css">
	.kghide{
