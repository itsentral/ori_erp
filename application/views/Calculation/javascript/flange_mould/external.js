...
$(document).on('keyup', '#layer_veil3', function(){
	...
	Hasil3(tot_thickness2, layer_veil, layer2, layer3, layer4, top_diameter, top_thickness, waste, angle);
	rubaharea();
});
...
$(document).on('keyup', '#layer_veil_add3', function(){
	...
	Hasil3(tot_thickness2, layer1, layer_veil, layer3, layer4, top_diameter, top_thickness, waste, angle);
	rubaharea();
});
...
$(document).on('keyup', '#layer_matcsm3', function(){
	...
	Hasil3(tot_thickness2, layer1, layer2, layer_veil, layer4, top_diameter, top_thickness, waste, angle);
	rubaharea();
});
...
$(document).on('keyup', '#layer_csm_add3', function(){
	...
	Hasil3(tot_thickness2, layer1, layer2, layer3, layer_veil, top_diameter, top_thickness, waste, angle);
	rubaharea();
});  