...
$(document).on('change', '#acuhan_1', function(){
	...
	$('#acuhan_2_neck1').val(struktur.toFixed(1));
	$('#acuhan_2_neck2').val(struktur.toFixed(1));
...
$(document).on('keyup', '#layer_veil', function(){
	...
	Hasil(tot_thickness2, layer_veil, layer_veil2, layer_veil3, layer_veil4, top_diameter, top_thickness, waste, angle, flange_od, area_neck_1, panjang_neck_1);
	rubaharea();
});
...
$(document).on('keyup', '#layer_veil_add', function(){
	...
	Hasil(tot_thickness2, layer_veil1, layer_veil, layer_veil3, layer_veil4, top_diameter, top_thickness, waste, angle, flange_od, area_neck_1, panjang_neck_1);
	rubaharea();
});
...
$(document).on('keyup', '#layer_matcsm', function(){
	...
	Hasil(tot_thickness2, layer_veil1, layer_veil2, layer_veil, layer_veil4, top_diameter, top_thickness, waste, angle, flange_od, area_neck_1, panjang_neck_1);
	rubaharea();
});
...
$(document).on('keyup', '#layer_csm_add', function(){
	...
	Hasil(tot_thickness2, layer_veil1, layer_veil2, layer_veil3, layer_veil, top_diameter, top_thickness, waste, angle, flange_od, area_neck_1, panjang_neck_1);
	rubaharea();
});
