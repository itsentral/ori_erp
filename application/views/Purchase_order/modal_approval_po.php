        ...
        <tbody>
            ...
            foreach($result AS $val => $valx){ $no++;
                ...
                echo "<tr>";
                    ...
                    echo "<td class='vmiddle' align='right'>".number_format($valx['net_price'],2)." <b class='text-primary'>".strtoupper($valx['mata_uang'])."</b></td>";
                    echo "<td class='vmiddle' align='right'>".number_format($valx['qty_purchase'])."</td>";
                    echo "<td class='vmiddle' align='right'>".number_format($valx['total_price'],2)."</td>";
               echo "</tr>";
            }
            ?>
            <tr>
            ...
            <tr>
                ...
                <td class='text-right mid text-bold'><?=number_format($result[0]['net_price2'],2);?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class='text-right mid text-bold'><?=number_format($result[0]['net_plus_tax'],2);?></td>
            </tr>
            <tr hidden>
