		...
		<table id="my-grid" class="table table-striped table-bordered table-hover table-condensed" width="100%">
			<thead id='head_table'>
				<tr class='bg-blue'>
					...
					<th class="text-right" width='15%'>Total Price</th>
			...
			<tbody>
				...
				foreach($result AS $val => $valx){ $no++;
					...
					echo "<tr>";
						...
						echo "<input type='hidden' name='detail[".$no."][price_ref_sup]' value='".$valx['price_ref_sup']."'>";
						echo "</td>";
						echo "<td class='vmiddle' align='left'>
						<input name='detail[".$no."][nm_material]' id='nm_material_".$no."' class='form-control input-md' value='".strtoupper($valx['nm_material'])."'>
						".strtoupper($nm_material)."</td>";
						...
						echo "<td class='vmiddle harga_idr' align='right'>".number_format($valx['net_price'],2)." <b class='text-primary'>".strtoupper($valx['currency'])."</b></td>";
