					...
					if(!empty($data_top)){
						foreach($data_top AS $val => $valx){ $id++;
							...
							echo "<tr class='header_".$id."'>";
								...
								if($styledisabled=="" && $valx['group_top']=='progress' && $data[0]->total_terima_barang_idr > 0 && $data[0]->invoice_no ==''){
								...
								}elseif($styledisabled=="" && $valx['group_top']=='uang muka' && $data[0]->total_terima_barang_idr < 1 && $data[0]->invoice_no ==''){
									
									
									echo '<br /><a class="receive btn btn-xs btn-success" href="'.base_url('purchase/invoice_receive/'.$valx['id']).'" title="Receive Invoice"> <i class="fa fa-newspaper-o"></i> Receive Invoice</a>';	
									
													
								}elseif($styledisabled=="" && $valx['group_top']=='progress' && $data[0]->total_terima_barang_idr > 0 && $data[0]->invoice_no !=''){
