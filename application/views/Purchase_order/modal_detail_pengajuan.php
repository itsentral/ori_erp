	...
	<table id="my-grid" class="table table-striped table-bordered table-hover table-condensed" width="100%">
		<thead id='head_table'>
			<tr class='bg-blue'>
				...
				<th class="text-center" width='20%'>Material Name</th>
				<th class="text-center" width='5%'>Price Ref ($)</th>
				<th class="text-center" width='5%'>Price From Supplier ($)</th>
				<th class="text-center" width='5%'>MOQ (Kg)</th>
				<th class="text-center" width='5%'>Qty PR (Kg)</th>
