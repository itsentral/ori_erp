...
history('View edit product estimasi in final drawing eccentric reducer : '.$id_bq.' / '.$id_milik.' / '.$idproduct);
// echo $idproduct;
...
$product			= $this->db->query("SELECT * FROM product WHERE parent_product='eccentric reducer' AND deleted='N'")->result_array();
...
?>
<form action="#" method="POST" id="form_proses_eccentric" enctype="multipart/form-data"> 
<div class="box box-primary">
	<div class="box-body">	
		...
		<?php
			...
			echo "&nbsp;<button type='button' name='simpan-bro' style='min-width:100px; float: right; margin-right:10px;' id='simpan-bro-eccentric' class='btn btn-success'>Save</button>";
