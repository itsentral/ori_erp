...
$sqlBef = "SELECT * FROM so_detail_header WHERE id_bq='".$id_bq."' AND id='".$id_milik."' LIMIT 1 ";
$restBef = $this->db->query($sqlBef)->result();
$idproduct = $restBef[0]->id_product;

history('View edit product estimasi in final drawing flange mould : '.$id_bq.' / '.$id_milik.' / '.$idproduct);
// echo $idproduct;
//berdasarkan diamater
$header				= $this->db->query("SELECT a.* FROM so_component_header a WHERE a.id_bq='".$id_bq."' AND a.id_product='".$idproduct."' AND a.id_milik='".$id_milik."' LIMIT 1 ")->result();
...
$product			= $this->db->query("SELECT * FROM product WHERE parent_product='flange mould' AND deleted='N'")->result_array();
...
$detLiner			= $this->db->query("SELECT * FROM so_component_detail WHERE id_bq='".$id_bq."' AND id_product='".$idproduct."' AND id_milik='".$id_milik."' AND detail_name='LINER THIKNESS / CB' ")->result_array();
$detLinerPlus		= $this->db->query("SELECT * FROM so_component_detail_plus WHERE id_bq='".$id_bq."' AND id_product='".$idproduct."' AND id_milik='".$id_milik."' AND detail_name='LINER THIKNESS / CB' ")->result_array();
$detLinerAdd		= $this->db->query("SELECT * FROM so_component_detail_add WHERE id_bq='".$id_bq."' AND id_product='".$idproduct."' AND id_milik='".$id_milik."' AND detail_name='LINER THIKNESS / CB' ")->result_array();
$footer				= $this->db->query("SELECT * FROM so_component_footer WHERE id_bq='".$id_bq."' AND id_product='".$idproduct."' AND id_milik='".$id_milik."' AND detail_name='LINER THIKNESS / CB' ")->result_array();
$detLinerNumRows	= $this->db->query("SELECT * FROM so_component_detail_add WHERE id_bq='".$id_bq."' AND id_product='".$idproduct."' AND id_milik='".$id_milik."' AND detail_name='LINER THIKNESS / CB' ")->num_rows();

$detStructure			= $this->db->query("SELECT * FROM so_component_detail WHERE id_bq='".$id_bq."' AND id_product='".$idproduct."' AND id_milik='".$id_milik."'  AND detail_name='STRUKTUR THICKNESS' ")->result_array();
$detStructurePlus		= $this->db->query("SELECT * FROM so_component_detail_plus WHERE id_bq='".$id_bq."' AND id_product='".$idproduct."' AND id_milik='".$id_milik."'  AND detail_name='STRUKTUR THICKNESS' ")->result_array();
$detStructureAdd		= $this->db->query("SELECT * FROM so_component_detail_add WHERE id_bq='".$id_bq."' AND id_product='".$idproduct."' AND id_milik='".$id_milik."'  AND detail_name='STRUKTUR THICKNESS' ")->result_array();
$detStructureNumRows	= $this->db->query("SELECT * FROM so_component_detail_add WHERE id_bq='".$id_bq."' AND id_product='".$idproduct."' AND id_milik='".$id_milik."'  AND detail_name='STRUKTUR THICKNESS' ")->num_rows();
$footerStructure		= $this->db->query("SELECT * FROM so_component_footer WHERE id_bq='".$id_bq."' AND id_product='".$idproduct."' AND id_milik='".$id_milik."'  AND detail_name='STRUKTUR THICKNESS' ")->result_array();

$detEksternal			= $this->db->query("SELECT * FROM so_component_detail WHERE id_bq='".$id_bq."' AND id_product='".$idproduct."' AND id_milik='".$id_milik."'  AND detail_name='EXTERNAL LAYER THICKNESS' ")->result_array();
$detEksternalPlus		= $this->db->query("SELECT * FROM so_component_detail_plus WHERE id_bq='".$id_bq."' AND id_product='".$idproduct."' AND id_milik='".$id_milik."'  AND detail_name='EXTERNAL LAYER THICKNESS' ")->result_array();
$detEksternalAdd		= $this->db->query("SELECT * FROM so_component_detail_add WHERE id_bq='".$id_bq."' AND id_product='".$idproduct."' AND id_milik='".$id_milik."'  AND detail_name='EXTERNAL LAYER THICKNESS' ")->result_array();
$detEksternalNumRows	= $this->db->query("SELECT * FROM so_component_detail_add WHERE id_bq='".$id_bq."' AND id_product='".$idproduct."' AND id_milik='".$id_milik."'  AND detail_name='EXTERNAL LAYER THICKNESS' ")->num_rows();
$footerEksternal		= $this->db->query("SELECT * FROM so_component_footer WHERE id_bq='".$id_bq."' AND id_product='".$idproduct."' AND id_milik='".$id_milik."'  AND detail_name='EXTERNAL LAYER THICKNESS' ")->result_array();

$detTopPlus				= $this->db->query("SELECT * FROM so_component_detail_plus WHERE id_bq='".$id_bq."' AND id_product='".$idproduct."' AND id_milik='".$id_milik."'  AND detail_name='TOPCOAT' ")->result_array();
$detTopAdd				= $this->db->query("SELECT * FROM so_component_detail_add WHERE id_bq='".$id_bq."' AND id_product='".$idproduct."' AND id_milik='".$id_milik."'  AND detail_name='TOPCOAT' ")->result_array();
$detTopNumRows			= $this->db->query("SELECT * FROM so_component_detail_add WHERE id_bq='".$id_bq."' AND id_product='".$idproduct."' AND id_milik='".$id_milik."'  AND detail_name='TOPCOAT' ")->num_rows();

$detStructureN1			= $this->db->query("SELECT * FROM so_component_detail WHERE id_bq='".$id_bq."' AND id_product='".$idproduct."' AND id_milik='".$id_milik."'  AND detail_name='STRUKTUR NECK 1' ")->result_array();
$detStructurePlusN1		= $this->db->query("SELECT * FROM so_component_detail_plus WHERE id_bq='".$id_bq."' AND id_product='".$idproduct."' AND id_milik='".$id_milik."'  AND detail_name='STRUKTUR NECK 1' ")->result_array();
$detStructureAddN1		= $this->db->query("SELECT * FROM so_component_detail_add WHERE id_bq='".$id_bq."' AND id_product='".$idproduct."' AND id_milik='".$id_milik."'  AND detail_name='STRUKTUR NECK 1' ")->result_array();
$detStructureNumRowsN1	= $this->db->query("SELECT * FROM so_component_detail_add WHERE id_bq='".$id_bq."' AND id_product='".$idproduct."' AND id_milik='".$id_milik."'  AND detail_name='STRUKTUR NECK 1' ")->num_rows();
$footerStructureN1		= $this->db->query("SELECT * FROM so_component_footer WHERE id_bq='".$id_bq."' AND id_product='".$idproduct."' AND id_milik='".$id_milik."'  AND detail_name='STRUKTUR NECK 1' ")->result_array();

$detStructureN2			= $this->db->query("SELECT * FROM so_component_detail WHERE id_bq='".$id_bq."' AND id_product='".$idproduct."' AND id_milik='".$id_milik."'  AND detail_name='STRUKTUR NECK 2' ")->result_array();
$detStructurePlusN2		= $this->db->query("SELECT * FROM so_component_detail_plus WHERE id_bq='".$id_bq."' AND id_product='".$idproduct."' AND id_milik='".$id_milik."'  AND detail_name='STRUKTUR NECK 2' ")->result_array();
$detStructureAddN2		= $this->db->query("SELECT * FROM so_component_detail_add WHERE id_bq='".$id_bq."' AND id_product='".$idproduct."' AND id_milik='".$id_milik."'  AND detail_name='STRUKTUR NECK 2' ")->result_array();
$detStructureNumRowsN2	= $this->db->query("SELECT * FROM so_component_detail_add WHERE id_bq='".$id_bq."' AND id_product='".$idproduct."' AND id_milik='".$id_milik."'  AND detail_name='STRUKTUR NECK 2' ")->num_rows();
$footerStructureN2		= $this->db->query("SELECT * FROM so_component_footer WHERE id_bq='".$id_bq."' AND id_product='".$idproduct."' AND id_milik='".$id_milik."'  AND detail_name='STRUKTUR NECK 2' ")->result_array();
			

?>
<form action="#" method="POST" id="form_proses_flangemould" enctype="multipart/form-data"> 
<div class="box box-primary">
	<div class="box-body">	
		...
		<?php
			...
			echo "&nbsp;<button type='button' name='simpan-bro' style='min-width:100px; float: right; margin-right:10px;' id='simpan-bro-flangemould' class='btn btn-success'>Save</button>";
...
<script>	
	$(document).ready(function(){
		...
		$(document).on('click', '#updateDefault', function(e){
			...
			$("#view4").load(base_url +'index.php/'+active_controller+'/modalEditEstDefault/'+$(this).data('id_milik')+'/'+$('#help_url').val());
			$("#ModalView4").modal();
		});
		...
		$.ajax({
			url: base_url +'index.php/json_help/getDefaultEditBqFD',
			cache: false,
			type: "POST", 
...
function AppendBaris_Liner(intd){
	...
	var Rows	 = "<tr id='trliner_"+nomor+"'>";
		...
		Rows	+=		"<input type='hidden' class='form-control Full' name='ListDetailAdd["+nomor+"][last_full]' id='last_full_liner_"+nomor+"' value='0' autocomplete='off'>";
		Rows 	+= 	"</td>";
		Rows	+= 	"<td align='left' width='20%'>";
		Rows	+=		"<select name='ListDetailAdd["+nomor+"][id_category]' id='id_category_liner_"+nomor+"' class='chosen_select form-control inline-block' required><option value=''>Select An Category</option></select>";
		Rows	+= 	"</td>";
		Rows	+= 	"<td align='left'>";
		Rows	+=		"<select name='ListDetailAdd["+nomor+"][id_material]' id='id_material_liner_"+nomor+"' class='chosen_select form-control inline-block' required><option value=''>List Empty</option></select>";
		Rows	+= 	"</td>";
		Rows	+= 	"<td  width='8%'>";
		Rows	+=		"<input type='text' style='text-align: right;' class='form-control input-sm numberOnly ChangeContaining' name='ListDetailAdd["+nomor+"][containing]' id='containing_liner_"+nomor+"' value='0' placeholder='Containing' autocomplete='off'>";
		Rows	+= 	"</td>";
		Rows	+= 	"<td  width='8%'>";
		Rows	+=		"<input type='text' style='text-align: right;' class='form-control input-sm numberOnly ChangePerse' name='ListDetailAdd["+nomor+"][perse]' id='perse_liner_"+nomor+"' value='0' placeholder='Percent' autocomplete='off'>";
		Rows	+= 	"</td>";
		Rows	+= 	"<td width='8%'>";
		Rows	+=		"<input type='text' style='text-align: right;' class='form-control input-sm Cost' name='ListDetailAdd["+nomor+"][last_cost]' id='last_cost_liner_"+nomor+"' value='0' readonly autocomplete='off'>";
		Rows	+= 	"</td>";
		Rows	+= "</tr>";
...
function AppendBaris_Strukture(intd){
	...
	var Rows	 = "<tr id='trstrukture_"+nomor+"'>";
		...
		Rows	+=		"<input type='hidden' class='form-control Full' name='ListDetailAdd2["+nomor+"][last_full]' id='last_full_strukture_"+nomor+"' value='0' autocomplete='off'>";
		Rows 	+= 	"</td>";
		Rows	+= 	"<td width='20%'>";
		Rows	+=		"<select name='ListDetailAdd2["+nomor+"][id_category]' id='id_category_strukture_"+nomor+"' class='chosen_select form-control inline-block' required><option value=''>Select An Category</option></select>";
		Rows	+= 	"</td>";
		Rows	+= 	"<td align='left'>";
		Rows	+=		"<select name='ListDetailAdd2["+nomor+"][id_material]' id='id_material_strukture_"+nomor+"' class='chosen_select form-control inline-block' required><option value=''>List Empty</option></select>";
		Rows	+= 	"</td>";
		Rows	+= 	"<td width='8%'>";
		Rows	+=		"<input type='text' style='text-align: right;' class='form-control input-sm numberOnly ChangeContainingStr' name='ListDetailAdd2["+nomor+"][containing]' id='containing_strukture_"+nomor+"' value='0' placeholder='Containing' autocomplete='off'>";
		Rows	+= 	"</td>";
		Rows	+= 	"<td width='8%'>";
		Rows	+=		"<input type='text' style='text-align: right;' class='form-control input-sm numberOnly ChangePerseStr' name='ListDetailAdd2["+nomor+"][perse]' id='perse_strukture_"+nomor+"' value='0' placeholder='Percent' autocomplete='off'>";
		Rows	+= 	"</td>";
		Rows	+= 	"<td width='8%'>";
		Rows	+=		"<input type='text' style='text-align: right;' class='form-control input-sm Cost' name='ListDetailAdd2["+nomor+"][last_cost]' id='last_cost_strukture_"+nomor+"' value='0' readonly autocomplete='off'>";
		Rows	+= 	"</td>";
		Rows	+= "</tr>";
...
function AppendBaris_StruktureN1(intd){
	...
	var Rows	 = "<tr id='trstruktureN1_"+nomor+"'>";
		...
		Rows	+=		"<input type='hidden' class='form-control Full' name='ListDetailAdd2N1["+nomor+"][last_full]' id='last_full_struktureN1_"+nomor+"' value='0' autocomplete='off'>";
		Rows 	+= 	"</td>";
		Rows	+= 	"<td width='20%'>";
		Rows	+=		"<select name='ListDetailAdd2N1["+nomor+"][id_category]' id='id_category_struktureN1_"+nomor+"' class='chosen_select form-control inline-block' required><option value=''>Select An Category</option></select>";
		Rows	+= 	"</td>";
		Rows	+= 	"<td align='left'>";
		Rows	+=		"<select name='ListDetailAdd2N1["+nomor+"][id_material]' id='id_material_struktureN1_"+nomor+"' class='chosen_select form-control inline-block' required><option value=''>List Empty</option></select>";
		Rows	+= 	"</td>";
		Rows	+= 	"<td width='8%'>";
		Rows	+=		"<input type='text' style='text-align: right;' class='form-control input-sm numberOnly ChangeContainingStrN1' name='ListDetailAdd2N1["+nomor+"][containing]' id='containing_struktureN1_"+nomor+"' value='0' placeholder='Containing' autocomplete='off'>";
		Rows	+= 	"</td>";
		Rows	+= 	"<td width='8%'>";
		Rows	+=		"<input type='text' style='text-align: right;' class='form-control input-sm numberOnly ChangePerseStrN1' name='ListDetailAdd2N1["+nomor+"][perse]' id='perse_struktureN1_"+nomor+"' value='0' placeholder='Percent' autocomplete='off'>";
		Rows	+= 	"</td>";
		Rows	+= 	"<td width='8%'>";
		Rows	+=		"<input type='text' style='text-align: right;' class='form-control input-sm Cost' name='ListDetailAdd2N1["+nomor+"][last_cost]' id='last_cost_struktureN1_"+nomor+"' value='0' readonly autocomplete='off'>";
		Rows	+= 	"</td>";
		Rows	+= "</tr>";
...
function AppendBaris_StruktureN2(intd){
	...
	var Rows	 = "<tr id='trstruktureN2_"+nomor+"'>";
		...
		Rows	+=		"<input type='hidden' class='form-control Full' name='ListDetailAdd2N2["+nomor+"][last_full]' id='last_full_struktureN2_"+nomor+"' value='0' autocomplete='off'>";
		Rows 	+= 	"</td>";
		Rows	+= 	"<td width='20%'>";
		Rows	+=		"<select name='ListDetailAdd2N2["+nomor+"][id_category]' id='id_category_struktureN2_"+nomor+"' class='chosen_select form-control inline-block' required><option value=''>Select An Category</option></select>";
		Rows	+= 	"</td>";
		Rows	+= 	"<td align='left'>";
		Rows	+=		"<select name='ListDetailAdd2N2["+nomor+"][id_material]' id='id_material_struktureN2_"+nomor+"' class='chosen_select form-control inline-block' required><option value=''>List Empty</option></select>";
		Rows	+= 	"</td>";
		Rows	+= 	"<td width='8%'>";
		Rows	+=		"<input type='text' style='text-align: right;' class='form-control input-sm numberOnly ChangeContainingStrN2' name='ListDetailAdd2N2["+nomor+"][containing]' id='containing_struktureN2_"+nomor+"' value='0' placeholder='Containing' autocomplete='off'>";
		Rows	+= 	"</td>";
		Rows	+= 	"<td width='8%'>";
		Rows	+=		"<input type='text' style='text-align: right;' class='form-control input-sm numberOnly ChangePerseStrN2' name='ListDetailAdd2N2["+nomor+"][perse]' id='perse_struktureN1_"+nomor+"' value='0' placeholder='Percent' autocomplete='off'>";
		Rows	+= 	"</td>";
		Rows	+= 	"<td width='8%'>";
		Rows	+=		"<input type='text' style='text-align: right;' class='form-control input-sm Cost' name='ListDetailAdd2N2["+nomor+"][last_cost]' id='last_cost_struktureN2_"+nomor+"' value='0' readonly autocomplete='off'>";
		Rows	+= 	"</td>";
		Rows	+= "</tr>";
...
function AppendBaris_External(intd){
	...
	var Rows	 = "<tr id='trexternal_"+nomor+"'>";
		...
		Rows	+=		"<input type='hidden' class='form-control Full' name='ListDetailAdd3["+nomor+"][last_full]' id='last_full_strukture_"+nomor+"' value='0' autocomplete='off'>";
		Rows 	+= 	"</td>";
		Rows	+= 	"<td width='20%'>";
		Rows	+=		"<select name='ListDetailAdd3["+nomor+"][id_category]' id='id_category_external_"+nomor+"' class='chosen_select form-control inline-block' required><option value=''>Select An Category</option></select>";
		Rows	+= 	"</td>";
		Rows	+= 	"<td align='left'>";
		Rows	+=		"<select name='ListDetailAdd3["+nomor+"][id_material]' id='id_material_external_"+nomor+"' class='chosen_select form-control inline-block' required><option value=''>List Empty</option></select>";
		Rows	+= 	"</td>";
		Rows	+= 	"<td width='8%'>";
		Rows	+=		"<input type='text' style='text-align: right;' class='form-control input-sm numberOnly ChangeContainingExt' name='ListDetailAdd3["+nomor+"][containing]' id='containing_external_"+nomor+"' value='0' placeholder='Containing' autocomplete='off'>";
		Rows	+= 	"</td>";
		Rows	+= 	"<td width='8%'>";
		Rows	+=		"<input type='text' style='text-align: right;' class='form-control input-sm numberOnly ChangePerseExt' name='ListDetailAdd3["+nomor+"][perse]' id='perse_external_"+nomor+"' value='0' placeholder='Percent' autocomplete='off'>";
		Rows	+= 	"</td>";
		Rows	+= 	"<td width='8%'>";
		Rows	+=		"<input type='text' style='text-align: right;' class='form-control input-sm Cost' name='ListDetailAdd3["+nomor+"][last_cost]' id='last_cost_external_"+nomor+"' value='0' readonly autocomplete='off'>";
		Rows	+= 	"</td>";
		Rows	+= "</tr>";
...
function AppendBaris_TopCoat(intd){
	...
	var Rows	 = "<tr id='trtopcoat_"+nomor+"'>";
		...
		Rows	+=		"<input type='hidden' class='form-control Full' name='ListDetailAdd4["+nomor+"][last_full]' id='last_full_topcoat_"+nomor+"' value='0' autocomplete='off'>";
		Rows 	+= 	"</td>";
		Rows	+= 	"<td width='20%'>";
		Rows	+=		"<select name='ListDetailAdd4["+nomor+"][id_category]' id='id_category_topcoat_"+nomor+"' class='chosen_select form-control inline-block' required><option value=''>Select An Category</option></select>";
		Rows	+= 	"</td>";
		Rows	+= 	"<td align='left'>";
		Rows	+=		"<select name='ListDetailAdd4["+nomor+"][id_material]' id='id_material_topcoat_"+nomor+"' class='chosen_select form-control inline-block' required><option value=''>List Empty</option></select>";
		Rows	+= 	"</td>";
		Rows	+= 	"<td width='8%'>";
		Rows	+=		"<input type='text' style='text-align: right;' class='form-control input-sm numberOnly ChangeContainingTC' name='ListDetailAdd4["+nomor+"][containing]' value='0' placeholder='Containing' autocomplete='off'>";
		Rows	+= 	"</td>";
		Rows	+= 	"<td width='8%'>";
		Rows	+=		"<input type='text' style='text-align: right;' class='form-control input-sm numberOnly ChangePerseTC' name='ListDetailAdd4["+nomor+"][perse]' value='0' placeholder='Percent' autocomplete='off'>";
		Rows	+= 	"</td>";
		Rows	+= 	"<td width='8%'>";
		Rows	+=		"<input type='text' style='text-align: right;' class='form-control input-sm Cost' name='ListDetailAdd4["+nomor+"][last_cost]' value='0' readonly autocomplete='off'>";
		Rows	+= 	"</td>";
		Rows	+= "</tr>";
