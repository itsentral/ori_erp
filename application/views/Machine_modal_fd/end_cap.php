...
history('View edit product estimasi in final drawing end cap : '.$id_bq.' / '.$id_milik.' / '.$idproduct);
// echo $idproduct;
...
$product			= $this->db->query("SELECT * FROM product WHERE parent_product='end cap' AND deleted='N'")->result_array();
...
?>
<form action="#" method="POST" id="form_proses_endcap" enctype="multipart/form-data"> 
<div class="box box-primary">
	<div class="box-body">				
		...
		<div class='form-group row'>		 	 
			...
			<div class='col-sm-2'>              
				<?php
					echo form_input(array('id'=>'radius','name'=>'radius','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly'), floatval($header[0]->radius));
				?>
			</div>
		</div>
		<!-- ====================================================================================================== -->
		...
		<?php
			...
			echo "&nbsp;<button type='button' name='simpan-bro' style='min-width:100px; float: right; margin-right:10px;' id='simpan-bro-endcap' class='btn btn-success'>Save</button>";
...
function LuasArea(){
	...
	var Luas_Area_Rumus		= 2 * 3.14 *(((diameter/2)+ est + overlap)*((diameter/2)+ est + overlap)) / 1000000 * (1+waste);
