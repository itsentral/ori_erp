...
history('View edit product estimasi in final drawing elbow mould : '.$id_bq.' / '.$id_milik.' / '.$idproduct);
// echo $idproduct;
...
// echo "SELECT a.*, b.id FROM so_component_header a LEFT JOIN product b ON a.nm_product = b.nm_product WHERE a.id_bq='".$id_bq."' AND a.id_milik='".$id_milik."' LIMIT 1 "; 
// echo "SELECT a.*, b.id FROM so_component_header a LEFT JOIN product b ON a.diameter = b.value_d WHERE a.diameter=b.value_d AND b.parent_product='elbow mould' AND a.id_bq='".$id_bq."' AND a.id_milik='".$id_milik."' LIMIT 1 ";
...
$product			= $this->db->query("SELECT * FROM product WHERE parent_product='elbow mould' AND deleted='N'")->result_array();
...
$detLiner			= $this->db->query("SELECT * FROM so_component_detail WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."' AND id_product='".$idproduct."' AND detail_name='LINER THIKNESS / CB' ")->result_array();
$detLinerPlus		= $this->db->query("SELECT * FROM so_component_detail_plus WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."' AND id_product='".$idproduct."' AND detail_name='LINER THIKNESS / CB' ")->result_array();
$detLinerAdd		= $this->db->query("SELECT * FROM so_component_detail_add WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."' AND id_product='".$idproduct."' AND detail_name='LINER THIKNESS / CB' ")->result_array();
$footer				= $this->db->query("SELECT * FROM so_component_footer WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."' AND id_product='".$idproduct."' AND detail_name='LINER THIKNESS / CB' ")->result_array();
$detLinerNumRows	= $this->db->query("SELECT * FROM so_component_detail_add WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."' AND id_product='".$idproduct."' AND detail_name='LINER THIKNESS / CB' ")->num_rows();

$detStructure			= $this->db->query("SELECT * FROM so_component_detail WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."' AND id_product='".$idproduct."'  AND detail_name='STRUKTUR THICKNESS' ")->result_array();
$detStructurePlus		= $this->db->query("SELECT * FROM so_component_detail_plus WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."' AND id_product='".$idproduct."'  AND detail_name='STRUKTUR THICKNESS' ")->result_array();
$detStructureAdd		= $this->db->query("SELECT * FROM so_component_detail_add WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."' AND id_product='".$idproduct."'  AND detail_name='STRUKTUR THICKNESS' ")->result_array();
$detStructureNumRows	= $this->db->query("SELECT * FROM so_component_detail_add WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."' AND id_product='".$idproduct."'  AND detail_name='STRUKTUR THICKNESS' ")->num_rows();
$footerStructure		= $this->db->query("SELECT * FROM so_component_footer WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."' AND id_product='".$idproduct."'  AND detail_name='STRUKTUR THICKNESS' ")->result_array();

$detEksternal			= $this->db->query("SELECT * FROM so_component_detail WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."' AND id_product='".$idproduct."'  AND detail_name='EXTERNAL LAYER THICKNESS' ")->result_array();
$detEksternalPlus		= $this->db->query("SELECT * FROM so_component_detail_plus WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."' AND id_product='".$idproduct."'  AND detail_name='EXTERNAL LAYER THICKNESS' ")->result_array();
$detEksternalAdd		= $this->db->query("SELECT * FROM so_component_detail_add WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."' AND id_product='".$idproduct."'  AND detail_name='EXTERNAL LAYER THICKNESS' ")->result_array();
$detEksternalNumRows	= $this->db->query("SELECT * FROM so_component_detail_add WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."' AND id_product='".$idproduct."'  AND detail_name='EXTERNAL LAYER THICKNESS' ")->num_rows();
$footerEksternal		= $this->db->query("SELECT * FROM so_component_footer WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."' AND id_product='".$idproduct."'  AND detail_name='EXTERNAL LAYER THICKNESS' ")->result_array();

$detTopPlus				= $this->db->query("SELECT * FROM so_component_detail_plus WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."' AND id_product='".$idproduct."'  AND detail_name='TOPCOAT' ")->result_array();
$detTopAdd				= $this->db->query("SELECT * FROM so_component_detail_add WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."' AND id_product='".$idproduct."'  AND detail_name='TOPCOAT' ")->result_array();
$detTopNumRows			= $this->db->query("SELECT * FROM so_component_detail_add WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."' AND id_product='".$idproduct."'  AND detail_name='TOPCOAT' ")->num_rows();

			

?>
<form action="#" method="POST" id="form_proses_elbowmould" enctype="multipart/form-data"> 
<div class="box box-primary">
	<div class="box-body">	
		...
		<div class='form-group row'>		 	 
			...
			<div class='col-sm-2'>
				<?php
					echo form_input(array('type'=>'hidden','id'=>'panjang','name'=>'panjang','class'=>'form-control input-sm numberOnly','autocomplete'=>'off','placeholder'=>'Pipe Length'), floatval($header[0]->panjang));				
		...
		<div class='form-group row'>
			<label class='label-control col-sm-2'><b>Type Radius | Value <?= $header[0]->type_elbow;?><span class='text-red'>*</span></b></label>
			<div class='col-sm-2'>    
				<?php
				if($header[0]->type_elbow == 'SR'){$selcx = 'selected';}else{$selcx = '';}
				if($header[0]->type_elbow == 'LR'){$selc2x = 'selected';}else{$selc2x = '';}
				if(!empty($header[0]->high) AND $header[0]->high != null AND floatval($header[0]->high) != 0){
					$nil_type = $header[0]->high;
				}
				else{
					if($header[0]->type_elbow == 'SR'){$nil_type = 1;}else{$nil_type = '';}
					if($header[0]->type_elbow == 'LR'){$nil_type = 1.5;}else{$nil_type = '';}
				}
				?>
				<select name='type_elbowx' id='type_elbowx' class='form-control input-sm' disabled>
					<option value='0'>Type Radius</option>
					<option value='SR' <?= $selcx;?>>Short Radius</option>
					<option value='LR' <?= $selc2x;?>>Long Radius</option>
				</select>
			</div>
			<div class='col-sm-1'>              
				<?php
					echo form_input(array('id'=>'type_elbow','name'=>'type_elbow','class'=>'form-control input-sm HideCost'), $header[0]->type_elbow);											
					echo form_input(array('id'=>'nil_type','name'=>'nil_type','class'=>'form-control input-sm numberOnly','autocomplete'=>'off','placeholder'=>'Val LR/SR', 'maxlength'=>'5'), $nil_type);											
				?>	
			</div>
			<div class='col-sm-1'>              
				<?php
					echo form_input(array('type'=>'text','id'=>'radius','name'=>'radius','class'=>'form-control input-sm ','autocomplete'=>'off','readonly'=>'readonly','placeholder'=>'Radius'), floatval($header[0]->radius));											
				?>	
			</div>
			<label class='label-control col-sm-2'><b>Angle <span class='text-red'>*</span></b></label>
			<div class='col-sm-2'>              
				<?php
					echo form_input(array('id'=>'angle','name'=>'angle','class'=>'form-control input-sm numberOnly','autocomplete'=>'off','placeholder'=>'Angle', 'maxlength'=>'3','readonly'=>'readonly'), floatval($header[0]->angle));											
				?>	
			</div>
		</div>
		<!-- ====================================================================================================== -->
		...
		<?php
			...
			echo "&nbsp;<button type='button' name='simpan-bro' style='min-width:100px; float: right; margin-right:10px;' id='simpan-bro-elbowmould' class='btn btn-success'>Save</button>";
...
<script>	
	$(document).ready(function(){
		...
		$(document).on('keyup', '#nil_type', function(){
			if($('#diameter').val() == '' || $('#diameter').val() == null || $('#diameter').val() == '0'){
				swal({
				  title	: "Error Message!",
				...
				var nil = parseFloat($(this).val());
				var Hsr	= parseFloat($('#diameter').val()) * nil;
				if(isNaN(Hsr)){
					var Hsr = 0;
				}
				$('#radius').val(Hsr);
...
function LuasArea(){
	...
	var topEST	= Estimasi();
	var angle	= getNum($('#angle').val());
	var overlap	= getNum($('#overlap').val());
	var radius	= getNum($('#radius').val());
	
	var Luas_Area_Rumus		= (angle / 360) *((2 * 3.14 *(radius)) *(3.14 * (diameter + (2 * topEST)) + overlap) / 1000000 * (1+waste));
...
function ChangeAreaToStr(Area){
	...
	var containingStr_13	= getNum($('#containingStr_13').val());
	...
	var resiTot			= (Area * 1.2 * containingStr_13) + resin2 + resin4 + resin6 + resin8 + resin10 + resin12;
...
function ChangeAreaToEks(Area){
	...
	var resiTot			= (Area * 1.2 * containingEks_9) + resin2 + resin4 + resin6 + resin8;
...
$(document).on('change', '.id_materialSTr', function(){
	...
	if(nomor != '13'){
		...
		var BWx			= $(this).parent().parent().find("td:nth-child(1) #bwStr_"+nomor).val();
		var Jumlahx		= $(this).parent().parent().find("td:nth-child(1) #jumlahStr_"+nomor).val();
		...
		$.ajax({
			...
			cache: false,
			type: "POST",
			data: "id_material="+id_material+"&diameter="+diameter+"&resin="+resin+"&id_ori="+id_ori+"&resinOri="+resinOri+"&bw="+BWx+"&jumlah="+Jumlahx, 
			dataType: "json",
			success: function(data){
				helpX.val(data.weight);
				layer.val(data.layer);
...
$(document).on('keyup', '.ChangeContainingStr', function(){
	var total_resin	= $('#last_costStr_13').val();
	var perse		= $(this).parent().parent().find("td:nth-child(5) input").val() / 100;
	var containing	= $(this).val();
