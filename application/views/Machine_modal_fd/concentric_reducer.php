...
history('View edit product estimasi in final drawing concentric reducer : '.$id_bq.' / '.$id_milik.' / '.$idproduct);
// echo $idproduct;
...
$product			= $this->db->query("SELECT * FROM product WHERE parent_product='concentric reducer' AND deleted='N'")->result_array();
...
?>
<form action="#" method="POST" id="form_proses_concentric" enctype="multipart/form-data"> 
<div class="box box-primary">
	<div class="box-body">		
		...
		<div class='form-group row'>		 	 
			...
			<div class='col-sm-1'>              
				<?php
					...
					echo form_input(array('type'=>'text','id'=>'area','name'=>'area','class'=>''), $header[0]->area);
		...
		<?php
			...
			echo "&nbsp;<button type='button' name='simpan-bro' style='min-width:100px; float: right; margin-right:10px;' id='simpan-bro-concentric' class='btn btn-success'>Save</button>";
...
function LuasArea(){
	...
	var panjang			= parseFloat($('#panjang_m').val());
...
function ChangeAreaToStr(Area){
	...
	// console.log(valueStr_9);
	// console.log(jumlahStr_9);
	// console.log(bwStr_9);
	// console.log(layerStr_9);
	// console.log(Area);
	// console.log(StrFakRv);
	// console.log(last_costStr_9);
