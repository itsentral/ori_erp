...
history('View edit product estimasi in final drawing reducer tee mould : '.$id_bq.' / '.$id_milik.' / '.$idproduct);
// echo $idproduct;
...
$product			= $this->db->query("SELECT * FROM product WHERE parent_product='reducer tee mould' AND deleted='N'")->result_array();
...
?>
<form action="#" method="POST" id="form_proses_reducerteemould" enctype="multipart/form-data"> 
<div class="box box-primary">
	<div class="box-body">
		...
		<?php
			...
			echo "&nbsp;<button type='button' name='simpan-bro' style='min-width:100px; float: right; margin-right:10px;' id='simpan-bro-reducerteemould' class='btn btn-success'>Save</button>";
