...
history('View edit product estimasi in final drawing blind flange : '.$id_bq.' / '.$id_milik.' / '.$idproduct);
// echo $idproduct;
...
<script>	
	$(document).ready(function(){
		...
		$(document).on('click', '#updateDefault', function(e){
			...
			// $("#view").load(base_url +'index.php/component_custom/editDefaultEstProjectFD/'+$(this).data('id_product'));
			$("#view4").load(base_url +'index.php/'+active_controller+'/editDefaultEstProjectFD/'+$(this).data('id_milik')+'/'+$('#help_url').val());
			$("#ModalView4").modal();
		});
