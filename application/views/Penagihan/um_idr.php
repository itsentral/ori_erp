...
$SUM_TANKI=0;
foreach($getTanki AS $val => $valx){
	$SUM_TANKI+=$valx['deal_idr'];
}
...
$total_invoice=0;
if(isset($penagihan[0]->total_invoice)){
	$total_invoice = round($penagihan[0]->total_invoice_idr, 2);
}
?>
			...
			<table id="my-grid" class="table table-striped table-bordered table-hover table-condensed" width="100%">
				<tfoot>
					...
					<tr class='HeaderHr'>
						...
						<td align='center' colspan='2'></td>
						<td align='right' colspan='2'>
							<input type="text" class="form-control total_invoice text-right input-sm divide" id="total_invoice" name="total_invoice" value="<?php echo set_value('total_invoice', isset($total_invoice) ? $total_invoice : '0'); ?>" tabindex="-1">
						</td>
					</tr>
				</tfoot>
			</table>
