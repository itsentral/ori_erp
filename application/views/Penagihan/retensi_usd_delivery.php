				...
				<tfoot>
					...
					<tr class='HeaderHr'>
						...
						<td align='right' style='text-align:center;'>
							...
							?>
							<input type="text" class="form-control grand_total text-right divide" id="grand_total" name="grand_total" value="<?php echo set_value('grand_total', isset($grand_total) ? $grand_total : '0'); ?>" placeholder="Automatic">
					...
					<tr class='HeaderHr'>
						...
						<td align='right'>
							...
							$grand_total_hidden = round($SUM, 2);
							?>
							<input type="text" class="divide form-control total_invoice text-right" id="total_invoice" name="total_invoice" value="<?php echo set_value('total_invoice', isset($grand_total) ? $grand_total : '0'); ?>" placeholder="Automatic">
