		...
		<div class="box-body">
			...
			<div class='form-group row'>
				...
				<div class='col-sm-2'>
					...
					<input type="hidden" id='wilayah' name="wilayah" class="form-control input-sm" value="<?= if(SUBSTR($getHeader[0]->no_ipp,0,4)) ='IPPT' ){'-'} else{get_name('so_number','wilayah','id_bq', "BQ-".$getHeader[0]->no_ipp);}?>">
				</div>
				<div class='col-sm-2'>
