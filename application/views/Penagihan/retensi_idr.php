					...
					<tbody>
						...
						foreach($get_retensi AS $val => $valx){ 
							...
							<tr id='tr5_<?= $nomor;?>' >
								...
								<td>
									...
									<input type="text" class="form-control text-right harga_tot6 changeAll divide" id="harga_tot6<?=$nomor ?>" data-nomor='<?=$nomor ?>' readonly name="data6[<?=$nomor ?>][harga_tot6]" value="<?=set_value('harga_tot6', isset($harga_tot6) ? $harga_tot6 : ''); ?>" tabindex='-1'>
						...
						<tr id='tr5X' class='FootColor'>
							...
							<td align="right">
								...
								<input type="hidden" class="form-control changeShipTot" value="<?=set_value('total_trucking', isset($total_trucking) ? $total_trucking : '0'); ?>" readonly >
							</td>
						</tr>
					</tbody>
				<?php } ?>	
				<tfoot>
					...
					<tr class='HeaderHr'>
						...
						<td align='right' style='text-align:center;'>
							...
							?>
							<input type="text" class="form-control grand_total text-right input-sm divide" id="grand_total" name="grand_total" value="<?php echo set_value('grand_total_hidden', isset($penagihan->total_dpp_rp) ? $penagihan->total_dpp_rp : '0'); ?>" tabindex="-1">
							<input type="hidden" class="grand_total_hidden" id="grand_total_hidden" name="grand_total_hidden" value="<?php echo set_value('grand_total_hidden', isset($penagihan->total_dpp_rp) ? $penagihan->total_dpp_rp : '0'); ?>">
						</td>
					</tr>
					<tr class='HeaderHr hidden'>
						...
						<td align='right'>
							...
							<input type="hidden" class="diskon_hidden" id="diskon_hidden" name="diskon_hidden" value="<?=(isset($penagihan[0]->total_diskon)?$penagihan[0]->total_diskon_idr:0)?>">
						</td>
					</tr>
					...
					<tr class='HeaderHr'>
						...
						<td align='right'>
							...
							<input type="hidden" class="ppn_hidden" id="ppn_hidden" name="ppn_hidden" value="<?=(isset($penagihan[0]->total_ppn)?$penagihan[0]->total_ppn_idr:0)?>">
						</td>
					</tr>
					<tr class='HeaderHr'>
						...
						<td align='right'>
							...
							$grand_total_hidden = round($SUM, 2);
							?>
							<input type="text" class="form-control total_invoice text-right input-sm divide" id="total_invoice" name="total_invoice" value="<?=(isset($penagihan[0]->total_ppn)?$penagihan[0]->total_invoice_idr:0)?>" tabindex="-1">
							<input type="hidden" class="total_invoice_hidden" id="total_invoice_hidden" name="total_invoice_hidden" value="<?=(isset($penagihan[0]->total_ppn)?$penagihan[0]->total_invoice_idr:0)?>">
						</td>
					</tr>
				</tfoot>
			</table>
