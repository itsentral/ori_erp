...
<form action="#" method="POST" id="form_proses_bro">
	<div class="box box-primary">
		...
		<div class="box-body">
			...
			<a href="<?php echo site_url('cost_quotation/project') ?>" class="btn btn-md btn-danger" style='float:right; width: 100px; margin-bottom: 5px;'>Back</a>
		...
		<div class='box-footer'>
			...
			?>
			<a href="<?php echo site_url('cost_quotation/project') ?>" class="btn btn-sm btn-danger">Back</a>
		</div>
		<!-- /.box-body -->
	 </div>
  <!-- /.box -->
