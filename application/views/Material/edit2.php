	...
	<div class="box box-primary">
		...
		<div class="box-body">
			...
			<div class='form-group row'>
				...
				<div class='col-sm-4'>
					<?php
						echo form_input(array('id'=>'safety_stock','name'=>'safety_stock','class'=>'form-control input-md maskM','autocomplete'=>'off','placeholder'=>'Safety Stock','data-decimal'=>".", 'data-thousand'=>"" , 'data-precision'=>"0", 'data-allow-zero'=>""), number_format($row[0]['safety_stock']));
					?>
				</div>
			</div>
			<div class='form-group row'>
				...
				<div class='col-sm-2'>
					<?php
						echo form_input(array('id'=>'nilai_konversi','name'=>'nilai_konversi','class'=>'form-control input-md maskM','autocomplete'=>'off','placeholder'=>'Conversion Value','data-decimal'=>".", 'data-thousand'=>"" , 'data-precision'=>"0", 'data-allow-zero'=>""),number_format($row[0]['nilai_konversi']));
					?>
				</div>
			...
			<div class='form-group row' hidden>
				...
				<div class='col-sm-4'>
					<?php
						echo form_input(array('id'=>'satuan_kg','name'=>'satuan_kg','class'=>'form-control input-md maskM','autocomplete'=>'off','placeholder'=>'Piece Of Kilogram'), number_format($row[0]['satuan_kg']));
					?>
				</div>
				<label class='label-control col-sm-2'><b>Kilogram Saldo <span class='text-red'>*</span></b></label>
				<div class='col-sm-4'>
					<?php
						echo form_input(array('id'=>'saldo_kg','name'=>'saldo_kg','class'=>'form-control input-md maskM','autocomplete'=>'off','placeholder'=>'Kilogram Balance'), number_format($row[0]['saldo_kg']));
					?>
				</div>
			</div>
			<div class='form-group row'>
