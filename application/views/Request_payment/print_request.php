...
//	include $sroot."/ori_dev_new/application/libraries/MPDF57/mpdf.php"; 
	...
	echo "<table class='gridtable2' border='0' width='100%' cellpadding='2'>";
		...
		echo "<tr>";
            ...
            echo "<td class='header_style_alamat'>:</td>";
			echo "<td class='header_style_alamat'>".date('d F Y',strtotime($datapo->req_payment_date))."</td>";
		echo "</tr>";
	...
	echo "<table class='gridtable' width='100%' border='0' cellpadding='2'>";
		...
		echo "<tr>";
			...
			echo "<td align='right'>" .number_format($datapo->nilai_invoice,2)."</td>";
	...
	echo "<table class='gridtableX' width='100%' border='0' cellpadding='2'>";
		echo "<tbody>";
			...
			echo "<tr>";
				...
				echo "<td width='20%'>".$datapo->curs_header.' '.number_format($datapo->request_payment,2)."</td>";
			echo "</tr>";
		echo "</tbody>";
	echo "</table><br /><br /><br />";
