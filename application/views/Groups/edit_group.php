			...
			<div class='form-group row'>			
				...
				<div class='col-sm-4'>
					<div class="input-group">
						...
						<?php
							...
							echo form_input(array('id'=>'name','name'=>'name','class'=>'form-control input-sm','autocomplete'=>'off','placeholder'=>'Group Name'),$rows_data[0]->name);											
						?>
					</div>
				...
				<div class='col-sm-4'>
					<div class="input-group">
						...
						<?php
							echo form_textarea(array('id'=>'descr','name'=>'descr','class'=>'form-control input-sm','cols'=>'75','rows'=>'1','autocomplete'=>'off','placeholder'=>'Description'),$rows_data[0]->descr);
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl=base_url + active_controller +'/edit_group';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
