...
<div class="box box-primary">
	<div class="box-header">
		...
		?>
		  <a href="<?php echo site_url('employee/add') ?>" class="btn btn-md btn-primary" id='add'><i class="fa fa-plus"></i> Add</a>
		  <?php
			}
		  ?>
		</div>
...
<script>
	...
	$(document).on('click', '.detail', function(e){
		...
		loading_spinner();
		var id = $(this).data('id');
		$("#head_title").html("<b>Detail Employee</b>");
		$("#view").load(base_url +'index.php/'+ active_controller+'/detail/'+id);
		$("#ModalView").modal();
	});
	...
	// function DataTables(){
		// var dataTable = $('#my-grid').DataTable({
			// "processing": true,
			// "serverSide": true,
			// "ajax": "http://103.228.117.98/hrori/assets/api/api_karyawan.min.php"
		// });
	// }
	...
	function DataTables(){
		var dataTable = $('#my-grid').DataTable({
			...
			"ajax":{
				url : base_url + active_controller+'/data_side_employee',
				type: "post",
				data: function(d){
