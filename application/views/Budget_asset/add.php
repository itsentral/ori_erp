...
<div class="box box-primary" style='margin-right: 17px;'>
	...
	<div class="box-body">
		<div class='form-group row'>
			...
			<label class='label-control col-sm-2'><b>Post Anggaran <span class='text-red'>*</span></b></label>
			<div class='col-sm-4'>
		...
		<div class='form-group row'>
			...
			<label class='label-control col-sm-2'><b>Post Penyusutan <span class='text-red'>*</span></b></label>
			<div class='col-sm-4'>
