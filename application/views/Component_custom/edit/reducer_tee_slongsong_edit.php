	...
	<div class="box box-primary">
		...
		<div class="box-body">
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('type'=>'text','id'=>'panjang','name'=>'panjang','class'=>'form-control input-sm numberOnly','placeholder'=>'Length'), floatval($header[0]->panjang));	
					?>	
				</div>
				<div class='col-sm-1'>              
					<?php
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl		= base_url +'edit_custom/reducer_tee_slongsong_edit';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
