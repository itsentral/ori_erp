							...
							<?php
								...
								foreach($detEksternalPlus AS $val => $valx){
									...
									<tr>
										...
										<td align='center'><input type='text' name='ListDetailPlus3[<?=$no;?>][containing]' id='Lincontaining3_<?=$no;?>' class='form-control input-sm conEks numberOnly' style='text-align:right; width:80px;' value='<?= $CONTAINING;?>'></td>
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl		= base_url +'edit_custom/eccentric_reducer_edit';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
