<?php
	...
	if(!empty($this->uri->segment(4))){
		$dada1 = "/".$this->uri->segment(4);
	}
	
	
	$id_product = $this->uri->segment(3).$dada1; 
	// echo $id_product;
			...
			<table id="my-grid" class="table table-striped table-bordered table-hover table-condensed" width="100%">
				<tbody>
					...
					<tr>
						...
						<?php
							...
							elseif($restHeader[0]['parent_product'] == 'elbow mould' OR $restHeader[0]['parent_product'] == 'elbow mitter' ){
								...
								$judulLabel	= "Belum di setting";
								$isiData	= "Belum di setting";
								$d1Label	= "Belum di setting";
								$d2Isi		= "Belum di setting";
								$persen		= "Belum di setting";
							}
						?>
						...
						<td class="text-left"><?= floatval($restHeader[0]['design']); ?></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="text-left"><?= floatval($restHeader[0]['est']); ?></td>
					</tr>
					<?php
