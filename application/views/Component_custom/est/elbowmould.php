...
<form action="#" method="POST" id="form_proses_bro">   
	<div class="box box-primary">
		...
		<div class="box-body">
			...
			<div class='form-group row'>
				<label class='label-control col-sm-2'><b>Type Radius | Value <span class='text-red'>*</span></b></label>
				<div class='col-sm-2'>              
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-3'>              
					...
					<!-- <input type='text' name='ListDetail3[8][containing]' class='HideCost' id='layer_resin_tot3'> -->
				</div>
				<div class='col-sm-3'></div>
				<div class='col-sm-1'>              
...
<script>
	...
	$(document).ready(function(){			
		...
		$(document).on('change', '#type_elbow', function(e){
			if($(this).val() == 'SR'){
				$('#nil_type').val('1');
			}
			else if($(this).val() == 'LR'){
