	...
	<div class="box box-primary">
		...
		<div class="box-body">
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-2'>              
					<?php
						echo form_input(array('id'=>'radius','name'=>'radius','class'=>'form-control input-sm numberOnly','autocomplete'=>'off','placeholder'=>'Radius', 'readonly'=>'readonly'));											
					?>	
				</div>
			</div>
			<!-- ====================================================================================================== -->
...
<script src="<?php echo base_url('application/views/Est_js/end_cap.js'); ?>"></script>
