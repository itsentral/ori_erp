	...
	<div class="box box-primary">
		...
		<div class="box-body">
			...
			<div class='form-group row'>
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('type'=>'text','id'=>'radius','name'=>'radius','class'=>'form-control input-sm ','autocomplete'=>'off','readonly'=>'readonly','placeholder'=>'Radius'));											
					?>	
				</div>
				...
				<div class='col-sm-2'>              
					<?php
						echo form_input(array('id'=>'angle','name'=>'angle','class'=>'form-control input-sm numberOnly','autocomplete'=>'off','placeholder'=>'Angle', 'maxlength'=>'4'));											
					?>	
				</div>
				<div class='col-sm-2'>              
					<?php
			...
			<div class='form-group row'>		 	 
				...
				<label class='col-sm-3'><u>Rs.Containing</u></label>
				<div class='col-sm-1'>              
					<?php
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-1'>              
					<input type='text' name='ListDetail[10][containing]' id='layer_resin_tot' class='form-control input-sm' readonly='readonly'>
				</div>
				<div class='col-sm-2'></div>
				<div class='col-sm-1'>              
					<?php
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-3'></div>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetail2[12][containing]' id='layer_resin_tot2' class='form-control input-sm numberOnly' readonly='readonly'>
				</div>
				<div class='col-sm-2'></div>
				<div class='col-sm-1'>              
					<?php
			...
			<div class='form-group row'>
				<div class='col-sm-8'></div>
				<label class='col-sm-2'>Total Strukture Thickness</label>
				<div class='col-sm-1'>              
					<?php
			...
			<div class='form-group row'>
				<div class='col-sm-8'></div>
				<label class='col-sm-2'>Min Strukture Thickness</label>
				<div class='col-sm-1'>              
					<?php
			...
			<div class='form-group row'>
				<div class='col-sm-8'></div>
				<label class='col-sm-2'>Max Strukture Thickness</label>
				<div class='col-sm-1'>              
					<?php
...
<script src="<?php echo base_url('application/views/Est_js/elbow_mitter.js'); ?>"></script>
	...
	$(document).ready(function(){			
		...
		$(document).on('keyup', '#nil_type', function(){
			if($('#top_diameter').val() == '' || $('#top_diameter').val() == null || $('#top_diameter').val() == '0'){
				...
				var Hsr	= parseFloat($('#top_diameter').val()) * nil;
				$('#radius').val(Hsr);
		...
		$(document).on('click', '#simpan-bro', function(e){
			...
			if(standart_code == '' || standart_code == null || standart_code == 0){
				swal({
				  title	: "Error Message!",
				  text	: 'Standart Default is Empty, please input first ...',
				  type	: "warning"
				});
				$('#simpan-bro').prop('disabled',false);
				return false;	
			...
			if(nil_type == '' || nil_type == null || nil_type == 0){
				swal({
				  title	: "Error Message!",
				  text	: 'Value LR/SR is Empty, please input first ...',
				  type	: "warning"
				});
				$('#simpan-bro').prop('disabled',false);
				return false;	
