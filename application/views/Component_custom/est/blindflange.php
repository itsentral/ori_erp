		...
		<div class="box-body">
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-3'>              
					...
					<input type='text' name='ListDetail2[8][id_ori]' class='HideCost' id='id_ori' value='TYP-0001'>
					<input type='text' name='ListDetail2[8][id_ori2]' class='HideCost' id='id_ori2' value='TYP-0001'>
					<input type='text' name='ListDetail2[8][last_full]' class='HideCost' id='hasil_resin_tot2' value='0'>
				</div>
				<div class='col-sm-3'></div>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetail2[8][containing]' class='form-control input-sm numberOnly' id='str_resin' readonly='readonly'>
				</div>
				<div class='col-sm-2'></div>
				<div class='col-sm-1'>              
					<?php
...
<script src="<?php echo base_url('application/views/Est_js/blind_flange.js'); ?>"></script>
	...
	$(document).ready(function(){	
		...
		$(document).on('click', '#simpan-bro', function(e){
			...
			if(flange_od == '' || flange_od == null || flange_od == 0){
				swal({
				  title	: "Error Message!",
				  text	: 'Flange OD is Empty, please input first ...',
				  type	: "warning"
				});
				$('#simpan-bro').prop('disabled',false);
				return false;	
