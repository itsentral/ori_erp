	...
	<div class="box box-primary">
		...
		<div class="box-body">
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-4'>              
					<?php
						...
						echo form_input(array('id'=>'diameter2','name'=>'diameter2','class'=>'form-control input-sm Hide','readonly'=>'readonly'));											
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'panjang','name'=>'panjang','class'=>'form-control input-sm numberOnly','autocomplete'=>'off','placeholder'=>'Length'));											
					?>		
				</div>
				<div class='col-sm-1'>              
					<?php
			...
			<div class='form-group row'>
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'wrap_length','name'=>'wrap_length','class'=>'form-control input-sm numberOnly','autocomplete'=>'off','placeholder'=>'B&W 1'));											
					?>	
				</div>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'wrap_length2','name'=>'wrap_length2','class'=>'form-control input-sm numberOnly','autocomplete'=>'off','placeholder'=>'B&W 2'));											
					?>	
				</div>
				<div class='col-sm-2'>              
					<?php
						echo form_input(array('id'=>'high','name'=>'high','class'=>'form-control input-sm numberOnly','value'=>'','placeholder'=>'High'));				
					?>	
				</div>	
			</div>
			<!-- ====================================================================================================== -->
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'layer_rooving22','name'=>'ListDetail2[10][layer]','class'=>'form-control input-sm numberOnly','autocomplete'=>'off', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1'>Thickness</label>
				<div class='col-sm-1'>              
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-3'></div>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetail2[12][containing]' class='form-control input-sm numberOnly' id='str_resin' readonly='readonly'>
				</div>
				<div class='col-sm-2'></div>
				<div class='col-sm-1'>                       
					<?php
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-3'></div>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetail3[8][containing]' class='form-control input-sm numberOnly' id='eks_resin' readonly='readonly'>
				</div>
				<div class='col-sm-2'></div>
				<div class='col-sm-1'>              
					<?php
...
<script src="<?php echo base_url('application/views/Est_js/reducer_tee.js'); ?>"></script>
	...
	$(document).ready(function(){	
		...
		$(document).on('change', '#standart_code', function(e){
			...
			$.ajax({
				...
				cache: false,
				type: "POST",
				data: "dim="+dim+"&std="+$(this).val()+"&parent_product="+parent_product+"&dim2="+dim2,
				dataType: "json",
		...
		$(document).on('keyup', '#bw_rooving21', function(){
			var bw_rooving21		= parseFloat($('#bw_rooving21').val());
			var jumlah_rooving21	= parseFloat($('#jumlah_rooving21').val());
			
			getBwOne(bw_rooving21, jumlah_rooving21);
		});
		
		$(document).on('keyup', '#jumlah_rooving21', function(){
			var bw_rooving21		= parseFloat($('#bw_rooving21').val());
			var jumlah_rooving21	= parseFloat($('#jumlah_rooving21').val()); 
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl		= base_url + active_controller +'/reducerteeslongsong';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
