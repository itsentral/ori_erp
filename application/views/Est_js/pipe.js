...
$(document).on('change', '#mid_mtl_rooving21', function(){
	...
	$.ajax({
		...
		cache: false,
		type: "POST",
		data: "id_material="+$(this).val()+"&resin="+$('#layer_resin25').val()+"&diameter="+$('#diameter').val()+"&diameter2="+diameter2+"&standart_code="+standart_code+"&beda="+beda,
		dataType: "json",
		success: function(data){
...
$(document).on('change', '#mid_mtl_rooving22', function(){
	...
	$.ajax({
		...
		cache: false,
		type: "POST",
		data: "id_material="+$(this).val()+"&resin="+$('#layer_resin26').val()+"&diameter="+$('#diameter').val()+"&diameter2="+diameter2+"&standart_code="+standart_code+"&beda="+beda,
		dataType: "json",
		success: function(data){
