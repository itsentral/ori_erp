...
//================================================LUAS AREA======================================================
	function LuasArea(){
		...
		var est			= getNum($('#tot_lin_thickness').val()) + getNum($('#tot_lin_thickness2').val()) + getNum($('#tot_lin_thickness3').val());
...
function Hasil2(a, b, c, d, e, f, g, StrFakCsm, StrFakCsmAdd, StrFakWr, StrFakWrAdd, StrFakRv, StrFakRvAdd){
	...
	var Hasillayer21		= getNum(HasilMadCsm) * layer_resin21 * kali;
	var Hasillayer22		= getNum(HasilMadCsmAdd) * layer_resin22 * kali;
	var Hasillayer23		= getNum(HasilWr) * layer_resin23 * kali;
	var Hasillayer24		= getNum(HasilWrAdd) * layer_resin24 * kali;
	var Hasillayer25		= getNum(HasilRoof21) * layer_resin25;
	var Hasillayer26		= getNum(HasilRoof22) * layer_resin26;
