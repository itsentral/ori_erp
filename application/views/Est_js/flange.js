...
function LuasArea(){ 
	...
	var top_diameter	= getNum($('#top_diameter').val());
...
function LuasAreaNeck1(){
	...
	var est_neck1		= parseFloat($('#tot_lin_thickness').val()) +  parseFloat($('#tot_lin_thickness2_neck1').val());
...
function LuasAreaNeck2(){
	...
	var est_neck1		= parseFloat($('#tot_lin_thickness').val()) +  parseFloat($('#tot_lin_thickness2_neck1').val());
	var est_neck2		= parseFloat($('#tot_lin_thickness2_neck2').val());
...
function BeratPlastic(area_neck_1, Luas_Area_Rumus, top_diameter){
	var perkalian = 1350;
...
function Hasil(a, b, c, d, e, LinFakVeil, LinFakVeilAdd, LinFakCsm, LinFakCsmAdd){
	...
	var diameter			= getNum($('#top_diameter').val());
	...
	var Luas_Area_Rumus		= LuasArea() + LuasAreaNeck1();
...
function Hasil2(a, b, c, d, e, f, g, StrFakCsm, StrFakCsmAdd, StrFakWr, StrFakWrAdd, StrFakRv, StrFakRvAdd){
	...
	var layer_resin_tot		= getNum($('#layer_resin_tot2').val());
	...
	var TotalResin2			= layer_resin_tot *  (Hasillayer21 + Hasillayer22 + Hasillayer23 + Hasillayer24  + Hasillayer25  + Hasillayer26);
...
function Hasil3(a, b, c, d, e, EksFakVeil, EksFakVeilAdd, EksFakCsm, EksFakCsmAdd){
	...
	var Luas_Area_Flange 	= LuasArea();
	
	var Luas_Area_Rumus		= parseFloat(LuasArea()) +  parseFloat(LuasAreaNeck1()) +  parseFloat(LuasAreaNeck2());
	...
	var TotalResin3			= layer_resin_tot * (Hasillayer31 + Hasillayer32 + Hasillayer33 + Hasillayer34);
...
function Hasil2_neck1(a, b, c, d, e, f, g, StrN1FakCsm, StrN1FakCsmAdd, StrN1FakWr, StrN1FakWrAdd, StrN1FakRv, StrN1FakRvAdd){
	AcuhanMaxMin();

	var struktur		= $('#acuhan_2_neck1').val();
	var MinToleransi	= $('#top_min_toleran').val();
	var MaxToleransi	= $('#top_max_toleran').val();
	...
	var weight_matcsm2		= getNum($('#weight_matcsm2_neck1').val());
	var layer_matcsm2		= getNum($('#layer_matcsm2_neck1').val());
	var weight_csm_add2		= getNum($('#weight_csm_add2_neck1').val());
	var layer_csm_add2		= getNum($('#layer_csm_add2_neck1').val());
	var weight_wr2			= getNum($('#weight_wr2_neck1').val());
	var layer_wr2			= getNum($('#layer_wr2_neck1').val());
	var weight_wr_add2		= getNum($('#weight_wr_add2_neck1').val());
	var layer_wr_add2		= getNum($('#layer_wr_add2_neck1').val());

	var weight_rooving21	= getNum($('#weight_rooving21_neck1').val());
	var penggali_rooving21	= getNum($('#penggali_rooving21_neck1').val());
	var bw_rooving21		= getNum($('#bw_rooving21_neck1').val());
	var jumlah_rooving21	= getNum($('#jumlah_rooving21_neck1').val());

	var weight_rooving22	= getNum($('#weight_rooving22_neck1').val());
	var penggali_rooving22	= getNum($('#penggali_rooving22_neck1').val());
	var bw_rooving22		= getNum($('#bw_rooving22_neck1').val());
	var jumlah_rooving22	= getNum($('#jumlah_rooving22_neck1').val());

	var layer_resin21		= getNum($('#layer_resin21_neck1').val());
	var layer_resin22		= getNum($('#layer_resin22_neck1').val());
	var layer_resin23		= getNum($('#layer_resin23_neck1').val());
	var layer_resin24		= getNum($('#layer_resin24_neck1').val());
	var layer_resin25		= getNum($('#layer_resin25_neck1').val());
	var layer_resin26		= getNum($('#layer_resin26_neck1').val());
	var layer_resin_tot		= getNum($('#layer_resin_tot2n1').val());

	var persen_katalis2		= getNum($('#persen_katalis2_neck1').val());
	var persen_sm2			= getNum($('#persen_sm2_neck1').val());
	var persen_coblat2		= getNum($('#persen_coblat2_neck1').val());
	var persen_dma2			= getNum($('#persen_dma2_neck1').val());
	var persen_hydroquinone2	= getNum($('#persen_hydroquinone2_neck1').val());
	var persen_methanol2	= getNum($('#persen_methanol2_neck1').val());
	
	var diameter			= getNum($('#top_diameter').val());

	var Luas_Area_Rumus 	= LuasArea();

	var Luas_Area_RumusNeck1	= LuasAreaNeck1();
	...
	var HasilMadCsm			= ((Luas_Area_RumusNeck1 * weight_matcsm2 * b)/1000) * StrN1FakCsm;
	var HasilMadCsmAdd		= ((Luas_Area_RumusNeck1 * weight_csm_add2 * c)/1000) * StrN1FakCsmAdd;
	var HasilWr				= ((Luas_Area_RumusNeck1 * weight_wr2 * d)/1000) * StrN1FakWr;
	var HasilWrAdd			= ((Luas_Area_RumusNeck1 * weight_wr_add2 * e)/1000) * StrN1FakWrAdd;
	var HasilRoof21			= ((weight_rooving21 * 0.001 * jumlah_rooving21 * 100)/(bw_rooving21/10)) * (2/1000) * f * Luas_Area_RumusNeck1 * StrN1FakRv;
	var HasilRoof22			= ((weight_rooving22 * 0.001 * jumlah_rooving22 * 100)/(bw_rooving22/10)) * (2/1000) * g * Luas_Area_RumusNeck1 * StrN1FakRvAdd;
...
function Hasil2_neck2(a, b, c, d, e, StrN1FakCsm, StrN1FakCsmAdd, StrN1FakWr, StrN1FakWrAdd){
	...
	var topEST		= parseFloat(a);


	var weight_matcsm2		= getNum($('#weight_matcsm2_neck2').val());
	var layer_matcsm2		= getNum($('#layer_matcsm2_neck2').val());
	var weight_csm_add2		= getNum($('#weight_csm_add2_neck2').val());
	var layer_csm_add2		= getNum($('#layer_csm_add2_neck2').val());
	var weight_wr2			= getNum($('#weight_wr2_neck2').val());
	var layer_wr2			= getNum($('#layer_wr2_neck2').val());
	var weight_wr_add2		= getNum($('#weight_wr_add2_neck2').val());
	var layer_wr_add2		= getNum($('#layer_wr_add2_neck2').val());

	var layer_resin21		= getNum($('#layer_resin21_neck2').val());
	var layer_resin22		= getNum($('#layer_resin22_neck2').val());
	var layer_resin23		= getNum($('#layer_resin23_neck2').val());
	var layer_resin24		= getNum($('#layer_resin24_neck2').val());
	var layer_resin_tot		= getNum($('#layer_resin_tot2n2').val());
	...
	var Luas_Area_Rumusx 	= LuasArea();
	var Luas_Area_Rumus		= LuasAreaNeck2();
	$('#area_neck_2').val(RoundUpEST(Luas_Area_Rumus));
	...
	var HasilMadCsm			= ((Luas_Area_Rumus * weight_matcsm2 * b)/1000) * StrN1FakCsm;
	var HasilMadCsmAdd		= ((Luas_Area_Rumus * weight_csm_add2 * c)/1000) * StrN1FakCsmAdd;
	var HasilWr				= ((Luas_Area_Rumus * weight_wr2 * d)/1000) * StrN1FakWr;
	var HasilWrAdd			= ((Luas_Area_Rumus * weight_wr_add2 * e)/1000) * StrN1FakWrAdd;
	...
	var TotalResin2			= layer_resin_tot * (Hasillayer21 + Hasillayer22 + Hasillayer23 + Hasillayer24);
...
function changeTop(){
	...
	var layer1_neck1			= getNum($("#layer_matcsm2_neck1").val());
	var layer2_neck1			= getNum($("#layer_csm_add2_neck1").val());
	var layer3_neck1			= getNum($("#layer_wr2_neck1").val());
	var layer4_neck1			= getNum($("#layer_wr_add2_neck1").val());
	var layer5_neck1			= getNum($("#layer_rooving21_neck1").val());
	var layer6_neck1			= getNum($("#layer_rooving22_neck1").val());
	var tot_thickness2_neck1	= getNum($('#tot_lin_thickness2_neck1').val());

	//Struktur Thickness Neck 2
	var layer1_neck2			= getNum($("#layer_matcsm2_neck2").val());
	var layer2_neck2			= getNum($("#layer_csm_add2_neck2").val());
	var layer3_neck2			= getNum($("#layer_wr2_neck2").val());
	var layer4_neck2			= getNum($("#layer_wr_add2_neck2").val());
	var tot_thickness2_neck2	= getNum($("#tot_lin_thickness2_neck2").val());
	...
	var StrN1FakCsm		= getNum($("#str_n1_faktor_csm").val());
	var StrN1FakCsmAdd	= getNum($("#str_n1_faktor_csm_add").val());
	var StrN1FakWr		= getNum($("#str_n1_faktor_wr").val());
	var StrN1FakWrAdd	= getNum($("#str_n1_faktor_wr_add").val());
	var StrN1FakRv		= getNum($("#str_n1_faktor_rv").val());
	var StrN1FakRvAdd	= getNum($("#str_n1_faktor_rv_add").val());
	
	var StrN2FakCsm		= getNum($("#str_n2_faktor_csm").val());
	var StrN2FakCsmAdd	= getNum($("#str_n2_faktor_csm_add").val());
	var StrN2FakWr		= getNum($("#str_n2_faktor_wr").val());
	var StrN2FakWrAdd	= getNum($("#str_n2_faktor_wr_add").val());
	...
	Hasil2_neck1(tot_thickness2_neck1, layer1_neck1, layer2_neck1, layer3_neck1, layer4_neck1, layer5_neck1, layer6_neck1, StrN1FakCsm, StrN1FakCsmAdd, StrN1FakWr, StrN1FakWrAdd, StrN1FakRv, StrN1FakRvAdd );
	Hasil2_neck2(tot_thickness2_neck2, layer1_neck2, layer2_neck2, layer3_neck2, layer4_neck2, StrN2FakCsm, StrN2FakCsmAdd, StrN2FakWr, StrN2FakWrAdd );
}
...
$(document).on('keyup', '#design_neck_2', function(){
	var designNeck2			= parseFloat($(this).val());
	$('#acuhan_2_neck2').val(designNeck2.toFixed(1));
...
function AcuhanMaxMin(){
	...
	//Neck
	var acuhan_2_neck1			= parseFloat($('#acuhan_2_neck1').val());
	var acuhan_2_neck2			= parseFloat($('#acuhan_2_neck2').val());
	...
	var min_lin_thickness_neck1	= acuhan_2_neck1 - (acuhan_2_neck1 * MinToleransi);
	var max_lin_thickness_neck1	= acuhan_2_neck1 + (acuhan_2_neck1 * MaxToleransi);

	var min_lin_thickness2_neck2	= acuhan_2_neck2 - (acuhan_2_neck2 * MinToleransi);
	var max_lin_thickness2_neck2	= acuhan_2_neck2 + (acuhan_2_neck2 * MaxToleransi);

	$('#mix_lin_thickness2_neck1').val(min_lin_thickness_neck1.toFixed(4));
	$('#max_lin_thickness2_neck1').val(max_lin_thickness_neck1.toFixed(4));

	$('#mix_lin_thickness2_neck2').val(min_lin_thickness2_neck2.toFixed(4));
	$('#max_lin_thickness2_neck2').val(max_lin_thickness2_neck2.toFixed(4));

	if(tot_thickness2_neck1 < min_lin_thickness_neck1){
		var HasilN1	= "TOO LOW";
	}
	if(tot_thickness2_neck1 > max_lin_thickness_neck1){
		var HasilN1	= "TOO HIGH";
	}
	if(tot_thickness2_neck1 > min_lin_thickness_neck1 && tot_thickness2_neck1 < max_lin_thickness_neck1){
		var HasilN1	= "OK";
	}
	$('#hasil_linier_thickness2_neck1').val(HasilN1);

	if(tot_thickness2_neck2 < min_lin_thickness2_neck2){
		var HasilN2	= "TOO LOW";
	}
	if(tot_thickness2_neck2 > max_lin_thickness2_neck2){
		var HasilN2	= "TOO HIGH";
	}
	if(tot_thickness2_neck2 > min_lin_thickness2_neck2 && tot_thickness2_neck2 < max_lin_thickness2_neck2){
		var HasilN2	= "OK";
	}
	$('#hasil_linier_thickness2_neck2').val(HasilN2);
}
...
function topcoatLast(){
	...
	var HasilTopCoat	= ((Luas_Area_Rumus + Luas_Area_RumusNeck1) * 1.2 * ResinCoat * 4);
...
function structureLayerNeck1(){
	...
	$('#totthick_matcsm2_neck1').val(getNum(thickness1_neck1).toFixed(4));
	$('#totthick_csm_add2_neck1').val(getNum(thickness2_neck1).toFixed(4));
	$('#totthick_wr2_neck1').val(getNum(thickness3_neck1).toFixed(4));
	$('#totthick_wr_add2_neck1').val(getNum(thickness4_neck1).toFixed(4));
	$('#totthick_rooving21_neck1').val(getNum(thickness5_neck1).toFixed(4));
	$('#totthick_rooving22_neck1').val(getNum(thickness6_neck1).toFixed(4));

	$('#tot_lin_thickness2_neck1').val(getNum(tot_thickness_neck1).toFixed(4));
}
function structureLayerNeck2(){
	...
	$('#totthick_matcsm2_neck2').val(getNum(thickness1_neck2).toFixed(4));
	$('#totthick_csm_add2_neck2').val(getNum(thickness2_neck2).toFixed(4));
	$('#totthick_wr2_neck2').val(getNum(thickness3_neck2).toFixed(4));
	$('#totthick_wr_add2_neck2').val(getNum(thickness4_neck2).toFixed(4));

	$('#tot_lin_thickness2_neck2').val(getNum(tot_thickness_neck2).toFixed(4));
}
...
$(document).on('change', '#mid_mtl_rooving21', function(){
	...
	$.ajax({
		...
		cache: false,
		type: "POST",
		data: "id_material="+$(this).val()+"&resin="+$('#layer_resin25').val()+"&diameter="+$('#top_diameter').val(),
		dataType: "json",
		success: function(data){
...
$(document).on('change', '#mid_mtl_rooving22', function(){
	...
	$.ajax({
		...
		cache: false,
		type: "POST",
		data: "id_material="+$(this).val()+"&resin="+$('#layer_resin26').val()+"&diameter="+$('#top_diameter').val(),
		dataType: "json",
		success: function(data){
...
function AppendBaris_Strukture_neck1(intd){
	...
	var Rows	 = "<tr id='trstruktureneck1_"+nomor+"'>";
		...
		Rows	+= 	"</td>";
		Rows	+= 	"<td  width='150px'>";
		Rows	+=		"Comparison<input type='text' class='form-control numberOnly ChangeContainingStrN1' name='ListDetailAdd_Strukture_neck1["+nomor+"][containing]' id='containing_strukture_neck1_"+nomor+"' value='0' placeholder='Containing' autocomplete='off'>";
		Rows	+= 	"</td>";
		Rows	+= 	"<td  width='150px'>";
		Rows	+=		"Percent<input type='text' class='form-control numberOnly ChangePerseStrN1' name='ListDetailAdd_Strukture_neck1["+nomor+"][perse]' id='perse_strukture_neck1_"+nomor+"' value='0' placeholder='Percent' autocomplete='off'>";
		Rows	+= 	"</td>";
		Rows	+= 	"<td width='150px'>";
...
function AppendBaris_Strukture_neck2(intd){
	...
	var Rows	 = "<tr id='trstruktureneck2_"+nomor+"'>";
		...
		Rows	+= 	"</td>";
		Rows	+= 	"<td  width='150px'>";
		Rows	+=		"Comparison<input type='text' class='form-control numberOnly ChangeContainingStrN2' name='ListDetailAdd_Strukture_neck2["+nomor+"][containing]' id='containing_strukture_neck2_"+nomor+"' value='0' placeholder='Containing' autocomplete='off'>";
		Rows	+= 	"</td>";
		Rows	+= 	"<td  width='150px'>";
		Rows	+=		"Percent<input type='text' class='form-control numberOnly ChangePerseStrN2' name='ListDetailAdd_Strukture_neck2["+nomor+"][perse]' id='perse_strukture_neck2_"+nomor+"' value='0' placeholder='Percent' autocomplete='off'>";
		Rows	+= 	"</td>";
		Rows	+= 	"<td width='150px'>";
...
$(document).on('change', '#mid_mtl_wr2_neck1', function(){
	...
	$.ajax({
		...
		cache: false,
		type: "POST",
		data: "id_material="+$(this).val()+"&resin4="+$('#layer_resin23_neck1').val(),
		dataType: "json",
		success: function(data){
...
$(document).on('change', '#mid_mtl_wr_add2_neck1', function(){
	...
	$.ajax({
		...
		cache: false,
		type: "POST",
		data: "id_material="+$(this).val()+"&resin4="+$('#layer_resin24_neck1').val(),
		dataType: "json",
		success: function(data){
...
$(document).on('keyup', '#persen_katalis2_neck1', function(){
	...
	$('#last_katalis2_neck1').val(RoundUp(Hasil));
});
$(document).on('keyup', '#persen_sm2_neck1', function(){
	...
	$('#last_sm2_neck1').val(RoundUp(Hasil));
});
$(document).on('keyup', '#persen_coblat2_neck1', function(){
	...
	$('#last_cobalt2_neck1').val(RoundUp(Hasil));
});
$(document).on('keyup', '#persen_dma2_neck1', function(){
	...
	$('#last_dma2_neck1').val(RoundUp(Hasil));
});
$(document).on('keyup', '#persen_hydroquinone2_neck1', function(){
	...
	$('#last_hidro2_neck1').val(RoundUp(Hasil));
});
$(document).on('keyup', '#persen_methanol2_neck1', function(){
	...
	$('#last_methanol2_neck1').val(RoundUp(Hasil));
});
...
$(document).on('keyup', '.ChangePerseStr', function(){
	var total_resin	= $('#last_resin_tot2').val();
	var containing	= $(this).parent().parent().find("td:nth-child(4) input").val() / 100;
	var perse	= $(this).val();
...
$(document).on('keyup', '.ChangeContainingStrN2', function(){
	var total_resin	= $('#last_resin_tot2_neck2').val();
	var perse		= $(this).parent().parent().find("td:nth-child(5) input").val() / 100;
	var containing	= $(this).val();
...
$(document).on('change', '#mid_mtl_resin_tot2_neck2', function(){
	if($("#mid_mtl_matcsm2_neck2").val() != 'MTL-1903000'){
		$("#layer_resin21hide_neck2").val($(this).val());
	}
	if($("#mid_mtl_csm_add2_neck2").val() != 'MTL-1903000'){
		$("#layer_resin22hide_neck2").val($(this).val());
	}
	if($("#mid_mtl_wr2_neck2").val() != 'MTL-1903000'){
		$("#layer_resin23hide_neck2").val($(this).val());
	}
	if($("#mid_mtl_wr_add2_neck2").val() != 'MTL-1903000'){
		$("#layer_resin24hide_neck2").val($(this).val());
	}
});
...
$(document).on('change', '#mid_mtl_wr2_neck2', function(){
	...
	$.ajax({
		...
		cache: false,
		type: "POST",
		data: "id_material="+$(this).val()+"&resin4="+$('#layer_resin23_neck2').val(),
		dataType: "json",
		success: function(data){
...
$(document).on('change', '#mid_mtl_wr_add2_neck2', function(){
	...
	$.ajax({
		...
		cache: false,
		type: "POST",
		data: "id_material="+$(this).val()+"&resin4="+$('#layer_resin24_neck2').val(),
		dataType: "json",
		success: function(data){
...
$(document).on('keyup', '#persen_katalis2_neck2', function(){
	var nilai			= $(this).val();
	var hasil_resin_tot = $('#hasil_resin_tot2_neck2').val();
	var layer_katalis	= $('#layer_katalis2_neck2').val();
	var Hasil			= (parseFloat(nilai)/100) * parseFloat(hasil_resin_tot) * parseFloat(layer_katalis);
	$('#last_katalis2_neck2').val(RoundUp(Hasil));
});
$(document).on('keyup', '#persen_sm2_neck2', function(){
	var nilai			= $(this).val();
	var hasil_resin_tot = $('#hasil_resin_tot2_neck2').val();
	var layer_sm		= $('#layer_sm2_neck2').val();
	var Hasil			= (parseFloat(nilai)/100) * parseFloat(hasil_resin_tot) * parseFloat(layer_sm);
	$('#last_sm2_neck2').val(RoundUp(Hasil));
});
$(document).on('keyup', '#persen_coblat2_neck2', function(){
	var nilai			= $(this).val();
	var hasil_resin_tot = $('#hasil_resin_tot2_neck2').val();
	var layer_coblat	= $('#layer_coblat2_neck2').val();
	var Hasil			= (parseFloat(nilai)/100) * parseFloat(hasil_resin_tot) * parseFloat(layer_coblat);
	$('#last_cobalt2_neck2').val(RoundUp(Hasil));
});
$(document).on('keyup', '#persen_dma2_neck2', function(){
	var nilai			= $(this).val();
	var hasil_resin_tot = $('#hasil_resin_tot2_neck2').val();
	var layer_dma		= $('#layer_dma2_neck2').val();
	var Hasil			= (parseFloat(nilai)/100) * parseFloat(hasil_resin_tot) * parseFloat(layer_dma);
	$('#last_dma2_neck2').val(RoundUp(Hasil));
});
$(document).on('keyup', '#persen_hydroquinone2_neck2', function(){
	var nilai				= $(this).val();
	var hasil_resin_tot 	= $('#hasil_resin_tot2_neck2').val();
	var layer_hydroquinone	= $('#layer_hydroquinone2_neck2').val();
	var Hasil				= (parseFloat(nilai)/100) * parseFloat(hasil_resin_tot) * parseFloat(layer_hydroquinone);
	$('#last_hidro2_neck2').val(RoundUp(Hasil));
});
$(document).on('keyup', '#persen_methanol2_neck2', function(){
	var nilai				= $(this).val();
	var hasil_resin_tot 	= $('#hasil_resin_tot2_neck2').val();
	var layer_methanol		= $('#layer_methanol2_neck2').val();
	var Hasil				= (parseFloat(nilai)/100) * parseFloat(hasil_resin_tot) * parseFloat(layer_methanol);
	$('#last_methanol2_neck2').val(RoundUp(Hasil));
});
