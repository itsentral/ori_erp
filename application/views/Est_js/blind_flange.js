...
function Hasil2(a, b, c, d, e, StrFakCsm, StrFakCsmAdd, StrFakWr, StrFakWrAdd){
	AcuhanMaxMin();
	...
	var TotalResin2			= str_resin * (Hasillayer21 + Hasillayer22 + Hasillayer23 + Hasillayer24);
...
function changeTop(){
	...
	Hasil2(tot_thickness2, layer1, layer2, layer3, layer4, StrFakCsm, StrFakCsmAdd, StrFakWr, StrFakWrAdd);
...
function structureLayer(){
	...
	var tot_thick_str		=  getNum(thickness1) +  getNum(thickness2) +  getNum(thickness3) +  getNum(thickness4);
