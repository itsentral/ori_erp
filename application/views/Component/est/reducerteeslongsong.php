			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-4'>              
					<?php
						...
						echo form_input(array('id'=>'parent_product','name'=>'parent_product','class'=>'form-control input-sm Hide'));
						echo form_input(array('id'=>'top_toleran','name'=>'top_toleran','class'=>'form-control input-sm Hide','readonly'=>'readonly'),'C100-1903000');
					?>	
