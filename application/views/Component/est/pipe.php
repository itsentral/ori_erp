	...
	<div class="box box-primary">
		...
		<div class="box-body">
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-3'></div>
				<div class='col-sm-1'>
					<input type='text' name='ListDetailPlus4[0][perse]' class='form-control input-sm' id='resin41' readonly value='0.25'>
				</div>
				<div class='col-sm-2'></div>
				<div class='col-sm-1'>              
					<?php
			...
			<div class='form-group row'>
				...
				<label class='col-sm-1'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus4[5][perse]' class='form-control input-sm numberOnly' id='persen_stery4' value='5'>	
				</div>
				<div class='col-sm-1'>              
					<?php
			...
			<div class='form-group row'>
				...
				<label class='col-sm-1'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus4[6][perse]' class='form-control input-sm numberOnly' id='persen_wax4' value='5'>	
				</div>
				<div class='col-sm-1'>              
					<?php
...
<script src="<?php echo base_url('application/views/Est_js/pipe.js'); ?>"></script>
