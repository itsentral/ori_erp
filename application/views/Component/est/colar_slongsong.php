...
<form action="#" method="POST" id="form_proses_bro">
	<div class="box box-success">
		...
		<div class="box-body">
			...
			<div class='headerTitle2'>COLAR</div>
			<div class='form-group row'>
			...
			<div class='form-group row'>
				...
				<div class='col-sm-1'>
					<?php
						echo form_input(array('id'=>'layer_resin4','name'=>'ListDetail[9][containing]','class'=>'form-control input-sm numberOnly','autocomplete'=>'off', 'readonly'=>'readonly'));
					?>
				</div>
				<div class='col-sm-2'></div>
				<div class='col-sm-1'>
			...
			<div class='form-group row'>
				...
				<div class='col-sm-1'>
					<?php
						echo form_input(array('id'=>'layer_resin_tot','name'=>'ListDetail[10][containing]','class'=>'form-control input-sm','readonly'=>'readonly', 'value'=>'0'));
					?>
				</div>
				<div class='col-sm-2'></div>
				<div class='col-sm-1'>
			...
			<div class='form-group row'>
				...
				<div class='col-sm-1'>
					<?php
						echo form_input(array('id'=>'layer_csm_add2_neck1','name'=>'ListDetail2_neck1[2][layer]','class'=>'form-control input-sm numberOnly','autocomplete'=>'off', 'value'=>''));
					?>
				</div>
				<label class='col-sm-1'>Thickness</label>
				<div class='col-sm-1'>
			...
			<div class='form-group row'>
				...
				<div class='col-sm-1'>
					<?php
						echo form_input(array('id'=>'layer_wr_add2_neck1','name'=>'ListDetail2_neck1[6][layer]','class'=>'form-control input-sm numberOnly','autocomplete'=>'off', 'value'=>''));
					?>
				</div>
				<label class='col-sm-1'>Thickness</label>
				<div class='col-sm-1'>
			...
			<div class='form-group row'>
				...
				<div class='col-sm-1'>
					<?php
						echo form_input(array('id'=>'layer_rooving22_neck1','name'=>'ListDetail2_neck1[10][layer]','class'=>'form-control input-sm numberOnly','autocomplete'=>'off', 'value'=>''));
					?>
				</div>
				<label class='col-sm-1'>Thickness</label>
				<div class='col-sm-1'>
			...
			<div class='form-group row'>
				...
				<div class='col-sm-1'>
					<?php
						echo form_input(array('id'=>'layer_csm_add2_neck2','name'=>'ListDetail2_neck2[2][layer]','class'=>'form-control input-sm numberOnly','autocomplete'=>'off', 'value'=>''));
					?>
				</div>
				<label class='col-sm-1'>Thickness</label>
				<div class='col-sm-1'>
			...
			<div class='form-group row'>
				...
				<div class='col-sm-1'>
					<?php
						echo form_input(array('id'=>'layer_wr_add2_neck2','name'=>'ListDetail2_neck2[6][layer]','class'=>'form-control input-sm numberOnly','autocomplete'=>'off', 'value'=>''));
					?>
				</div>
				<label class='col-sm-1'>Thickness</label>
				<div class='col-sm-1'>
			...
			<!-- ============================================STRUKTUR THICKNESS======================================== -->
			<!-- ====================================================================================================== -->
			<div class='headerTitle'>THIKNESS COLAR</div>
			<div class='form-group row'>
				<div class='col-sm-12'>
			...
			<div class='form-group row'>
				<div class='col-sm-8'></div>
				<label class='col-sm-2'>Total Colar Thickness</label>
				<div class='col-sm-1'>              
					<?php
			...
			<div class='form-group row'>
				<div class='col-sm-8'></div>
				<label class='col-sm-2'>Min Colar Thickness</label>
				<div class='col-sm-1'>              
					<?php
			...
			<div class='form-group row'>
				<div class='col-sm-8'></div>
				<label class='col-sm-2'>Max Colar Thickness</label>
				<div class='col-sm-1'>              
					<?php
...
<script src="<?php echo base_url('application/views/Est_js/colar.js'); ?>"></script>
<style type="text/css">
	.kghide{
	...
	$(document).ready(function(){
		...
		$(document).on('click', '#simpan-bro', function(e){
			...
			if(flange_od == '' || flange_od == null || flange_od == 0){
				swal({
				  title	: "Error Message!",
				  text	: 'Colar_od is Empty, please input first ...',
				  type	: "warning"
				});
				$('#simpan-bro').prop('disabled',false);
				return false;
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl		= base_url + active_controller +'/colar_slongsong';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
