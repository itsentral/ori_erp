	...
	<div class="box box-primary">
		...
		<div class="box-body">
			...
			<div class='form-group row'>
				...
				<label class='label-control col-sm-2'><b>Length Mitter</b></label>
				<div class='col-sm-2'>
					<?php
			...
			<div class='form-group row'>
				<label class='label-control col-sm-2'><b><div>MIRROR GLASS<span class='text-red'>*</span></div></b></label>
				<div class='col-sm-3'>
			...
			<div class='form-group row'>
				...
				<div class='col-sm-1'>
					<input type='text' name='ListDetail[10][containing]' class='form-control input-sm' id='layer_resin_tot' readonly>
				</div>
				<div class='col-sm-2'></div>
				<div class='col-sm-1'>
					<?php
			...
			<div class='form-group row'>
				<div class='col-sm-10'></div>
				<div class='col-sm-2'>
					<input type='text' name='acuhan_2' class='form-control input-md Acuhan numberOnly' id='acuhan_2' readonly='readonly' value='0'>
			...
			<div class='form-group row'>
				<div class='col-sm-12'>
					<button type='button' name='simpan-bro' id='simpan-bro' class='btn btn-primary' style='float:right; width:100px;'>Save</button>
				</div>
			</div>
			<!-- ====================================================================================================== -->
			<!-- ===============================================END TOPCOAT============================================ -->
	...
	$(document).ready(function(){
		...
		$(document).on('keyup', '#nil_type', function(){
			if($('#top_diameter').val() == '' || $('#top_diameter').val() == null || $('#top_diameter').val() == '0'){
				swal({
				  title	: "Error Message!",
				  text	: 'Diameter Elbow belum dipilih ...',
				  type	: "warning"
				});
				return false;
			}
