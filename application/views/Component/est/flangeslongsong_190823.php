	...
	<div class="box box-success">
		...
		<div class="box-body">
			...
			<div class='form-group row'>
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_katalis2_neck2','name'=>'ListDetailPlus2_neck2[0][last_cost]', 'style'=>'margin-left:-81px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-101px; margin-top: 6px;'>Kg</label>
			</div>
...
<script src="<?php echo base_url('application/views/Component/est/javascript/flange_slongsong/add_table.js'); ?>"></script>
<script src="<?php echo base_url('application/views/Component/est/javascript/flange_slongsong/top.js'); ?>"></script>
<script src="<?php echo base_url('application/views/Component/est/javascript/flange_slongsong/liner.js'); ?>"></script>
<script src="<?php echo base_url('application/views/Component/est/javascript/flange_slongsong/structure.js'); ?>"></script>
<script src="<?php echo base_url('application/views/Component/est/javascript/flange_slongsong/external.js'); ?>"></script>
<script src="<?php echo base_url('application/views/Component/est/javascript/flange_slongsong/topcoat.js'); ?>"></script>
<script src="<?php echo base_url('application/views/Component/est/javascript/flange_slongsong/change_all.js'); ?>"></script>
<style type="text/css">
	.kghide{
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl		= base_url + active_controller +'/flange_slongsong';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
