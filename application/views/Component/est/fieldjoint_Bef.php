	...
	<div class="box box-primary">
		...
		<div class="box-body">
			...
			<div class='form-group row'>
				...
				<div class='col-sm-3'>
					<?php
						echo form_input(array('type'=>'text','id'=>'factor_thickness','name'=>'factor_thickness','class'=>'form-control input-sm','value'=>'1.5'));
					?>
				</div>
			</div>
				...
				*/
				...
				for (var q = 10; q >= 1; q--) {
					if ($('#glassconfiguration_'+q).val()	==	"VEIL") {
						...
						console.log(parseFloat($('#width_'+q)));
						console.log(gl);
						console.log(parseFloat($('#veil_area_weight').val()));
