	...
	<div class="box">
		<div class="box-body" style="">
			<table id="my-grid" class="table table-striped table-bordered table-hover table-condensed" width="100%">
				<tbody>
					<tr>
						<td class="text-left"><b>Component ID</b></td>
						<td class="text-left" colspan='5' style='color: #2c92b1;'><b><?= $id_product; ?></b></td>
					</tr>
					<tr>
						<td class="text-left"><b>Component GROUP</b></td>
						<td class="text-left" colspan='5'><?= strtoupper($restHeader[0]['resin_sistem']." - ".$restHeader[0]['pressure']." BAR - ".$restHeader[0]['stiffness']." - ".$restHeader[0]['criminal_barier']." - ".$restHeader[0]['vacum_rate']." - ".$restHeader[0]['aplikasi_product']); ?></td>
					</tr>
					<tr>
						<td class="text-left"><b>Custom By</b></td>
						<td class="text-left" colspan='5'><?= $restCustomer[0]['nm_customer'].' <b>('.$restHeader[0]['standart_code'].')</b>'; ?></td> 
					</tr>
					<tr>
						<td class="text-left" width='20%'><b>Product Name</b></td>
					...
					?>
					<tr>
						<td class="text-left" style='color:red;'><b>Reject Reason</b></td>
