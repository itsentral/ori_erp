		...
		<table id="example1" width='100%' class="table table-bordered table-striped">
			<thead>
				<tr class='bg-blue'>
					...
					<th class="text-center" width='9%'>Stifness</th>
					<th class="text-center" width='10%'>Service Fluide</th>
...
<script>
	$(document).ready(function(){
		...
		$(document).on('click', '.mat_weight', function(e){
			...
			loading_spinner();
			$("#head_title").html("<b>DETAIL ESTIMATION ["+$(this).data('id_product')+"]</b>");
			$("#view").load(base_url +'index.php/'+ active_controller+'/modalWeight/'+$(this).data('id_product'));
			$("#ModalView").modal();
		});
	...
	function DataTables(series = null, komponen = null){
		...
		var dataTable = $('#example1').DataTable({
			...
			"ajax":{
				url : base_url + active_controller+'/server_side_component',
				type: "post",
				data: function(d){
					d.series 	= series,
					d.komponen 	= komponen
