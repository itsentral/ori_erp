<?php
	...
	if ($restHeader[0]['parent_product']=='branch joint' || $restHeader[0]['parent_product']=='field joint' || $restHeader[0]['parent_product']=='shop joint')
	{
		...
		$qDetail2		= "SELECT * FROM component_detail WHERE id_product='".$id_product."' AND detail_name='RESIN AND ADD' AND id_material <> 'MTL-1903000'";
		$qDetail3		= "SELECT * FROM component_lamination WHERE id_product='".$id_product."' AND detail_name='Inside Lamination' ";
		$qDetail4		= "SELECT * FROM component_lamination WHERE id_product='".$id_product."' AND detail_name='Outside Lamination' AND width > 0";
		
		$qDetailAdd2	= "SELECT * FROM component_detail_add WHERE id_product='".$id_product."' AND detail_name='RESIN AND ADD'";
...
?>
				...
				<tbody>
					...
					if ($restHeader[0]['parent_product']=='branch joint' || $restHeader[0]['parent_product']=='field joint' || $restHeader[0]['parent_product']=='shop joint')
					{
						...
						<tr style="background-color:#A0A0A0">
							<td class="text-center" colspan='11'><b><?= $restDetail1[0]['detail_name']; ?></b></td>
						</tr>
						<tr class='bg-blue'>
							<td class="text-left" width='12%' colspan="2">MATERIAL TYPE</td>
							<td class="text-left" colspan='5'>MATERIAL NAME</td>
							<td class="text-center" width='6%'>AREA WEIGHT</td>
							<td class="text-right" width='6%'>RESIN CONTENT</td>
							<td class="text-center" width='6%'>THICKNESS</td>
							<td class="text-right" width='6%'>MATERIAL WEIGHT</td>
						</tr>
						<?php
						foreach($restDetail1 AS $val => $valx){
							...
							?>
							<tr>
								<td class="text-left" colspan="2"><?= strtoupper($restName[0]['category']);?></td>
								<td class="text-left" colspan='5'><?= $valx['nm_material'];?></td>
								<td class="text-center" style='background-color: <?=$bgC1;?>; color: <?= $Cl1;?>'><?= floatval($valx['area_weight']);?></td>
								<td class="text-right" style='background-color: <?=$bgC2;?>; color: <?= $Cl2;?>'><?= $valx['resin_content'];?></td>
								<td class="text-right" style='background-color: <?=$bgC3;?>; color: <?= $Cl3;?>'><?= floatval($valx['thickness']);?></td>
								<td class="text-right" style='background-color: <?=$bgC4;?>; color: <?= $Cl4;?>'><?= floatval($valx['material_weight']);?></td>
							</tr>
							<?php
						}
							?>
						<tr style="background-color:#A0A0A0">
							<td class="text-center" colspan='11'><b><?= $restDetail2[0]['detail_name']; ?></b></td>
						</tr>
						<tr class='bg-blue'>
							<td class="text-left" width='12%' colspan="2">MATERIAL TYPE</td>
							<td class="text-left" colspan='5'>MATERIAL NAME</td>
							<td class="text-center" width='6%'></td>
							<td class="text-right" width='6%'>PERCENTAGE</td>
							<td class="text-center" width='6%'></td>
							<td class="text-right" width='6%'>MATERIAL WEIGHT</td>
						</tr>
							<?php
						foreach($restDetail2 AS $val => $valx){
							...
							<tr>
								...
								<td class="text-center"></td>
								<td class="text-right" style='background-color: <?=$bgC2;?>; color: <?= $Cl2;?>'><?= number_format($valx['material_weight'],4);?></td>
							</tr>
							<?php
						}
							if(!empty($restDetailAdd2)){
								?>
								<tr>
									<td class="text-left" colspan='11'><b>Material Add</b></td>
								</tr>
								<?php
								foreach($restDetailAdd2 AS $val => $valx){
									...
									<tr>
										...
										<td class="text-center"></td>
										<td class="text-right" style='background-color: <?=$bgC2;?>; color: <?= $Cl2;?>'><?= number_format($valx['last_cost'], 4);?></td>
									</tr>
								<?php
								}
							}
						...
						<tr class='bg-blue'>
							<td class="text-left" width='6%'>LAPISAN</td>
							<td class="text-left" width='6%'>STD GLASS</td>
							<td class="text-center" width='6%'>WIDTH</td>
							<td class="text-right" width='6%'>STAGE</td>
							<td class="text-center" width='6%'>GLASS CONF.</td>
							<td class="text-right" width='6%' colspan="2">THICKNESS</td>
							<td class="text-center" width='6%'>GLASS LENGTH</td>
							<td class="text-center" width='6%'>WEIGHT VEIL</td>
							<td class="text-center" width='6%'>WEIGHT CSM</td>
							<td class="text-center" width='6%'>WEIGHT WR</td>
						</tr>
						<tr style="background-color:#A0A0A0">
							<td class="text-center" colspan='11'><b><?= $restDetail3[0]['detail_name']; ?></b></td>
						</tr>
							<?php
						foreach($restDetail3 AS $val => $valx){
							...
							<tr>
								...
								<td class="text-center" style='background-color: <?=$bgC1;?>; color: <?= $Cl1;?>'><?= number_format($valx['width']);?></td>
								<td class="text-center"></td>
								<td class="text-right"><?= $valx['glass'];?></td>
								<td class="text-right" style='background-color: <?=$bgC2;?>; color: <?= $Cl2;?>'><?= $valx['thickness_1'];?></td>
								<td class="text-center" style='background-color: <?=$bgC3;?>; color: <?= $Cl3;?>'><?= floatval($valx['thickness_2']);?></td>
								<td class="text-center" style='background-color: <?=$bgC4;?>; color: <?= $Cl4;?>'><?= floatval($valx['glass_length']);?></td>
								<td class="text-center" style='background-color: <?=$bgC5;?>; color: <?= $Cl5;?>'><?= floatval($valx['weight_veil']);?></td>
								<td class="text-center" style='background-color: <?=$bgC6;?>; color: <?= $Cl6;?>'><?= floatval($valx['weight_csm']);?></td>
								<td class="text-center" style='background-color: <?=$bgC7;?>; color: <?= $Cl7;?>'><?= floatval($valx['weight_wr']);?></td>
							</tr>
							<?php
						}
							?>
						<tr style="background-color:#A0A0A0">
							<td class="text-center" colspan='11'><b><?= $restDetail4[0]['detail_name']; ?></b></td>
						</tr>
							<?php
	...
	<?php
	if(isset($numRowsN1) && $numRowsN1 > 0){
		?>
					...
					<tbody>
						...
						if($NumDetailAdd2N2 > 0){
							...
							<tr>
								...
								<td class="text-right" style='background-color: <?=$bgC8;?>; color: <?= $Cl8;?>'><?= floatval($valx['perse']);?></td>
								<td class="text-right" style='background-color: <?=$bgC0;?>; color: <?= $Cl0;?>'><?= $valx['last_cost'];?></td>
							</tr>
								<?php
							}
	...
	if(isset($NumDetailPlus4) && $NumDetailPlus4 > 0){
		?>
