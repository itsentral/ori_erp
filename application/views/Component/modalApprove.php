				...
				<tbody>
					...
					<tr>
						...
						<?php
							...
							elseif($restHeader[0]['parent_product'] == 'field joint' OR $restHeader[0]['parent_product'] == 'shop joint' OR $restHeader[0]['parent_product'] == 'branch joint'  ){
								$judulLabel	= "Min. Width";
								$isiData	= $restHeader[0]['panjang']." mm";
								$d1Label	= " 1 / Diameter 2";
								$d2Isi		= " / ".$restHeader[0]['diameter2']." mm";
								$persen		= "";
								$minmax		= 'Thickness Joint / Thickness Factor';
								$minmax_v	=	$restHeader[0]['joint_thickness']." mm / ".$restHeader[0]['factor_thickness']." mm";
								$waste		= 'Factor';
								$waste_v	= $restHeader[0]['factor'];
							}
						?>
						...
						<td class="text-left"><?= (substr($restHeader[0]['parent_product'],-5)=='joint')?floatval($restHeader[0]['pipe_thickness']):floatval($restHeader[0]['design'])." mm"; ?></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="text-left" width='15%'><u><?=isset($waste)?$waste:'Waste '.$persen?> </u></td>
						<td class="text-left" width='15%'><?= isset($waste_v)?$waste_v:floatval($restHeader[0]['waste']); ?></td>
