...
<script src="<?php echo base_url('application/views/Component/edit/javascript/equal_tee.js'); ?>"></script>
...
<script>	
	$(document).ready(function(){
		...
		$.ajax({
			...
			data: "diameter="+diameter+"&standart="+standart_code+"&parent_product="+parent_product,
			dataType: "json",
			success: function(data){ 
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl		= base_url +'edit_standart/equal_tee_mould_edit';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
