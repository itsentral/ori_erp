...
function LuasArea(){
	...
	var panjang			= parseFloat($('#length').val());
...
function AllThickness(){
	...
	var totthicknessStr1	= parseFloat($('#total_thicknessStr_1').val());
	var totthicknessStr2	= parseFloat($('#total_thicknessStr_3').val());
	var totthicknessStr3	= parseFloat($('#total_thicknessStr_5').val());
	var totthicknessStr4	= parseFloat($('#total_thicknessStr_7').val());
	var totthicknessStr5	= parseFloat($('#total_thicknessStr_9').val());
	var totthicknessStr6	= parseFloat($('#total_thicknessStr_11').val());
	...
	var totthicknessEks1	= parseFloat($('#total_thicknessEks_1').val());
	var totthicknessEks2	= parseFloat($('#total_thicknessEks_3').val());
	var totthicknessEks3	= parseFloat($('#total_thicknessEks_5').val());
	var totthicknessEks4	= parseFloat($('#total_thicknessEks_7').val());
