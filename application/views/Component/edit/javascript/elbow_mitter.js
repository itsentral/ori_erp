...
function LuasArea(){
	...
	var panjang	= getNum($('#panjang').val());
	// console.log(angle);
...
function ChangeAreaToStr(Area){
	...
	$('#last_costStr_13').val(RoundUp(resiTot));
	...
	$("#last_costStr_9").val(RoundUp(last_costStr_9));
	$("#last_costStr_11").val(RoundUp(last_costStr_11));
	...
	$("#last_costStr_10").val(RoundUp(resin10));
	$("#last_costStr_12").val(RoundUp(resin12));
}
...
function length_mitter(radius, angle){
	...
	$('#panjang').val(getNum(hasil_tan).toFixed(2));
}
