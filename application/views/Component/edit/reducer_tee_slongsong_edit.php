...
<form action="#" method="POST" id="form_proses_bro">   
	<div class="box box-primary">
		...
		<div class="box-body">
			<?php
				echo "&nbsp;<a href='".site_url('component')."' style='min-width:100px;margin-bottom:-35px;float: right;' class='btn btn-md btn-danger' title='Back To List' data-role='qtip'>Back</a>";
			?>						
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-4'>              
					<?php
						...
						echo form_input(array('id'=>'diameter2','name'=>'diameter2','class'=>'Hide'),$header[0]->diameter2);
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('type'=>'text','id'=>'panjang','name'=>'panjang','class'=>'form-control input-sm numberOnly','placeholder'=>'Waste','readonly'=>'readonly'), floatval($header[0]->panjang));	
					?>	
				</div>
				<div class='col-sm-1'>              
					<?php
			...
			<div class="box box-primary">
				<?php
					echo "<b>Thickness Structure : </b>".form_input(array('type'=>'text','id'=>'ThStr','name'=>'ThStr','class'=>'form-control input-sm numberOnly','style'=>'width:150px; text-align:center;','readonly'=>'readonly'), floatval($detStructure[0]['acuhan']));
				?>
				<div class="box-body" style="">
					<table id="my-grid" class="table table-striped table-bordered table-hover table-condensed" width="100%"> 
						<head>
			...
			<div class="box box-primary">
				<?php
					echo "<b>Thickness External : </b>".form_input(array('type'=>'text','id'=>'ThEks','name'=>'ThEks','class'=>'form-control input-sm numberOnly','style'=>'width:150px; text-align:center;'), floatval($detEksternal[0]['acuhan']));
				?>
				<div class="box-body" style="">
					<table id="my-grid" class="table table-striped table-bordered table-hover table-condensed" width="100%">
						<head>
							...
							<?php
								...
								foreach($detEksternalPlus AS $val => $valx){
									...
									<tr>
										...
										<td align='center'><input type='text' name='ListDetailPlus3[<?=$no;?>][containing]' id='Lincontaining3_<?=$no;?>' class='form-control input-sm numberOnly' style='text-align:right; width:80px;' value='<?= $CONTAINING;?>'></td>
			...
			<?php
				echo "&nbsp;<a href='".site_url('component')."' style='min-width:100px;float: right;' class='btn btn-md btn-danger' title='Back To List' data-role='qtip'>Back</a>";
...
<script src="<?php echo base_url('application/views/Component/edit/javascript/reducer_tee.js'); ?>"></script>
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl		= base_url +'edit_standart/reducer_tee_slongsong_edit';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
							...
							success		: function(data){								
								if(data.status == 1){											
									...
									window.location.href = base_url + 'component';
								}
