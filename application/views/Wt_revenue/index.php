...
<div class="box">
	...
	<div class="box-body">
		...
		<tr>
			...
			<td><?= number_format($record->total_deal_idr) ?></td>
			<td><?= number_format($record->percent_invoice)?>%</td>
			<td><?= number_format($record->percent_do)?>%</td>		
			<td style="padding-left:20px">			
			
				<a class="btn btn-success btn-sm" href="<?= base_url('/wt_revenue/createRevenue/'.$record->no_ipp) ?>" target="_blank" title="Create Revenue" data-no_so="<?=$record->no_ipp?>"><i class="fa fa-plus"></i>
				</a>
