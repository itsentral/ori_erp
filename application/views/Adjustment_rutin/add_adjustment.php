	...
	<div class="box box-primary">
		...
		<div class="box-body">
			...
			<div class='form-group row gudang_mutasi'>
				...
				<label class='label-control col-sm-2'><b>Dept/Costcenter</b></label>
				<div class='col-sm-4'>
					<select name='id_gudang_ke_m' id='id_gudang_ke_m' class='form-control input-sm'>
						<option value='0'>Select Dept/Costcenter</option>
						<?php
						foreach(get_list_dept() AS $val => $valx){
							echo "<option value='".$valx['id']."'>".strtoupper($valx['nm_dept'])."</option>";
						}
						?>
					</select>
				</div>
