	...
	<div class="box box-primary">
		...
		<h3 class="box-title"><?php echo $title;?></h3><br><br>
			...
			<?php if($akses_menu['create']=='1'){ ?>
				<a href="<?php echo base_url('amortisasi/add') ?>" class="btn btn-md btn-success" id='btn-add'>
					<i class="fa fa-plus"></i> Add Amortisasi
				</a>
				<a href="<?php echo base_url('amortisasi/jurnal') ?>" class="btn btn-md btn-primary" id='btn-jurnal'>
				...
				<table id="example1" class="table table-bordered table-striped" width='100%'>
					<thead>
						<tr class='bg-blue' >
							...
							<th class="text-center">Amortisasi Total</th>
							<th class="text-center">Nilai Amortisasi</th>
							<th class="text-center">Amortisasi</th>
