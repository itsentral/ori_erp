<div class="box box-info">
    ...
    <div class="box-footer bg-info">
        <input type="hidden" id="id_pro_detail" value="<?= $id_pro_detail ; ?>">
        <button type="button" style="margin-bottom:10px" id="print_qrcode" class="btn btn-success"><i
                class="fa fa-print"></i> Print QR Code</button>
    </div>
</div>