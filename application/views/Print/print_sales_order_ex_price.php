<?php
	...
	echo "<table class='gridtable' width='100%' border='0' cellpadding='2'>";
		echo "<thead>";
			echo "<tr>";
				...
				echo "<th style='text-align: left'>ITEM NO</th>";
				echo "<th style='text-align: left' width='15%'>PO DESCRIPTION</th>";
				echo "<th style='text-align: left' width='15%'>SPEC</th>";
				...
				// echo "<th style='text-align: right' width='12%'>TOTAL PRICE</th>";
			echo "</tr>";
		echo "</thead>";
		echo "<tbody>";
			$no = 0;
			...
			foreach($data_product AS $val => $valx2){ $no++;
				$SUM += $valx2['total_price'] * $data_header[0]['kurs_usd_dipakai'];
				echo "<tr>";
					echo "<td>".$no."</td>";
					...
					// echo "<td align='right'>".number_format($valx2['price_satuan'] * $data_header[0]['kurs_usd_dipakai'])."</td>";
					// echo "<td align='right'>".number_format($valx2['total_price'] * $data_header[0]['kurs_usd_dipakai'])."</td>";
				echo "</tr>";
			}
			foreach($data_material AS $val => $valx2){ $no++;
				echo "<tr>";
					...
					echo "<td align='left'>".strtoupper($valx2['customer_item'])."</td>";
					echo "<td align='left'>".strtoupper($valx2['desc'])."</td><td></td>";
					echo "<td align='right'>".number_format($valx2['qty'],2)."</td>";
					echo "<td align='left'>".strtoupper($valx2['satuan'])."</td>";
					// echo "<td align='right'>".number_format($valx2['unit_price'],2)."</td>";
			...
			foreach($data_packing AS $val => $valx2){ $no++;
				echo "<tr>";
					...
					// echo "<td align='right'>".$matauang.number_format($valx2['total_deal_usd'],2)."</td>";
				echo "</tr>";
			}
			foreach($data_shipping AS $val => $valx2){ $no++;
				echo "<tr>";
					...
					echo "<td align='right'>".number_format($valx2['qty'],2)."</td>";
					echo "<td align='left'>".strtoupper($valx2['satuan'])."</td>";
					// echo "<td align='right'>".number_format($valx2['total_deal_usd']/$valx2['qty'],2)."</td>";
					// echo "<td align='right'>".number_format($valx2['total_deal_usd'],2)."</td>";
				echo "</tr>";
			}
			foreach($data_other AS $val => $valx2){ $no++;
				echo "<tr>";
					echo "<td>".$no."</td>";
					echo "<td align='left' colspan='4'>".strtoupper($valx2['desc'])."</td>";
					echo "<td align='right'>".number_format($valx2['qty'],2)."</td>";
					echo "<td align='left'></td>";
				echo "</tr>";
			}
			...
			// echo "<tr>";
				...
				// echo "<td align='right'><b>".number_format($data_total[0]['product_idr'])."</b></td>";
			// echo "</tr>";
			// if($data_total[0]['pack_idr'] > 0){
			// echo "<tr>";
				// echo "<td colspan='5'></td>";
				// echo "<td colspan='2'><b>PACKING</b></td>";
				// echo "<td align='right'><b>".number_format($data_total[0]['pack_idr'])."</b></td>";
			// echo "</tr>";
			// }
			...
			// echo "<tr>";
				...
				// echo "<td align='right'><b>".number_format($data_total[0]['ship_idr'])."</b></td>";
			// echo "</tr>";
			// }
			...
			// echo "<tr>";
				...
				// echo "<td align='right'><b>".number_format($data_total[0]['eng_idr'])."</b></td>";
			// echo "</tr>";
			// }
			...
			// echo "<tr>";
				...
				// echo "<td align='right'><b>".number_format($data_total[0]['mat_idr'])."</b></td>";
			// echo "</tr>";
			// }
			...
			// echo "<tr>";
				...
				// echo "<td align='right'><b>".number_format($data_total[0]['acc_idr'])."</b></td>";
			// echo "</tr>";
			// }
			// $SUM_IDR = $data_header[0]['total_price'] * $data_header[0]['kurs_usd_dipakai'] ;
			// echo "<tr>";
				// echo "<td colspan='5'></td>";
				// echo "<td colspan='2'><b>DISCOUNT (".$data_header[0]['diskon']."%)</b></td>";
				// echo "<td align='right'><b>".number_format($SUM_IDR - $data_header[0]['total_deal_idr'])."</b></td>";
			// echo "</tr>";
			// echo "<tr>";
				// echo "<td colspan='5'><b>Kurs : ".number_format($data_header[0]['kurs_usd_dipakai'])."</b></td>";
				// echo "<td colspan='2'><b>SUBTOTAL</b></td>";
				// echo "<td align='right'><b>".number_format($data_header[0]['total_deal_idr'])."</b></td>";
			// echo "</tr>";
			echo "<tr>";
				echo "<td colspan='6'>Note : ".ucfirst($data_header[0]['catatan'])."</td>";
			echo "</tr>";
			echo "<tr>";
	...
	echo "<table class='gridtable' width='100%' border='0' cellpadding='2'>";
		echo "<thead>";
			echo "<tr>";
				...
				// echo "<th style='text-align: left' width='16%'>VALUE</th>";
		...
		foreach($data_top AS $val => $valx2){
			echo "<tr>";
				...
				// echo "<td align='right'>".number_format($valx2['value_idr'])."</td>";
	...
	$mpdf->WriteHTML($html);
	$mpdf->Output('sales-order-ex-price-'.$no_ipp.'.pdf' ,'I');
