...
<table class='gridtable3' width='100%' border='0' cellpadding='0' cellspacing='0'>
	<tbody>
		...
		<tr>
			<td><b>B.</b></td>
			<td colspan='6'><b>Kondisi dan Tahap Pembayaran Harga</b></td>
		</tr>
		<tr>
			<td></td>
			<td class='valign'>1.</td>
			<td colspan='4' class='justify'>
				Sehubungan dengan Produk yang disebutkan di atas, dengan ini kami mengajukan harga produk adalah  Terlampir.  Harga tersebut tidak meliputi hal sebagai berikut:<br>
				<ul>
					<li>Pajak penjualan sebesar 10% sebagaimana disebutkan dalam ketentuan peraturan hukum pajak yang berlaku di Indonesia.</li>
					<li>Pajak penghasilan pasal 23 sebesar 2 % sebagaimana disebutkan dalam ketentuan peraturan hukum pajak yang berlaku di Indonesia. (khusus instalasi).</li>
				</ul>
			</td>
		</tr>
		<tr>
...
<table class='gridtable3' width='100%' border='0' cellpadding='0' cellspacing='0'>
	<tbody>
		...
		<tr>
			<td></td>
			<td class='valign'>4.</td>
			<td colspan='3' class='justify'>Order tidak dapat dibatalkan dalam kondisi dan alasan apapun.</td>
		</tr>
		<tr>
			<td colspan='5' height='10px;'></td>
		</tr>
