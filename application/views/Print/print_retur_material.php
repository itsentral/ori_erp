...
<table class="gridtable2" border='1' width='100%' cellpadding='2'>
	...
	<tr>
		<td align='center'><b><h2>TANDA RETUR BARANG</h2></b></td>
	</tr>
</table>
<br>
<br>
...
<table class="gridtable" width='100%' border='1' cellpadding='2'>
	<thead align='center'>
		<tr>
			...
			<th class="mid" style='vertical-align:middle;'>Nama Material</th>
			<th class="mid" width='10%'>Qty Order (Kg)</th>
			<th class="mid" width='10%'>Qty Retur (Kg)</th>
...
$mpdf->WriteHTML($html);
$mpdf->Output('tanda retur material '.$kode_trans.'/'.date('ymdhis', strtotime($dated)).'.pdf' ,'I');