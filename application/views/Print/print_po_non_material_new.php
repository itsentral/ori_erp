<?php
	...
	$rest_detail	= $this->db->get_where('tran_po_detail',array('no_po'=>$no_po))->result_array();
	if($data_header[0]->status != 'DELETED'){
		$rest_detail	= $this->db->get_where('tran_po_detail',array('no_po'=>$no_po,'deleted'=>'N'))->result_array();
	}
	...
	echo "<table class='gridtable3' width='50%' border='1' cellpadding='2'>";
		echo "<tbody>";
			...
			echo "<tr>";
				...
				echo "<td>".date('d F Y', strtotime($REQ_DATE))."</td>";
			echo "</tr>";
		echo "</tbody>";
	echo "</table>";
	echo "<br>";
	echo "<table class='gridtable' width='100%' border='0' cellpadding='2'>";
		...
		echo "<tbody>";
			...
			echo "<tr>";
				echo "<td align='right' colspan='4'><b>DISCOUNT (".number_format($data_header[0]->discount,2)." %)</b></td>";
				echo "<td align='right'><b>".number_format($diskon,2)."</b></td>";
			echo "</tr>";
			$net_price = $data_header[0]->total_po - $diskon;
			echo "<tr>";
				echo "<td align='right' colspan='4'><b>NET PRICE</b></td>";
				echo "<td align='right'><b>".number_format($net_price,2)."</b></td>";
			echo "</tr>";
            echo "<tr>";
				echo "<td align='right' colspan='4'><b>TAX (".number_format($data_header[0]->tax,1)." %)</b></td>";
				echo "<td align='right'><b>".number_format($net_price * $data_header[0]->tax / 100,2)."</b></td>";
			echo "</tr>";
			echo "<tr>";
				echo "<td align='right' colspan='4'><b>DELIVERY COST</b></td>";
				echo "<td align='right'><b>".number_format($data_header[0]->delivery_cost,2)."</b></td>";
			echo "</tr>";
			echo "<tr>";
				echo "<td align='right' colspan='4'><b>GRAND TOTAL</b></td>";
