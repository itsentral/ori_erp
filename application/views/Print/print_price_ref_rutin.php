...
<table class="gridtable" width='100%' border='1' cellpadding='2'>
	<thead align='center'>
		<tr>
			...
			<th class="mid" width='18%' style='vertical-align:middle;'>Material Name</th>
			<th class="mid" style='vertical-align:middle;'>Spec</th>
			<th class="mid" width='12%' style='vertical-align:middle;'>Brand</th>
			<th class="mid" width='6%'>Unit</th>
			<th class="mid" width='8%'>Price (IDR)</th>
			<th class="mid" width='9%'>Expired</th>
			<th class="mid" width='10%'>Ket</th> 
		</tr>
	</thead>
	<tbody>
		<?php
			...
			foreach($rest_d AS $val => $valx){
				...
				if($status == 'all'){
					...
					echo "<tr>";
						...
						echo "<td align='right'>".date('d-M-Y', strtotime($valx['updated_date']))."</td>";
						echo "<td>".strtoupper($valx['material_name'])."</td>";
						echo "<td>".strtoupper($valx['spec'])."</td>";
						echo "<td>".strtoupper($valx['brand'])."</td>";
						echo "<td>".strtoupper($valx['unit'])."</td>";
						echo "<td align='right'>".number_format($valx['rate'])."</td>";
