...
$nm_ke 		= strtoupper($rest_data[0]->note);
$nm_dari 	= get_name('warehouse', 'nm_kode', 'id', $rest_data[0]->id_gudang_dari);

$nm_gd_ke 	= strtoupper($rest_data[0]->note);
...
<table class="gridtable2" width="100%" border='0' style='border-bottom:none;'>
	<tr>
		...
		<td style='border-left:none; border-bottom: none;' width='20%'><?=$rest_data[0]->form_no;?></td>
	...
	<tr>
		...
		<td style='border-left:none; border-top: none; border-bottom: none;'><?=$rest_data[0]->rev_no;?></td>
	</tr>
	<tr>
		<td style='border-right:none; border-top: none;'>Issue Date</td>
		<td style='border-right:none; border-top: none; border-left:none;'>:</td>
		<td style='border-left:none; border-top: none;'><?=$rest_data[0]->issue_date;?></td>
	...
	<tr>
		...
		<td style='border:none;'>:</td>
		<td style='border-bottom:none; border-top: none; border-left:none;'><?=$rest_data[0]->no_memo;?></td>
	...
	<tr>
		...
		<td style='border:none;'>:</td>
		<td style='border-bottom:none; border-top: none; border-left:none;'><?=$rest_data[0]->no_so;?></td>
...
$mpdf->WriteHTML($html);
ob_clean();
$mpdf->Output('request subgudang material '.$kode_trans.'/'.date('ymdhis', strtotime($dated)).'.pdf' ,'I');