<?php
		...
		echo "<tbody>";
			...
			foreach($data_product AS $val => $valx2){ $no++;
				echo "<tr>";
					...
					echo "<td align='right'>".$matauang.number_format($valx2['total_deal_usd']/$valx2['qty'],2)."</td>";
			...
			foreach($data_other AS $val => $valx2){ $no++;
				$SUM_OTHER += $valx2['total_deal_usd'];
				echo "<tr>";
					echo "<td>".$no."</td>";
			...
			echo "<tr>";
				...
				echo "<td colspan='2' align='right'><b>".$matauang.number_format($data_total[0]['product_usd'] + $data_total[0]['mat_usd'] + $data_total[0]['acc_usd'],2)."</b></td>";
			echo "</tr>";
			if($data_total[0]['pack_usd'] > 0){
			echo "<tr>";
				echo "<td colspan='4'></td>";
				echo "<td colspan='2'><b>PACKING</b></td>";
				echo "<td colspan='2' align='right'><b>".$matauang.number_format($data_total[0]['pack_usd'],2)."</b></td>";
			echo "</tr>";
			}
			if($SUM_OTHER > 0){
			echo "<tr>";
				...
				echo "<td colspan='2' align='right'><b>".$matauang.number_format($SUM_OTHER,2)."</b></td>";
			echo "</tr>";
			}
			if($data_total[0]['ship_usd'] > 0){
			echo "<tr>";
				echo "<td colspan='4'></td>";
				echo "<td colspan='2'><b>TRUCKING</b></td>";
				echo "<td colspan='2' align='right'><b>".$matauang.number_format($data_total[0]['ship_usd'],2)."</b></td>";
			echo "</tr>";
			}
			if($data_total[0]['eng_usd'] > 0){
			echo "<tr>";
				echo "<td colspan='4'></td>";
				echo "<td colspan='2'><b>ENGENEERING</b></td>";
				echo "<td colspan='2' align='right'><b>".$matauang.number_format($data_total[0]['eng_usd'],2)."</b></td>";
			echo "</tr>";
			}
			if($data_total[0]['mat_usd'] > 0){
			echo "<tr>";
				echo "<td colspan='4'></td>";
				echo "<td colspan='2'><b>MATERIAL</b></td>";
				echo "<td colspan='2' align='right'><b>".$matauang.number_format($data_total[0]['mat_usd'],2)."</b></td>";
			echo "</tr>";
			}
			if($data_total[0]['acc_usd'] > 0){
			echo "<tr>";
				echo "<td colspan='4'></td>";
				echo "<td colspan='2'><b>ACCESSORIES</b></td>";
				echo "<td colspan='2' align='right'><b>".$matauang.number_format($data_total[0]['acc_usd'],2)."</b></td>";
			echo "</tr>";
			}
			$SUM_IDR = $data_header[0]['total_price'];
			if($data_total[0]['diskon'] > 0){
			echo "<tr>";
				echo "<td colspan='4'></td>";
				echo "<td colspan='2'><b>DISCOUNT (".$data_header[0]['diskon']."%)</b></td>";
				echo "<td colspan='2' align='right'><b>".$matauang.number_format($SUM_IDR - $data_header[0]['total_deal_usd'],2)."</b></td>";
			echo "</tr>";
			}
			echo "<tr>";
				echo "<td colspan='4'></td>";
				echo "<td colspan='2'><b>SUBTOTAL</b></td>";
				echo "<td colspan='2' align='right'><b>".$matauang.number_format($data_header[0]['total_deal_usd'],2)."</b></td>";
			echo "</tr>";
			echo "<tr>";
				echo "<td colspan='8'>Note : ".ucfirst($data_header[0]['catatan'])."</td>";
			echo "</tr>";
			echo "<tr>";
	...
	echo "<table class='gridtable' width='100%' border='0' cellpadding='2'>";
		...
		foreach($data_top AS $val => $valx2){
			echo "<tr>";
				...
				echo "<td align='right'>".$matauang.number_format($valx2['value_usd'],2)."</td>";
	...
	$mpdf->WriteHTML($html);
	$mpdf->Output('sales-order-price-usd-'.$no_ipp.'.pdf' ,'I');
