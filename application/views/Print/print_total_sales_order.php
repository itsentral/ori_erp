...
<table class="gridtable2" border='1' width='100%' cellpadding='2'>
	...
	<tr>
		<td align='center'><b><h2>LIST DEAL SALES ORDER <?=date('Y');?></h2></b></td>
	</tr>
</table>
<br>
<table class="gridtable" width='100%' border='1' cellpadding='2'>
	<thead align='center'>
		<tr>
			...
			<th class="mid" width='10%' >App SO.</th>
			<th class="mid" width='10%'>Deal SO</th>
		</tr>
	</thead>
	<tbody>
		<?php
		...
		if(!empty($result)){
			...
			foreach($result AS $val => $valx){ 
                ...
                echo "<tr>";
                    ...
                    echo "<td style='vertical-align:top;' align='center'>".date('d-M-Y', strtotime($valx['approved_date']))."</td>";
                    echo "<td style='vertical-align:top;' align='right'>".number_format($valx['total_deal_usd'],2)."</td>";
                echo "</tr>";
			}
            echo "<tr>";
                echo "<td align='center'></td>";
                echo "<td colspan='4'>TOTAL DEAL SO</td>";
...
$mpdf->WriteHTML($html);
$mpdf->Output('deal-sales-order.pdf' ,'I');