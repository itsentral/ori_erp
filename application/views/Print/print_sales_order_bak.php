<?php
	...
	echo "<table class='gridtable' width='100%' border='0' cellpadding='2'>";
		echo "<thead>";
			echo "<tr>";
				...
				echo "<th style='text-align: left' width='20%'>CUST ITEM</th>";
		...
		echo "<tbody>";
			...
			foreach($data_product AS $val => $valx2){ $no++;
				...
				echo "<tr>";
					...
					echo "<td align='right'>".number_format($valx2['total_deal_usd'] / $valx2['qty'] * $data_header[0]['kurs_usd_dipakai'])."</td>";
					echo "<td align='right'>".number_format($valx2['total_deal_usd'] * $data_header[0]['kurs_usd_dipakai'])."</td>";
				echo "</tr>";
			}
			foreach($data_material AS $val => $valx2){ $no++;
				...
				echo "<tr>";
					echo "<td>".$no."</td>";
					echo "<td align='left' colspan='3'>".strtoupper($valx2['nm_material'])."</td>";
			...
			foreach($data_shipping AS $val => $valx2){ $no++;
				...
				echo "<tr>";
					echo "<td>".$no."</td>";
					echo "<td align='left' colspan='3'>TRUCKING ".
			...
			echo "<tr>";
				...
				echo "<td align='right'><b>".number_format($data_total[0]['product_idr'] + $data_total[0]['mat_idr'] + $data_total[0]['acc_idr'])."</b></td>";
			echo "</tr>";
	...
	$mpdf->AddPage();
	$mpdf->WriteHTML($html);
	$mpdf->Output('Sales Order '.$no_ipp.' '.date('dmyhis').'.pdf' ,'I');
