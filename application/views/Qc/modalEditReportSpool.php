...
<div class="box-body"> 
	...
	<div class='form-group row'>
		...
		<div class='col-sm-9'>
			<?php
			 echo form_input(array('id'=>'daycode','name'=>'daycode','class'=>'form-control input-md','placeholder'=>'Daycode'), strtoupper($get_detail[0]->sp_group_daycode));
			?>
		</div>
	</div>
	<!-- <div class='form-group row'>
		...
		<div class='col-sm-9'>
			<?php
			 echo form_input(array('id'=>'qc_pass','name'=>'qc_pass','class'=>'form-control input-md datepicker','placeholder'=>'QC Pass Date','readonly'=>true), $get_detail[0]->sp_group_pass_date);
			?>
		</div>
	</div> -->
	<div class='form-group row'>
		...
		<div class='col-sm-9'>
			<?php
			 echo form_input(array('id'=>'keterangan','name'=>'keterangan','class'=>'form-control input-md','placeholder'=>'Keterangan'), $get_detail[0]->sp_group_keterangan);
			?>
		</div>
	</div>
	<div class='form-group row'>
