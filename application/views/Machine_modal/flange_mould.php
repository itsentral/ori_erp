...
history('View edit product estimasi flange mould : '.$id_bq.' / '.$id_milik.' / '.$idproduct);
// echo $idproduct;
		...
		<div class='form-group row'>
			...
			<div class='col-sm-2'>
				<?php
					...
					echo form_input(array('type'=>'text','id'=>'waste_n1','name'=>'waste_n1','class'=>''));
					echo form_input(array('type'=>'text','id'=>'waste_n2','name'=>'waste_n2','class'=>''));
