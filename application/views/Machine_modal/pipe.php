...
history('View edit product estimasi pipe : '.$id_bq.' / '.$id_milik.' / '.$idproduct); 
// echo $idproduct;
...
<div class="box box-primary">
	<div class="box-body">	
		...
		<div class='form-group row'>		 	 
			...
			<div class='col-sm-2'>
				<?php
					echo form_input(array('type'=>'text','id'=>'length','name'=>'length','class'=>'form-control input-sm numberOnly HideCost','autocomplete'=>'off','placeholder'=>'Pipe Length','readonly'=>'readonly'), floatval($header[0]->panjang));				
		...
		<div class='form-group row'>		 	 
			...
			<div class='col-sm-4'>
				<?php
					echo form_input(array('type'=>'text','id'=>'lengthx','name'=>'lengthx','class'=>'form-control input-sm numberOnly','autocomplete'=>'off','placeholder'=>'Pipe Length'), floatval($header[0]->panjang - 400));				
				?>
...
<script>	
	$(document).ready(function(){
		...
		$(document).on('keyup', '#lengthx', function(){
			$('#length').val(parseInt($(this).val()) + 400);
			ChangeLuasArea();
		});
