...
$product			= $this->db->query("SELECT * FROM product WHERE parent_product='branch joint' AND deleted='N'")->result_array();
...
history('View edit product estimasi branch joint : '.$id_bq.' / '.$id_milik.' / '.$header[0]->id_product); 
