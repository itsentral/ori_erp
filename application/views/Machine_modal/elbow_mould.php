...
history('View edit product estimasi elbow mould : '.$id_bq.' / '.$id_milik.' / '.$idproduct);
// echo $idproduct;
...
// echo "SELECT a.*, b.id FROM bq_component_header a LEFT JOIN product b ON a.diameter = b.value_d WHERE a.diameter=b.value_d AND b.parent_product='elbow mould' AND a.id_bq='".$id_bq."' AND a.id_milik='".$id_milik."' LIMIT 1 ";
