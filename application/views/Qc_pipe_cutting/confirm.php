...
<div class="box box-primary">
	...
	<div class="box-body">
		<table class="table table-striped table-bordered table-hover table-condensed" width="100%">
			...
			<tbody>
				...
				echo "<tr>";
					...
					echo "<td class='text-bold'>Status</td>";
					echo "<td class='text-bold' colspan='2'>Daycode</td>";
					echo "<td class='text-bold'>QC Pass Date</td>";
					echo "<td class='text-bold' colspan='2'>Keterangan</td>";
				echo "</tr>";
				echo "<tr>";
					echo "<td colspan='3'></td>";
					echo "<td>";
					echo "<select name='qc_status' class='form-control'>";
					echo "<option value='OKE'>OKE</option>";
					echo "</select>";
					echo "</td>";
					echo "<td colspan='2'><input type='text' name='qc_daycode' class='form-control input-sm'></td>";
					echo "<td><input type='text' name='qc_pass_date' data-role='datepicker' class='form-control input-sm' datepicker readonly></td>";
					echo "<td colspan='2'><input type='text' name='qc_keterangan' class='form-control input-sm'></td>";
				echo "</tr>";
				?>
			</tbody>
		</table>
		...
		<?php if(!empty($detail)){ ?>
		<button type='button' id='save_split' class='btn btn-success' style='margin-top:5px; margin-right:5px; float:right;'>Process QC</button>	
		<?php } ?>		
	</div>
</div>
</form>
