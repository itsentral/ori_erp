...
<script>
	$(document).ready(function(){
		...
		$(document).on('click','#create_plan', function(e){
			...
			// if(validasi.etd == ''){
				// swal({
				  // title	: "Error Message!",
				  // text	: 'ETD is empty, please input first ...',
				  // type	: "warning"
				// });
				// return false;
			// }
			// if(validasi.eta == ''){
				// swal({
				  // title	: "Error Message!",
				  // text	: 'ETA is empty, please input first ...',
				  // type	: "warning"
				// });
				// return false;
			// }
			// if(validasi.consignee == ''){
				// swal({
				  // title	: "Error Message!",
				  // text	: 'Consignee  is empty, please input first ...',
				  // type	: "warning"
				// });
				// return false;
			// }
			// if(validasi.notify_party == ''){
				// swal({
				  // title	: "Error Message!",
				  // text	: 'Notify Party is empty, please input first ...',
				  // type	: "warning"
				// });
				// return false;
			// }
			// if(validasi.port_of_loading == ''){
				// swal({
				  // title	: "Error Message!",
				  // text	: 'Port Of Loading is empty, please input first ...',
				  // type	: "warning"
				// });
				// return false;
			// }
			// if(validasi.port_of_discharges == ''){
				// swal({
				  // title	: "Error Message!",
				  // text	: 'Port Of Discharges is empty, please input first ...',
				  // type	: "warning"
				// });
				// return false;
			// }
			// if(validasi.flight_airway_no == ''){
				// swal({
				  // title	: "Error Message!",
				  // text	: 'Flight/Airway-bill No  is empty, please input first ...',
				  // type	: "warning"
				// });
				// return false;
			// }
			// if(validasi.ship_via == ''){
				// swal({
				  // title	: "Error Message!",
				  // text	: 'Ship Via is empty, please input first ...',
				  // type	: "warning"
				// });
				// return false;
			// }
			// if(validasi.saliling == ''){
				// swal({
				  // title	: "Error Message!",
				  // text	: 'Saliling on/About is empty, please input first ...',
				  // type	: "warning"
				// });
				// return false;
			// }
			// if(validasi.vessel_flight == ''){
				// swal({
				  // title	: "Error Message!",
				  // text	: 'Vessel / Flight is empty, please input first ...',
				  // type	: "warning"
				// });
				// return false;
			// }
	...
	function DataTables(customer=null, type=null, no_po=null){
		var dataTable = $('#my-grid').DataTable({
			...
			"ajax":{
				url : base_url + active_controller+'/server_side_penagihan_add',
				type: "post",
				data: function(d){
					d.customer = customer,
					d.type = type,
