	...
	<div class="box box-primary">
		...
		<div class="box-body">
			<div class='form-group row'>		 	 
				<label class='label-control col-sm-2'><b>Pieces Code<span class='text-red'>*</span></b></label>
				<div class='col-sm-4'>            
						<?php
							echo form_input(array('id'=>'kode_satuan','name'=>'kode_satuan','class'=>'form-control input-md','autocomplete'=>'off','placeholder'=>'Piece Code'), $row[0]['kode_satuan']);	
							echo form_input(array('type'=>'hidden','id'=>'id_satuan','name'=>'id_satuan','class'=>'form-control input-md','autocomplete'=>'off','placeholder'=>'Menu Name'), $row[0]['id_satuan']);								
						?>	
				</div>
				...
				<div class='col-sm-4'>            
						<?php
							echo form_input(array('id'=>'nama_satuan','name'=>'nama_satuan','class'=>'form-control input-md','autocomplete'=>'off','placeholder'=>'Piece Name'), $row[0]['nama_satuan']);	
						?>		
				</div>
			</div>
			<div class='form-group row'>		 	 
...
<script>
	$(document).ready(function(){
		$('#simpan-bro').click(function(e){
			...
			if(kode_satuan=='' || kode_satuan==null){
				swal({
				  title	: "Error Message!",
				  text	: 'Pieces Code is Empty, please input first ...',
				  type	: "warning"
				});
			...
			if(nama_satuan == '' || nama_satuan == null){
				swal({
				  title	: "Error Message!",
				  text	: 'Pieces Name Name is Empty, please input first ...',
				  type	: "warning"
				});
				$('#simpan-bro').prop('disabled',false);
				return false;
