	...
	<div class="box box-primary">
		...
		<div class="box-body">
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-4'>             
						<?php
							echo form_input(array('id'=>'kode_satuan','name'=>'kode_satuan','class'=>'form-control input-md','autocomplete'=>'off','placeholder'=>'Pieces Code'));											
						?>		
				</div>
				<label class='label-control col-sm-2'><b>Pieces Name <span class='text-red'>*</span></b></label>
				<div class='col-sm-4'>            
						<?php
							echo form_input(array('id'=>'nama_satuan','name'=>'nama_satuan','class'=>'form-control input-md','autocomplete'=>'off','placeholder'=>'Pieces Name'));											
						?>		
				</div>
			</div>	
			<div class='form-group row'>
