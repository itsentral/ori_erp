	...
	<div class="box box-primary">
		<div class="box-header">
			...
			<?php if($akses_menu['create']=='1'){ ?>
			  <button type='button' class="btn btn-md btn-info" id='add'><i class="fa fa-plus"></i> Add Rate</button>
			  <?php } ?>
			</div>
		</div>
		<div class="box-body">
...
<script>
	...
	$(document).on('click', '#save', function(){
		...
		var kurs	= $("#kurs").val();
		if(mata_uang==''){
			swal({title:"Error Message!", text:'Currency Empty', type:"warning"});
			$('#save').prop('disabled',false);
			return false;
		}
		if(tanggal==''){
			swal({title:"Error Message!", text:'Date Empty', type:"warning"});
			$('#save').prop('disabled',false);
			return false;
		}
		if(kurs==''){
			swal({title:"Error Message!", text:'Rate Empty', type:"warning"});
			$('#save').prop('disabled',false);
			return false;
		}
		swal({
