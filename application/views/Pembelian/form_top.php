					...
					if(!empty($data_top)){
						foreach($data_top AS $val => $valx){ $id++;
							...
							echo "<tr class='header_".$id."'>";
								...
								echo "<td align='left'><input type='text' id='idr_".$id."' name='detail_po[".$id."][value_idr]' value='".number_format($valx['value_idr'],2)."' class='form-control input-md text-right maskM sum_tot_idr' tabindex='-1' ".$styledisabled."></td>";
								echo "<td align='left'><input type='text' id='total_harga_".$id."' name='detail_po[".$id."][keterangan]' value='".strtoupper($valx['invoice_no'])."' class='form-control input-md text-left'></td>";
