			...
			<div class="box-body">
				...
				<div class="col-md-6">
					...
					if($datapo->mata_uang=='IDR'){
						$nilai_po_invoice=(!empty($info_payterm->invoice_total)) ? ($info_payterm->invoice_total - $info_payterm->nilai_ppn) : ($info_payterm->value_idr - $info_payterm->nilai_ppn);
					}else{
					...
					<input type="hidden" class="form-control divide" id="potongan_claim" name="potongan_claim" placeholder=0 value=0 onblur="calculate_invoice()">
					<label class="control-label"></label>
					<input type="hidden" class="form-control" id="keterangan_potongan" name="keterangan_potongan" value="">
