...
<script>
	var url_add = base_url+'expense/transport_req_create/';
	var url_edit = base_url+'expense/transport_req_edit/';
	var url_delete = base_url+'expense/transport_req_delete/';
	var url_view = base_url+'expense/transport_req_view/';</script>
