	...
	<div class="tab-pane active">
		<div class="box box-primary">
			...
			<table class="table table-bordered table-striped" width="100%">
				...
				<?php $total=0; $idd=1;$grand_total=0;$total_expense=0;$total_kasbon=0; $error_coa='';
				if(!empty($data_detail)){
					...
					<tr id='tr1_<?=$idd?>' class='delAll <?=($record->id_kasbon!=''?'kasbonrow':'')?>'>
						...
						?>
						<input type="text" class="form-control input-sm" name="tanggal[]" id="tanggal<?=$idd;?>" value="<?=$record->tanggal;?>" <?=$tekskasbon?> <?=$readonly?>></td>
						...
						<input type="text" class="form-control input-sm" name="keterangan[]" id="keterangan_<?=$idd;?>" value="<?=$record->keterangan;?>" <?=$readonly?>></td>
						...
						if(isset($data)){
							if($data->status==1){
								if($stsview=='review'){
									...
									if ($error_coa=='') echo '<button type="submit" name="save" class="btn btn-success btn-sm" id="submit"><i class="fa fa-save">&nbsp;</i>Approve</button>';
