			...
			<div class='form-group row'>			
				...
				<div class='col-sm-4'>
					<div class="input-group">
						...
						<?php
							echo form_input(array('id'=>'name','name'=>'name','class'=>'form-control input-sm','autocomplete'=>'off','placeholder'=>'Menu Name'));											
						?>
					</div>
				...
				<div class='col-sm-4'>
					<div class="input-group">
						...
						<?php
							echo form_input(array('id'=>'path','name'=>'path','class'=>'form-control input-sm','autocomplete'=>'off','placeholder'=>'Menu Path'));											
						?>
					</div>
