                   ...
                   <div class="col-sm-6 form-horizontal">
						...
						<div class="form-group ">
                            ...
                            <div class="col-sm-2" style="padding-top: 8px;">
                              <input type="text" name="base_cur" class="form-control input-sm" id="base_cur" value="<?php echo($data_header->base_cur) ?>" readonly>
                            </div>
                        </div>
						<div class="form-group ">
...
<table id="my-grid" class="table table-striped table-bordered table-hover table-condensed" width="100%">
	...
	<tbody>
		...
		foreach($getDetail AS $val => $valx){
			if($valx['harga_total_idr'] > 0){
			$no++;
            $numb++;
			$pr='pr';
			$SUM += $valx['harga_total_idr'];
			?>
			<tr id='tr_<?= $numb;?>' >
			...
			<td align='right'><?= number_format($valx['harga_satuan_idr'],2);?></td>
			<td align='center'><?= number_format($valx['qty']);?></td>
			<td align='center'><?= strtoupper($valx['unit']);?></td>
			<td align='right'><?= number_format($valx['harga_total_idr'],2);?></td>
			<?php
			}
		}
		?>
	...
	if(!empty($non_frp)){
		...
		foreach($non_frp AS $val => $valx){
			$numb2++;
			$SUM_NONFRP += $valx['harga_total_idr'];
			?>
			<tr id='tr1_<?= $numb2;?>' >
			<td align='center'>
			...
			<td>
			<?php
				$harga_sat2= number_format($valx['harga_satuan_idr'],2);
				$harga_sat2_hidden= round($valx['harga_satuan_idr'],2);
				?>
			...
			<td>
			<?php
				$harga_tot2= number_format($valx['harga_total_idr'],2);
				$harga_tot2_hidden= round($valx['harga_total_idr'],2);
				?>
	...
	if(!empty($material)){
		...
		<tr id='tr2_<?= $numb3;?>' >
			...
			<td>
			<?php
				$harga_sat3= number_format($valx['harga_satuan_idr'],2);
				$harga_sat3_hidden= round($valx['harga_satuan_idr'],2);
				?>
			...
			<td>
			<?php
				$harga_tot3= number_format($valx['harga_total_idr'],2);
				$harga_tot3_hidden= round($valx['harga_total_idr'],2);
				?>
	...
	<tbody>
		...
		foreach($getEngCost AS $val => $valx){
			...
			$Price1 	= (!empty($valx['harga_satuan_idr']))?number_format($valx['harga_satuan_idr'],2):'-';
			$TotalP1 	= (!empty($valx['harga_total_idr']))?number_format($valx['harga_total_idr'],2):'-';
			$SUM1 += $valx['harga_total_idr'];
			$no1++;
			$numb4++;
		?>
		<tr id='tr3_<?= $numb4;?>' >
			...
			<td>
			<?php
				$harga_sat4= (!empty($valx['harga_satuan_idr']))?number_format($valx['harga_satuan_idr'],2):'-';
				$harga_sat4_hidden= (!empty($valx['harga_satuan_idr']))?round($valx['harga_satuan_idr'],2):'-';
				?>
			...
			<td>
			<?php
				$harga_tot4= (!empty($valx['harga_total_idr']))?number_format($valx['harga_total_idr'],2):'-';
				$harga_tot4_hidden= (!empty($valx['harga_total_idr']))?round($valx['harga_total_idr'],2):'-';
				?>
	...
	<tbody>
		...
		foreach($getPackCost AS $val => $valx){
			...
			<!--<td>
			<?php
				$harga_sat5= (!empty($valx['harga_satuan_idr']))?number_format($valx['harga_satuan_idr'],2):'-';
				$harga_sat5_hidden= (!empty($valx['harga_satuan_idr']))?round($valx['harga_satuan_idr'],2):'-';
				?>
			...
			<td>
			<?php
				$harga_tot5= number_format($valx['harga_total_idr'],2);
				$harga_tot5_hidden= round($valx['harga_total_idr'],2);
				?>
	...
	<tbody>
		...
		foreach($getTruck AS $val => $valx){
			...
			<td>
			<?php
				$harga_sat6= number_format($valx['harga_satuan_idr'],2);
				$harga_sat6_hidden= round($valx['harga_satuan_idr'],2);
				?>
...
//			if(!empty($non_frp)){
				echo "<tr class='HeaderHr'>";
					...
					?>
					<?php
					$grand_total_nonfrp = number_format($data_header->total_um_idr, 2);
					$grand_total_hidden_nonfrp = round($data_header->total_um_idr, 2);
					?>
...
//			}
		?>
			...
			<td align='right' style='text-align:center;'>
			<?php
			$tot_diskon = number_format($data_header->total_diskon_idr, 2);
			$tot_diskon_hidden = round($data_header->total_diskon_idr, 2);
			?>
			...
			<td align='right' style='text-align:center;'>
			<?php
			$tot_retensi = number_format($data_header->total_retensi_idr, 2);
			$tot_retensi_hidden = round($data_header->total_retensi_idr, 2);
			...
			<td align='right' style='text-align:center;'>
			<?php
			$tot_ppn = number_format($data_header->total_ppn_idr, 2);
			$tot_ppn_hidden = round($data_header->total_ppn_idr, 2);
			?>
			...
			<td align='right' style='text-align:center;'>
			<?php
			$total_retensi2 = number_format($data_header->total_retensi2_idr, 2);
			?>
			...
			<td align='right' style='text-align:center;'>
			<?php
			$grand_total = number_format($data_header->total_invoice_idr, 2);
			$grand_total_hidden = round($data_header->total_invoice_idr, 2);
			?>
