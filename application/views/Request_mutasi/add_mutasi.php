            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="col-sm-6 form-horizontal">
					    ...
					    <div class="row">
                          <div class="form-group">
                              <label for="dari" class="col-sm-4 control-label">Dari </font></label>
                              <div class="col-sm-6">
								 <?php
								echo form_dropdown('dari_matauang',$matauang, '',array('id'=>'dari_matauang','required'=>'required','class'=>'form-control'));
								?>								 
						...
						<div class="row">
							<div class="form-group">
								  <label for="ke" class="col-sm-4 control-label">Ke </font></label>
								  <div class="col-sm-6">
									 <?php
								echo form_dropdown('ke_matauang',$matauang, '',array('id'=>'ke_matauang','required'=>'required','class'=>'form-control'));
								?>								 
								  </div>
							  </div>
						</div>
                   ...
                   <div class="col-sm-6 form-horizontal">
                         <div class="row">
						  <div class="form-group">
                            <label for="ket_bayar" class="col-sm-4 control-label">Keterangan </font></label>
                            <div class="col-sm-6">
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<button id="simpanpenerimaan" class="btn btn-primary" type="button" onclick="savemutasi()">
					<i class="fa fa-save"></i><b> Simpan Mutasi</b>
				</button>
...
<script>
	$(document).ready(function(){
	 ...
	 function savemutasi(){
	    ...
	    if ($('#tgl_request').val() == "") {
		  ...
		  else if ($('#dari_matauang').val() == "0") {
          swal({
            title	: "Matauang Asal tidak boleh kosong!",
            text	: "Silahkan Pilih Matauang Asal Dahulu!",
            type	: "warning",
            timer	: 3000,
            showCancelButton	: false,
            showConfirmButton	: false,
		 ...
		 else if ($('#ke_matauang').val() == "0") {
          swal({
            title	: "Matauang Tujuan tidak boleh kosong!",
            text	: "Silahkan Pilih Matauang Tujuan Dahulu!",
            type	: "warning",
            timer	: 3000,
            showCancelButton	: false,
            showConfirmButton	: false,
			...
			if(isConfirm) {
				...
				$.ajax({
					...
					success: function(data){
						...
						window.location.href = base_url + active_controller+'/mutasi';
					  }else{
	...
	function total(){
		var dari = $('#dari_matauang').val();
		var ke = $('#ke_matauang').val();		
		...
		// exit;
		 if(dari=='IDR'){
		   ...
		   var jumlah = parseFloat(kurs)*parseFloat(nilai);
		   }
		
		
		$('#rupiah').val(number_format(jumlah,2));
