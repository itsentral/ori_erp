                    ...
                    <div class="col-sm-6 form-horizontal">
                        ...
                        <div class="row">
                          <div class="form-group">
                              ...
                              <div class="col-sm-6">
								<?php
								echo form_dropdown('dari',$datbank, '',array('id'=>'dari','required'=>'required','class'=>'form-control'));
								?>								 
						...
						<div class="row">
                          ...
                          <label for="tgl_bayar" class="col-sm-4 control-label">Nilai :</label>
                            <div class="col-sm-6">
                                 <input type="text" name="nilai" class="form-control input-sm divide " id="nilai" value="0" onblur="fn_terbilang()">
							 </div>
                          </div>
                        </div>
				   </div>
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<button id="simpanpenerimaan" class="btn btn-primary" type="button" onclick="savemutasi()">
					<i class="fa fa-save"></i><b> Simpan Request Mutasi</b>
				</button>
	 ...
	 function savemutasi(){
        ...
        function(isConfirm){
			if(isConfirm) {
				...
				$.ajax({
					url: base_url+"request_mutasi/save_request",
					dataType : "json",
					type: 'POST',
					data: formdata,
