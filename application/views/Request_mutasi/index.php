	...
	<div class="box box-primary">
		...
		<tr>
			...
			<button class="btn btn-primary" type="button">
					<b> Menunggu Approval</b>
				</button>
			<?php } elseif($record->status_approve =='2') {?>
			<button class="btn btn-danger" type="button" >
					<b> Ditolak &nbsp;</b> <a href="#" title='<?= $record->alasan ?>'><i class='fa fa-info-circle'></i></a>
			</button>
			
			
			<?php } else {?>
			<a href="<?=base_url('request_mutasi/add_mutasi/'.$record->kd_mutasi)?>" class='btn btn-sm btn-warning' title='Add Mutasi'target="_blank"><i class='fa fa-plus'></i></a>
