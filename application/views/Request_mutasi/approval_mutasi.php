  ...
  <div class="modal-dialog modal-lg" style="width: 50%;">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><span class="fa fa-times"></span>&nbsp;Alasan Reject</h4>
      </div>
	 ...
	 function savemutasi(){
        ...
        function(isConfirm){
			if(isConfirm) {
				...
				$.ajax({
					url: base_url+"approval_mutasi/approve_mutasi",
					dataType : "json",
					type: 'POST',
					data: formdata,
...
//		totalterima();
    ...
    $(document).on('click', '.reject', function(){
		...
		$("#head_title").html("<i class='fa fa-list-alt'></i><b>Alasan Reject</b>");
		$.ajax({
			type:'POST',
			url:base_url + active_controller +'/reject/'+no_request,
