	...
	<div class="box box-primary">
		...
		<div class="box-body"> 
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-2'>              
					<?php
						echo form_input(array('id'=>'flange_bcd','name'=>'flange_bcd','class'=>'form-control input-sm numberOnly HideCost','autocomplete'=>'off','placeholder'=>'BCD /mm'));											
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'flange_n','name'=>'flange_n','class'=>'form-control input-sm HideCost','autocomplete'=>'off','placeholder'=>'N /mm '));											
					?>	
				</div>
				<label class='label-control col-sm-1'></label>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'flange_oh','name'=>'flange_oh','class'=>'form-control input-sm HideCost','autocomplete'=>'off','placeholder'=>'&Oslash;H /mm'));											
					?>	
				</div>
			</div>
			<!-- ====================================================================================================== -->
