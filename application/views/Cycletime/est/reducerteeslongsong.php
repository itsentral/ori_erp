	...
	<div class="box box-primary">
		...
		<div class="box-body">
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-2'>              
					<?php
						...
						echo form_input(array('type'=>'text','id'=>'area2','name'=>'area2','class'=>''));
			...
			<div class='form-group row'>
				...
				<div class='col-sm-2'>              
					<?php
						echo form_input(array('id'=>'wrap_length','name'=>'wrap_length','class'=>'form-control input-sm numberOnly','autocomplete'=>'off','placeholder'=>'Butt & Wrap Length 1', 'value'=>''));											
					?>	
				</div>
				<div class='col-sm-2'>              
					<?php
						echo form_input(array('id'=>'wrap_length2','name'=>'wrap_length2','class'=>'form-control input-sm numberOnly','autocomplete'=>'off','placeholder'=>'Butt & Wrap Length 2', 'value'=>''));											
					?>
				</div>
				
			</div>
			<div class='form-group row'>
				<label class='label-control col-sm-2'><b>High <span class='text-red'>*</span></b></label>
...
<script>
	...
	$(document).ready(function(){	
		...
		$(document).on('click', '#simpan-bro', function(e){
			...
			var wrap_length2			= $('#wrap_length2').val();
			var high				= $('#high').val();
			...
			if(wrap_length == '' || wrap_length == null || wrap_length == 0){
				swal({
				  title	: "Error Message!",
				  text	: 'Butt & Wrap Length 1 is Empty, please input first ...',
				  type	: "warning"
				});
				$('#simpan-bro').prop('disabled',false);
				return false;	
			}
			if(wrap_length2 == '' || wrap_length2 == null || wrap_length2 == 0){
				swal({
				  title	: "Error Message!",
				  text	: 'Butt & Wrap Length 2 is Empty, please input first ...',
				  type	: "warning"
				});
				$('#simpan-bro').prop('disabled',false);
				return false;	
