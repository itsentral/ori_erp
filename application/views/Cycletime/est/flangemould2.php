		...
		<div class="box-body">
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-2'>              
					<?php
						...
						echo form_input(array('type'=>'text','id'=>'area','name'=>'area','class'=>''));
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-2'>              
					<?php
						...
						echo form_input(array('type'=>'text','id'=>'area_neck_1','name'=>'area_neck_1','value'=>'0', 'class'=>''));
					?>	
				</div>
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-2'>              
					<?php
						...
						echo form_input(array('type'=>'text','id'=>'area_neck_2','name'=>'area_neck_2', 'value'=>'0', 'class'=>''));
					?>	
				</div>
				<label class='label-control col-sm-2'><b>Thickness 2 (Design) /mm <span class='text-red'>*</span></b></label>
				<div class='col-sm-2'>              
					<?php
						echo form_input(array('id'=>'design_neck_2','name'=>'design_neck_2','class'=>'form-control input-sm numberOnly','autocomplete'=>'off','placeholder'=>'Thickness 2 (Design)', 'readonly'=>'readonly'));											
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-3'>              
					...
					<input type='text' name='ListDetail2_neck1[8][fak_pengali]' class='' id='penggali_rooving21_neck1' value='100'>
					<input type='text' name='ListDetail2_neck1[8][bw]' class='' id='bw_rooving21_neck1' value='0'>	
					<input type='text' name='ListDetail2_neck1[8][jumlah]' class='' id='jumlah_rooving21_neck1' value='0'>	
				</div>
				<label class='col-sm-2' style='text-align:left; margin-top: 6px;'>Weight</label>
				<div class='col-sm-1'>              
					<?php
			...
			<div class='form-group row'>		 	 
				...
				<label class='col-sm-2' style='text-align:left; margin-left: -50px; margin-top: 6px;'>Total Strukture Neck 1</label>
				<div class='col-sm-1'>              
					<?php
			...
			<div class='form-group row'>		 	 
				...
				<label class='col-sm-2' style='text-align:left; margin-left: -50px; margin-top: 6px;'>Min Strukture Neck 1</label>
				<div class='col-sm-1'>              
					<?php
			...
			<div class='form-group row'>		 	 
				...
				<label class='col-sm-2' style='text-align:left; margin-left: -50px; margin-top: 6px;'>Max Strukture Neck 1</label>
				<div class='col-sm-1'>              
					<?php
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'weight_matcsm2_neck2','name'=>'ListDetail2_neck2[0][value]', 'style'=>'margin-left:-110px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1' style='text-align:left; margin-left:-130px; margin-top: 6px;'>Layer</label>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'layer_matcsm2_neck2','name'=>'ListDetail2_neck2[0][layer]', 'style'=>'margin-left:-90px;width: 50px;','class'=>'form-control input-sm numberOnly','autocomplete'=>'off', 'value'=>''));											
					?>	
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -130px; margin-top: 6px;'>Thickness</label>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'totthick_matcsm2_neck2','name'=>'ListDetail2_neck2[0][total_thickness]', 'style'=>'margin-left:-90px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly','value'=>'0'));											
					?>	
				</div>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_matcsm2_neck2','name'=>'ListDetail2_neck2[0][last_cost]', 'style'=>'margin-left:-80px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly','value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-100px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-3'>              
					...
					<!--<input type='text' name='ListDetail2_neck2[1][containing]' class='HideCost' id='layer_resin21_neck2' value='2.333'>-->
				</div>
				<label class='col-sm-2' style='text-align:left; margin-top: 6px;'><u>Rs.Containing</u></label>
				<div class='col-sm-1'>              
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'layer_resin21_neck2','name'=>'ListDetail2_neck2[1][containing]', 'style'=>'margin-left:-90px;width: 50px;','class'=>'form-control input-sm numberOnly','autocomplete'=>'off', 'readonly'=>'readonly', 'value'=>'0'));	//2.333										
					?>
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -130px; margin-top: 6px;'></label>
				<div class='col-sm-1'>              
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_resin21_neck2','name'=>'ListDetail2_neck2[1][last_cost]', 'style'=>'margin-left:-80px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-100px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'weight_csm_add2_neck2','name'=>'ListDetail2_neck2[2][value]', 'style'=>'margin-left:-110px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1' style='text-align:left; margin-left:-130px; margin-top: 6px;'>Layer</label>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'layer_csm_add2_neck2','name'=>'ListDetail2_neck2[2][layer]', 'style'=>'margin-left:-90px;width: 50px;','class'=>'form-control input-sm numberOnly','autocomplete'=>'off', 'value'=>''));											
					?>	
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -130px; margin-top: 6px;'>Thickness</label>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'totthick_csm_add2_neck2','name'=>'ListDetail2_neck2[2][total_thickness]', 'style'=>'margin-left:-90px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly','value'=>'0'));											
					?>	
				</div>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_csm_add2_neck2','name'=>'ListDetail2_neck2[2][last_cost]', 'style'=>'margin-left:-80px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly','value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-100px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'layer_resin22_neck2','name'=>'ListDetail2_neck2[3][containing]', 'style'=>'margin-left:-90px;width: 50px;','class'=>'form-control input-sm numberOnly','autocomplete'=>'off', 'readonly'=>'readonly', 'value'=>'0'));	//2,333										
					?>
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -130px; margin-top: 6px;'></label>
				<div class='col-sm-1'>              
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_resin22_neck2','name'=>'ListDetail2_neck2[3][last_cost]', 'style'=>'margin-left:-80px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-100px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'weight_wr2_neck2','name'=>'ListDetail2_neck2[4][value]', 'style'=>'margin-left:-110px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1' style='text-align:left; margin-left:-130px; margin-top: 6px;'>Layer</label>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'layer_wr2_neck2','name'=>'ListDetail2_neck2[4][layer]', 'style'=>'margin-left:-90px;width: 50px;','class'=>'form-control input-sm numberOnly','autocomplete'=>'off', 'value'=>''));											
					?>	
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -130px; margin-top: 6px;'>Thickness</label>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'totthick_wr2_neck2','name'=>'ListDetail2_neck2[4][total_thickness]', 'style'=>'margin-left:-90px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly','value'=>'0'));											
					?>	
				</div>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_wr2_neck2','name'=>'ListDetail2_neck2[4][last_cost]', 'style'=>'margin-left:-80px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly','value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-100px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-3'>              
					...
					<!--<input type='text' name='ListDetail2_neck2[5][containing]' class='HideCost' id='layer_resin23_neck2' value='1'>-->
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'layer_resin23_neck2','name'=>'ListDetail2_neck2[5][containing]', 'style'=>'margin-left:-90px;width: 50px;','class'=>'form-control input-sm numberOnly','autocomplete'=>'off', 'readonly'=>'readonly','value'=>'0'));		//1									
					?>
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -130px; margin-top: 6px;'></label>
				<div class='col-sm-1'>              
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_resin23_neck2','name'=>'ListDetail2_neck2[5][last_cost]', 'style'=>'margin-left:-80px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-100px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'weight_wr_add2_neck2','name'=>'ListDetail2_neck2[6][value]', 'style'=>'margin-left:-110px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1' style='text-align:left; margin-left:-130px; margin-top: 6px;'>Layer</label>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'layer_wr_add2_neck2','name'=>'ListDetail2_neck2[6][layer]', 'style'=>'margin-left:-90px;width: 50px;','class'=>'form-control input-sm numberOnly','autocomplete'=>'off', 'value'=>''));											
					?>	
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -130px; margin-top: 6px;'>Thickness</label>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'totthick_wr_add2_neck2','name'=>'ListDetail2_neck2[6][total_thickness]', 'style'=>'margin-left:-90px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_wr_add2_neck2','name'=>'ListDetail2_neck2[6][last_cost]', 'style'=>'margin-left:-80px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-100px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-3'>              
					...
					<!--<input type='text' name='ListDetail2_neck2[7][containing]' class='HideCost' id='layer_resin24_neck2' value='1'>-->
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'layer_resin24_neck2','name'=>'ListDetail2_neck2[7][containing]', 'style'=>'margin-left:-90px;width: 50px;','class'=>'form-control input-sm numberOnly','autocomplete'=>'off', 'readonly'=>'readonly', 'value'=>'0'));		//1									
					?>
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -130px; margin-top: 6px;'></label>
				<div class='col-sm-1'>              
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_resin24_neck2','name'=>'ListDetail2_neck2[7][last_cost]', 'style'=>'margin-left:-80px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-100px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-3'>              
					...
					<!--<input type='text' name='ListDetail2_neck2[12][id_material]' class='HideCost' id='layer_resin27hide_neck2'>-->
				</div>
				<label class='col-sm-2' style='text-align:left; margin-top: 6px;'></label>
				<div class='col-sm-1'>              
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_resin_tot2_neck2','name'=>'ListDetail2_neck2[12][last_cost]', 'style'=>'margin-left:-80px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-100px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>
				...
				<div class='col-sm-3'>              
					...
					<!--
					<input type='text' name='ListDetailPlus2_neck2[0][containing]' class='HideCost' id='layer_katalis2_neck2' value='0'>
					<input type='text' name='ListDetailPlus2_neck2[0][perse]' class='HideCost' id='persen_katalis2_neck2' value='0.025'>
					--> 
				</div>
				
				<label class='col-sm-1' style='text-align:left; margin-left: 0px; margin-top: 6px;'>Comparison</label>
				<div class='col-sm-2'>              
					<input type='text' name='ListDetailPlus2_neck2[0][containing]' style='width:50px; margin-left:12px;' class='form-control input-sm numberOnly' readonly='readonly' id='layer_katalis2_neck2' value='0'>	
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -129px; margin-top: 6px;'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus2_neck2[0][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_katalis2_neck2' value='2'>	
				</div>
				<div class='col-sm-1'>              
					<?php
			...
			<div class='form-group row'>
				...
				<div class='col-sm-3'>              
					...
					<!--
					<input type='text' name='ListDetailPlus2_neck2[1][containing]' class='HideCost' id='layer_sm2_neck2' value='0'>
					<input type='text' name='ListDetailPlus2_neck2[1][perse]' class='HideCost' id='persen_sm2_neck2' value='0.025'>
					-->					
				</div>
				
				<label class='col-sm-1' style='text-align:left; margin-left: 0px; margin-top: 6px;'>Comparison</label>
				<div class='col-sm-2'>              
					<input type='text' name='ListDetailPlus2_neck2[1][containing]' style='width:50px; margin-left:12px;' class='form-control input-sm numberOnly' readonly='readonly' id='layer_sm2_neck2' value='0'>	
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -129px; margin-top: 6px;'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus2_neck2[1][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_sm2_neck2' value='2.5'>	
				</div>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_sm2_neck2','name'=>'ListDetailPlus2_neck2[1][last_cost]', 'style'=>'margin-left:-81px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-101px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>
				...
				<div class='col-sm-3'>              
					...
					<!--
					<input type='text' name='ListDetailPlus2_neck2[2][containing]' class='HideCost' id='layer_coblat2_neck2' value='0'>
					<input type='text' name='ListDetailPlus2_neck2[2][perse]' class='HideCost' id='persen_coblat2_neck2' value='0.002'>
					-->
				</div>
				
				<label class='col-sm-1' style='text-align:left; margin-left: 0px; margin-top: 6px;'>Comparison</label>
				<div class='col-sm-2'>              
					<input type='text' name='ListDetailPlus2_neck2[2][containing]' style='width:50px; margin-left:12px;' class='form-control input-sm numberOnly' readonly='readonly' id='layer_coblat2_neck2' value='0'>	
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -129px; margin-top: 6px;'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus2_neck2[2][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_coblat2_neck2' value='0.2'>	
				</div>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_cobalt2_neck2','name'=>'ListDetailPlus2_neck2[2][last_cost]', 'style'=>'margin-left:-81px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-101px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>
				...
				<div class='col-sm-3'>              
					...
					<!--
					<input type='text' name='ListDetailPlus2_neck2[3][containing]' class='HideCost' id='layer_dma2_neck2' value='0'>
					<input type='text' name='ListDetailPlus2_neck2[3][perse]' class='HideCost' id='persen_dma2_neck2' value='0.002'>
					-->					
				</div>
				
				<label class='col-sm-1' style='text-align:left; margin-left: 0px; margin-top: 6px;'>Comparison</label>
				<div class='col-sm-2'>              
					<input type='text' name='ListDetailPlus2_neck2[3][containing]' style='width:50px; margin-left:12px;' class='form-control input-sm numberOnly' readonly='readonly' id='layer_dma2_neck2' value='0'>	
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -129px; margin-top: 6px;'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus2_neck2[3][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_dma2_neck2' value='0.2'>	
				</div>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_dma2_neck2','name'=>'ListDetailPlus2_neck2[3][last_cost]', 'style'=>'margin-left:-81px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-101px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>
				...
				<div class='col-sm-3'>              
					...
					<!--
					<input type='text' name='ListDetailPlus2_neck2[4][containing]' class='HideCost' id='layer_hydroquinone2_neck2' value='0'>
					<input type='text' name='ListDetailPlus2_neck2[4][perse]' class='HideCost' id='persen_hydroquinone2_neck2' value='0.002'>
					-->
				</div>
				
				<label class='col-sm-1' style='text-align:left; margin-left: 0px; margin-top: 6px;'>Comparison</label>
				<div class='col-sm-2'>              
					<input type='text' name='ListDetailPlus2_neck2[4][containing]' style='width:50px; margin-left:12px;' class='form-control input-sm numberOnly' readonly='readonly' id='layer_hydroquinone2_neck2' value='0'>	
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -129px; margin-top: 6px;'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus2_neck2[4][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_hydroquinone2_neck2' value='0.2'>	
				</div>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_hidro2_neck2','name'=>'ListDetailPlus2_neck2[4][last_cost]', 'style'=>'margin-left:-81px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-101px; margin-top: 6px;'>Kg</label>
			</div>
			<div class='form-group row'>
				...
				<div class='col-sm-3'>              
					...
					<!--
					<input type='text' name='ListDetailPlus2_neck2[5][containing]' class='HideCost' id='layer_methanol2_neck2' value='0'>
					<input type='text' name='ListDetailPlus2_neck2[5][perse]' class='HideCost' id='persen_methanol2_neck2' value='0.002'>
					-->
				</div>
				
				<label class='col-sm-1' style='text-align:left; margin-left: 0px; margin-top: 6px;'>Comparison</label>
				<div class='col-sm-2'>              
					<input type='text' name='ListDetailPlus2_neck2[5][containing]' style='width:50px; margin-left:12px;' class='form-control input-sm numberOnly' readonly='readonly' id='layer_methanol2_neck2' value='0'>	
				</div>
				<label class='col-sm-2' style='text-align:left; margin-left: -129px; margin-top: 6px;'>Percent</label>
				<div class='col-sm-1'>              
					<input type='text' name='ListDetailPlus2_neck2[5][perse]' style='margin-left:-92px;' class='form-control input-sm numberOnly' id='persen_methanol2_neck2' value='0.2'>	
				</div>
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_methanol2_neck2','name'=>'ListDetailPlus2_neck2[5][last_cost]', 'style'=>'margin-left:-81px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-101px; margin-top: 6px;'>Kg</label>
			</div>
			...
			<div class='form-group row'>		 	 
				...
				<label class='col-sm-2' style='text-align:left; margin-left: -50px; margin-top: 6px;'>Total Strukture Neck 2</label>
				<div class='col-sm-1'>              
					<?php
			...
			<div class='form-group row'>		 	 
				...
				<label class='col-sm-2' style='text-align:left; margin-left: -50px; margin-top: 6px;'>Min Strukture Neck 2</label>
				<div class='col-sm-1'>              
					<?php
			...
			<div class='form-group row'>		 	 
				...
				<label class='col-sm-2' style='text-align:left; margin-left: -50px; margin-top: 6px;'>Max Strukture Neck 2</label>
				<div class='col-sm-1'>              
					<?php
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-3'>              
					...
					<!--<input type='text' name='ListDetail2[8][id_material]' class='HideCost' id='layer_resin27hide'>-->
				</div>
				<label class='col-sm-2' style='text-align:left; margin-top: 6px;'></label>
				<div class='col-sm-1'>              
				...
				<div class='col-sm-1'>              
					<?php
						echo form_input(array('id'=>'last_resin_tot2','name'=>'ListDetail2[8][last_cost]', 'style'=>'margin-left:-80px;','class'=>'form-control input-sm','autocomplete'=>'off','readonly'=>'readonly', 'value'=>'0'));											
					?>	
				</div>
				<label class='col-sm-1 kghide' style='text-align:left; margin-left:-100px; margin-top: 6px;'>Kg</label>
			</div>
...
<script src="<?php echo base_url('application/views/Component/est/javascript/flange_mould2/add_table.js'); ?>"></script>
<script src="<?php echo base_url('application/views/Component/est/javascript/flange_mould2/top.js'); ?>"></script>
<script src="<?php echo base_url('application/views/Component/est/javascript/flange_mould2/liner.js'); ?>"></script>
<script src="<?php echo base_url('application/views/Component/est/javascript/flange_mould2/structure.js'); ?>"></script>
<script src="<?php echo base_url('application/views/Component/est/javascript/flange_mould2/external.js'); ?>"></script>
<script src="<?php echo base_url('application/views/Component/est/javascript/flange_mould2/topcoat.js'); ?>"></script>
<script src="<?php echo base_url('application/views/Component/est/javascript/flange_mould2/change_all.js'); ?>"></script>
<style type="text/css">
	.kghide{
...
<script>
	$(document).ready(function(){
		...
		$(document).on('keyup', '#design_neck_1', function(){
			...
			$('#acuhan_2_neck1').val($(this).val());
			$('#acuhan_2_neck2').val(designNeck2.toFixed(1));
			
			var acuhan_2			= parseFloat($(this).val());
			...
			var min_lin_thickness2	= designNeck2 - (designNeck2 * top_min_toleran);
			var max_lin_thickness2	= designNeck2 + (designNeck2 * top_max_toleran);
			
			$('#mix_lin_thickness2_neck1').val(min_lin_thickness.toFixed(4));
			$('#max_lin_thickness2_neck1').val(max_lin_thickness.toFixed(4));
			
			$('#mix_lin_thickness2_neck2').val(min_lin_thickness2.toFixed(4));
			$('#max_lin_thickness2_neck2').val(max_lin_thickness2.toFixed(4));
			
			if(tot_thickness2_neck1 < min_lin_thickness){
				var Hasil	= "TOO LOW";
			}
			if(tot_thickness2_neck1 > max_lin_thickness){
				var Hasil	= "TOO HIGH";
			}
			if(tot_thickness2_neck1 > min_lin_thickness && tot_thickness2_neck1 < max_lin_thickness){
				var Hasil	= "OK";
			}
			$('#hasil_linier_thickness2_neck1').val(Hasil);
			
			if(tot_thickness2_neck2 < min_lin_thickness2){
				var Hasil2	= "TOO LOW";
			}
			if(tot_thickness2_neck2 > max_lin_thickness2){
				var Hasil2	= "TOO HIGH";
			}
			if(tot_thickness2_neck2 > min_lin_thickness2 && tot_thickness2_neck2 < max_lin_thickness2){
				var Hasil2	= "OK";
			}
			$('#hasil_linier_thickness2_neck2').val(Hasil2);
		});
