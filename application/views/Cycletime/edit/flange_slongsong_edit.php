...
<form action="#" method="POST" id="form_proses_bro">   
	<div class="box box-primary">
		...
		<div class="box-body">
			...
			<div class='form-group row'>
				<label class='label-control col-sm-2'><b>Thickness Design</b></label>
				<div class='col-sm-2'>              
					<?php
						echo form_input(array('id'=>'design','name'=>'design','class'=>'form-control input-sm numberOnly','autocomplete'=>'off','placeholder'=>'Thickness (Design)'),floatval($header[0]->design));											
				...
				<div class="box-body" style="">
					<table id="my-grid" class="table table-striped table-bordered table-hover table-condensed" width="100%"> 
							...
							<?php
								...
								foreach($detStructureN1 AS $val => $valx){
									...
									if($ListdetStructure[0]['category'] == 'RESIN'){
										...
										$layY	= "<input type='text' name='ListDetail2N1[".$no."][layer]' id='layerStrN1_".$no."' data-nomor='".$no."' class='form-control input-sm numberOnly layerStrN1' style='text-align:right; width:80px;' value='".floatval($valx['layer'])."'>";
								...
								<tbody>
									...
									foreach($detStructureAddN1 AS $val => $valx){
										...
										<tr>
											...
											<td align='center'><input type='text' name='ListDetailAdd2N1[<?=$no;?>][containing]' id='Addcontaining2N1_<?=$no;?>' class='form-control input-sm numberOnly' readonly='readonly' style='text-align:right; width:80px;' value='<?=$valx['containing'];?>'></td>
						...
						<tbody>
							<tr>
								<td class="text-center" colspan='4'></td>
								<td class="text-left" colspan='2' style='vertical-align: middle;'><b>STRUCTURE NECK 1</b></td>
								<td align='center'><input type='text' name='thickStrN1' id='thickStrN1' class='form-control input-sm' readonly='readonly' style='text-align:right; width:80px;' value='<?= $footerStructureN1[0]['total'];?>'></td>
							</tr>
							<tr>
								<td class="text-center" colspan='4'></td>
				...
				<div class="box-body" style="">
					<table id="my-grid" class="table table-striped table-bordered table-hover table-condensed" width="100%"> 
							...
							<?php
								...
								foreach($detStructureN2 AS $val => $valx){
									...
									if($ListdetStructure2[0]['category'] == 'RESIN'){
										...
										$layY	= "<input type='text' name='ListDetail2N2[".$no2."][layer]' id='layerStrN2_".$no2."' data-nomor='".$no2."' class='form-control input-sm numberOnly layerStrN2' style='text-align:right; width:80px;' value='".floatval($valx['layer'])."'>";
								...
								<tbody>
									...
									foreach($detStructureAddN2 AS $val => $valx){
										...
										<tr>
											...
											<td align='center'><input type='text' name='ListDetailAdd2N2[<?=$no;?>][containing]' id='Addcontaining2N2_<?=$no;?>' class='form-control input-sm numberOnly' readonly='readonly' style='text-align:right; width:80px;' value='<?=$valx['containing'];?>'></td>
						...
						<tbody>
							<tr>
								<td class="text-center" colspan='4'></td>
								<td class="text-left" colspan='2' style='vertical-align: middle;'><b>STRUCTURE NECK 2</b></td>
								<td align='center'><input type='text' name='thickStrN2' id='thickStrN2' class='form-control input-sm' readonly='readonly' style='text-align:right; width:80px;' value='<?= $footerStructureN2[0]['total'];?>'></td>
							</tr>
							<tr>
								<td class="text-center" colspan='4'></td>
...
<script src="<?php echo base_url('application/views/Component/edit/flange_mould_edit/change_all.js'); ?>"></script>
<script src="<?php echo base_url('application/views/Component/edit/flange_mould_edit/change_material.js'); ?>"></script>
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl		= base_url + active_controller +'/flange_slongsong_edit';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
