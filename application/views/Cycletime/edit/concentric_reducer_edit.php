			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-4'>              
					<?php
						...
						echo form_input(array('id'=>'diameter2','name'=>'diameter2','class'=>'form-control input-sm HideCost'),$header[0]->diameter2);	
					?>	
...
<script src="<?php echo base_url('application/views/Component/edit/concentric_reducer_edit/change_all.js'); ?>"></script>
<script src="<?php echo base_url('application/views/Component/edit/concentric_reducer_edit/change_material.js'); ?>"></script>
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl		= base_url + active_controller +'/concentric_reducer_edit';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
