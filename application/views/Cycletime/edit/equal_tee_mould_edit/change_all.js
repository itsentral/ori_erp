...
function LuasArea2(diameter, waste, high, estimasi){
	
	var LuasAreaTwo		= 3.14 * (diameter + estimasi)/1000 * (high / 1000) * (1+(waste/100));
...
function Length(){
	...
	var length		= wrap_length + (diameter + 2 * design) + 50;
...
function High(){
	...
	var high		= 0.5 * (wrap_length + diameter + 2 * design) + 25;
...
function ChangeLuasArea(){
	...
	var LuasArea2x = LuasArea2(diameter, waste, high, estimasi);
