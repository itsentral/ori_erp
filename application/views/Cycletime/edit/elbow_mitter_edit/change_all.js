...
function LuasArea(diameter, estimasi, waste, length){
	var Luas_Area_Rumus		= 3.14 * (diameter + estimasi) * length / 1000000 * (1+waste/100);
...
function ChangeLuasArea(){
	...
	var LuasAreaX 	= LuasArea(diameter, estimasi, waste, length);
