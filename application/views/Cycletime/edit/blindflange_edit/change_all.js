...
function LuasArea(flange_od, waste){
	var Luas_Area_Rumus		= (3.14/4)*((Math.pow(flange_od,2))/1000000)*(1+(waste/100));
...
function ChangeLuasArea(){ 
	...
	var LuasAreaX 	= LuasArea(flange_od, waste);
...
function ChangeAreaToLiner(Area){
	...
	var last_cost_2 	= ((Area * value_2 * layer_2)/1000) * 1.2 ;
	var last_cost_4 	= ((Area * value_4 * layer_4)/1000) * 1.2 ;
