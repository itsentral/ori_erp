...
<script src="<?php echo base_url('application/views/Component/edit/equal_tee_mould_edit/change_all.js'); ?>"></script>
<script src="<?php echo base_url('application/views/Component/edit/equal_tee_mould_edit/change_material.js'); ?>"></script>
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl		= base_url + active_controller +'/equal_tee_slongsong_edit';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
