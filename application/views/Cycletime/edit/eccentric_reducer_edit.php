...
<script src="<?php echo base_url('application/views/Component/edit/eccentric_reducer_edit/change_all.js'); ?>"></script>
<script src="<?php echo base_url('application/views/Component/edit/eccentric_reducer_edit/change_material.js'); ?>"></script>
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl		= base_url + active_controller +'/eccentric_reducer_edit';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
