...
function LuasArea(diameter, waste, length, diameter2){
	var pangkat1		= Math.pow(length, 2);
	var help1			= (diameter - diameter2)/2;
	var pangkat2		= Math.pow(help1, 2);
	var help2			= pangkat1 + pangkat2;
	var pangkat3		= Math.pow(help2, 0.5);
	
	var Luas_Area_Rumus		= 3.14 * pangkat3 * ((diameter/2)+(diameter2/2)) / 1000000 * (1 + (waste/100));
...
function ChangeLuasArea(){
	...
	var LuasAreaX 	= LuasArea(diameter, waste, length, diameter2);
