...
<form action="#" method="POST" id="form_proses_bro">   
	<div class="box box-primary">
		...
		<div class="box-body">
			...
			<div class='form-group row'>
				<label class='label-control col-sm-2'><b>Thickness Design | Radius <span class='text-red'>*</span></b></label>
				<div class='col-sm-2'>              
					<?php
				...
				<div class='col-sm-2'>   
					<?php
						echo form_input(array('id'=>'radius','name'=>'radius','class'=>'form-control input-sm numberOnly','autocomplete'=>'off','placeholder'=>'Pipe Thickness (Design)', 'readonly'=>'readonly'),floatval($header[0]->radius));
					?>
				</div>
...
<script src="<?php echo base_url('application/views/Component/edit/end_cap_edit/change_all.js'); ?>"></script>
<script src="<?php echo base_url('application/views/Component/edit/end_cap_edit/change_material.js'); ?>"></script>
