	...
	<div class="box box-primary">
		...
		<div class="box-body">
			...
			<div class='form-group row'>
				...
				<div class='col-sm-2'>  
<?php				
					echo form_input(array('type'=>'text','id'=>'length','name'=>'length','class'=>'form-control input-sm numberOnly','autocomplete'=>'off','placeholder'=>'Pipe Length','readonly'=>'readonly'), floatval($header[0]->panjang));				
						?>
				</div> 
...
<script src="<?php echo base_url('application/views/Component/edit/elbow_mitter_edit/change_all.js'); ?>"></script>
<script src="<?php echo base_url('application/views/Component/edit/elbow_mitter_edit/change_material.js'); ?>"></script>
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl		= base_url + active_controller +'/elbow_mitter_edit';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
