...
$dimensi 		= (!empty($header[0]->dimensi))?$header[0]->dimensi:'';
	...
	<div class="box box-primary">
		...
		<div class="box-body">
			...
			<div class='form-group row'>
				...
				<label class='label-control col-sm-2'><b>Material/Brand </b></label>
				<div class='col-sm-4'>
					<?php
			...
			<div class='form-group row'>
				<label class='label-control col-sm-2'><b>Dimensi </b></label>
				<div class='col-sm-4'>
					<?php
					 echo form_input(array('id'=>'dimensi','name'=>'dimensi','class'=>'form-control input-md','placeholder'=>'Dimensi'),$dimensi);
					?>
				</div>
				<label class='label-control col-sm-2'><b>Spesifikasi </b></label>
				<div class='col-sm-4'>
					<?php
					 echo form_input(array('id'=>'spesifikasi','name'=>'spesifikasi','class'=>'form-control input-md','placeholder'=>'Spesifikasi'),$spesifikasi);
					?>
				</div>
			</div>
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl		= base_url + active_controller +'/add_lainnya';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
