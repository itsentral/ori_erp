	...
	<div class="box box-primary">
		...
		<div class="box-body">
			...
			<div class='form-group row'>
				...
				<label class='label-control col-sm-2'><b>Ukuran/Diameter (mm) </b></label>
				<div class='col-sm-4'>
					<?php
					 echo form_input(array('id'=>'diameter','name'=>'diameter','class'=>'form-control input-md autoNumeric','placeholder'=>'Ukuran/Diameter'),$diameter);
					?>
				</div>
			</div>
			<div class='form-group row'>
				...
				<label class='label-control col-sm-2'><b>Panjang (mm) </b></label>
				<div class='col-sm-4'>
					<?php
					 echo form_input(array('id'=>'panjang','name'=>'panjang','class'=>'form-control input-md autoNumeric','placeholder'=>'Panjang'),$panjang);
					?>
				</div>
			</div>
			<div class='form-group row'>
				<label class='label-control col-sm-2'><b>Standart/Tipe </b></label>
				<div class='col-sm-4'>
					<?php
					 echo form_input(array('id'=>'standart','name'=>'standart','class'=>'form-control input-md','placeholder'=>'Standart/Tipe'),$standart);
					?>
				</div>
				<label class='label-control col-sm-2'><b>Radius (mm) </b></label>
				<div class='col-sm-4'>
					<?php
					 echo form_input(array('id'=>'radius','name'=>'radius','class'=>'form-control input-md autoNumeric','placeholder'=>'Radius'),$radius);
					?>
				</div>
			</div>
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl		= base_url + active_controller +'/add_bold_nut';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
