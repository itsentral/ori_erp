<?php
	...
	{
		$joint = 1;
		$qDetail1		= "SELECT a.*, b.price_ref_estimation FROM component_detail a LEFT JOIN raw_materials b ON a.id_material = b.id_material WHERE a.id_product='".$id_product."' AND a.detail_name='GLASS' AND a.id_material <> 'MTL-1903000' AND a.id_category <> 'TYP-0001'";
		$qDetail2		= "SELECT a.*, b.price_ref_estimation FROM component_detail a LEFT JOIN raw_materials b ON a.id_material = b.id_material WHERE a.id_product='".$id_product."' AND a.detail_name='RESIN AND ADD' AND a.id_material <> 'MTL-1903000' AND a.id_category <> 'TYP-0001'";
				...
				<tbody>
					...
					if (isset($restDetail1)) {
						...
						<tr>
							...
							<td class="text-right" style='background-color: bisque;'><?= $material_weight;?> Kg</td>
