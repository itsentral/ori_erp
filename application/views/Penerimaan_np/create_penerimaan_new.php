						...
						<div class="row">
                          <div class="form-group">
                              ...
                              <select class="form-control input-sm" name="jenis_pph" id="jenis_pph">
									...
									<option value="1106-01-02">PREPAID TAX - PPH 25</option>
									<option value="1106-01-03">PREPAID TAX - PPH 23</option>
									<option value="1106-01-04">PREPAID TAX - PPH 22</option>
									<option value="1106-01-05">PREPAID TAX - PPH 21</option>
                   ...
                   <div class="col-sm-6 form-horizontal">
                        <div class="row">
                         ...
                         <div class="form-group">
                              ...
                              <div class="col-sm-6">
								<?php
								echo form_dropdown('bank',$datbank, '',array('id'=>'bank','required'=>'required','class'=>'form-control'));
								?>								 
		...
		<div class="row">
			...
			<div class="col-lg-6">
                       ...
                       <div class="form-group " hidden>
                            ...
                            <div class="col-sm-6">
                              <input type="hidden" name="biaya_adm" class="form-control input-sm divide" id="biaya_adm" value="0" onchange="cekall()">
                            </div>
                        </div>
						<div class="form-group ">
                            <label class="col-sm-4 control-label">PPH </label>
                            <div class="col-sm-6">
                            <input type="text" name="biaya_pph" class="form-control input-sm divide" id="biaya_pph" value="0" onchange="cekall()">
                            </div>
                        </div>
	 ...
	 function savemutasi(){
        ...
        function(isConfirm){
			if(isConfirm) {
				...
				$.ajax({
					url: base_url+"penerimaan_np/save_penerimaan",
					dataType : "json",
					type: 'POST',
					data: formdata,
