...
<form action="#" method="POST" id="form_proses_bro" enctype="multipart/form-data"> 
	<div class="box box-primary">
		<div class="box-header">
			...
			<div class="box-tool pull-right">
				<button class="btn btn-success" type="button" onclick="add_inv()">
					<i class="fa fa-plus"></i>Buat Penerimaan
				</button>
		...
		<tr>
			...
			<a href="<?=base_url('penerimaan_np/printout/'.$record->kd_pembayaran)?>" class='btn btn-sm btn-default' title='Print'target="_blank"><i class='fa fa-print'></i></a>
			</td>
