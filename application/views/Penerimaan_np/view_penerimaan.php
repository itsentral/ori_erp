...
// print_r($id_bq);
// exit;
$data_header        = $this->db->query("SELECT * FROM tr_invoice_np_payment WHERE kd_pembayaran ='$kodebayar'")->row();
$data_detail        = $this->db->query("SELECT sum(total_bayar_idr) as total_bayar FROM tr_invoice_np_payment_detail WHERE kd_pembayaran ='$kodebayar'")->row();
...
// $dt_fabric          = $this->db->query("SELECT * FROM tr_invoice_np_detail WHERE no_invoice ='$no_invoice' AND kategori_detail ='FABRIC'")->result();
// $rail               = $this->db->query("SELECT * FROM tr_invoice_np_detail WHERE no_invoice ='$no_invoice' AND kategori_detail ='BQ'")->result();
// $sew                = $this->db->query("SELECT * FROM tr_invoice_np_detail WHERE no_invoice ='$no_invoice' AND kategori_detail ='SEWING'")->result();
// $airfreight         = $this->db->query("SELECT * FROM tr_invoice_np_detail WHERE no_invoice ='$no_invoice' AND kategori_detail ='AIRFREIGHT'")->result();
// $akomodasi          = $this->db->query("SELECT * FROM tr_invoice_np_detail WHERE no_invoice ='$no_invoice' AND kategori_detail ='AKOMODASI'")->result();
// $acc                = $this->db->query("SELECT * FROM tr_invoice_np_detail WHERE no_invoice ='$no_invoice' AND kategori_detail ='ACCESSORIES'")->result();
?>

<?php
$inv          =  $this->db->query("SELECT * FROM tr_invoice_np_header WHERE no_invoice = '$data_header->no_invoice' ")->row();
$alamat_cust =  $this->db->query("SELECT * FROM customer WHERE id_customer = '$data_header->id_customer'")->row();
?>
                   ...
                   <div class="col-sm-6 form-horizontal">                       
					    <div class="form-group ">
                            ...
                            <div class="col-sm-6" style="padding-top: 8px;">
                              ...
                              <input type="text" name="total_invoice" class="form-control input-sm" id="total_invoice" value="<?php echo number_format($data_detail->total_bayar) ?>" readonly>
						...
						<div class="form-group ">
                            ...
                            <div class="col-sm-6" style="padding-top: 8px;">                              
                              <input type="text" name="total_bank" class="form-control input-sm" id="total_bank" value="<?php echo  number_format($data_header->jumlah_bank_idr,2)?>" readonly>             
                       ...
                       <div class="form-group ">
                            ...
                            <div class="col-sm-6" style="padding-top: 8px;">                              
                              <input type="text" name="biaya_adm" class="form-control input-sm" id="biaya_adm" value="<?php echo  number_format($data_header->biaya_admin_idr,2)?>"readonly >             
						...
						<div class="form-group ">
                            ...
                            <div class="col-sm-6" style="padding-top: 8px;">                              
                            <input type="text" name="total_terima" class="form-control input-sm" id="total_terima" value="<?php echo  number_format($data_header->jumlah_pembayaran_idr,2)?>" readonly>             
						...
						<form id="form-detail-mutasi" method="post">
							<table class="table table-bordered" width="100%" id="tabel-detail-mutasi">
								...
								<?php
									...
									$detail        = $this->db->query("SELECT * FROM tr_invoice_np_payment_detail WHERE kd_pembayaran ='$kodebayar'")->result();
									...
									$inv_det  = $this->db->query("SELECT * FROM tr_invoice_np_header WHERE no_invoice ='$kodeinv'")->row();
								...
								<tbody>
									<tr>
										...
										<td class="text-center"><?php echo  number_format($inv_det->total_invoice_idr,2)?></td>
										<td class="text-center"><?php echo  number_format($inv_det->sisa_invoice_idr,2)?></td>
