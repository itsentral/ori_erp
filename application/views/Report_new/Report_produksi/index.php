	...
	<div class="box-body">
        ...
        <!-- <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                <li class="active"><a href="#tab_1" data-toggle="tab" aria-expanded="true">Report</a></li>
                <li class=""><a href="#tab_2" data-toggle="tab" aria-expanded="false">Group Report</a></li>
            </ul>
                    ...
                    <div class='form-group row'>
                        <div class='col-sm-4'>
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control float-right text-center" id="range_picker3" placeholder='Select range date' readonly value='' style='width:300px;'>
                            </div>
                        </div>
                        <div class='col-sm-8'>
...
<script>
	$(document).ready(function(){
		$('#range_picker,#range_picker2,#range_picker3').daterangepicker({
            locale: {
                format: 'YYYY-MM-DD'
            }
        });
		...
		DataTables3(tgl_awal2,tgl_akhir2);
	});
	...
	$('#range_picker3').on('apply.daterangepicker', function(ev, picker) {
		let range = $('#range_picker3').val();
		var tgl_awal 	= '0';
		var tgl_akhir 	= '0';
		if(range != ''){
			var sPLT 		= range.split(' - ');
		...
		DataTables3(tgl_awal,tgl_akhir);
	});

	$('#range_picker3').on('cancel.daterangepicker', function(ev, picker) {
		let range = $('#range_picker3').val();
		var tgl_awal 	= '0';
		var tgl_akhir 	= '0';
		if(range != ''){
	...
	function DataTables3(tgl_awal=null,tgl_akhir=null){
		var dataTable = $('#my-grid3').DataTable({
			...
			"aLengthMenu": [[10, 20, 50, 100, 150], [10, 20, 50, 100, 150]],
			"ajax":{
				url : base_url + active_controller+'/get_data_json_spk_produksi_progress3',
				type: "post",
				data: function(d){
					d.tgl_awal = tgl_awal,
					d.tgl_akhir = tgl_akhir
