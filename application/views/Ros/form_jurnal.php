...
<?=form_open('Ros/jurnal_save',array('id'=>'frm_data','name'=>'frm_data','role'=>'form','class'=>'form-horizontal',));?>
...
<div class="tab-content">
	<div class="tab-pane active">
		...
		if($jenis_jurnal=='JV032') $link='index_jurnal_incoming';
		if($jenis_jurnal=='JV033') $link='index_jurnal_incoming';
		if($jenis_jurnal=='JV034') $link='closing_po_jurnal';
		if($jenis_jurnal=='JV040') $link='index_jurnal_ros';
		?>
			</tbody>
			</table>
			</div>
			<div class="box-footer">
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
						...
						<a href="<?=base_url("ros/".$link)?>" class="btn btn-warning btn-sm"><i class="fa fa-reply">&nbsp;</i>Kembali</a>
					</div>
				</div>
			</div>
		</div>
