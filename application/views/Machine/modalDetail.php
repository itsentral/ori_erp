<?php
	...
	// echo $id_product;
	$qHeader		= "SELECT * FROM bq_component_header WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."' ";
	$qDetail1		= "SELECT * FROM bq_component_detail WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."' AND detail_name='LINER THIKNESS / CB' AND id_material <> 'MTL-1903000' AND id_category <> 'TYP-0001'";
	$qDetail2		= "SELECT * FROM bq_component_detail WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."' AND detail_name='STRUKTUR THICKNESS' AND id_material <> 'MTL-1903000' AND id_category <> 'TYP-0001'";
	$qDetail2N1		= "SELECT * FROM bq_component_detail WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."' AND detail_name='STRUKTUR NECK 1' AND id_material <> 'MTL-1903000' AND id_category <> 'TYP-0001'";
	$qDetail2N2		= "SELECT * FROM bq_component_detail WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."' AND detail_name='STRUKTUR NECK 2' AND id_material <> 'MTL-1903000' AND id_category <> 'TYP-0001'";
	$qDetail3		= "SELECT * FROM bq_component_detail WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."' AND detail_name='EXTERNAL LAYER THICKNESS' AND id_material <> 'MTL-1903000' AND id_category <> 'TYP-0001'";
	$detailResin1	= "SELECT * FROM bq_component_detail WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."' AND detail_name='LINER THIKNESS / CB' AND id_category ='TYP-0001' ORDER BY id_detail DESC LIMIT 1 ";
	$detailResin2	= "SELECT * FROM bq_component_detail WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."' AND detail_name='STRUKTUR THICKNESS' AND id_category ='TYP-0001' ORDER BY id_detail DESC LIMIT 1 ";
	$detailResin2N1	= "SELECT * FROM bq_component_detail WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."' AND detail_name='STRUKTUR NECK 1' AND id_category ='TYP-0001' ORDER BY id_detail DESC LIMIT 1 ";
	$detailResin2N2	= "SELECT * FROM bq_component_detail WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."' AND detail_name='STRUKTUR NECK 2' AND id_category ='TYP-0001' ORDER BY id_detail DESC LIMIT 1 ";
	
	$detailResin3	= "SELECT * FROM bq_component_detail WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."' AND detail_name='EXTERNAL LAYER THICKNESS' AND id_category ='TYP-0001' ORDER BY id_detail DESC LIMIT 1 ";
	$qDetailPlus1	= "SELECT * FROM bq_component_detail_plus WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."' AND detail_name='LINER THIKNESS / CB' AND id_material <> 'MTL-1903000'";
	$qDetailPlus2	= "SELECT * FROM bq_component_detail_plus WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."'  AND detail_name='STRUKTUR THICKNESS' AND id_material <> 'MTL-1903000'";
	$qDetailPlus2N1	= "SELECT * FROM bq_component_detail_plus WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."'  AND detail_name='STRUKTUR NECK 1' AND id_material <> 'MTL-1903000'";
	$qDetailPlus2N2	= "SELECT * FROM bq_component_detail_plus WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."'  AND detail_name='STRUKTUR NECK 2' AND id_material <> 'MTL-1903000'";
	
	$qDetailPlus3	= "SELECT * FROM bq_component_detail_plus WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."'  AND detail_name='EXTERNAL LAYER THICKNESS' AND id_material <> 'MTL-1903000'";
	$qDetailPlus4	= "SELECT * FROM bq_component_detail_plus WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."'  AND detail_name='TOPCOAT' AND id_material <> 'MTL-1903000'";
	$qDetailAdd1	= "SELECT * FROM bq_component_detail_add WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."'  AND detail_name='LINER THIKNESS / CB'";
	$qDetailAdd2	= "SELECT * FROM bq_component_detail_add WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."'  AND detail_name='STRUKTUR THICKNESS'";
	$qDetailAdd2N1	= "SELECT * FROM bq_component_detail_add WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."'  AND detail_name='STRUKTUR NECK 1'";
	$qDetailAdd2N2	= "SELECT * FROM bq_component_detail_add WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."'  AND detail_name='STRUKTUR NECK 2'";
	
	$qDetailAdd3	= "SELECT * FROM bq_component_detail_add WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."'  AND detail_name='EXTERNAL LAYER THICKNESS'";
	$qDetailAdd4	= "SELECT * FROM bq_component_detail_add WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."'  AND detail_name='TOPCOAT'";
	$qFooter1		= "SELECT * FROM bq_component_footer WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."'  AND detail_name='LINER THIKNESS / CB'";
	$qFooter2		= "SELECT * FROM bq_component_footer WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."'  AND detail_name='STRUKTUR THICKNESS'";
	$qFooter2N1		= "SELECT * FROM bq_component_footer WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."'  AND detail_name='STRUKTUR NECK 1'";
	$qFooter2N2		= "SELECT * FROM bq_component_footer WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."'  AND detail_name='STRUKTUR NECK 2'";
	
	$qFooter3		= "SELECT * FROM bq_component_footer WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."'  AND detail_name='EXTERNAL LAYER THICKNESS'";
	// $qTiming		= "SELECT * FROM bq_component_time WHERE id_product='".$id_product."'";
	// echo $qDetail2;
	...
	{
		$qDetail1		= "SELECT * FROM bq_component_detail WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."' AND detail_name='GLASS' AND id_material <> 'MTL-1903000'";
		$qDetail2		= "SELECT * FROM bq_component_detail WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."' AND detail_name='RESIN AND ADD' AND id_material <> 'MTL-1903000'";
		$qDetail3		= "SELECT * FROM bq_component_lamination WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."' AND detail_name='Inside Lamination' ";
		$qDetail4		= "SELECT * FROM bq_component_lamination WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."' AND detail_name='Outside Lamination' AND width > 0";
		$qDetailAdd1	= "SELECT * FROM bq_component_detail_add WHERE id_bq='".$id_bq."' AND id_milik='".$id_milik."'  AND detail_name='RESIN AND ADD'";
					...
					if ($restHeader[0]['parent_product']=='branch joint' || $restHeader[0]['parent_product']=='field joint' || $restHeader[0]['parent_product']=='shop joint')
					{
						...
						foreach($restDetail1 AS $val => $valx){
							...
							<tr>
								...
								<td class="text-right" style='background-color: <?=$bgC4;?>; color: <?= $Cl4;?>'><?= number_format($valx['last_cost'],3);?></td>
							</tr>
							<?php
						}
						...
						<?php
							...
							if(!empty($restDetailAdd1)){
								...
								foreach($restDetailAdd1 AS $val => $valx){
									...
									?>
								<tr>
									<td class="text-left" width='24%' colspan="2"><?= strtoupper($valx['nm_category']);?></td>
									<td class="text-left" colspan='7'><?= strtoupper($valx['nm_material']);?></td>
									<td class="text-center"width='6%'  style='background-color: <?=$bgC8;?>; color: <?= $Cl8;?>'><?= floatval($valx['perse']);?></td>
									<td class="text-right"width='6%' style='background-color: <?=$bgC0;?>; color: <?= $Cl0;?>'><?= $valx['last_cost'];?></td>
								</tr>
									<?php
								}
							} 
