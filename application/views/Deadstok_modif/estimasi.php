			...
			<table class="table table-bordered table-striped" id="my-grid" width='100%'>
				<thead class='thead'>
					<tr class='bg-blue'>
						...
						<th class="text-center th">Est By</th>
						<th class="text-center th">Est Date</th>
						<th class="text-center th">Status</th>
						<th class="text-center th">Reject Reason</th>
	...
	$(document).on('click', '.approve', function(){
		...
		function(isConfirm) {
			if (isConfirm) {
				loading_spinner();
				$.ajax({
					url			: base_url+active_controller+'/approve/'+bF,
					type		: "POST",
					data		: "id="+bF,
					cache		: false,
					dataType	: 'json',
