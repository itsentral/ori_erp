...
$qSupplier	= "	SELECT * FROM laporan_wip_per_hari WHERE `date` = '".$tanggal."' ";
    ...
    <table class="table table-bordered table-striped" id="my-grid2">
        <thead>
            <tr class='bg-blue'>
				...
				<th rowspan='2' class="text-center valignmid" width='80px'>ID</th>
...
<script>
    ...
    function DataTables2(tanggal=null){
		var dataTable = $('#my-grid2').DataTable({
			...
			"ajax":{
				url : base_url + active_controller+'/getDataJSONDetail_WIP', 
				type: "post",
				data: function(d){
