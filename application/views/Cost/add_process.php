	...
	<div class="box box-primary">
		...
		<div class="box-body">
			<div class='form-group row'>		 	 
				...
				<label class='label-control col-sm-2'><b>Standart Rate (USD) <span class='text-red'>*</span></b></label>
				<div class='col-sm-4'>             
						<?php
							echo form_input(array('id'=>'std_rate','name'=>'std_rate','class'=>'form-control input-md numberOnly','autocomplete'=>'off','placeholder'=>'Standart Rate USD'));											
						?>		
				</div>
			</div>
			<div class='form-group row'>		 	 
