	...
	<div class="box box-primary">
		...
		<div class="box-body">
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-5'>              
					<?php
						echo form_input(array('id'=>'nama','name'=>'nama','class'=>'form-control input-md','readonly'=>'readonly'), strtoupper(get_name('con_nonmat_new','material_name','code_group',$row[0]['code_group'])));	
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-5'>              
					<?php
						echo form_input(array('id'=>'nm_material','name'=>'nm_material','class'=>'form-control input-md','readonly'=>'readonly'), strtoupper(get_name('con_nonmat_new','spec','code_group',$row[0]['code_group'])));
			...
			<div class='form-group row'>
				...
				<div class='col-sm-5'>          
					<?php
						echo form_input(array('id'=>'price_ref_purchase','name'=>'price_ref_purchase','class'=>'form-control input-md','readonly'=>'readonly','autocomplete'=>'off','placeholder'=>'Price Ref Purchase'), number_format($row[0]['price_purchase']));											
					?>	
				</div>
				<div class='col-sm-5'>          
					<?php
						echo form_input(array('id'=>'price_from_supplier','name'=>'price_from_supplier','class'=>'form-control input-md','readonly'=>'readonly','autocomplete'=>'off','placeholder'=>'Price From Supplier'), number_format($row[0]['price_supplier']));											
					?>	
				</div>
			</div>
			<div class='form-group row'>
				...
				<div class='col-sm-5'>          
					<?php
						echo form_input(array('id'=>'exp_price_ref_pur','name'=>'exp_price_ref_pur','class'=>'form-control input-md','readonly'=>'readonly','placeholder'=>'Exp Price Ref Purchase'), $row[0]['expired_purchase']);											
					?>	
				</div>
				<div class='col-sm-5'>          
					<?php
						echo form_input(array('id'=>'exp_price_ref_sup','name'=>'exp_price_ref_sup','class'=>'form-control input-md','readonly'=>'readonly','placeholder'=>'Exp Price Ref Purchase'), $row[0]['expired_supplier']);											
					?>	
				</div>
			</div>
			<div class='form-group row'>
				...
				<div class='col-sm-5'>             
					<?php
						echo form_input(array('id'=>'price_ref_estimationx','name'=>'price_ref_estimationx','class'=>'form-control input-md','readonly'=>'readonly','autocomplete'=>'off','placeholder'=>'Price Ref Estimation'), number_format($row[0]['rate']));											
					?>
				</div>
				<div class='col-sm-5'>             
					<?php
			...
			<div class='form-group row'>
				...
				<div class='col-sm-5'>             
					<?php
						echo form_input(array('id'=>'exp_price_ref_estx','name'=>'exp_price_ref_estx','class'=>'form-control input-md','readonly'=>'readonly','placeholder'=>'Exp Price Ref Estimation'), $row[0]['expired']);											
					?>
				</div>
				<div class='col-sm-5'>             
					<?php
						echo form_input(array('id'=>'exp_price_ref_est','name'=>'exp_price_ref_est','class'=>'form-control input-md tgl','readonly'=>'readonly','placeholder'=>'Exp Price Ref Estimation'), $row[0]['expired_supplier']);											
					?>
				</div>
			</div>
			<div class='form-group row'>
...
<script>
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl		= base_url + active_controller +'/edit_rutin';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						loading_spinner();
						var formData  	= new FormData($('#form_proses_bro')[0]);
						var baseurl		= base_url + active_controller +'/reject_rutin';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
	...
	// 	let new_price = price_from_supplier + (price_from_supplier * profit);
		
	// 	$('#price_ref_estimation').val(number_format(new_price));
