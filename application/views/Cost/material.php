		...
		<div>
			...
			<div class="tab-content">
				<div role="tabpanel" class="tab-pane <?=$active1_mat;?>" id="material">
					<br>
					<a href="<?php echo site_url('cost/excel_price_ref_material') ?>" target='_blank' class="btn btn-sm btn-success" style='float:right;'>Download</a>
					<br><br>
					...
					<table id="example4" class="table table-bordered table-striped">
						<thead>
							<tr class='bg-blue'>
								...
								<th class="text-center mid">Price Ref. ($)</th>
								<th class="text-center mid">Expired</th>
								<th class="text-center mid">Status</th>
								<th class="text-center mid">Price Pur. ($)</th>
								<th class="text-center mid">Expired</th>
								<th class="text-center mid">Status</th>
								<th class="text-center mid">CostBook (Rp)</th>
								<th class="text-center mid">Option</th>
							</tr>
						</thead>
						<tbody>  
						<?php 
						if($row){
								...
								foreach($row as $datas){
									...
									$date_exp2 	= $datas->exp_price_ref_pur;
									...
									$PRE = (!empty($datas->price_ref_estimation))?$datas->price_ref_estimation:0;
									$PRP = (!empty($datas->price_ref_purchase))?$datas->price_ref_purchase:0;
									
									$tit_lab = 'Approve';
									$dis_lab = '';
									$col_lab = 'success';
									if($datas->app_price_sup == 'N'){
									...
									$COSTBOOK = (!empty($GetCostBook[$datas->id_material]))?$GetCostBook[$datas->id_material]:0;
									...
									echo"<tr>";							
										...
										echo"<td align='right'>".number_format($PRP,2)."</td>";
										echo"<td align='right'>".$date_expv2."</td>";
										echo"<td align='left'>".$tambahan2."</td>";
										echo"<td align='right'>".number_format($COSTBOOK,2)."</td>";
										echo"<td align='center'>"; 
											if($akses_menu['update']=='1'){
												echo"&nbsp;<a href='".site_url($this->uri->segment(1).'/edit_material/'.$datas->id_material)."' class='btn btn-sm btn-".$col_lab."' ".$dis_lab." title='".$tit_lab."' data-role='qtip'><i class='fa fa-check'></i></a>";
											}
										echo"</td>";
									echo"</tr>";
								}
				...
				<div role="tabpanel" class="tab-pane <?=$active2_acc;?>" id="accessories">
					<br>
					<a href="<?php echo site_url('cost/excel_price_ref_aksesoris') ?>" target='_blank' class="btn btn-sm btn-success" style='float:right;'>Download</a>
					<div>
						<!-- Nav tabs -->
						<ul class="nav nav-tabs" role="tablist">
							...
							<div role="tabpanel" class="tab-pane <?=$active1;?>" id="boltnut">
								...
								<table class="table table-bordered table-striped" id="my-grid_bold_nut" width='100%'>
									<thead width='100%'>
										<tr class='bg-blue'>
											<th class="text-center mid">#</th>
											<th class="text-center mid">ID</th>
											<th class="text-center mid">Name</th>
											<th class="text-center mid">Material</th> 
											<th class="text-center mid">Diameter (mm)</th> 
											<th class="text-center mid">Panjang (mm)</th> 
											<th class="text-center mid">Standard/Tipe</th> 
											<th class="text-center mid">Radius (mm)</th> 
											<th class="text-center mid">Satuan</th> 
											<!-- <th class="text-center mid">Keterangan</th> -->
											<th class="text-center mid">Price Ref. ($)</th>
											<th class="text-center mid">Expired</th>
											<th class="text-center mid">Status</th>
											<th class="text-center mid">Price Pur. ($)</th>
								...
								<table class="table table-bordered table-striped" id="my-grid_plate" width='100%'>
									<thead width='100%'>
										<tr class='bg-blue'>
											...
											<th class="text-center mid">Name</th>
											<th class="text-center mid">Material</th> 
											<th class="text-center mid">Thickness (mm)</th> 
											<th class="text-center mid">Density (kg/cm3)</th> 
											<th class="text-center mid">Ukuran Standard</th> 
											<th class="text-center mid">Standart</th> 
											<th class="text-center mid">Satuan</th> 
											<!-- <th class="text-center mid">Keterangan</th> -->
											<th class="text-center mid">Price Ref. ($)</th>
											<th class="text-center mid">Expired</th>
								...
								<table class="table table-bordered table-striped" id="my-grid_gasket" width='100%'>
									<thead width='100%'>
										<tr class='bg-blue'>
											...
											<th class="text-center mid">Material</th> 
											<th class="text-center mid">Thickness (mm)</th> 
											<th class="text-center mid">Ukuran Standart</th> 
											<th class="text-center mid">Standard</th>
											<th class="text-center mid">Satuan</th> 
											<!-- <th class="text-center mid">Keterangan</th> -->
											<th class="text-center mid">Price Ref. ($)</th>
											<th class="text-center mid">Expired</th>
								...
								<table class="table table-bordered table-striped" id="my-grid_lainnya" width='100%'>
									<thead width='100%'>
										<tr class='bg-blue'>
											...
											<th class="text-center mid">ID</th>
											<th class="text-center mid">Name</th>
											<th class="text-center mid">Material/Brand</th> 
											<th class="text-center mid">Dimensi</th> 
											<th class="text-center mid">Spesifikasi</th> 
											<th class="text-center mid">Ukuran Standart</th> 
											<th class="text-center mid">Standart</th> 
											<th class="text-center mid">Satuan</th> 
											<!-- <th class="text-center mid">Keterangan</th> -->
								...
								<table class="table table-bordered table-striped" id="my-grid_lokal" width='100%'>
									<thead>
										<tr class='bg-blue'>
											...
											<th class="text-center">Price Ref. (IDR)</th>
											<th class="text-center">Expired</th>
											<th class="text-center">Status</th>
											<th class="text-center">Price Pur. (IDR)</th>
											<th class="text-center">Expired</th>
											<th class="text-center">Status</th>
											<th class="text-center no-sort">Option</th>
										</tr>
								...
								<table class="table table-bordered table-striped" id="example2" width='100%'>
									<thead width='100%'>
										<tr class='bg-blue'>
											...
											<th class="text-center">Price Ref. (USD)</th>
											<th class="text-center">Expired</th>
											<th class="text-center">Status</th>
											<th class="text-center">Price Pur. (USD)</th>
											<th class="text-center">Expired</th>
											<th class="text-center">Status</th>
									...
									foreach ($transport_export as $key => $value) { $key++;
										...
										//purchase
										$date_now2 	= date('Y-m-d');
										$date_exp2 	= $value['expired_purchase'];
										...
										$PRE = (!empty($value['price']))?$value['price']:0;
										$PRP = (!empty($value['price_purchase']))?$value['price_purchase']:0;
										
										$tit_lab = 'Approve';
										$dis_lab = '';
										$col_lab = 'success';
										if($value['app_price_sup'] == 'N'){
											$tit_lab= "Tidak ada pengajuan price";
											$dis_lab = 'disabled';
											$col_lab = 'danger';
										}
										...
										echo "<tr>";
											...
											echo "<td align='center'>"; 
												if($akses_menu['update']=='1'){
													echo"&nbsp;<a href='".site_url($this->uri->segment(1).'/edit_eksport/'.$value['id'])."' class='btn btn-sm btn-".$col_lab."' ".$dis_lab." title='".$tit_lab."' data-role='qtip'><i class='fa fa-check'></i></a>";
												}
											echo"</td>";
										echo "</tr>";
									}
					...
					<table class="table table-bordered table-striped" id="example3" width='100%'>
						<thead width='100%'>
							<tr class='bg-blue'>
								...
								<th class="text-center">Expired</th>
								<th class="text-center">Status</th>
								<th class="text-center">Price Pur.</th>
								<th class="text-center">Expired</th>
								<th class="text-center">Status</th>
								<th class="text-center mid">CostBook (Rp)</th>
								<th class="text-center">App</th>
						...
						foreach ($rutin as $key => $value) { $key++;
							...
							$PRE = (!empty($value['rate']))?$value['rate']:0;
							$PRP = (!empty($value['price_purchase']))?$value['price_purchase']:0;
							...
							$COSTBOOK = (!empty($GetCostBook[$value['code_group']]))?$GetCostBook[$value['code_group']]:0;
							...
							echo "<tr>";
								...
								echo "<td align='center'>"; 
									if($akses_menu['update']=='1'){
										echo"&nbsp;<a href='".site_url($this->uri->segment(1).'/edit_rutin/'.$value['id'])."' class='btn btn-sm btn-".$col_lab."' ".$dis_lab." title='".$tit_lab."' data-role='qtip'><i class='fa fa-check'></i></a>";
									}
								echo"</td>";
							echo "</tr>";
						}
...
<script>
	$(document).ready(function(){
		...
		DataTables_bold_nut(baut_filter.barang1, baut_filter.brand1, uri_app);
		
		let plate_filter = {
			'barang2' : $('#barang2').val(),
			'brand2' : $('#brand2').val()
		};
		DataTables_plate(plate_filter.barang2, plate_filter.brand2, uri_app);
		
		let gasket_filter = {
			'barang3' : $('#barang3').val(),
			'brand3' : $('#brand3').val()
		};
		DataTables_gasket(gasket_filter.barang3, gasket_filter.brand3, uri_app);
		
		let lainnya_filter = {
			'barang4' : $('#barang4').val(),
			'brand4' : $('#brand4').val()
		};
		DataTables_lainnya(lainnya_filter.barang4, lainnya_filter.brand4, uri_app);
		...
		DataTables_trucking(category,area,dest,truck, uri_app);
	...
	function DataTables_bold_nut(nama=null,brand=null,uri_app=null){
		var dataTable = $('#my-grid_bold_nut').DataTable({
			...
			"ajax":{
				url : base_url + active_controller+'/data_side_bold_nut_app',
				type: "post",
				data: function(d){
					d.nama = nama,
					d.brand = brand,
	...
	function DataTables_plate(nama=null,brand=null,uri_app=null){
		var dataTable = $('#my-grid_plate').DataTable({
			...
			"aLengthMenu": [[10, 20, 50, 100, 150], [10, 20, 50, 100, 150]],
			"ajax":{
				url : base_url + active_controller+'/data_side_plate_app',
				type: "post",
				data: function(d){
					d.nama = nama,
					d.brand = brand,
	...
	function DataTables_gasket(nama=null,brand=null,uri_app=null){
		var dataTable = $('#my-grid_gasket').DataTable({
			...
			"aLengthMenu": [[10, 20, 50, 100, 150], [10, 20, 50, 100, 150]],
			"ajax":{
				url : base_url + active_controller+'/data_side_gasket_app',
				type: "post",
				data: function(d){
					d.nama = nama,
					d.brand = brand,
	...
	function DataTables_lainnya(nama=null,brand=null,uri_app=null){
		var dataTable = $('#my-grid_lainnya').DataTable({
			...
			"aLengthMenu": [[10, 20, 50, 100, 150], [10, 20, 50, 100, 150]],
			"ajax":{
				url : base_url + active_controller+'/data_side_lainnya_app',
				type: "post",
				data: function(d){
					d.nama = nama,
					d.brand = brand,
	...
	//trucking
	function DataTables_trucking(category = null, area = null, dest = null, truck = null, uri_app=null){
		...
		var dataTable = $('#my-grid_lokal').DataTable({
			...
			"aLengthMenu": [[10, 20, 50, 100, 150], [10, 20, 50, 100, 150]],
			"ajax":{
				url : base_url + active_controller+'/data_side_trucking_app',
				type: "post",
				data: function(d){
					d.category 	= category,
					d.area 	= area,
