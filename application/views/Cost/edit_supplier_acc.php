	...
	<div class="box box-primary">
		...
		<div class="box-body">
			...
			<div class='form-group row'>
				...
				<div class='col-sm-4'>
					<select name="satuan_" id="satuan_" class='form-control input-md' disabled="disabled">
						<?php
						foreach ($satuan as $key => $value) {
							$selected = ($value['id_satuan'] == $row[0]['satuan'])?'selected':'';
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl		= base_url + active_controller +'/edit_supplier_acc';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
