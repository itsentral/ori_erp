...
<form action="#" method="POST" id="form_proses_bro">   
	<div class="box box-primary">
		...
		<div class="box-body">
			...
			<div class='form-group row'>
				<label class='label-control col-sm-2'><b>Price Ref Estimation ($)</b></label>
				<div class='col-sm-5'>             
					<?php
						echo form_input(array('id'=>'price_ref_estimationx','name'=>'price_ref_estimationx','class'=>'form-control input-md autoNumeric3','readonly'=>'readonly','autocomplete'=>'off','placeholder'=>'Price Ref Estimation'), number_format($row[0]['price_ref_estimation'],3));											
					?>
				</div>
				<div class='col-sm-5'>             
					<?php
						echo form_input(array('id'=>'price_ref_estimation','name'=>'price_ref_estimation','class'=>'form-control input-md autoNumeric3','autocomplete'=>'off','placeholder'=>'Price Ref Estimation'), number_format($row[0]['price_ref_estimation'],3));											
					?>
				</div>
			</div>
			<div class='form-group row'>
				...
				<div class='col-sm-5'>             
					<?php
						echo form_input(array('id'=>'exp_price_ref_est','name'=>'exp_price_ref_est','class'=>'form-control input-md tgl','readonly'=>'readonly','placeholder'=>'Exp Price Ref Estimation'), $row[0]['exp_price_ref_est']);											
					?>
				</div>
			</div>
			<div class='form-group row'>
				...
				<div class='col-sm-5'>             
					<?php
						echo form_textarea(array('id'=>'ket_price','name'=>'ket_price','class'=>'form-control input-md','rows'=>'3'), $row[0]['ket_price']);											
					?>
				</div>
				<div class='col-sm-5'>             
					<?php
						echo form_textarea(array('id'=>'ket_price_sup','name'=>'ket_price_sup','class'=>'form-control input-md','readonly'=>'readonly','rows'=>'3'), strtoupper($row[0]['ket_price_sup']));											
					?>
				</div>
			</div>
			<div class='form-group row'>
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl		= base_url + active_controller +'/edit_material';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						loading_spinner();
						var formData  	= new FormData($('#form_proses_bro')[0]);
						var baseurl		= base_url + active_controller +'/reject_material';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
