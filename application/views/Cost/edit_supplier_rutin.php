	...
	<div class="box box-primary">
		...
		<div class="box-body">
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-4'>              
					<?php
						echo form_input(array('id'=>'nama','name'=>'nama','class'=>'form-control input-md','autocomplete'=>'off','placeholder'=>'Material ID','readonly'=>'readonly'), strtoupper(get_name('con_nonmat_new','material_name','code_group',$row[0]['code_group'])));	
				...
				<div class='col-sm-4'>              
					<?php
						echo form_input(array('id'=>'nm_material','name'=>'nm_material','class'=>'form-control input-md','autocomplete'=>'off','placeholder'=>'Material Name','readonly'=>'readonly'), strtoupper(get_name('con_nonmat_new','spec','code_group',$row[0]['code_group'])));	
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl		= base_url + active_controller +'/edit_supplier_rutin';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
