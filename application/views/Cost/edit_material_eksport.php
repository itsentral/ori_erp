	...
	<div class="box box-primary">
		...
		<div class="box-body">
			...
			<div class='form-group row'>		 	 
				...
				<div class='col-sm-5'>              
					<?php
						echo form_input(array('id'=>'nm_material','name'=>'nm_material','class'=>'form-control input-md','readonly'=>'readonly'), strtoupper($row[0]['shipping_name']));
			...
			<div class='form-group row'>
				...
				<div class='col-sm-5'>          
					<?php
						echo form_input(array('id'=>'price_ref_purchase','name'=>'price_ref_purchase','class'=>'form-control input-md','readonly'=>'readonly','autocomplete'=>'off','placeholder'=>'Price Ref Purchase'), number_format($row[0]['price_purchase'],2));											
					?>	
				</div>
				<div class='col-sm-5'>          
					<?php
						echo form_input(array('id'=>'price_from_supplier','name'=>'price_from_supplier','class'=>'form-control input-md','readonly'=>'readonly','autocomplete'=>'off','placeholder'=>'Price From Supplier'), number_format($row[0]['price_supplier'],2));											
					?>	
				</div>
			</div>
			<div class='form-group row'>
			...
			<div class='form-group row'>
				...
				<div class='col-sm-5'>             
					<?php
						echo form_input(array('id'=>'price_ref_estimationx','name'=>'price_ref_estimationx','class'=>'form-control input-md','readonly'=>'readonly','autocomplete'=>'off','placeholder'=>'Price Ref Estimation'), number_format($row[0]['price'],2));											
					?>
				</div>
				<div class='col-sm-5'>             
					<?php
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl		= base_url + active_controller +'/edit_eksport';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						loading_spinner();
						var formData  	= new FormData($('#form_proses_bro')[0]);
						var baseurl		= base_url + active_controller +'/reject_eksport';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
