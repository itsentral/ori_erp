...
<form action="#" method="POST" id="form_proses_bro">   
	<div class="box box-primary">
		...
		<div class="box-body">
			...
			<div class='form-group row'>		 	 
				<label class='label-control col-sm-2'><b>Profit (%) <span class='text-red'>*</span></b></label>
				<div class='col-sm-2'>             
						<?php
							echo form_input(array('id'=>'profit','name'=>'profit','class'=>'form-control input-md numberOnly','autocomplete'=>'off','placeholder'=>'Profit','maxlength'=>'4'),(!empty($tanda))?floatval($data[0]['profit']):'');											
						?>		
				</div>
			</div>		
		</div>
...
<script>
	$(document).ready(function(){
		...
		$(document).on('click','#kembali', function(){
			window.location.href = base_url + active_controller + "/profit";
		});
