...
<nav class="navbar navbar-inverse">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="https://www.hostinger.co.id/" rel="nofollow"><img src="https://raw.githubusercontent.com/hostinger/banners/master/hostinger_welcome/images/hostinger-logo.png" width="120"></a>
        </div>
...
<div class="empty-account-page">
    <div class="container">
        <div class="row congratz">
            <h1>Akun Anda berhasil dibuat!</h1><i></i>
        ...
        <div class="column-wrap clearfix">
            ...
            <div class="col-xs-12 col-sm-4 column-custom-wrap">
                <div class="column-custom">
                    ...
                    <br>
                    <a href="https://www.hostinger.co.id/pengetahuan-dasar" rel="nofollow">Pelajari lebih lanjut</a>
                </div>
            </div>
            <div class="col-xs-12 col-sm-4 column-custom-wrap">
                <div class="column-custom">
        ...
        <div class="footer">
            <div class="row">
                ...
                <div class="copyright text-center">
                    Hostinger © 2019. Hak cipta dilindungi.
                </div>
            </div>
        </div>
    </div>
