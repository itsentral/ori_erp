...
class Set_bottom_price extends Admin_Controller
{
    //Permission
    protected $viewPermission = 'Set_bottom_price.View';
    protected $addPermission  = 'Set_bottom_price.Add';
    protected $managePermission = 'Set_bottom_price.Manage';
    protected $deletePermission = 'Set_bottom_price.Delete';
    ...
    public function index()
    {
        ...
        $this->template->title('Set Bottom Price');
