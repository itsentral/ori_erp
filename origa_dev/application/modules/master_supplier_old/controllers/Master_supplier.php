...
class Master_supplier extends Admin_Controller
{
  //Permission
  ...
  public function getDataJSON()
  {
    ...
    foreach ($query->result_array() as $row) {
      ...
      $nestedData[]  = "<div align='center'>" . strtoupper($row['name_type']) . "</div>";
  ...
  public function queryDataJSON($activation, $like_value = NULL, $column_order = NULL, $column_dir = NULL, $limit_start = NULL, $limit_length = NULL)
  {
    ...
    $sql = "
  			...
  			FROM
          master_supplier a
          LEFT JOIN child_supplier_type b on a.id_type = b.id_type
  			WHERE 1=1
          " . $where_activation . "
  				AND (
  				...
  				OR b.name_type LIKE '%" . $this->db->escape_like_str($like_value) . "%'
  	        )
  		";
  ...
  public function getDataProductCategory()
  {
    ...
    foreach ($query->result_array() as $row) {
      ...
      $nestedData[]  = "<div align='left'>" . strtoupper($row['shipping']) . "</div>";
      if ($this->auth->restrict($this->viewPermission)) :
        $nestedData[]  = "<div style='text-align:center'>
  ...
  public function queryDataProductCategory($activation, $like_value = NULL, $column_order = NULL, $column_dir = NULL, $limit_start = NULL, $limit_length = NULL)
  {
    ...
    $sql = "
          ...
          " . $where_activation . "
  				AND (
  				a.shipping LIKE '%" . $this->db->escape_like_str($like_value) . "%'
  ...
  public function modal_Process($page = "", $action = "", $id = "")
  {
    ...
    if ($page == 'Supplier') {
      if ($action == 'add' || $action == 'edit') {
        ...
        $this->template->render('view_supplier');
      }
  ...
  public function saveSupplier()
  {
    ...
    $id_country_factory     = $data['id_country_factory'];
    $id_prov_factory        = $data['id_prov_factory'];
    ...
    $id_country_excompany   = $data['id_country_excompany'];
    $id_prov_excompany      = $data['id_prov_excompany'];
    $city_excompany         = $data['id_city_excompany'];
    ...
    // PIC OFFICE
    $pic_name_office        = $data['pic_name'];
    $pic_position_office    = $data['pic_position'];
    $pic_phone_office       = $data['pic_phone'];
    $pic_email_office       = $data['pic_email'];
    $pic_wechat_office      = $data['pic_wechat'];
    $pic_wa_office          = $data['pic_wa'];
    $pic_web_office         = $data['pic_web'];
    $pic_card_office        = $data['pic_card'];
    $pic_card_office_old    = $data['filelama'];

    // PIC FACTORY
    $pic_name_factory       = $data['pic_name_factory'];
    $pic_position_factory   = $data['pic_position_factory'];
    $pic_phone_factory      = $data['pic_phone_factory'];
    $pic_email_factory      = $data['pic_email_factory'];
    $pic_wechat_factory     = $data['pic_wechat_factory'];
    $pic_wa_factory         = $data['pic_wa_factory'];
    $pic_web_factory        = $data['pic_web_factory'];
    $pic_card_factory_old   = $data['filelama_factory'];
    //$pic_card_factory       = $data['pic_card']['factory'];

    // PIC EXPORT COMPANY
    $pic_name_excompany     = $data['pic_name_excompany'];
    $pic_position_excompany = $data['pic_position_excompany'];
    $pic_phone_excompany    = $data['pic_phone_excompany'];
    $pic_email_excompany    = $data['pic_email_excompany'];
    $pic_wechat_excompany   = $data['pic_wechat_excompany'];
    $pic_wa_excompany       = $data['pic_wa_excompany'];
    $pic_web_excompany      = $data['pic_web_excompany'];
    $pic_card_excompany_old = $data['filelama_excompany'];
    ...
    $bank_beneficiary_no       = $data['bank_beneficiary_no'];
    $swift_code                = $data['swift_code'];
    $iban                      = $data['iban'];
    $bic                       = $data['bic'];
    $currency                  = $data['currency'];
    $bank_name_intermediary    = $data['bank_name_intermediary'];
    $bank_address_intermediary = $data['bank_address_intermediary'];
    $swift_code_intermediary   = $data['swift_code_intermediary'];
    $iban_intermediary         = $data['iban_intermediary'];
    $bic_intermediary          = $data['bic_intermediary'];
    ...
    if (!empty($pic_name_office)) {
      for ($i = 0; $i < count($pic_name_office); $i++) {
        $_FILES['pic_card']['name'] = $files_tmp['pic_card']['name'][$i];
        $_FILES['pic_card']['type'] = $files_tmp['pic_card']['type'][$i];
        $_FILES['pic_card']['tmp_name'] = $files_tmp['pic_card']['tmp_name'][$i];
        $_FILES['pic_card']['error'] = $files_tmp['pic_card']['error'][$i];
        $_FILES['pic_card']['size'] = $files_tmp['pic_card']['size'][$i];
        $config = array(
        ...
        if (empty($_FILES['pic_card']['name'][$i])) {
          $dataPICOffice[$i]['pic_card']     = $pic_card_office_old[$i];
        } else {
          $dataPICOffice[$i]['pic_card']     = $name_card;
        }

        if ($data['type'] == 'edit') {
          $dataPICOffice[$i]['modified_on']     = date('Y-m-d H:i:s');
          $dataPICOffice[$i]['modified_by']     = $this->auth->user_id();
        } else {
          $dataPICOffice[$i]['created_on']     = date('Y-m-d H:i:s');
          $dataPICOffice[$i]['created_by']     = $this->auth->user_id();
        }
      }
    }
    if (!empty($pic_name_factory)) {
      for ($i = 0; $i < count($pic_name_factory); $i++) {
        $_FILES['pic_card_factory']['name'] = $files_tmp['pic_card_factory']['name'][$i];
        $_FILES['pic_card_factory']['type'] = $files_tmp['pic_card_factory']['type'][$i];
        $_FILES['pic_card_factory']['tmp_name'] = $files_tmp['pic_card_factory']['tmp_name'][$i];
        $_FILES['pic_card_factory']['error'] = $files_tmp['pic_card_factory']['error'][$i];
        $_FILES['pic_card_factory']['size'] = $files_tmp['pic_card_factory']['size'][$i];
        $config = array(
        ...
        $this->load->library('upload', $config);
        $this->upload->initialize($config);
        if (!$this->upload->do_upload('pic_card_factory')) {
          $result = $this->upload->display_errors();
        } else {

          $data_foto  = array('upload_data' => $this->upload->data('pic_card_factory'));
          $ext = end((explode(".", $_FILES['pic_card_factory']['name'])));
          $name_card_factory = 'name_card_' . $id_supplier . "-P" . str_pad($i + 1, 2, "0", STR_PAD_LEFT) . "." . $ext;
        }
        ...
        $dataPICFactory[$i]['pic_card']     = $name_card_factory[$i];


        if (empty($_FILES['pic_card_factory']['name'][$i])) {
          $dataPICFactory[$i]['pic_card']     = $pic_card_factory_old[$i];
        } else {
          $dataPICFactory[$i]['pic_card']     = $name_card_factory;
        }

        if ($data['type'] == 'edit') {
          $dataPICFactory[$i]['modified_on']     = date('Y-m-d H:i:s');
          $dataPICFactory[$i]['modified_by']     = $this->auth->user_id();
        } else {
          $dataPICFactory[$i]['created_on']     = date('Y-m-d H:i:s');
          $dataPICFactory[$i]['created_by']     = $this->auth->user_id();
        }
      }
    }
    if (!empty($pic_name_excompany)) {
      ...
      for ($i = 0; $i < count($pic_name_excompany); $i++) {
        $_FILES['pic_card_excompany']['name'] = $files_tmp['pic_card_excompany']['name'][$i];
        $_FILES['pic_card_excompany']['type'] = $files_tmp['pic_card_excompany']['type'][$i];
        $_FILES['pic_card_excompany']['tmp_name'] = $files_tmp['pic_card_excompany']['tmp_name'][$i];
        $_FILES['pic_card_excompany']['error'] = $files_tmp['pic_card_excompany']['error'][$i];
        $_FILES['pic_card_excompany']['size'] = $files_tmp['pic_card_excompany']['size'][$i];
        $config = array(
          'upload_path' => './assets/img/master_supplier/PIC_Excompany/',
          'allowed_types' => 'gif|jpg|png|jpeg|JPG|PNG',
          'file_name' => 'name_card_' . $id_supplier . "-P" . str_pad($i + 1, 2, "0", STR_PAD_LEFT),
          'file_ext_tolower' => TRUE,
          'overwrite' => TRUE,
        ...
        $this->load->library('upload', $config);
        $this->upload->initialize($config);
        if (!$this->upload->do_upload('pic_card_excompany')) {
          $result = $this->upload->display_errors();
        } else {

          $data_foto  = array('upload_data' => $this->upload->data('pic_card_excompany'));
          $ext = end((explode(".", $_FILES['pic_card_excompany']['name'])));
          $name_card_excompany = 'name_card_' . $id_supplier . "-P" . str_pad($i + 1, 2, "0", STR_PAD_LEFT) . "." . $ext;
        }
        ...
        if (empty($_FILES['pic_card_excompany']['name'][$i])) {
          $dataPICExcompany[$i]['pic_card']     = $pic_card_excompany_old[$i];
        } else {
          $dataPICExcompany[$i]['pic_card']     = $name_card_excompany;
        }

        if ($data['type'] == 'edit') {
          $dataPICExcompany[$i]['modified_on']     = date('Y-m-d H:i:s');
          $dataPICExcompany[$i]['modified_by']     = $this->auth->user_id();
        } else {
          $dataPICExcompany[$i]['created_on']     = date('Y-m-d H:i:s');
          $dataPICExcompany[$i]['created_by']     = $this->auth->user_id();
        }
      }
    }
    ...
    if (!empty($bank_name)) {
      for ($i = 0; $i < count($bank_name); $i++) {
        ...
        $dataBANK[$i]['bank_name']                    = $bank_name[$i];
        $dataBANK[$i]['bank_address']                 = $bank_address[$i];
        $dataBANK[$i]['bank_beneficiary_name']        = $bank_beneficiary_name[$i];
        $dataBANK[$i]['bank_beneficiary_no']          = $bank_beneficiary_no[$i];
        $dataBANK[$i]['swift_code']                   = $swift_code[$i];
        $dataBANK[$i]['iban']                         = $iban[$i];
        $dataBANK[$i]['bic']                          = $bic[$i];
        $dataBANK[$i]['currency']                     = $currency[$i];
        $dataBANK[$i]['bank_name_intermediary']       = $bank_name_intermediary[$i];
        $dataBANK[$i]['bank_address_intermediary']    = $bank_address_intermediary[$i];
        $dataBANK[$i]['swift_code_intermediary']      = $swift_code_intermediary[$i];
        $dataBANK[$i]['iban_intermediary']            = $iban_intermediary[$i];
        $dataBANK[$i]['bic_intermediary']             = $bic_intermediary[$i];

        if ($data['type'] == 'edit') {
          $dataBANK[$i]['modified_on']     = date('Y-m-d H:i:s');
          $dataBANK[$i]['modified_by']     = $this->auth->user_id();
        } else {
          $dataBANK[$i]['created_on']     = date('Y-m-d H:i:s');
          $dataBANK[$i]['created_by']     = $this->auth->user_id();
        }
      }
    }
    ...
    if ($data['type'] == 'edit') {
      ...
      $insertData  = array(
        ...
        'id_country_factory'        =>  $id_country_factory,
        'id_prov_factory'           =>  $id_prov_factory,
        ...
        'id_country_excompany'      =>  $id_country_excompany,
        'id_prov_excompany'         =>  $id_prov_excompany,
        ...
        'id_product_category'       =>  $id_category,
        'remarks'                   =>  $remarks,
