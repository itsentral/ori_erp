		            ...
		            <table class="table table-hover table-bordered table-responsive">
		              ...
		              <tbody>
		                <tr id='exis_1' class='header_1'>
		                  ...
		                  <td class='text-right mid'><div class='order' id='exis_order_1'><?=number_format($qty_order1);?></div></td>
		                  <td class='text-right mid'><div class='propose' id='exis_propose_1'><?=number_format($qty_propose1);?></div></td>
		                  <td class='text-right mid'><div class='fg' id='exis_fg_1'><?=number_format($qtyfg1);?></div></td>
		                  <td class='text-right mid'><div class='bal' id='exis_balance_1'><?=number_format($qtybal1);?></div></td>
		                  <td class='text-right mid'><div id='exis_progress_1'><?=number_format($progres1,2);?> %</div></td>
		                </tr>
										<tr id='exis_2'>
		                ...
		                <tr id='doha_1'  class='header2_1'>
		                  ...
		                  <td class='text-right mid'><div class='order' id='doha_order_1'><?=number_format($qty_order2);?></div></td>
		                  <td class='text-right mid'><div class='propose' id='doha_propose_1'><?=number_format($qty_propose2);?></div></td>
		                  <td class='text-right mid'><div class='fg' id='doha_fg_1'><?=number_format($qtyfg2);?></div></td>
		                  <td class='text-right mid'><div class='bal' id='doha_balance_1'><?=number_format($qtybal2);?></div></td>
		                  <td class='text-right mid'><div id='doha_progress_1'><?=number_format($progres2,2);?> %</div></td>
		                </tr>
										<tr id='doha_2'>
		                ...
		                <tr>
		                  <td></td>
											<td class='text-left mid'>TOTAL</td>
		                  <td class='text-right mid'><div class='tot_order'><?=number_format($qty_order1 + $qty_order2);?></div></td>
		                  <td class='text-right mid'><div class='tot_propose'><?=number_format($qty_propose1 + $qty_propose2);?></div></td>
		                  <td class='text-right mid'><div class='tot_fg'><?=number_format($qtyfg1 + $qtyfg2);?></div></td>
		                  <td class='text-right mid'><div class='tot_bal'><?=number_format($qtybal1 + $qtybal2);?></div></td>
											<?php
											$progres = 0;
											if(($qtyfg1 + $qtyfg2) > 0 AND ($qty_propose1 + $qty_propose2) > 0){
												$progres = (($qtyfg1 + $qtyfg2)/($qty_propose1 + $qty_propose2)) * 100;
											 ...
											 ?>
		                  <td class='text-right mid'><div class='tot_progress'><?=number_format($progres,2);?> %</div></td>
		                </tr>
		              </tbody>
		            </table>
			        </div>
