...
class Proses_cost extends Admin_Controller
{
    //Permission
    protected $viewPermission = 'Proses_cost.View';
    protected $addPermission  = 'Proses_cost.Add';
    protected $managePermission = 'Proses_cost.Manage';
    protected $deletePermission = 'Proses_cost.Delete';
    ...
    public function index()
    {
        ...
        $this->template->title('Proses Cost');
