...
class Master_supplier extends Admin_Controller
{
    ...
    function print_request($id)
    {
        ...
        $cust_data      =  $this->Supplier_model->find_data('supplier', $id_supplier, 'id_supplier');
        $inisial        =  $this->Supplier_model->find_data('data_reff', $id_supplier, 'id_supplier');
    ...
    function rekap_pdf()
    {
        ...
        $kdcab = $session['kdcab'];
        $data_cus = $this->Supplier_model->rekap_data($kdcab)->result_array();
