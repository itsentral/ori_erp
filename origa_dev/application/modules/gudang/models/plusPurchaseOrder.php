...
function print_request_material($Nama_APP, $kode_trans, $koneksi, $printby, $check){
	...
	<table class="gridtable2" border='1' width='100%' cellpadding='2'>
		...
		<tr>
			<td align='center'><b><h2>REQUEST MATERIAL <?= $$kode_trans; ?></h2></b></td>
		</tr>
	</table>
	<br>
	<br>
	...
	<table class="gridtable" width='100%' border='1' cellpadding='2'>
        ...
        <th class="text-right" style='vertical-align:middle;' width='12%'>Qty Mutasi (Pack)</th>
        <th class="text-right" style='vertical-align:middle;' width='12%'>Qty Mutasi (Kg)</th>
		...
		<tbody>
			<?php
			$No=0;
            while($valx = mysqli_fetch_array($rest_d)){
              $No++;
