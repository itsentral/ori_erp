...
<div class="box">
    ...
    <div class="box-tool pull-left" style='margin-left: 30px;'>
        ...
        if(!empty($double_daycode)){
          foreach($double_daycode AS $val => $valx){ $val++;
            ...
            echo "<span style='color:red;'><b><br>".$val.") ".strtoupper($valx['nama_costcenter']).", ".strtoupper($valx['nama_product'])." [".$valx['daycode']."], JUMLAH DOUBLE ".$jml_doub." ".$ketX."</b></span>";
          }
        }
        else{
