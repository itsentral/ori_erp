...
<form class="" id="form-supplier" action="" method="post">
  <div class="box box-success">
    <div class="box-body" style="">
          ...
          <table id="my-grid3" class="table-condensed" width="100%">
            <thead>
              <tr style='background-color: #175477 !important; color: white; font-size: 15px !important;'>
                <th class="text-center" colspan='3'>DETAIL INTERNATIONAL SUPPLAYER</th>
              </tr>
            </thead>
          </table>
          <div class="col-md-6">
              ...
              <tbody>
                ...
                <tr id="my-grid-tr-id_prov">
                  ...
                  <td class="text-left">
                    ...
                    <label class="label_input">
					<input type="text" class="form-control required w50" id="id_prov" name="id_prov" placeholder="Province" value="<?= empty($getC->id_prov) ? '' : $getC->id_prov ?>">
                ...
                <tr id="my-grid-tr-city">
                  ...
                  <td class="text-left">
                    ...
                    <label class="label_input">
                      <input type="text" class="form-control required w50" id="city" name="city" placeholder="City" value="<?= empty($getC->city) ? '' : $getC->city ?>">
      ...
      <label class="label_input">
        <?php
        echo form_button(array('type' => 'button', 'class' => 'btn btn-md btn-success', 'style' => 'min-width:100px; float:right;', 'value' => 'save', 'content' => 'Save', 'id' => 'addInternationalSave')) . ' ';
        ?>
      </label>
