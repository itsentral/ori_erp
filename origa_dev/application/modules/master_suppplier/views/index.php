...
<div class="nav-tabs-custom">
  <ul class="nav nav-tabs">
    ...
    <li class=""><a href="#Customer_category" data-toggle="tab" aria-expanded="false">Master Supplier Category</a></li>
  </ul>
...
<script type="text/javascript">
  ...
  function add_data() {
    ...
    $("#view").load(siteurl + active_controller + 'modal_Process/Customer_International/add/');
    $("#ModalView").modal();
  }
