...
<div class="box">
    ...
    <span class="pull-right">
			<?php if($ENABLE_ADD) : ?>
					<a class="btn btn-success btn-md" href="<?= base_url('engine/add_bom') ?>" title="Add"> <i class="fa fa-plus">&nbsp;</i>Add</a>
			<?php endif; ?>
      <a class="btn btn-success btn-md" href="<?= base_url('engine/excel_report_all_bom') ?>" target='_blank' title="Download Excel"> <i class="fa fa-file-excel-o">&nbsp;</i>&nbsp;Download Excel</a>
...
<script type="text/javascript">
	...
	$(document).on('click', '.detail', function(){
		...
		$.ajax({
			type:'POST',
			url:siteurl+'engine/detail_bom/'+no_bom,
			data:{'no_bom':no_bom},
    ...
    function DataTables(){
  		var dataTable = $('#example1').DataTable({
  			...
  			"ajax":{
  				url : siteurl+'engine/data_side_bom',
  				type: "post",
  				data: function(d){
