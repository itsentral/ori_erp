...
class Slitting_cost extends Admin_Controller
{
    //Permission
    protected $viewPermission = 'Slitting_cost.View';
    protected $addPermission  = 'Slitting_cost.Add';
    protected $managePermission = 'Slitting_cost.Manage';
    protected $deletePermission = 'Slitting_cost.Delete';
    ...
    public function index()
    {
        ...
        $this->template->title('Slitting Cost');
